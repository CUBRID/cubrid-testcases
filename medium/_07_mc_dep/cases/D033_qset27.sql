...
SELECT attr1_int_unique_idx FROM virtual_c1
...
SELECT attr3_smallint_idx FROM virtual_c0
        WHERE attr3_smallint_idx > 7
          AND attr3_smallint_idx < 21 order by 1;
SELECT attr4_float_idx FROM base_c1
