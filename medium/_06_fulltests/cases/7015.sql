...
call change_owner('co_2_3_v', 'DBA') on class db_root;
CREATE VCLASS co_2_1_v;
call change_owner('co_2_1_v', 'DBA') on class db_root;
CREATE VCLASS co_5_1_v;
call change_owner('co_5_1_v', 'DBA') on class db_root;
CREATE VCLASS co_4_3_v;
call change_owner('co_4_3_v', 'DBA') on class db_root;
CREATE VCLASS co_3_3_v;
call change_owner('co_3_3_v', 'DBA') on class db_root;
CREATE VCLASS co_4_5_v;
call change_owner('co_4_5_v', 'DBA') on class db_root;
CREATE VCLASS co_1_1_v;
call change_owner('co_1_1_v', 'DBA') on class db_root;
CREATE VCLASS co_3_4_v;
call change_owner('co_3_4_v', 'DBA') on class db_root;
CREATE VCLASS sd_0_v;
call change_owner('sd_0_v', 'DBA') on class db_root;
CREATE VCLASS co_3_1_v;
call change_owner('co_3_1_v', 'DBA') on class db_root;
CREATE VCLASS co_4_4_v;
call change_owner('co_4_4_v', 'DBA') on class db_root;
CREATE VCLASS sd_1_4_v;
call change_owner('sd_1_4_v', 'DBA') on class db_root;
CREATE VCLASS sd_1_5_v;
call change_owner('sd_1_5_v', 'DBA') on class db_root;
CREATE VCLASS sd_2_3_v;
call change_owner('sd_2_3_v', 'DBA') on class db_root;
CREATE VCLASS sd_3_3_v;
call change_owner('sd_3_3_v', 'DBA') on class db_root;
CREATE VCLASS sd_4_2_v;
call change_owner('sd_4_2_v', 'DBA') on class db_root;
CREATE VCLASS sd_5_2_v;
call change_owner('sd_5_2_v', 'DBA') on class db_root;
CREATE VCLASS sd_6_1_v;
call change_owner('sd_6_1_v', 'DBA') on class db_root;
CREATE VCLASS sd_7_1_v;
call change_owner('sd_7_1_v', 'DBA') on class db_root;
CREATE VCLASS sd_8_1_v;
call change_owner('sd_8_1_v', 'DBA') on class db_root;
CREATE VCLASS sd_9_1_v;
call change_owner('sd_9_1_v', 'DBA') on class db_root;
CREATE VCLASS sd_10_1_v;
call change_owner('sd_10_1_v', 'DBA') on class db_root;
CREATE VCLASS sd_11_1_v;
call change_owner('sd_11_1_v', 'DBA') on class db_root;
CREATE VCLASS sd_2_4_v;
call change_owner('sd_2_4_v', 'DBA') on class db_root;
CREATE VCLASS sd_3_4_v;
call change_owner('sd_3_4_v', 'DBA') on class db_root;
CREATE VCLASS sd_4_3_v;
call change_owner('sd_4_3_v', 'DBA') on class db_root;
CREATE VCLASS sd_5_3_v;
call change_owner('sd_5_3_v', 'DBA') on class db_root;
CREATE VCLASS sd_6_2_v;
call change_owner('sd_6_2_v', 'DBA') on class db_root;
CREATE VCLASS co_0_v;
call change_owner('co_0_v', 'DBA') on class db_root;
CREATE VCLASS co_1_2_v;
call change_owner('co_1_2_v', 'DBA') on class db_root;
CREATE VCLASS co_2_2_v;
call change_owner('co_2_2_v', 'DBA') on class db_root;
CREATE VCLASS co_3_2_v;
call change_owner('co_3_2_v', 'DBA') on class db_root;
CREATE VCLASS co_4_2_v;
call change_owner('co_4_2_v', 'DBA') on class db_root;
CREATE VCLASS co_4_6_v;
call change_owner('co_4_6_v', 'DBA') on class db_root;
...
FILE       '$UNISQLX/one/qatools/dynamic_methods.o'
;
