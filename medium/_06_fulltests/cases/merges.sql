...
create index i_med2_a on med2(a);
create index i_med_a on med(a);
create index i_med_b on med(b);
select count(*) from med x,med2 y where x.a+1+y.a = y.a+y.a
	and x.a < 10 ;
select count(*) from med x,med2 y where y.a>0 and x.a+1+y.a2+1 = y.a+y.a
	and x.a < 10;
select count(*) from med x,med2 y where x.a+1 = y.a
	and x.a < 10 ;
select count(*) from med x,med2 y where x.a+1 = y.a;
select count(*) from med x,med2 y where x.a>-1 and y.a>0 and x.a+1+x.a+1 = y.a+y.a;
