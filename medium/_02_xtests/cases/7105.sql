...
select class_name, owner_name, class_type, is_system_class, tde_algorithm, partitioned, is_reuse_oid_class, collation, comment from db_class where  class_name = 'eeeoo';
rollback;
create class eeeoo (a int, b int, unique(a,b));
...
alter class eeeoo rename a as c;
select class_name, owner_name, class_type, is_system_class, tde_algorithm, partitioned, is_reuse_oid_class, collation, comment from db_class where  class_name = 'subeeeoo';
rollback;
create class eeeoo (a int, b int, unique(a,b));
