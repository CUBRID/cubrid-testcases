...
select NULL, b,    c,    NA,   e,    f    from v union
...
select NULL, NULL, NULL from v union
select a,    NULL, NULL from w union
select NULL, b,    NULL from x union
select NULL, NULL, c    from y union
select 5,    5,    5    from z;
select NA,   NA,   NA   from v union
select a,    NA,   NA   from w union 
select NA,   b,    NA   from x union
select NA,   NA,   c    from y union
select 5,    5,    5    from z; 
select NULL as p, NULL as q, NULL as r from v union
select a,    NULL, NULL from w union 
select NULL, b,    NULL from x union
select NULL, NULL, c    from y union
select 5,    5,    5    from z;
select 1 as p, 1 as q, 1 as r from v union
select a,    NULL, NULL from w union
select NULL, b,    NULL from x union
select NULL, NULL, c    from y union
select 5,    5,    5    from z;
select 1,    1,    1    from v union
select a,    NULL, NULL from w union
select NULL, b,    NULL from x union
select NULL, NULL, c    from y union
select 5,    5,    5    from z;
...
select cast('v' as varchar(5)) as p, cast('v' as varchar(5)) as q, 
       cast('v' as varchar(5)) as r from v union
select d,    NULL, NULL from w union
select NULL, e,    NULL from x union
select NULL, NULL, f    from y;
select cast('v' as varchar(5)), cast('v' as varchar(5)),    
