autocommit off;
insert into public.person(name, age, phones, hobbies, residence, lifetime, clubs)
values ('Amy', 20, {3437190, 3437191}, { 'reading', 'camping' , 111}, 
         ( insert into public.address(street, city)
 		    values ('1 Wolf St. ', 'Austin')), 223344, 
	{124, 'club1'}) to  person1;
insert into public.person(name, age, phones, residence, lifetime, clubs, love)
values ('John', 30, {3437290, 3437291}, (insert into public.address(street, city)
  		    values ('2 Eeat 20 st. ', 'Austin')), 223344,
	{125, 'club2',  person1},  person1) to  person2;
insert into public.person(name, phones, hobbies, residence, age, lifetime, love)
values ('Kent', {3437390}, {'music', 222},
       (insert into public.address(street, city)
       values ('10 West 1 St. ', 'New York')),
       35, 223355,  person2) to  person3;
insert into public.person(name, age, phones, hobbies, residence, lifetime, love)
...
insert into public.person(name, age, phones, residence, lifetime, love)
values ('Jack', 15, {3437490}, ( insert into public.address(street, city)
 		    values ('11 Wolf St. ', 'Houston')), 223399, 
	 person6)
	to  person7;
insert into public.person(name, age, phones, hobbies, residence, lifetime, love)
values ('Bob', 22, {3437491}, {'music'},( insert into public.address(street, city)
  		    values ('22 Eeat 20 st. ', 'Dallas')), 224400, 
	 person7)
	to  person8;
insert into public.person(name, phones, residence, age, lifetime, love)
...
insert into public.department(name, emps)
...
values ('dep10', { person14,  person4,  person11,  person9, 
	 person10}) to  d10;
insert into public.company(name, headquarter, president, departments)
	values ( 'IBM',
		( insert into public.address(street, city)
		values ('6 Red Rd.', 'Cleveland')), 
		( insert into public.person(name, age, hobbies, residence)
		values ('Jeff', 
                         30, 
                         {'music','reading'},
                         ( insert into public.address(street, city)
...
insert into public.company(name, headquarter, president, departments)
	values ( 'UniSQL',
		( insert into public.address(street, city)
		values ('9380 Research Blvd', 'Austin')), 
		( insert into public.person(name, age, phones, residence)
		values ('Jeff', 
                         33, 
                         { 3431010, 3452020 },
                         ( insert into public.address(street, city)
...
insert into public.company(name, headquarter, president, departments)
	values ( 'IBM',
		...
		( insert into public.person(name, age, phones, hobbies, residence)
		values ('Bob', 
                         35, 
...
insert into public.company(name, headquarter, president, departments)
	values ( 'TI',
		...
		( insert into public.person(name, age, residence)
		values ('Hans', 
                         65,
                         ( insert into public.address(street, city)
...
insert into public.company(name, headquarter, president, departments)
	values ( 'CompZ',
		...
		values ('Chen Yung', 
		         ...
		         values ('111 Wolf St. ', 'Austin')))),
	{ d6,  d8,  d9}) to  c13;
insert into public.empl(name, age, residence, salary, worksfor, lifetime, friends,
...
insert into public.empl(name, age, residence, salary, worksfor, friends, emp_date,
	emp_time, tax)
values ('Joyce', 
	40, 
        ( insert into public.address(street, city)
...
select name from public.empl e  where
 age = (select age from public.empl where
       e.salary = 30000 AND '183' = e.residence.street);
select name from public.empl e  where
 age = (select max(age) from public.empl where
