...
select _db_user to u1 from _db_user where name = 'PR4916_U1';
...
call add_user('PR4916_U1', '') on class _db_user;
call add_user('PR4916_U2', '') on class _db_user;
call add_user('PR4916_U3', '') on class _db_user;
call add_user('PR4916_U4', '') on class _db_user;
select _db_user to u1 from _db_user where name = 'PR4916_U1';
select _db_user to u2 from _db_user where name = 'PR4916_U2';
select _db_user to u3 from _db_user where name = 'PR4916_U3';
select _db_user to u4 from _db_user where name = 'PR4916_U4';
select _db_user to dba from _db_user where name = 'DBA';
call add_member(u1) on u2;
