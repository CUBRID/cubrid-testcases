...
select * from bar where x = 123.45 order by 1;
...
select count(*) from bar where x > 0 order by 1;
select * from bar where x < 100000 order by 1;
delete from bar where x < 100000 order by 1;
select count(*) from bar where x > 0 order by 1;
select count(*) from bar where x < 10000000 order by 1;
update bar set x = x / 2 where x < 10000000 order by 1;
