--+ holdcas on;
---- ALTER TABLE ...  CHANGE COLUMN  , type change : NUMERIC to DOUBLE
...
-- should fail
alter table t1 change n1 d1 double;
-- should fail (prec)
...
-- should fail
alter table t1 change n1 d1 double unique;
-- should fail : prec
