--Test the constraint of the foreign key using delete cascade and update no action with parition table(update parition table)
--it tests a constraint of the foreign key syntax using delete cascade and update no action with parition table,update parition table
...
update range_test set test_char = 'zzz' where test_char = 'aaa'; 
