--Test the constraint of the foreign key using update FK table
-- it tests a the constraint of the foreign key syntax using update FK table
...
update track set album = '003' where album = '001';
