--Test the constraint of the foreign key using delete cascade and update no action(delete FK table)
--it tests a constraint of the foreign key syntax using delete cascade and  update no action,delete from the FK table
