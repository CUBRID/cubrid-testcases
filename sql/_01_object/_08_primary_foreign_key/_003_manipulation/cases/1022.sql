--Test the constraint of the foreign key using delete no action(data don't exist in the FK table)
--it tests a constraint of the foreign key using delete no action,because data don't exist in the FK table,data in the PK table don't affect
