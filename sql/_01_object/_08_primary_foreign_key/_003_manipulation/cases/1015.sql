--Test the constraint of the foreign key using delete cascade
--it tests a constraint of the foreign key syntax using delete cascade,when data in the PK table is deleted,data in the FK table is deleted too
