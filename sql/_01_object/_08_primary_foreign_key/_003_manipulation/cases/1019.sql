--Test the constraint of the foreign key using delete restrict(data don't exist in the FK table)
--it tests a constraint of the foreign key syntax using delete restrict,when data don't exist in the FK table,data is deleted in the PK table
