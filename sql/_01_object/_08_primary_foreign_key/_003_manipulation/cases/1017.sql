--Test the constraint of the foreign key using delete FK table(delete cascade)
--it tests a  constraint of the foreign key syntax using delete FK table
...
delete from track where album = '003';
