--Test the constraint of the foreign key using update (update no action and FK table data don't exist)
--it tests constraint of the foreign key syntax using update,when data don't exist in the FK table,action of update is complete.
