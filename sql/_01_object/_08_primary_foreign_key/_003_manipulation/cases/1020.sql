--Test the constraint of the foreign key using delete FK table(delete restrict)
--it tests a  constraint of the foreign key syntax using delete restrict,data in the FK table can be deleted
