--Test the constraint of the foreign key using delete cascade and update no action with parition table 
--create partition table1,insert data into table1,create table2 using FK,insert data into table2,retrieve partition table1,retireve table2,drop table2,table1


create table range_test(id int ,
			test_int int,
			test_char char(50) not null primary key ,
...
insert into comment values (3, '333','bbb');
insert into comment values (4, '444','ggg');
