-- create a table with many fields,create a table having a FOREIGN KEY REFERENCES many created table's char data type fields
...
CREATE TABLE album(
 ...
 title varchar(100) ,
 artist  VARCHAR(100) ,
 PRIMARY KEY (id_1, id_2, id_3, id_4, id_5, id_6, id_7, id_8, id_9, id_10, 
