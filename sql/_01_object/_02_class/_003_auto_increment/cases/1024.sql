-- create a class with three different data type auto_increment field,the types are int ,decimal,numeric.insert data,select data,update these three different data type auto_increment fields,drop class
