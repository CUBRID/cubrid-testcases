--Test db_attr_setdomain_elm using create class with 'SHARED' attribute and 'SEQUENCE' attribute

create class test_class 
  (col1 sequence varchar(10) shared NULL, col2 date default '2001-05-05');
