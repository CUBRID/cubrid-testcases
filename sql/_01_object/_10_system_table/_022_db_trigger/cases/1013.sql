--+ holdcas on;
--Create trigger with 'statement insert' event and retrieve the priority from virtual class _db_trigger
...
create trigger test_trigger
  ...
  execute insert into op_record
          values(user, 'insert a new record to test_class', '2008-05-27 15:50:58');
