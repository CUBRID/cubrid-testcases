--+ holdcas on;
--Test method  get_owner() on  db_root
...
call change_owner('test_class1','test_user') on class db_root;
call get_owner('test_user.test_class1') on class db_root to test_class1_owner;
