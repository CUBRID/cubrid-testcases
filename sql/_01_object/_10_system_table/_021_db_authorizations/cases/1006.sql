--+ holdcas on;
--Test method change_owner() on  db_root
call login('dba') on class db_user;
call add_user('test_user1') on class db_root;
call add_user('test_user2') on class db_root;

create class test_class(col1 integer, col2 varchar(20));
grant select on test_class to test_user;
call change_owner('test_class','test_user2') on class db_root;
...
call drop_user('test_user1') on class db_root;
call drop_user('test_user2') on class db_root;
