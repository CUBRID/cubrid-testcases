-- create vclass for created class with threee int auto_increment field,insert data to this clause,select data ,insert data,select data ,update the auto_increment field,select data,drop class
