-- create vclass for created table with an auto_increment field,create trigger based on after delete event,insert data , delete data,select data , drop class
