-- create vclass for created range partition table,insert data to this class,select data from these partition
...
create vclass vxoo (
	a int, 
	b int
) as select * from range_test;

select * from vxoo order by a, b;
