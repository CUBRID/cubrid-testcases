-- create vclass for created class,insert data to this class,select data,insert data to this class by specifying the auto_increment field value,select data
