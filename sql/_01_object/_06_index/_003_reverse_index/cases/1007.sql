-- create reverse index on two fields at which create table using varchar and then drop index and insert/update/select/delete after drop
...
drop Reverse index "t_n_index" on t;
