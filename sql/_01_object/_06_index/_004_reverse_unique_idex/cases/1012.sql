-- create class on all type and create reverse Unique index on bit type and insert/update/delete/select data
...
create reverse Unique index t1_index on t1(col14);
