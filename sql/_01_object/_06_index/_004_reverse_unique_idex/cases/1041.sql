-- [er]create class on all type and create reverse Unique index on string string and insert/update/delete/select data
...
create reverse Unique index t1_index on t1(col2);
