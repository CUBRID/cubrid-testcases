-- [er]create class on all type and insert/update/delete/select data and create reverse Unique index on int type
...
create reverse Unique index t1_index on t1(col1);
