-- [er]create class on all type and create Unique index on SET type and insert/update/delete/select data
...
create Unique index t1_index on t1(col11);
...
SELECT * FROM t1 USING INDEX t1_index order by 1, 11;
