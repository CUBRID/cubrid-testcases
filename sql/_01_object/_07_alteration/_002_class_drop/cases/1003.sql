--create class and alter classs by adding some attributes and droping two attributes in one time
...
ALTER CLASS ddl_0001 drop attribute col20, col17;
ALTER CLASS ddl_0001 drop col13, col11;
ALTER ddl_0001 drop col8, col1;
