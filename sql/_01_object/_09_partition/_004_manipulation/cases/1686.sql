--[er]create range partition table with nvarchar data type and three partitions having no maxvalue,then insert data to this table,but the inserted separator field value is equal with boundary value
...
create table range_test(id int not null ,
	...
	insert into range_test values(9,'lll','lll',B'101',B'1111',N'lll',N'lll','llllllllll','2007-01-01 09:00:00');
