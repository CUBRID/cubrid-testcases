--test update(time) for many list partition(have no NULL value) with correct values within range
...
insert into list_test values(19,'11:20:00','2006-04-21','2006-04-21 09:00:00');
	update list_test set test_time      = '09:20:00' where test_time      = '09:00:00';
	update list_test set test_time      = '10:20:00' where test_time      = '10:00:00';
