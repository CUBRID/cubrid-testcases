--create range partition table with varchar data type and one partitions having no maxvalue,then insert data to this table,,then update the separator field value,the updated data is in the boundary of the separator value
...
update range_test set test_varchar     = 'aaa' where test_char     = 'ccc';
