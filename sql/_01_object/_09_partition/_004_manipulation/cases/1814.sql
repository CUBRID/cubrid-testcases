-- insert data  whith create hash partition table on a time field with size 4 and update data and  query data from every partition and then drop table
...
update hash_test set test_time = '18:20:18' where test_time = '09:20:04';
update hash_test set test_time = '18:20:01' where test_time = '09:10:03';
