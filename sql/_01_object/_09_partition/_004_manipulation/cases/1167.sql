--test delete(nchar): deleting all data in a list partition(has NULL) using a delete statement with all of the partition key values
...
delete from list_test where test_nchar   IN (N'aaa',NULL,N'bbb',N'ddd');
