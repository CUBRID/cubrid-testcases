--[er]test update(time) for list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_time      = '17:00:00' where test_time      = '09:00:00';
