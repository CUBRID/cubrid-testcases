-- insert data  whith create hash partition table on a char field with size 4 and update data to null  and  query data from every partition and then drop table
...
update hash_test set test_char = NULL where test_char = 'sss';
