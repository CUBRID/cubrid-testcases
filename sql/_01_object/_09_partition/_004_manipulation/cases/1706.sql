--[er]create range partition table with timestamp data type and three partitions having no maxvalue,then insert data to this table,but the inserted separator field value is equal with boundary value
...
create table range_test(id int not null,	
	...
	insert into range_test values(8,'12:00:00','2006-04-01','2006-04-01 10:00:00');
