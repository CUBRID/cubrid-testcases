--create range partition table with timestamp data type and three partitions having no maxvalue,then insert data to this table,then delete record where the separated fields' value is equal with some value
...
create table range_test(id int,	
	...
	delete from range_test  where test_timestamp      = '2006-01-11 08:20:00';
	delete from range_test  where test_timestamp      = '2006-03-11 09:50:00';
