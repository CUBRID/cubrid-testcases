--create range partition table with date data type and three partitions having maxvalue,then insert data to this table,then delete record where the separated field value is less than the boundary value
