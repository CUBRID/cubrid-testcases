--[er]test update(string) for many list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_string     = 'cccccccccc' where test_string     = 'gggggggggg';
