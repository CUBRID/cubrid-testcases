--[er]test updating nvarchar type list partition using three partitions and invalid value not exist in partitions
...
update list_test set test_nvarchar = (select test_nvarchar from list_test2 where  id = 8) where test_nvarchar = N'aaa';
update list_test set test_nvarchar = (select test_nvarchar from list_test2 where  id = 10) where test_nvarchar = N'fff';
