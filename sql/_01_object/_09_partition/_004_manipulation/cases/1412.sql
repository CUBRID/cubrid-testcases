--create range partition table with varchar data type and one partitions having no maxvalue,then insert data to this table,,then update the separator field value to null value
...
update range_test set test_varchar     = NULL where test_varchar     = 'ccc';
