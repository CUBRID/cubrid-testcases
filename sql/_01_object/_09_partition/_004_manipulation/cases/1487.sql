--create range partition table with int data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value to null value
...
update range_test set test_int      = NULL where test_int      = 26 ;
