-- insert data  whith create hash partition table on a nvarchar field with size 4 and query data from every partition and then dorp table
...
select * from hash_test where test_nvarchar = N'ccc';
