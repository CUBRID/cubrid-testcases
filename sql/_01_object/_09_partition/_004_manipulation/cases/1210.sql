--test delete(smallint): deleting a data in a list partition(has no NULL) using many partitions and two delete statement with a partition key value
create table list_test(id int,
	...
	delete from list_test where  test_smallint      = 7; 
	delete from list_test where  test_smallint      = 10;
