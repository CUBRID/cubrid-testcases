--create range partition table with string data type and one partition having no maxvalue,then insert data to this table,then delete several records whose separated value less than partition boundary value
...
create table range_test(id int ,
	...
	delete from range_test  where test_string   < 'dddddddddd';
