--create range partition table with date data type and three partitions having no maxvalue,then insert data to this table, the inserted separator field values contain null value
...
create table range_test(id int not null ,	
	...
	insert into range_test values(8,'12:00:00',NULL,'2006-04-01 10:00:00');
