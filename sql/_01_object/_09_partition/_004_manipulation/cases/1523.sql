--create range partition table with int data type and three partitions having maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
