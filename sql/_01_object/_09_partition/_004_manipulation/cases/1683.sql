--create range partition table with timestamp data type and three partitions having maxvalue,then insert data to this table,then delete record where the separated field value is less than the boundary value
...
delete from range_test  where test_timestamp  <'2006-04-01 09:00:00';
