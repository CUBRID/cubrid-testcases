--[er]test update(nvarchar varying) for list partition(have no NULL value) with null value
...
update list_test set test_nvarchar     = NULL where  test_nvarchar     = N'aaa';
