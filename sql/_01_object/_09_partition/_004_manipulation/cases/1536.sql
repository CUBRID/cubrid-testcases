--create range partition table with date data type and three partitions having maxvalue,then insert data to this table,then update the separator field value from null to other value
...
update range_test set test_date      = '2006-03-21' where test_date  is null;
