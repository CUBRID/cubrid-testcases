--test partition and non partition join with nchar type partition value
...
select a.test_nchar, b.test_nchar from list_test A, list_test2 B where a.test_nchar =N'aaa'
order by 1,2;
