--create a hash partition table  on timestamp field and insert into this table values that query from another new create hash partition  table on timestamp field and then drop tables
...
create table hash_test2(id int,    
        ...
        insert into hash_test2 values(51,null,null,null); 
