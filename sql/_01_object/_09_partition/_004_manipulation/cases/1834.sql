-- insert data  whith create hash partition table on a nchar field with size 4 and delete data from null and  query data from every partition and then drop table
...
delete from hash_test where test_nchar is null;
