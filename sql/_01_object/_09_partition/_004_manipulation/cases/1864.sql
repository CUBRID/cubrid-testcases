-- create a hash partition table  on int field and update this table to value that query from another table which new create and then drop tables
...
update hash_test set test_int = (select test_int from hash_test2 where  id = 8) where test_int =1.0;
update hash_test set test_int = (select test_int from hash_test2 where  id = 31) where test_int = 2.0;
