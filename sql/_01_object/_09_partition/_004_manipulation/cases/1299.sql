--[er]test updating date type list partition using three partitions and invalid value not exist in partitions
...
update list_test set test_date   = (select test_date from list_test2 where  id = 8) where test_date ='2006-02-01';
update list_test set test_date = (select test_date from list_test2 where  id = 20) where test_date = '2006-03-11';
