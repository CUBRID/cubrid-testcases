--test delete(nvarchar): deleting all data in a list partition(has NULL) using a delete statement with all of the partition key values
...
delete from list_test where test_nvarchar IN (N'aaa',NULL,N'bbb',N'ddd');
