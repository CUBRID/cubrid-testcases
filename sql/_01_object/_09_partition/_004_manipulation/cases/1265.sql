--test delete(timestamp): deleting all data in a list partition(has NULL) using many partitions and a delete statement with all of the partition key values
...
delete from list_test where  test_timestamp   IN ('2006-03-01 09:00:00','2006-03-11 09:00:00',null,'2006-03-21 09:00:00');
