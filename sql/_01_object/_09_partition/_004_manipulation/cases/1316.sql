--test partition and non partition join with string type partition value
...
select a.test_string, b.test_string from list_test A, list_test2 B where a.test_string ='aaaaaaaaaa'
order by 1,2;
