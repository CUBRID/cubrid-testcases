-- create a hash partition table  on nvarchar field and insert into this table values that query from another new create hash partition  table on nvarchar field and then drop tables
