--create range partition table with smallint data type and one partition having no maxvalue,then insert data to this table,then delete several records whose separated value less than partition boundary value
...
delete from range_test   where test_smallint <10;
