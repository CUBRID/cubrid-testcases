--create range partition table with date data type and three partitions having no maxvalue,then insert data to this table,then delete record where the separated field value is less than the boundary value
...
delete from range_test  where test_date  <'2006-04-01';
