--create range partition table with smallint data type and three partitions having no maxvalue,then insert data to this table, the inserted separator field values contain null value
...
create table range_test(id int,
	...
	insert into range_test values( 8,35,NULL,35.1802523285,35.9167372882,35.6244295835,35.982398624, 35,'2007-01-01 09:00:00');
