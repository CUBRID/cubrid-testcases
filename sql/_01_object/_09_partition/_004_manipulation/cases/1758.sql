-- create a hash partition table  on timestamp field and update this table to value that query from another table which new create and then drop tables
...
create table hash_test2(id int not null primary key,    
                           ...
                           test_date date,
                           test_timestamp timestamp);
        insert into hash_test2 values(1,'08:11:01','2006-01-01','2006-01-01 08:10:01');
        insert into hash_test2 values(2,'08:22:02','2006-01-11','2006-01-11 08:20:02');
        insert into hash_test2 values(3,'09:13:03','2006-02-01','2006-02-01 09:10:03');
        insert into hash_test2 values(4,'09:24:04','2006-02-11','2006-02-11 09:20:04');
        insert into hash_test2 values(5,'09:35:05','2006-03-01','2006-03-01 10:30:05');
        insert into hash_test2 values(6,'10:16:06','2006-03-11','2006-03-11 10:40:06');
        insert into hash_test2 values(7,'10:27:07','2006-04-01','2006-04-01 11:50:07');
        insert into hash_test2 values(8,'11:38:08','2006-04-11','2006-04-11 11:30:08');
        insert into hash_test2 values(9,'11:19:09','2006-05-01','2006-05-01 12:40:09');
        insert into hash_test2 values(10,'12:20:10','2006-05-11','2006-05-11 12:50:10');
        insert into hash_test2 values(11,'13:11:11','2006-06-01','2007-01-01 08:10:11');
        insert into hash_test2 values(12,'13:22:12','2006-06-11','2007-01-11 08:20:12');
        insert into hash_test2 values(13,'14:13:13','2006-07-01','2007-02-01 09:10:13');
        insert into hash_test2 values(14,'14:24:14','2006-07-11','2007-02-11 09:20:14');
        insert into hash_test2 values(15,'15:35:15','2006-08-01','2007-03-01 10:30:15');
        insert into hash_test2 values(16,'15:16:16','2006-08-11','2007-03-11 10:40:16');
        insert into hash_test2 values(17,'16:27:17','2006-09-01','2007-04-01 11:50:17');
        insert into hash_test2 values(18,'16:38:18','2006-09-11','2007-04-11 11:30:18');
        insert into hash_test2 values(19,'17:19:19','2006-10-01','2007-05-01 12:40:19');
        insert into hash_test2 values(20,'17:20:20','2006-10-11','2007-05-11 12:50:20');           
        insert into hash_test2 values(21,null,null,null); 
update hash_test set test_timestamp   = (select test_timestamp from hash_test2 where  id = 8) where test_timestamp ='2006-02-01 09:10:03';
update hash_test set test_timestamp = (select test_timestamp from hash_test2 where  id = 20) where test_timestamp = '2006-03-11 10:40:06';
