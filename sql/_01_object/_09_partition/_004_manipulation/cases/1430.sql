--create range partition table with timestamp data type and one partitions having no maxvalue,then insert data to this table,,then update the separator field value to null value
...
update range_test set test_timestamp = NULL where test_timestamp ='2005-12-01 09:00:00';
