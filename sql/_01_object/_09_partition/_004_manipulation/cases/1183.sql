--test delete(time): deleting all data in a list partition(has NULL) using a delete statement with all of the partition key values
...
delete from list_test where test_time  IN ('06:00:00',NULL,'07:00:00','09:00:00');
