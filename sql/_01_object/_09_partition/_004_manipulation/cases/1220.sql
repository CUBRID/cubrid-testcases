--test delete(timestamp): deleting a data in a list partition(has no NULL) using many partitions and two delete statement with a partition key value
...
insert into list_test values(19,'11:20:00','2006-04-21','2006-04-21 09:00:00');
	delete from list_test where  test_timestamp      = '2006-02-11 09:00:00';
	delete from list_test where  test_timestamp      = '2006-03-21 09:00:00';
