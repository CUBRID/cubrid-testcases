--test delete(char): deleting all data in a list partition(has no NULL) using many partitions and a delete statement with all of the partition key values
...
delete from list_test where  test_char  IN ('fff','ggg','hhh');
