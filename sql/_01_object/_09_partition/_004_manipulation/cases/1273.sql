--test inserting all data from non-partition to partition using two tables and select-insert(nchar)
...
insert into list_test2 values(14,NULL,NULL,NULL,NULL,'fff',NULL,NULL,'2006-03-01 09:00:00');
