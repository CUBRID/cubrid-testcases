--create range partition table with time data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
create table range_test(id int not null ,	
	...
	update range_test set test_time      = '08:30:00' where test_time = '08:10:00';
	update range_test set test_time      = '10:30:00' where test_time = '10:20:00';
