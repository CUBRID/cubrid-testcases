--test update(string) for list partition(have no NULL value) with correct values within range
...
update list_test set test_string     = 'bbbbbbbbbb' where test_string     ='aaaaaaaaaa';
