--test inserting one partition data from non-partition to partition using two tables and select-insert(timestamp) 
...
insert into list_test select * from list_test2 where test_timestamp  IN ('2006-03-01 09:00:00','2006-03-11 09:00:00',null,'2006-03-21 09:00:00');
