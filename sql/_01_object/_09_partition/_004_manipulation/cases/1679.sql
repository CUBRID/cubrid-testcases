--create range partition table with nvarchar data type and three partitions having no maxvalue,then insert data to this table
...
create table range_test(id int ,
	...
	insert into range_test values(6,'fff','fff',B'101',B'1111',N'fff',N'fff','eeeeeeeeee','2007-01-01 09:00:00');
