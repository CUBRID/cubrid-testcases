--create range partition table with char data type and one partitions having maxvalue,then insert data to this table,,then update the separator field value to null value
