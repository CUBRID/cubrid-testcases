-- insert data  whith create hash partition table on a timestamp field with size 4 and delete data and  query data from every partition and then drop table
...
delete from hash_test where test_timestamp in ('2006-01-01 08:10:01','2006-03-01 10:30:05','2006-05-01 12:40:09','2007-02-01 09:10:13','2007-04-01 11:50:17');
