--create range partition table with varchar data type and one partition having maxvalue,then insert data to this table,then delete  record whose separated value less than partition boundary value
