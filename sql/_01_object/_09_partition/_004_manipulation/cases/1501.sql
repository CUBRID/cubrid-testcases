--create range partition table with date data type and one partition,then insert data to this table,the inserted separator field values are less than boundary value
