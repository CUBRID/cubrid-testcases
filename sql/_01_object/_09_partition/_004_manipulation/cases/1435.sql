--create range partition table with int data type and one partition,then insert data to this table,the inserted separator field value contain null value
...
create table range_test(id int not null ,
	...
	insert into range_test values( 2,NULL,3,2.102201596,2.448271838,2.309828743,2.862653912,2,'2007-01-01 09:00:00');
...
select * from range_test where test_int  is NULL order by 1;
