--[er]test update(varchar) for many list partition(have NULL value) with incorrect values out of range
...
update list_test set test_varchar     = 'ccc' where test_varchar     = 'bbb';
