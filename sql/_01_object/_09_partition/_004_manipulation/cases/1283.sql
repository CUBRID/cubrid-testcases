--test inserting one partition data from non-partition to partition using two tables and select-insert(smallint) 
...
insert into list_test select * from list_test2 where test_smallint  IN (2,4,6,null,8,10);
