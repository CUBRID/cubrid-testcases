--create range partition table with int data type and three partitions having no maxvalue,then insert data to this table,then delete record whose separated value in a boundary
...
create table range_test(id int,
	...
	delete from range_test   where test_int  <20 and test_int   >=10;
