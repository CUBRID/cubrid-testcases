--create range partition table with nchar data type and three partitions having maxvalue,then insert data to this table,then delete record where the separated fields' value is equal with some value
