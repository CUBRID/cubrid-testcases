--test update(nvarchar varying) for list partition(have no NULL value) with correct values within range
...
update list_test set test_nvarchar     = N'bbb' where test_nvarchar     = N'aaa';
