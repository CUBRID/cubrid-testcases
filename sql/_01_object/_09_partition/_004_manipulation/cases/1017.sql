--[er]test insert(time) for many list partition(have NULL value) with incorrect values out of range
...
insert into list_test values(8,'12:00:00','2006-04-01','2006-04-01 10:00:00');
