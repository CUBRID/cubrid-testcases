-- insert data  whith create hash partition table on a char field with size 4 and update data and  query data from every partition and then drop table
...
update hash_test set test_char = 'ttt' where test_char = 'ooo';
