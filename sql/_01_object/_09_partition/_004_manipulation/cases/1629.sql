--create range partition table with time data type and three partitions having no maxvalue,then insert data to this table,then delete record whose separated value is in a boundary
...
delete from range_test  where test_time  < '10:00:00' and test_time >='09:00:00';
