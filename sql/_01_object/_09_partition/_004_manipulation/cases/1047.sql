--[er]test update(smallint) for list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_smallint      = 2 where test_smallint      = 1;
