--test update(timestamp) for many list partition(have no NULL value) with correct values within range
...
insert into list_test values(19,'11:20:00','2006-04-21','2006-04-21 09:00:00');
	update list_test set test_timestamp      = '2006-02-11 09:00:00' where test_timestamp      = '2006-02-01 09:00:00';
	update list_test set test_timestamp      = '2006-03-21 09:00:00' where test_timestamp      = '2006-03-01 09:00:00';
