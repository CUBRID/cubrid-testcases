--[er]test update(time) for many list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_time      = '12:00:00' where test_time      = '10:00:00';
