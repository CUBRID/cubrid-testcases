-- insert data  whith create hash partition table on a smallint field with size 4 and update data to null and  query data from every partition and then drop table
...
update hash_test set test_smallint  = null where  test_smallint = 11;
update hash_test set test_smallint  = null where  test_smallint = 19;
