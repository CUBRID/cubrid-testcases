--create range partition table with varchar data type and three partitions having no maxvalue,then insert data to this table,then delete record whose separated value is in a boundary
...
delete from range_test  where test_timestamp  <'2006-03-01 09:00:00' and  test_timestamp  >='2006-02-01 09:00:00';
