--test delete(string): deleting a data in a list partition(has no NULL) using a delete statement with a partition key value
...
delete from list_test where test_string     = 'bbbbbbbbbb';
