--create range partition table with varchar data type and three partitions having maxvalue,then insert data to this table,then delete record whose separated value is in a boundary
...
delete from range_test  where test_varchar  < 'ggg' and test_varchar >='ddd';
