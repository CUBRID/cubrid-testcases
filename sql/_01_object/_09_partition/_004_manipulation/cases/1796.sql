-- insert data  whith create hash partition table on a varchar field with size 4 and update data to null and  query data from every partition and then drop table
...
update hash_test set test_varchar   = null  where  test_varchar  = 'ccc';
