...
update list_test set test_nchar = (select test_nchar from list_test2 where  id = 8) where test_nchar = N'aaa';
update list_test set test_nchar = (select test_nchar from list_test2 where  id = 10) where test_nchar = N'fff';
