--test delete(date): deleting all data in a list partition(has no NULL) using a delete statement with all of the partition key values
...
delete from list_test where test_date   IN ('2006-01-01','2006-02-01','2006-03-01');
