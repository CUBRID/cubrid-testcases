--create range partition table with time data type and three partitions having no maxvalue,then insert data to this table, the inserted separator field values contain null value
