--create range partition table with nchar data type and one partitions having  maxvalue,then insert data to this table,then update the separator field value,the data is in the boundary of the separator value
