--[er]test update(nvarchar) for many list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_nvarchar     = N'ccc' where  test_nvarchar     = N'ggg';
