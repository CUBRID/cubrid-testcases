--[er]test update(nchar) for list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_nchar     = N'ccc' where  test_nchar     = N'aaa';
