--create range partition table with string data type and one partition having no maxvalue,then insert data to this table,then delete one record where the separated field value is equal with some value
...
delete from range_test  where test_string   = 'aaaaaaaaaa';
