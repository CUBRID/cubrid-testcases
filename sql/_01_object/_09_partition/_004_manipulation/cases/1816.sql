-- insert data  whith create hash partition table on a time field with size 4 and update data from null  and  query data from every partition and then drop table
...
update hash_test set test_time = '18:20:19' where test_time is null;
