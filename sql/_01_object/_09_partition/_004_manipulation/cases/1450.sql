--create range partition table with date data type and one partition having maxvalue,then insert data to this table,then update the separator field value to null value
