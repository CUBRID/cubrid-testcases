--[er]create range partition table with nchar data type and one partition,then insert data to this table,the inserted separator field value  is equal with separator value
