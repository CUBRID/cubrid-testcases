--[er]test updating string type list partition using three partitions and invalid value not exist in partitions
...
update list_test set test_string = (select test_string from list_test2 where  id = 8) where test_string ='aaaaaaaaaa';
update list_test set test_string= (select test_string from list_test2 where  id = 10) where test_string= 'bbbbbbbbbb';
