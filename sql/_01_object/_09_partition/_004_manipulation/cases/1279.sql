--test inserting one partition data from non-partition to partition using two tables and select-insert(string) 
...
insert into list_test select * from list_test2 where test_string  IN ('ffffffffff','gggggggggg','hhhhhhhhhh',NULL);
