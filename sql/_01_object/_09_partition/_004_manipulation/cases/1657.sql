--[er]create range partition table with nchar data type and three partitions having no maxvalue,then insert data to this table,but the inserted separator field value is equal with boundary value
