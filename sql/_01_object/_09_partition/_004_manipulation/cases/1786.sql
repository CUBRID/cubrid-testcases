-- insert data  whith create hash partition table on a int field with size 4 and update data and  query data from every partition and then drop table
...
update hash_test set test_int = 4 where test_int = 20;
update hash_test set test_int = 3 where test_int = 19;
