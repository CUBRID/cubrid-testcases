--create range partition table with time data type and one partition having maxvalue,then insert data to this table,the inserted separator field contain null value
