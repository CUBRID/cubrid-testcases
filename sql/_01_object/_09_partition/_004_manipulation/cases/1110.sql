--[er]test update(date) for many list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_date      = '2006-09-11' where test_date      = '2006-03-01';
