--test delete(string): deleting a data in a list partition(has no NULL) using many partitions and two delete statement with a partition key value
...
insert into list_test values(19,'mmm','mmm',B'101',B'1111',N'mmm',N'mmm','mmmmmmmmmm','2006-03-01 09:00:00');
	delete from list_test where  test_string     = 'aaaaaaaaaa';
	delete from list_test where  test_string     = 'ffffffffff';
