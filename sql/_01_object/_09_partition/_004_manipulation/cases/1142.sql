--test delete(nchar): deleting all data in a list partition(has no NULL) using a delete statement with all of the partition key values
...
delete from list_test where test_nchar   IN (N'aaa',N'bbb',N'ddd');
