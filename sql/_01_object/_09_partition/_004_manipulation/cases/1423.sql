--create range partition table with time data type and one partitions having no maxvalue,then insert data to this table,,then update the separator field value to null value
...
update range_test set test_time      = NULL where test_time = '08:00:00';
