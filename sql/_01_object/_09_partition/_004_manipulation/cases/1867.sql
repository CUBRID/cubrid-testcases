-- create a hash partition table  on date field and update this table to value that query from another table which new create and then drop tables
...
update hash_test set test_date   = (select test_date from hash_test2 where  id = 8) where test_date ='2006-02-01';
update hash_test set test_date = (select test_date from hash_test2 where  id = 20) where test_date = '2006-03-11';
