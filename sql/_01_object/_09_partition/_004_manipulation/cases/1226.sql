--test delete(char): deleting all data in a list partition(has NULL) using many partitions and a delete statement with all of the partition key values
...
delete from list_test where  test_char  IN ('kkk','lll','mmm');
