--test delete(nvarchar): deleting all data in a list partition(has no NULL) using a delete statement with all of the partition key values
...
delete from list_test where test_nvarchar   IN (N'aaa',N'bbb',N'ddd');
