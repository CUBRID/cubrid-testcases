--test delete(timestamp): deleting 'null' partition data from many partitions(has NULL) using a delete statement with 'is null' condition
...
delete from list_test where  test_timestamp    is null;
