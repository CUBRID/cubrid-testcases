--create range partition table with smallint data type and one partition,then insert data to this table,the inserted separator field values are less than separator value
