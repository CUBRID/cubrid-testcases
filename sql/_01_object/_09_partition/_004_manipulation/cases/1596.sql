--create range partition table with char data type and three partitions having no maxvalue,then insert data to this table,then delete two records where the separated fields' values are equal with some values
...
create table range_test(id int not null ,
	...
	delete from range_test  where test_char     = 'aaa';
	delete from range_test  where test_char     = 'iii';
