--create range partition table with timestamp data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
create table range_test(id int,	
	...
	update range_test set test_timestamp      = '2006-01-21 08:20:00' where test_timestamp      = '2006-01-11 08:20:00';
	update range_test set test_timestamp      = '2006-03-21 09:50:00' where test_timestamp      = '2006-02-21 09:30:00';
