--create range partition table with nvarchar data type and one partition having no maxvalue,then insert data to this table,then delete one record where the separated field value is null
...
delete from range_test where  test_nvarchar is NULL;
