-- create a hash partition table  on nvarchar field and update this table to value that query from another table which new create and then drop tables
...
create table hash_test2(id int ,
	...
	update hash_test set test_nvarchar = (select test_nvarchar from hash_test2 where  id = 8) where test_nvarchar = N'aaa';
	update hash_test set test_nvarchar = (select test_nvarchar from hash_test2 where  id = 10) where test_nvarchar = N'fff'   ;
