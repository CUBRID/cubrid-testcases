-- insert data  whith create hash partition table on a string field with size 4 and delete data and  query data from every partition and then drop table
...
delete from hash_test where test_string = 'aaaaaaaaaa';
delete from hash_test where test_string = 'ssssssssss';
