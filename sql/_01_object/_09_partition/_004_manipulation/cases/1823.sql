-- insert data  whith create hash partition table on a timestamp field with size 4 and update data to null  and  query data from every partition and then drop table
...
update hash_test set test_timestamp = null where test_timestamp ='2006-02-11 09:20:04';
update hash_test set test_timestamp = null where test_timestamp =  '2007-05-01 12:40:19';
