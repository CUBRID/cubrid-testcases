--create range partition table with nvarchar data type and one partition having maxvalue,then insert data to this table,then delete record whose separated value less than partition boundary value
...
delete from range_test  where test_nvarchar < N'ddd';
