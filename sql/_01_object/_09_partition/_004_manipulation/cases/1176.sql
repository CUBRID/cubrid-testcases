--test delete(int): deleting all data in a list partition(has NULL) using a delete statement with all of the partition key values
...
delete from list_test where test_int  IN (1,3,NULL,5,7,9);
