--test inserting one partition data from non-partition to partition using two tables and select-insert(date) 
...
insert into list_test select * from list_test2 where test_date IN ('2006-03-01','2006-03-11',null,'2006-03-21');
