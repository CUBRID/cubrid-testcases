--[er]create range partition table with date data type and one partitions having no maxvalue,then insert data to this table,,then update the separator field value,the updated data is equal with the boundary of the separator value
...
update range_test set test_date      = '2006-01-01' where test_date = '2005-12-01';
