--create range partition table with char data type and three partitions having maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
create table range_test(id int ,
	...
	update range_test set test_char     = 'aaa' where test_char     = 'iii';
	update range_test set test_char     = 'xxx' where test_char     = 'ccc';
