--[er]create range partition table with char data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is equal with the boundary of the separator value
...
update range_test set test_varchar  = 'kkk' where test_varchar = 'ccc';
