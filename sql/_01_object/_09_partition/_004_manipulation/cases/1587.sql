--create range partition table with time data type and one partition having maxvalue,then insert data to this table,then delete several records whose separated value less than maxvalue
...
delete from range_test  where test_time      < '09:00:00';
