--create range partition table with char data type and one partition having maxvalue,then insert data to this table,the inserted separator field contain null value
