-- insert data  whith create hash partition table on a nvarchar field with size 4 and update data and  query data from every partition and then drop table
...
update hash_test set test_nvarchar = N'aaa' where test_nvarchar = N'ddd';
update hash_test set test_nvarchar = N'bbb' where test_nvarchar = N'sss';
