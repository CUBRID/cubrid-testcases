--[er]test updating char type list partition using three partitions and invalid value not exist in partitions
...
update list_test set test_char = (select test_char from list_test2 where  id = 8) where test_char = 'aaa';
update list_test set test_char = (select test_char from list_test2 where  id = 10) where test_char = 'fff';
