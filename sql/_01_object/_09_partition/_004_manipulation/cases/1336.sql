--test partition and partition join with timestamp type partition value
...
select a.test_timestamp, b.test_timestamp from list_test A, list_test2 B where a.test_timestamp ='2006-02-01 09:00:00'
order by 1,2;
