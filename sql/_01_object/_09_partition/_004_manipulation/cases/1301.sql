...
update list_test set test_timestamp   = (select test_timestamp from list_test2 where  id = 8) where test_timestamp ='2006-02-01 09:00:00';
update list_test set test_timestamp = (select test_timestamp from list_test2 where  id = 20) where test_timestamp = '2006-03-21 09:00:00';
