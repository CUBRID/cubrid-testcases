-- create a hash partition table  on string field and update this table to value that query from another table which new create and then drop tables
...
create table hash_test2(id int not null primary key ,
	...
	update hash_test set test_string = (select test_string from hash_test2 where  id = 8) where test_string = 'aaaaaaaaaa';
	update hash_test set test_string = (select test_string from hash_test2 where  id = 10) where test_string = 'ffffffffff'  ;
