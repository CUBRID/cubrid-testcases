--create range partition table with string data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value to null value
...
update range_test set test_string  = NULL where  test_string  = 'iiiiiiiiii';
