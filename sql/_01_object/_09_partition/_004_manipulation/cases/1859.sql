-- create a hash partition table  on char field and update this table to value that query from another table which new create and then drop tables
...
create table hash_test2(id int ,
	...
	update hash_test set test_char = (select test_char from hash_test2 where  id = 8) where test_char = 'aaa';
	update hash_test set test_char = (select test_char from hash_test2 where  id = 10) where test_char = 'fff' ;
