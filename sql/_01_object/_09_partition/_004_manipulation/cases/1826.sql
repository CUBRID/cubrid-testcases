-- insert data  whith create hash partition table on a char field with size 4 and delete data and  query data from every partition and then drop table
...
delete from hash_test where test_char = 'aaa';
delete from hash_test where test_char = 'sss';
