--test delete(char): deleting a data in a list partition(has NULL) using many partitions and two delete statement with a partition key value
...
delete from list_test where  test_char     = 'aaa'; 
delete from list_test where  test_char     = 'fff';
