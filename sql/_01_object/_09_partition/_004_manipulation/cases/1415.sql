--create range partition table with int data type and one partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
update range_test set test_int      = 4 where test_int = 3;
