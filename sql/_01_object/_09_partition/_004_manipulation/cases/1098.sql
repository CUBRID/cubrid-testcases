--test update(nvarchar) for many list partition(have no NULL value) with correct values within range
...
insert into list_test values(19,'mmm','mmm',B'101',B'1111',N'mmm',N'mmm','mmmmmmmmmm','2006-03-01 09:00:00');
	update list_test set test_nvarchar     = N'aaa' where test_nvarchar     = N'bbb';
	update list_test set test_nvarchar     = N'fff' where test_nvarchar     = N'ggg';
