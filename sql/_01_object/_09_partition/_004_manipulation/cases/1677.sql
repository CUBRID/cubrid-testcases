--create range partition table with date data type and three partitions having maxvalue,then insert data to this table,then delete record whose separated value is in a boundary
