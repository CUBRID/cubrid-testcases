--create range partition table with date data type and three partitions having no maxvalue,then insert data to this table,then delete record whose separated value is in a boundary
...
delete from range_test  where test_date <'2006-03-01' and test_date >= '2006-02-01';
