--test update(char) for many list partition(have NULL value) with correct values within range
...
update list_test set test_char     = 'aaa' where test_char     = 'bbb';
	update list_test set test_char     = 'fff' where test_char     = 'ggg';
