-- insert data  whith create hash partition table on a string field with size 4 and update data and  query data from every partition and then drop table
...
update hash_test set test_string =  'aaaaaaaaaa' where test_string = 'dddddddddd';
update hash_test set test_string =  'dddddddddd' where test_string = 'ssssssssss';
