--[er]test insert(smallint) for many list partition(have NULL value) with incorrect values out of range
...
insert into list_test values( 8,35,36,35.1802523285,35.9167372882,35.6244295835,35.982398624, 35,'2006-03-01 09:00:00');
