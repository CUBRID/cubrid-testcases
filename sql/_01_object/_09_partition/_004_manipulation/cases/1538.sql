--create range partition table with timestamp data type and three partitions having maxvalue,then insert data to this table,then update the separator field value to null value
...
update range_test set test_timestamp      = NULL where test_timestamp      ='2006-03-01 09:40:00';
