--test delete(date): deleting a data in a list partition(has no NULL) using a delete statement with a partition key value
...
delete from list_test where test_date      = '2006-02-01';
