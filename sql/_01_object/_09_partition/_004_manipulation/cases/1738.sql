--create range partition table with nvarchar data type and three partitions having maxvalue,then insert data to this table,the inserted separator field values contain null value
