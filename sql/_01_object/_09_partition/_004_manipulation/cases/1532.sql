--create range partition table with time data type and three partitions having maxvalue,then insert data to this table,then update the separator field value from null to other value
...
update range_test set test_time      = '23:30:00' where  test_time  is null;
