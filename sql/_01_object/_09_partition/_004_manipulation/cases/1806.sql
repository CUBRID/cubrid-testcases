-- insert data  whith create hash partition table on a nvarchar field with size 4 and update data to null and  query data from every partition and then drop table
...
update hash_test set test_nvarchar =  null where test_nvarchar = N'ddd';
update hash_test set test_nvarchar =  null where test_nvarchar = N'sss';
