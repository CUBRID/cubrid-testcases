--[er]test updating smallint type list partition using three partitions and invalid value not exist in partitions
...
create table list_test2(id int,
	...
	insert into list_test2 values(31,20,20,19.1234,19.2345,19.3456,19.4567,190,'2006-03-01 09:00:00');
	insert into list_test2 values(50,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');
update list_test set test_smallint = (select test_smallint from list_test2 where  id = 8) where test_smallint  =1;
update list_test set test_smallint = (select test_smallint from list_test2 where  id = 31) where test_smallint = 2;
