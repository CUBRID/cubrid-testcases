--[er]create range partition table with time data type and one partitions having no maxvalue,then insert data to this table,,then update the separator field value,the updated data is equal with the boundary of the separator value
...
update range_test set test_time      = '09:00:00' where test_time = '08:00:00';
