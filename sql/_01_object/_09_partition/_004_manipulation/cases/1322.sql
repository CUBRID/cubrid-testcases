--test partition and partition join with smallint type partition value
create table list_test(id int not null,
	...
	insert into list_test values(50,NULL,1,NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');
create table list_test2(id int not null,
				test_int int,
				test_smallint smallint,
				test_numeric numeric(38,10),
				test_float float,
...
select a.test_smallint, b.test_smallint from list_test A, list_test2 B where a.test_smallint =1
order by 1,2;
