--create range partition table with string data type and three partitions having no maxvalue,then insert data to this table, the inserted separator field values contain null value
...
create table range_test(id int ,
	...
	insert into range_test values(9,'lll','lll',B'101',B'1111',N'lll',N'lll',NULL,'2007-01-01 09:00:00');
