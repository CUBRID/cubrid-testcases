--create range partition table with nvarchar data type and three partitions having maxvalue,then insert data to this table,then update the separator field value from null to other value
...
update range_test set test_nvarchar  = N'xxx' where test_nvarchar is null;
