--create range partition table with string data type and three partitions having no maxvalue,then insert data to this table,then delete record whose separated value in a boundary
...
delete from range_test  where test_string  < 'gggggggggg' and test_string  >= 'dddddddddd';
