--create range partition table with string data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
create table range_test(id int ,
	...
	update range_test set test_string  = 'jjjjjjjjjj' where test_string  = 'aaaaaaaaaa';
	update range_test set test_string  = 'bbbbbbbbbb' where test_string  = 'iiiiiiiiii';
