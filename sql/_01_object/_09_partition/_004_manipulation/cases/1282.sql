--test inserting all data from non-partition to partition using two tables and select-insert(smallint)
...
insert into list_test2 values( 1,1,1,1.1234   , 1.2345, 1.3456, 1.4567, 10,'2006-03-01 09:00:00');
	...
	insert into list_test2 values(50,NULL,2,NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');
