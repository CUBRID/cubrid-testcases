--create range partition table with varchar data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
create table range_test(id int ,
	...
	update range_test set test_varchar  = 'jjj' where test_varchar  = 'aaa';
	update range_test set test_varchar  = 'bbb' where test_varchar  = 'iii';
