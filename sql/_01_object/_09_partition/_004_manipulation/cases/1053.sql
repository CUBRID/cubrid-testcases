--[er]test update(date) for list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_date      = '2006-05-01' where test_date      = '2006-03-01';
