--create range partition table with date data type and one partition having maxvalue,then insert data to this table,then delete one record where the separated field value is equal with some value
...
delete from range_test  where test_date      = '2005-12-01';
