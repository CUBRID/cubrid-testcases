--create range partition table with smallint data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
create table range_test(id int,
	...
	update range_test set test_smallint      = 5  where test_smallint = 2;
	update range_test set test_smallint      = 29 where test_smallint = 26;
