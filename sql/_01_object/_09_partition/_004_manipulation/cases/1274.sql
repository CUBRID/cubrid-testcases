--test inserting one partition data from non-partition to partition using two tables and select-insert(nchar) 
...
insert into list_test select * from list_test2 where test_nchar IN (N'fff',N'ggg',N'hhh',NULL);
