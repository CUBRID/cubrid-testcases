-- create a hash partition table  on time field and update this table to value that query from another table which new create and then drop tables
...
update hash_test set test_time  = (select test_time from hash_test2 where  id = 8) where test_time ='08:22:02';
update hash_test set test_time = (select test_time from hash_test2 where  id = 20) where test_time = '12:20:10';
