-- insert data  whith create hash partition table on a string field with size 4 and update data from null and  query data from every partition and then drop table
...
update hash_test set test_string = 'cccccccccc' where test_string is null;
