-- insert data  whith create hash partition table on a smallint field with size 4 and delete data and  query data from every partition and then drop table
...
delete from hash_test where test_smallint = 1;
delete from hash_test where test_smallint = 3;
