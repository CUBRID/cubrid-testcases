-- insert data  whith create hash partition table on a date field with size 4 and update data and  query data from every partition and then drop table
...
update hash_test set test_date = '2006-03-01' where test_date = '2006-02-01';
update hash_test set test_date = '2006-01-11' where test_date = '2006-08-11';
