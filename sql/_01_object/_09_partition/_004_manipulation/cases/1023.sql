--[er]test insert(timestamp) for many list partition(have NULL value) with incorrect values out of range
...
insert into list_test values(8,'12:00:00','2006-05-01','2006-05-01 10:00:00');
