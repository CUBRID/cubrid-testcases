--[er]test update(varchar) for list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_varchar     = 'ccc' where test_varchar     = 'aaa';
