--test update(varchar) for list partition(have no NULL value) with correct values within range
...
update list_test set test_varchar     = 'bbb' where  test_varchar     = 'aaa';
