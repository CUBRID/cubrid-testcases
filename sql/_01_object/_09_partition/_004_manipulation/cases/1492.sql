--create range partition table with time data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value to null value
...
update range_test set test_time      = NULL where test_time      ='10:10:00';
