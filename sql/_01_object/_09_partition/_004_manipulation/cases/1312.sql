--test self join with list partition(nvarchar)
...
insert into list_test values(14,NULL,NULL,NULL,NULL,NULL,'fff',NULL,'2006-03-01 09:00:00');

select * from list_test A, list_test B order by a.id,b.id;
select a.test_nvarchar, b.test_nvarchar from list_test A, list_test B where a.test_nvarchar =N'aaa'
order by 1,2;
