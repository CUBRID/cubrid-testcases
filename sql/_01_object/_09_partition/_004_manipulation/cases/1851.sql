-- insert data  whith create hash partition table on a time field with size 4 and delete data from null and  query data from every partition and then drop table
...
delete from hash_test where test_time is null;
