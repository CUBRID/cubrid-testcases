--create range partition table with date data type and one partition having maxvalue,then insert data to this table,then delete record whose separated value less than maxvalue
...
delete from range_test  where test_date      < '2006-01-01';
