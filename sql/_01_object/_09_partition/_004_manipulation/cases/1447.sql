--create range partition table with time data type and one partition having  maxvalue,then insert data to this table,then update the separator field value,the data is in the boundary of the separator value
...
update range_test set test_time      = '23:10:00' where test_time = '08:00:00';
