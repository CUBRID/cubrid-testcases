-- insert data  whith create hash partition table on a nchar field with size 4 and update data from null and  query data from every partition and then drop table
...
update hash_test set test_nchar = N'ccc' where test_nchar is null;
