-- insert data  whith create hash partition table on a nchar field with size 4 and update data to null and  query data from every partition and then drop table
...
update hash_test set test_nchar = null where test_nchar = N'ddd';
update hash_test set test_nchar = null where test_nchar = N'sss';
