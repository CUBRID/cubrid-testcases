--create range partition table with date data type and three partitions having no maxvalue,then insert data to this table,then delete record where the separated fields' value is equal with some value
...
create table range_test(id int not null ,	
	...
	delete from range_test  where test_date      = '2006-01-11';
	delete from range_test  where test_date      = '2006-03-11' ;
