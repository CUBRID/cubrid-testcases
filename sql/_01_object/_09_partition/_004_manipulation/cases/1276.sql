--test inserting one partition data from non-partition to partition using two tables and select-insert(nvarchar) 
...
insert into list_test select * from list_test2 where test_nvarchar IN (N'fff',N'ggg',N'hhh',NULL);
