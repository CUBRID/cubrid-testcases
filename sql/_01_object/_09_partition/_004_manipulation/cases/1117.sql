--test update(varchar) for many list partition(have NULL value) with correct values within range
...
insert into list_test values(50,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');
	update list_test set test_varchar     = 'aaa' where test_char     = 'bbb';
	update list_test set test_varchar     = 'fff' where test_char     = 'ggg';
