-- create a hash partition table  on time field and insert into this table values that query from another new create hash partition  table on time field and then drop tables
