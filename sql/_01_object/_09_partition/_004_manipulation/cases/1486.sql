--create range partition table with int data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
create table range_test(id int not null ,
	...
	update range_test set test_int      = 29  where test_int      = 1 ;
	update range_test set test_int      = 5   where test_int      = 26 ;
