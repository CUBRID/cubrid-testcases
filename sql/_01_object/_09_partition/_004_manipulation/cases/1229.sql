--test delete(varchar): deleting a data in a list partition(has NULL) using many partitions and two delete statement with a partition key value
...
insert into list_test values(20,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');
	delete from list_test where  test_varchar     = 'aaa'; 
	delete from list_test where  test_varchar     = 'fff';
