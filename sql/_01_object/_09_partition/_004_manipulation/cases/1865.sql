-- create a hash partition table  on smallint field and update this table to value that query from another table which new create and then drop tables
...
update hash_test set test_smallint = (select test_smallint from hash_test2 where  id = 8) where test_smallint =1.0;
update hash_test set test_smallint = (select test_smallint from hash_test2 where  id = 31) where test_smallint = 2.0;
