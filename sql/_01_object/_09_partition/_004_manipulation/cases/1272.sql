--test inserting one partition data from non-partition to partition using two tables and select-insert(varchar) 
...
insert into list_test select * from list_test2 where test_varchar in ('fff','ggg','hhh');
