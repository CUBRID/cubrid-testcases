--create range partition table with char data type and one partition having  maxvalue,then insert data to this table,then delete one record where the separated field value is equal with some value
