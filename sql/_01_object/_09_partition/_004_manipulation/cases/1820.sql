-- insert data  whith create hash partition table on a date field with size 4 and update data from null  and  query data from every partition and then drop table
...
update hash_test set test_date = '2006-08-11' where test_date is null;
