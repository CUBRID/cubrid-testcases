--create range partition table with nchar data type and three partitions having no maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
...
create table range_test(id int not null ,
	...
	update range_test set test_nchar  = N'jjj' where test_nchar  =N'aaa';
	update range_test set test_nchar  = N'bbb' where test_nchar  =N'iii';
