--create range partition table with date data type and three partitions having maxvalue,then insert data to this table,then update the separator field value,the updated data is in the boundary of the separator value
create table range_test(id int not null ,	
	...
	update range_test set test_date      = '2006-01-21' where test_date      = '2006-03-01';
	update range_test set test_date      = '2006-03-21' where test_date      = '2006-01-01';
