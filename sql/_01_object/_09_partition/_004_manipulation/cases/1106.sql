--[er]test update(smallint) for many list partition(have no NULL value) with incorrect values out of range
create table list_test(id int not null ,
	...
	update list_test set test_smallint      = 20 where  test_smallint = 2;
