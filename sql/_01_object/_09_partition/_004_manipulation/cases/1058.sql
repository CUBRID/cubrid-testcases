--[er]test update(timestamp) for list partition(have no NULL value) with null value.
...
update list_test set test_timestamp = NULL where test_timestamp = '2006-03-01 09:00:00';
