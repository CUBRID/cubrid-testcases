--create range partition table with nvarchar data type and three partitions having maxvalue,then insert data to this table,then update the separator field value to null value
