-- insert data  whith create hash partition table on a smallint field with size 4 and update data and  query data from every partition and then drop table
...
update hash_test set test_smallint  = 20  where  test_smallint = 4 ;
update hash_test set test_smallint  = 3 where  test_smallint = 11;
