--create range partition table with string data type and one partition,then insert data to this table,the inserted separator field value contain null value
...
select * from range_test where test_string  is NULL order by 1;
