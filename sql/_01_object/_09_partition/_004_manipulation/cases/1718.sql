--create range partition table with nvarchar data type and one partition having maxvalue,then insert data to this table,the inserted separator field contain null value
...
create table range_test(id int ,
	...
	insert into range_test values(2,'bbb','bbb',B'10',B'1100',N'bbb',NULL,'bbbbbbbbbb','2007-01-01 09:00:00');
