--[er]test updating int type list partition using three partitions and invalid value not exist in partitions
...
update list_test set test_int = (select test_int from list_test2 where  id = 8) where test_int =1;
update list_test set test_int = (select test_int from list_test2 where  id = 31) where test_int = 2;
