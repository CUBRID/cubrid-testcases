--create range partition table with char data type and one partition,then insert data to this table,the data value contain null value
create table range_test(id int not null ,
	...
	insert into range_test values(2,NULL,'bbb',B'10',B'1100',N'bbb',N'bbb','bbbbbbbbbb','2007-01-01 09:00:00');
	insert into range_test values(3,'ccc','ccc',B'11',B'1101',N'ccc',N'ccc','cccccccccc','2007-01-01 09:00:00');

	select * from range_test;
select * from range_test where test_char is NULL order by 1;
