--create range partition table with string data type and one partition having  maxvalue,then insert data to this table,then update the separator field value,the data is in the boundary of the separator value
