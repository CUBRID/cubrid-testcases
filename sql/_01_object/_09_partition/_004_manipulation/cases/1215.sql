--test delete(time): deleting all data in a list partition(has no NULL) using many partitions and a delete statement with all of the partition key values
...
delete from list_test where  test_time   IN ('10:00:00','10:10:00','10:20:00');
