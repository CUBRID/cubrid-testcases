--[er]test update(timestamp) for many list partition(have no NULL value) with incorrect values out of range
...
update list_test set test_timestamp      = '2007-02-11 09:00:00' where test_timestamp      = '2006-03-01 09:00:00';
