--create range partition table with smallint data type and three partitions having maxvalue,then insert data to this table,then update the separator field value from null to other value
...
update range_test set test_smallint      = 29 where test_smallint is null;
