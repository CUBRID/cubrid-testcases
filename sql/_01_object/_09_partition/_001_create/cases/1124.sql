--create list partiition table with a function to_char to change date data type to char data type as a partition value

create table list_test(id int,	
				   test_time time,
				   test_date date,
				   test_timestamp timestamp, primary key(id,test_date))
	PARTITION BY LIST (to_char(test_date,'yyyymmdd')) (
	PARTITION p0 VALUES IN ('19910101','19920111','19940201','19950211','19960301'),
	PARTITION p1 VALUES IN ('19970311','19980401','19990411','20000501'),
	PARTITION p2 VALUES IN ('20010611','20020701','20030711','20040801'),
	PARTITION p3 VALUES IN ('20050811','20060901','20070911',null)

);


create index date_idx on list_test (test_date);
