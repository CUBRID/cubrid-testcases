--create list partiition table with a extract(month  from timestamp  date field) function 

create table list_test(id int,	
				   test_time time,
				   test_date date,
				   test_timestamp timestamp, primary key(id,test_timestamp))
	PARTITION BY LIST (extract(month from test_timestamp)) (
	PARTITION p0 VALUES IN (1,2,3,4),
	PARTITION p1 VALUES IN (5,6,7,8),
	PARTITION p2 VALUES IN (9,10,11,12,null)
);
...
update list_test set test_timestamp = '2008-12-01 15:30:00' where test_timestamp < '2000-01-21 15:30:00';
