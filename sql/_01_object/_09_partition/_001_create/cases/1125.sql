--create list partiition table with a function to_char to change timestamp data type to char data type as a partition value

create table list_test(id int,	
				   test_time time,
				   test_date date,
				   test_timestamp timestamp, primary key(id,test_timestamp))
	PARTITION BY LIST (to_char(test_timestamp, 'yyyy-mm-dd hh24:mi:ss')) (
	PARTITION p0 VALUES IN ('1991-01-01 09:00:00','1992-01-11 09:30:00','1994-02-01 09:50:00','1995-02-11 12:00:00','1996-03-01 12:30:00'),
	PARTITION p1 VALUES IN ('1997-03-11 12:50:00','1998-04-01 15:00:00','1999-04-11 15:30:00','2000-05-01 15:50:00'),
	PARTITION p2 VALUES IN ('2001-06-11 18:00:00','2002-07-01 18:30:00','2003-07-11 18:50:00','2004-08-01 21:00:00'),
	PARTITION p3 VALUES IN ('2005-08-11 21:30:00','2006-09-01 21:50:00','2007-09-11 23:00:00',null)
);
create index timestamp_idx on list_test (test_timestamp);
