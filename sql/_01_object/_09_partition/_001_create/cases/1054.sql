--[er]many List(have NULL value) partition creating test with some float type values and null value.
create table list_test(id int,
	...
	PARTITION BY LIST (test_float) (
	PARTITION p0 VALUES IN (1.1234,3.257,5.456,7.975,9.4356),
	PARTITION p1 VALUES IN (2.3456,4.85934,6.72145,8.5673,10.23467,NULL),
