--create list partiition table with a extract(minute from timestamp  date field) function 

create table list_test(id int,	
				   test_time time,
				   test_date date,
				   test_timestamp timestamp, primary key(id,test_timestamp))
	PARTITION BY LIST (extract(minute from test_timestamp)) (
	PARTITION p0 VALUES IN (0),
	PARTITION p1 VALUES IN (30),
	PARTITION p2 VALUES IN (50, null)
);
...
update list_test set test_timestamp = '2008-01-01 15:00:00' where test_timestamp < '2000-01-21 15:00:00';
