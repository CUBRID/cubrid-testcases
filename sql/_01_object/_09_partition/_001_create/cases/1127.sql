--create list partiition table with a function to_char to change int data type to char data type as a partition value

create table list_test(id int,
			test_int int,                                
			test_smallint smallint, primary key(id,test_int))                      
		PARTITION BY LIST (to_char(test_int)) (       
