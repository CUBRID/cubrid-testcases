-- [er]create table of range partition on varchar field having boundary values and unite all partition to one partition but lost data
...
PARTITION p3 VALUES LESS THAN ('vvv'));
