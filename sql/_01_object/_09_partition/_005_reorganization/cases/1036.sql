-- insert data  whith create range partition table on a char field and add a partition and then query all partitions and drop table
...
select * from range_test__p__p3 order by 1 ;
