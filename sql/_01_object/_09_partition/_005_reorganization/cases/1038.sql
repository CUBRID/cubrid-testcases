-- [er]create range partition table on a char field and add a partition and then insert a bigger value than range of new partition
...
insert into range_test values (12,42,'mmm','mmm','2000-05-02 09:00:00');
