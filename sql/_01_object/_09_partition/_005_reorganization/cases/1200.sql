-- alter table which create using int,smallint,numeric,float,real,double,monetary,timestamp of inserting data to add 3 range partitions on int field
...
select * from range_test where test_int = 1 ;
