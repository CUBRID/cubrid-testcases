-- alter table which create using int,time,date,timestamp of inserting data to add 3 range partitions on timestamp field
...
select * from range_test where test_timestamp = '2006-01-01 08:10:00';
