-- insert data which create a list partition table on int  field and reorganize two partitons to one partition
...
PARTITION p3 VALUES IN (11,12,13,null,21,22,23,31));

select * from db_partition where class_name = 'list_test' order by partition_name;
insert into list_test values (11,21,'ggg','ggg','2000-05-01 09:00:00');
