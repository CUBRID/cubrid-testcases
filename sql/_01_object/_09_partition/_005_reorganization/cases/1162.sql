-- [er]insert data which create a list partition table on int  field and split across 2nd partition but contain a used data
...
ALTER TABLE list_test REORGANIZE PARTITION p1 INTO ( 
PARTITION p3 VALUES IN (11,12,21),
PARTITION p4 VALUES IN (13,14,null,15));

select * from db_partition where class_name = 'list_test' order by partition_name;

insert into list_test values (11,21,'hhh','hhh','2000-05-01 09:00:00');
insert into list_test values (12,13,'eee','eee','2000-05-02 09:00:00');
insert into list_test values (13,15,'lll','lll','2000-05-02 09:00:00');
...
select * from list_test__p__p4 order by 1,2;
