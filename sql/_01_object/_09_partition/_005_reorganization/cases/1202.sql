-- alter table which create using int,time,date,timestamp of inserting data to add 3 range partitions on time field
...
select * from range_test where test_time = '08:10:00';
