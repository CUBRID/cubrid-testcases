-- [er]create table of range partition on varchar field having boundary values and maxvalue and unite two partition to one partition but data is distant
...
ALTER TABLE range_test REORGANIZE PARTITION p0,p2 INTO ( 
