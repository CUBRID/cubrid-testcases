-- [er]create table of range partition on varchar field having boundary values and maxvalue and delete all partition and query data from partition
...
insert into range_test values (11,32,'kkk','kkk','2000-05-01 09:00:00');
ALTER TABLE range_test DROP PARTITION p0, p1,p2,p7;
