-- alter table which create using int,time,date,timestamp of inserting data to add 3 range partitions having maxvalue on date field
...
select * from range_test where test_date ='2006-01-11';
