-- [er]insert data which create a list partition table on int  field and split across 2nd partition but lost list data
...
PARTITION p3 VALUES IN (11),
PARTITION p4 VALUES IN (13));
