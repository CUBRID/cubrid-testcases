-- [er]insert data which create a list partition table on varchar  field and reorganize two partitons to one partition but lost list data
...
PARTITION p3 VALUES IN ('eee','ggg','hhh',null,'jjj'));
