-- insert data which create a list partition table on varchar  field and reorganize all partitons to one partition
...
PARTITION p3 VALUES IN ('aaa','bbb','ccc','ddd','eee','fff','ggg','hhh',null,'iii','jjj')
);
