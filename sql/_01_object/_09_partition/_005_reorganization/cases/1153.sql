-- insert data which create a list partition table on varchar  field and split across 2nd partition but lost null
...
PARTITION p3 VALUES IN ('eee','fff','lll'),
...
insert into list_test values (13,51,'lll','lll','2000-05-02 09:00:00');
