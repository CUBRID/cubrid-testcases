-- alter table which create using int,char,varchar,bit,bit varying,nchar,nchar varying,string of inserting data to add 3 range partitions on char field
...
select * from range_test where test_char = 'ccc';
