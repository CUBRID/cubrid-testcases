-- [er]insert data which create a list partition table on varchar  field and split across 2nd partition but lost list data
...
PARTITION p3 VALUES IN ('eee'),
PARTITION p4 VALUES IN ('ggg'));
