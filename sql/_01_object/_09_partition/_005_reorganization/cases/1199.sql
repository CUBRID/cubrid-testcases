-- alter table which create using int,char,varchar,bit,bit varying,nchar,nchar varying,string to add 1 range partition on string field
...
PARTITION BY RANGE (test_string) (
    PARTITION p0 VALUES LESS THAN ('qwertyuiop')
);
