-- [er]create table of range partition on varchar field having boundary values and split across 2nd partition but data is bigger than quondam 
...
PARTITION p3 VALUES LESS THAN ('eee'),
PARTITION p4 VALUES LESS THAN ('hhh'));
