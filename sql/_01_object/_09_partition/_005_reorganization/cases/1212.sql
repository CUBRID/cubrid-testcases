-- alter table which create using int,smallint,numeric,float,real,double,monetary,timestamp of inserting data to add 3 range partitions having maxvalue on smallint field
...
select * from range_test where test_smallint = 3;
