-- alter table which create using int,char,varchar,bit,bit varying,nchar,nchar varying,string of inserting data to add 3 range partitions having maxvalue on nchar field
