-- insert data which create a list partition table on varchar  field and split across 2nd partition
...
PARTITION p3 VALUES IN ('eee','fff'),
PARTITION p4 VALUES IN ('ggg','hhh',null));
