-- insert data  whith create range partition table on a int field and add a partition and then query all partitions and drop table
...
insert into range_test values (13,null,'lll','lll','2000-05-02 09:00:00');
