-- [er]create table of range partition on int field having boundary values and split across 2nd partition but data is bigger than quondam 
...
PARTITION p4 VALUES LESS THAN (22));
