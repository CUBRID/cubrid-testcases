-- alter table which create using int,char,varchar,bit,bit varying,nchar,nchar varying,string and range partition on nchar field having maxvalue  of inserting data to remove partition
