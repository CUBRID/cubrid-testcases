-- [er]create range partition table on a varchar field and add a partition and then insert a bigger value than range of new partition
...
insert into range_test values (11,41,'mmm','mmm','2000-05-01 09:00:00');
