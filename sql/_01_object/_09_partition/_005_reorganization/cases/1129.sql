-- [er]create table of range partition on varchar field having boundary values and delete all partitions and query data from partition
...
ALTER TABLE range_test DROP PARTITION p0, p1,p2;
