-- alert table that insert data whith create to hash partition on nvarchar field and it's size 4 and then query and drop on this table
...
ALTER TABLE hash_test	PARTITION BY HASH(test_nvarchar)
        PARTITIONS 4;
