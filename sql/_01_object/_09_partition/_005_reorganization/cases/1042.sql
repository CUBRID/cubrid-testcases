-- [er]insert data  which create range partition table on char field having boundary values and maxvalue and add a partition with a less range than existing
