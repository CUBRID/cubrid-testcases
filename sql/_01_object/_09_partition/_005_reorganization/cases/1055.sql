-- [er]insert data  which create range partition table on int field having boundary values and add a partition with a less range than first partition existing
