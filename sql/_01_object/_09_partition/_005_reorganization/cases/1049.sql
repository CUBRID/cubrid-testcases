-- insert data  whith create range partition table on a varchar field and add a partition with maxvalue and then query data and drop table
...
select * from range_test__p__p8 order by 1,2;
