-- [er]insert data which create a list partition table on char field and split across 2nd partition but contain a used data
...
PARTITION p4 VALUES IN ('ggg','hhh',null,'iii'));
