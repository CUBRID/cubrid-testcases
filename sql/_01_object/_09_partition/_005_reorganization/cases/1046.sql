-- insert data  whith create range partition table on a varchar field and add 3 partitions and then query all partitions and drop table
...
insert into range_test values (13,51,'ppp','ppp','2000-05-02 09:00:00');
