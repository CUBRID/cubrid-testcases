-- [er]create table of range partition on varchar field having boundary values and unite three partitions to one partition but data is lost
...
PARTITION p3 VALUES LESS THAN ('hhh'));
