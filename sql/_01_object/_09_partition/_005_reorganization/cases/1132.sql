-- create table of range partition on varchar field having boundary values and maxvalue and delete last partition
...
ALTER TABLE range_test DROP PARTITION p7;
