-- alert hash partition on timestamp field table that insert data whith create removing partitioning and then query and drop on this table
...
ALTER TABLE hash_test remove partitioning;
