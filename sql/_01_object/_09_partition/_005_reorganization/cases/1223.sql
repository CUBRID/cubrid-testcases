-- alter table which create using int,smallint,numeric,float,real,double,monetary,timestamp and range partition on smallint field having maxvalue  of inserting data to remove partition
