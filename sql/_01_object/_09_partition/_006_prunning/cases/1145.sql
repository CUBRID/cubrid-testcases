-- create a hash partition table  on string field and insert into this table values that query from another new create table of non partition and then drop tables
