--create range  table with string data type,create range table with string data type,then insert the second table with records of the first table and other data 
