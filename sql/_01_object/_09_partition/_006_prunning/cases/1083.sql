--create range partition table with nchar data type and three partitions,create table,insert data to tables,update the range partition table with where complex clause
...
update range_test set test_nchar = (select test_nchar from range_test2 where  id = 8) where test_nchar = N'aaa';
update range_test set test_nchar = (select test_nchar from range_test2 where  id = 9) where test_nchar = N'bbb';
