--create range partition table with varchar data type and three partitions,create table,insert data to tables,update the range partition table with where complex clause
...
update range_test set test_varchar = (select test_varchar from range_test2 where  id = 8) where test_varchar = 'aaa';
update range_test set test_varchar = (select test_varchar from range_test2 where  id = 9) where test_varchar = 'bbb';
