-- insert data  whith create hash partition table on a int field with size 4 and query data using keyword of  "in","not in","not null","not between" and "<>"
...
select * from hash_test where test_int in (1,13,10) order by 1,2;

select * from hash_test  where test_int not in (2, 15, 10) order by 1,2;
select * from hash_test  where test_int is NOT NULL order by 1,2;

select * from hash_test  where test_int not between 2 and 15 order by 1,2;
select * from hash_test  where test_int  <> 10 order by 1,2;
select * from hash_test  where test_int <> 13 order by 1,2;
