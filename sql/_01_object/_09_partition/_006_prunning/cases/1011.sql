--create range partition table with int data type,insert data to this table and select data in where clause with operation '+','/','/'
...
select * from range_test where test_int = (-1 + 0) order by 1;
select * from range_test where test_int = (4/2) order by 1;
select * from range_test where test_int = (121/11) order by 1;
select * from range_test where -test_int = -1 order by 1;
drop range_test;
