-- create a hash partition class on a time field with size 4 and query data using self-join and then drop class
...
select a.test_time, b.test_time from hash_test A, hash_test B where a.test_time ='08:10:01'
order by 1,2;
