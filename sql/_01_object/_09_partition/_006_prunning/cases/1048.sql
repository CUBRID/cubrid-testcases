--create range  table with date data type,create range table with date data type,then insert the second table with records of the first table and other data 
