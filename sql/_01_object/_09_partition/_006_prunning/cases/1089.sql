--create range partition table with date data type and three partitions,create table,insert data to tables,update the range partition table with where complex clause
...
update range_test set test_date = (select test_date from range_test2 where  id = 7) where test_date = '2006-01-01';
update range_test set test_date = (select test_date from range_test2 where  id = 8) where test_date = '2006-01-11';
