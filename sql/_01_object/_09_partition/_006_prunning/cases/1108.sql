-- insert data  whith create hash partition class on a char field with size 4 and query data using self-join and then drop class
...
select a.test_char, b.test_char from hash_test A, hash_test B where a.test_char ='aaa' order by 1,2;
