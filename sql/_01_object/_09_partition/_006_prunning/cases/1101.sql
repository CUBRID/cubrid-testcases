-- insert data  whith create hash partition table on a nvarchar field with size 4 and query data using keyword of  "in","not in","not null","not between" and "<>"
...
select * from hash_test where test_nvarchar in (N'aaa',N'ddd',N'lll') order by 1,2;
select * from hash_test where test_nvarchar not in (N'bbb',N'eee',N'hhh') order by 1,2;
select * from hash_test where  test_nvarchar is not null order by 1,2;

select * from hash_test where test_nvarchar not between N'bbb' and N'ggg' order by 1,2;
select * from hash_test where test_nvarchar <> N'ccc' order by 1,2;
select * from hash_test where test_nvarchar <> N'hhh' order by 1,2;
