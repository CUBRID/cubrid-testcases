-- create a hash partition table  on date field with size 4 and a hash partition table on date field with size 6  and query data from the two join table and then drop tables
...
create table hash_test(id int not null ,	
	...
	insert into hash_test values(21,NULL,'2005-12-31',NULL);
	...
	insert into hash_test2 values(21,NULL,'2005-12-31',NULL);

select * from hash_test A, hash_test2 B order by a.id,b.id;
select a.test_date, b.test_date from hash_test A, hash_test2 B where a.test_date ='2006-01-01'
order by 1,2; 
