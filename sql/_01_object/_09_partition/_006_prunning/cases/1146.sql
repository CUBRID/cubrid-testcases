-- create a hash partition table  on int field and insert into this table values that query from another new create table of non partition and then drop tables
...
insert into hash_test2 values(51,0,NULL,NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');
