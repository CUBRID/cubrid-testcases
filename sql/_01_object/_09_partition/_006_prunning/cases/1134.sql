-- create a hash partition class on a date field with size 4 and query data using self-join and then drop class
...
select a.test_date, b.test_date from hash_test A, hash_test B where a.test_date ='2006-01-01'
order by 1,2;
