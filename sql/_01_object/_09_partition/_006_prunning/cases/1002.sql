--test the operators(in, not in, not null, not between, <>) with select queries and timestamp type
...
select * from list_test where test_timestamp in ( '2006-02-01 09:00:00','2006-03-21 09:00:00','2006-04-11 09:00:00'   ) order by 1,2;
select * from list_test where test_timestamp not in ('2006-02-01 09:00:00','2006-03-21 09:00:00','2006-04-11 09:00:00'    )  order by 1,2;
select * from list_test where test_timestamp is not null order by 1,2;

select * from list_test where test_timestamp not between '2006-02-21 09:00:00' and '2006-04-01 09:00:00' order by 1,2;
select * from list_test where test_timestamp <> '2006-03-01 09:00:00' order  by 1;
select * from list_test where test_timestamp <> '2006-04-01 09:00:00' order by 1,2;
