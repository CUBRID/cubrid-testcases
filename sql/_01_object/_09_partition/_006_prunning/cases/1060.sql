--create range partition table with char data type and three partitions,create other table,select data from these two tables, they are partition - non partition join
...
select * from range_test A, range_test2 B where a.test_char <'ddd' and b.test_char ='iii'  order by 1;
order by a.test_char , b.test_char;
