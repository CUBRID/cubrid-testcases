--create range partition table with timestamp data type and three partitions,create table,insert data to tables,update the range partition table with where complex clause
...
update range_test set test_timestamp = (select test_timestamp from range_test2 where  id = 7) where test_timestamp = '2006-01-01 08:10:00';
update range_test set test_timestamp = (select test_timestamp from range_test2 where  id = 8) where test_timestamp = '2006-01-11 08:20:00';
