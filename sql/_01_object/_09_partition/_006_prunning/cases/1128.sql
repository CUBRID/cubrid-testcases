-- create a hash partition class on a smallint field with size 4 and query data using self-join and then drop class
...
select a.test_smallint, b.test_smallint from hash_test A, hash_test B where a.test_smallint =1.0
order by 1,2;
