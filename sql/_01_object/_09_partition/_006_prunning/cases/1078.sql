--create range partition table with time data type and  three partitions,create table,insert data to the first table with the records of the second table,select data from tables
