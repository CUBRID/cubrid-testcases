--create range partition table with int data type and  three partitions,create table,insert data to the first table with the records of the second table in a boundary,select data from tables
...
insert into range_test select * from range_test2 where test_int >=10 and test_int <20;
