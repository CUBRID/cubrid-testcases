--create range partition table with nvarchar data type,insert data to this table and select data in where clause with keyword 'in', 'not in', 'not null', 'not between','<>'
...
select * from range_test where test_nvarchar in (N'aaa',N'ddd',N'iii') order by 1,2;
select * from range_test where test_nvarchar not in (N'bbb',N'eee',N'hhh') order by 1,2;
select * from range_test where  test_nvarchar is not null order by 1,2;
select * from range_test where test_nvarchar not between N'bbb' and N'ggg' order by 1,2;
select * from range_test where test_nvarchar <> N'ccc' order by 1,2;
select * from range_test where test_nvarchar <> N'hhh' order by 1,2;
