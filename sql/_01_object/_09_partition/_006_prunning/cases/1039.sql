--create range  table with char data type,create range table with char data type,then insert the second table with records of the first table and other data 
