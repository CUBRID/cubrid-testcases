-- create a hash partition class on a string field with size 4 and query data using self-join and then drop class
...
select a.test_string, b.test_string from hash_test A, hash_test B where a.test_string ='aaaaaaaaaa'
order by 1,2;
