--create range partition table with varchar data type,insert data to this table and select data in where clause with keyword 'in', 'not in', 'not null', 'not between','<>'
...
select * from range_test where test_varchar in ('aaa','ddd','iii') order by 1,2;
select * from range_test where test_varchar not in ('bbb','eee','hhh') order by 1,2;
select * from range_test where  test_varchar is not null order by 1,2;
select * from range_test where test_varchar not between 'bbb' and 'ggg' order by 1,2;
select * from range_test where test_varchar <> 'ccc' order by 1,2;
select * from range_test where test_varchar <> 'hhh' order by 1,2;
