--create range partition table with int data type and three partitions,create other range partition table with int data type and three partitions,select data from these two tables,they are partition - partition table join
...
select * from range_test A, range_test2 B order by a.test_int, b.test_int;
select a.test_int, b.test_int from range_test A, range_test2 B
where a.test_int < 10 and b.test_int =25
order by a.test_int, b.test_int;
