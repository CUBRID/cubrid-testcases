--create range partition table with int data type and three partitions,create table,insert data to tables,update the range partition table with where complex clause
...
update range_test set test_int = (select test_int from range_test2 where  id = 7) where test_int = 1;
update range_test set test_int = (select test_int from range_test2 where  id = 8) where test_int = 2;
