-- create a hash partition table  on nvarchar field with size 4 and a hash partition table on nvarchar field with size 6  and query data from the two join table and then drop tables
...
create table hash_test(id int not null  ,
	...
	insert into hash_test values(21,NULL,NULL,NULL,NULL,NULL,N'zll',NULL,'2006-03-01 09:00:00');
...
create table hash_test2(id int not null  ,
	...
	insert into hash_test2 values(21,NULL,NULL,NULL,NULL,NULL,N'zll',NULL,'2006-03-01 09:00:00');

select * from hash_test A, hash_test2 B order by a.id,b.id;
select a.test_nvarchar, b.test_nvarchar from hash_test A, hash_test2 B where a.test_nvarchar =N'aaa'
order by 1,2;
