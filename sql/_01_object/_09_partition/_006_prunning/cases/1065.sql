--create range partition table with timestamp data type and three partitions,select data from two tables,they are same(partition table self-join)
...
select * from range_test A, range_test B order by a.test_timestamp,b.test_timestamp;
select a.test_timestamp, b.test_timestamp from range_test A, range_test B 
