-- create a hash partition class on a nvarchar field with size 4 and query data using self-join and then drop class
...
select a.test_nvarchar, b.test_nvarchar from hash_test A, hash_test B where a.test_nvarchar =N'aaa'
order by 1,2;
