--create range partition table with char data type and three partitions,create other range partition table with char data type and three partitions,select data from these two tables,they are partition - partition table join
...
select * from range_test A, range_test2 B order by a.test_char, b.test_char;
select a.test_char, b.test_char from range_test A, range_test2 B where a.test_char <'ddd' and b.test_char = 'iii' order by a.test_char, b.test_char;
