-- create a hash partition table  on nvarchar field and a non partition table and query data from the two join table and then drop tables
...
create table hash_test(id int not null ,
	...
	insert into hash_test values(21,NULL,NULL,NULL,NULL,NULL,N'zllliketext',NULL,'2006-03-01 09:00:00');
