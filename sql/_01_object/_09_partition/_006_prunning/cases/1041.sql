--create range  table with nchar data type,create range table with nchar data type,then insert the second table with records of the first table and other data 
