-- create a hash partition class on a nchar field with size 4 and query data using self-join and then drop class
...
select a.test_nchar, b.test_nchar from hash_test A, hash_test B where a.test_nchar =N'aaa'
order by 1,2;
