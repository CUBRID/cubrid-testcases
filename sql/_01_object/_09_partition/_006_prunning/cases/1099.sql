-- insert data  whith create hash partition table on a varchar field with siz"e 4 and query data using keyword of  "in","not in","not null","not between" and "<>"
...
select * from hash_test where test_varchar in ('aaa','ddd','lll') order by 1,2;
select * from hash_test where test_varchar not in ('bbb','eee','hhh') order by 1,2;
select * from hash_test where  test_varchar is not null order by 1,2;

select * from hash_test where test_varchar not between 'bbb' and 'ggg' order by 1,2;
select * from hash_test where test_varchar <> 'ccc' order by 1,2;
select * from hash_test where test_varchar <> 'hhh' order by 1,2;
