-- create a hash partition class on a timestamp field with size 4 and query data using self-join and then drop class
...
select a.test_timestamp, b.test_timestamp from hash_test A, hash_test B where a.test_timestamp ='2006-01-01 08:10:01'
order by 1,2;
