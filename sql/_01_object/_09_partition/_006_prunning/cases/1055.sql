--create range partition table with int data type,insert data to this table and select data in where clause with function abs,trunc,cast and numeric
...
select * from range_test where test_int = abs(-11) order by 1;
select * from range_test where test_int = trunc(1.1) order by 1;
select * from range_test where test_int = trunc(11.10) order by 1;
select * from range_test where test_int = trunc(cast('11.10' as numeric)) order by 1;
