-- create a hash partition class on a varchar field with size 4 and query data using self-join and then drop class
...
select a.test_varchar, b.test_varchar from hash_test A, hash_test B where a.test_varchar ='aaa' order by 1,2;
