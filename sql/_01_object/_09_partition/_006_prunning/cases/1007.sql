--test the operators(in, not in, not null, not between, <>) with select queries and int type
...
select * from list_test where test_int in (1,13,10) order by 1,2;
select * from list_test  where test_int not in (2, 15, 10) order by 1,2;
select * from list_test  where test_int is NOT NULL order by 1,2;

select * from list_test  where test_int not between 2 and 15 order by 1,2;
select * from list_test  where test_int  <> 10 order by 1,2;
select * from list_test  where test_int <> 13 order by 1,2;
