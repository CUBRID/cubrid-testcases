-- create a hash partition table  on nvarchar field and insert into this table values that query from another new create table of non partition and then drop tables
...
create table hash_test2(id int not null primary key ,
	...
	insert into hash_test2 values(51,NULL,NULL,NULL,NULL,NULL,N'zll',NULL,'2006-03-01 09:00:00');	      	
