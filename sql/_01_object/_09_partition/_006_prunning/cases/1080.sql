--create range partition table with char data type and three partitions,create table,insert data to tables,update the range partition table with where complex clause
...
update range_test set test_char = (select test_char from range_test2 where  id = 8) where test_char = 'aaa';
update range_test set test_char = (select test_char from range_test2 where  id = 9) where test_char = 'bbb';
