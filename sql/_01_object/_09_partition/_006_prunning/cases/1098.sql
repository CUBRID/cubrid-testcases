-- insert data  whith create hash partition table on a char field with siz"e 4 and query data using keyword of  "in","not in","not null","not between" and "<>"
...
select * from hash_test where test_char in ('aaa','ddd','lll') order by 1,2;
select * from hash_test where test_char not in ('bbb','eee','hhh') order by 1,2;
select * from hash_test where  test_char is not null order by 1,2;

select * from hash_test where test_char not between 'bbb' and 'ggg' order by 1,2;
select * from hash_test where test_char <> 'aaa' order by 1,2;
select * from hash_test where test_char <> 'kkk' order by 1,2;
