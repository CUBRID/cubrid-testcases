--create range  table with nvarchar data type,create range table with nvarchar data type,then insert the second table with records of the first table and other data 
