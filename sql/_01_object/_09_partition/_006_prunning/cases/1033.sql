--create range partition table with int data type,insert data to this table and select data in where clause with  function extract,to_number,cast
...
select * from range_test where test_int = extract( month from date '2007-04-05') order by 1;
select * from range_test where test_int = extract( day from date '2007-04-05') order by 1;
select * from range_test where test_int = to_number ('11') order by 1;
select * from range_test where test_int = cast('11' as int) order by 1;
