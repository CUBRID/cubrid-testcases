...
select * from range_test2 A, range_test B order by a.id;
select a.test_int, b.test_int from range_test A, range_test2 B where a.test_int =1.0 order by a.id;
select a.test_int, b.test_int from range_test2 A, range_test B where a.test_int =1.0 order by a.id;
