-- create a hash partition class on a int field with size 4 and query data using self-join and then drop class
...
create table hash_test(id int not null ,
	...
	insert into hash_test values(21,21,NULL,NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');
...
select a.test_int, b.test_int from hash_test A, hash_test B where a.test_int =1.0
order by 1,2;
