-- create a hash partition table  on time field with size 4 and a hash partition table on time field with size 6  and query data from the two join table and then drop tables
...
create table hash_test(id int not null,	
	...
	insert into hash_test values(21,'08:08:08',NULL,NULL);
	...
	insert into hash_test2 values(21,'08:08:08',NULL,NULL);

select * from hash_test A, hash_test2 B order by a.id,b.id;
select a.test_time, b.test_time from hash_test A, hash_test2 B where a.test_time ='08:10:01'
order by 1,2;
