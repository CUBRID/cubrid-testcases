--create range  table with time data type,create range table with time data type,then insert the second table with records of the first table and other data 
