--create range partition table with char data type,insert data to this table and select data in where clause with function trim,substring
...
select * from range_char where test_char = trim(substring('123AA  ' from 4)) order by 1;
