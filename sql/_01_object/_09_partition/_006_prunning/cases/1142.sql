-- create a hash partition table  on varchar field and insert into this table values that query from another new create hash partition  table on varchar field and then drop tables
...
create table hash_test(id int not null ,
	...
	insert into hash_test values(21,NULL,'zll',NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');
...
insert into hash_test2 values(31,'aaa','aaa',B'100',B'1011',N'aaa',N'aaa','aaaaaaaaaa','2006-03-01 09:00:00');
	...
	insert into hash_test2 values(51,NULL,'zll',NULL,NULL,NULL,NULL,NULL,'2006-03-01 09:00:00');	 
