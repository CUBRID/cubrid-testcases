--create range partition table with timestamp data type and three partitions,create other table,select data from these two tables, they are partition - non partition join
