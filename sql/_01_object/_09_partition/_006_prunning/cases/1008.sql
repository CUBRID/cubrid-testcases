--test the operators(in, not in, not null, not between, <>) with select queries and smallint type
...
select * from list_test where test_smallint in (1,13,10) order by 1,2;
select * from list_test  where test_smallint not in (2, 15, 10) order by 1,2;
select * from list_test  where test_smallint is NOT NULL order by 1,2;

select * from list_test  where test_smallint not between 2 and 15 order by 1,2;
select * from list_test  where test_smallint <> 10 order by 1,2;
select * from list_test  where test_smallint <> 13 order by 1,2;
