--create range partition table with int data type,insert data to this table and select data in where clause with keyword 'in', 'not in', 'not null', 'not between','<>'
...
select * from range_test where test_int in (1,13,26) order by 1,2;
select * from range_test  where test_int not in (2, 15, 27) order by 1,2;
select * from range_test  where test_int is NOT NULL order by 1,2;
select * from range_test  where test_int not between 2 and 25 order by 1,2;
select * from range_test  where test_int  <> 14 order by 1,2;
select * from range_test  where test_int <> 25 order by 1,2;
