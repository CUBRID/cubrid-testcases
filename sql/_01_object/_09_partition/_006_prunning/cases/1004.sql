--test the operators(in, not in, not null, not between, <>) with select queries and nchar type
...
select * from list_test where test_nchar in (N'aaa',N'ddd',N'lll') order by 1,2;
select * from list_test where test_nchar not in (N'bbb',N'eee',N'hhh') order by 1,2;
select * from list_test where  test_nchar is not null order by 1,2;

select * from list_test where test_nchar not between N'bbb' and N'ggg' order by 1,2;
select * from list_test where test_nchar <> N'ccc' order by 1,2;
select * from list_test where test_nchar <> N'hhh' order by 1,2;
