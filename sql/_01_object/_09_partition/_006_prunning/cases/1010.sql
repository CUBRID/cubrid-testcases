--test the operators(in, not in, not null, not between, <>) with select queries and date type
...
select * from list_test where test_date in ('2006-04-01','2006-02-01','2006-03-01') order by 1,2;
select * from list_test where test_date not in ('2006-04-01','2006-02-01','2006-03-01') order by 1,2;
select * from list_test where test_date is not null order by 1,2;

select * from list_test where test_date not between '2006-01-11' and '2006-03-01' order by 1,2;
select * from list_test where test_date <> '2006-02-01' order  by 1;
select * from list_test where test_date <> '2006-03-01' order by 1,2;
