-- insert data  whith create hash partition table on a timestamp field with size 4 and query data using keyword of  "in","not in","not null","not between" and "<>"
...
select * from hash_test where test_timestamp in ( '2006-02-01 09:10:03','2006-03-11 10:40:06','2006-04-11 11:30:08'   ) order by 1,2;
select * from hash_test where test_timestamp not in ('2006-02-01 09:10:03','2006-03-11 10:40:06','2006-04-11 11:30:05'    )  order by 1,2;
select * from hash_test where test_timestamp is not null order by 1,2;

select * from hash_test where test_timestamp not between '2006-02-21 09:00:00' and '2006-04-01 09:00:00' order by 1,2;
select * from hash_test where test_timestamp <> '2006-03-11 10:40:06' order  by 1;
select * from hash_test where test_timestamp <> '2007-05-01 12:40:19' order by 1,2;
