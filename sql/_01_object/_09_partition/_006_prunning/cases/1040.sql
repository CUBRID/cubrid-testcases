--create range  table with varchar data type,create range table with varchar data type,then insert the second table with records of the first table and other data 
