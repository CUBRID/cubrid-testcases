--create range  table with int data type,create range table with int data type,then insert the second table with records of the first table and other data 
