-- create a hash partition table  on varchar field with size 4 and a hash partition table on varchar field with size 6  and query data from the two join table and then drop tables
...
select a.test_varchar, b.test_varchar from hash_test A, hash_test2 B where a.test_varchar ='aaa'
order by 1,2;
