--test the operators(in, not in, not null, not between, <>) with select queries and string type
...
select * from list_test where test_string in ('aaaaaaaaaa','gggggggggg','mmmmmmmmmm') order by 1,2;
select * from list_test where test_string not in ('bbbbbbbbbb','hhhhhhhhhh','llllllllll') order by 1,2;
select * from list_test where  test_string is not null order by 1,2;

--select * from list_test where test_nvarchar not between 'bbbbbbbbbb' and 'gggggggggg' order by 1,2;
--select * from list_test where test_nvarchar <> 'cccccccccc' order by 1,2;
--select * from list_test where test_nvarchar <> 'hhhhhhhhhh' order by 1,2;
