--test the operators(in, not in, not null, not between, <>) with select queries and time type
...
select * from list_test where test_time in ('09:10:00','09:20:00','10:20:00') order by 1,2;
select * from list_test where test_time not in ('09:20:00', '11:20:00','10:20:00') order by 1,2;
select * from list_test where test_time is not null order by 1,2;

select * from list_test where test_time not between '08:20:00' and '10:10:00' order by 1,2;
select * from list_test where test_time <>'09:10:00' order  by 1;
select * from list_test where test_time <> '10:10:00' order by 1,2;
