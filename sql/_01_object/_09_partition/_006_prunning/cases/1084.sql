--create range partition table with nvarchar data type and three partitions,create table,insert data to tables,update the range partition table with where complex clause
...
update range_test set test_nvarchar = (select test_nvarchar from range_test2 where  id = 8) where test_nvarchar = N'aaa';
update range_test set test_nvarchar = (select test_nvarchar from range_test2 where  id = 9) where test_nvarchar = N'bbb';
