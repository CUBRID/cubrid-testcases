...
select * from foo where a = 1 and b <= 3 using index none order by a, b, c, d;
select * from foo where a = 2 and b <= 3 using index none order by a, b, c, d;
select * from foo where a = 3 and b <= 3 using index none order by a, b, c, d;

create index idx1 on foo ( a , b , c );
select a, b from foo where a = 1 and b <= 3 using index idx1 order by b;
select a, b from foo where a = 2 and b <= 3 using index idx1 order by b;
select a, b from foo where a = 3 and b <= 3 using index idx1 order by b;
