...
select * from foo where a = 1 and b >= 3 using index none order by b, c, d;
select * from foo where a = 1 and b >= 3 using index none order by b, c, d;
select * from foo where a = 1 and b >= 3 using index none order by b, c, d;

create index idx1 on foo ( a , b , c );
select * from foo where a = 1 and b >= 3 using index idx1 order by b, c, d;
select * from foo where a = 2 and b >= 3 using index idx1 order by b, c, d;
select * from foo where a = 3 and b >= 3 using index idx1 order by b, c, d;
