...
select * from foo where a = 1 and b < 3 using index idx1;
select * from foo where a = 2 and b < 3 using index idx1;
select * from foo where a = 3 and b < 3 using index idx1;
