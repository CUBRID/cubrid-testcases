...
SELECT INDEX_CARDINALITY('dba.t1','i_t1_i3_s2',0);
SELECT INDEX_CARDINALITY('dba.t1','i_t1_i3_s2',1);
SELECT INDEX_CARDINALITY('dba.t1','u_t1_i3_s3',1);

SELECT INDEX_CARDINALITY('dba.t1__p__p0','i_t1_i1',0);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','i_t1_i1_s1',0);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','i_t1_i1_s1',1);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','i_t1_i3_s2',0);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','i_t1_i3_s2',1);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','u_t1_i3_s3',0);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','u_t1_i3_s3',1);
...
SELECT INDEX_CARDINALITY('dba.t1','i_t1_i3_s2',0);
SELECT INDEX_CARDINALITY('dba.t1','i_t1_i3_s2',1);
SELECT INDEX_CARDINALITY('dba.t1','pk_t1_i3_s3',0);
SELECT INDEX_CARDINALITY('dba.t1','pk_t1_i3_s3',1);
...
SELECT INDEX_CARDINALITY('dba.t1__p__p0','i_t1_i3_s2',0);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','i_t1_i3_s2',1);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','pk_t1_i3_s3',0);
SELECT INDEX_CARDINALITY('dba.t1__p__p0','pk_t1_i3_s3',1);
