...
insert into t select 1988,'n'||rownum,rownum+1,rownum+2,rownum+3 from db_root connect by level<=226;
...
insert into t select 2020,'n'||rownum,rownum+1,rownum+2,rownum+3 from db_root connect by level<=226;
