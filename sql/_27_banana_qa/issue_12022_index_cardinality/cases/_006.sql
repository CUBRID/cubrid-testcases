--test the cardinality of filtered index on hash partition table
...
) partition by hash(b5) partitions 10;
...
create index fidx3 on t(b2, b5, b7, b8, b9, b10, b14, b12, a2) where b14 is null and b4>'a' and b6=1;
