...
select index_cardinality('dba.t', 'idx1', 0);
select index_cardinality('dba.t', 'idx2', 1);
select index_cardinality('dba.t', 'idx3', 2);
select index_cardinality('dba.t', 'idx1', 3);
select index_cardinality('dba.t', 'idx2', 4);
select index_cardinality('dba.t', 'idx3', 5);
select index_cardinality('dba.t', 'idx4', 6);
select index_cardinality('dba.t', 'idx1', 7);
select index_cardinality('dba.t', 'idx2', 8);
select index_cardinality('dba.t', 'idx3', 9);
select index_cardinality('dba.t', 'idx4', 10);
select index_cardinality('dba.t', 'idx1', 11);
select index_cardinality('dba.t', 'idx2', 12);
select index_cardinality('dba.t', 'idx3', 13);
select index_cardinality('dba.t', 'idx4', 14);
select index_cardinality('dba.t', 'idx4', 15);
select index_cardinality('dba.t', 'idx4', 16);
select index_cardinality('dba.t', 'idx4', 17);
drop table t;
