--test the cardinality of function index
...
create index fidx1 on t(a2, upper(b1), b2, b3, b4, b5);
create index fidx0 on t(a2, trim(b1), b2, b3, upper(b4), b5);
create index fidx2 on t(b2, day(b5), b7, b8, b9, b10, b14, b12, a2);
create index fidx3 on t(b14, md5(b13), b12, b11, b10, b9, b8, b7, b6, b5, b4, b3, b2, b1, a2, a3);
