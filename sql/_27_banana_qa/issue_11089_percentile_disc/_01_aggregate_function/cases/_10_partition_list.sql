...
select * from p_disc where col1 = (select percentile_disc(1) within group (order by col1) p_disc from p_disc);
--test: [er]
...
update p_disc set col1 = (select percentile_disc(0.8) within group (order by col2) from p_disc), col3='updated';
select * from p_disc__p__p4 order by 1, 2, 3, 4, 5;
rollback;
update p_disc set col2 = (select percentile_disc(0.8) within group (order by col1) from p_disc), col3='updated';
select * from p_disc__p__p4 order by 1, 2, 3, 4, 5;
rollback;
update p_disc set col2 = (select percentile_disc(0.8) within group (order by col1) from p_disc group by col2 order by 1 limit 1), col3='updated';
select * from p_disc order by 1, 2, 3, 4, 5;
rollback;
update p_disc t1 set col2 = (select percentile_disc(0.8) within group (order by t1.col1) from p_disc where col1 < 20), col3='updated';
select * from p_disc order by 1, 2, 3, 4, 5;
rollback;
update p_disc t1 set col2 = (select percentile_disc(0.8) within group (order by t1.col1) from p_disc where col1 < 20 group by col2 order by 1 limit 1), col3='updated';
select * from p_disc order by 1, 2, 3, 4, 5;
rollback;

--test: subquery in odku statement
alter table p_disc add constraint pk primary key(col1, col3);
insert into p_disc(col1, col2, col3, col4, col5) values(20, 999, 'cubrid', '2013-12-12 12:12:12.222', B'1111') on duplicate key update col1=(select percentile_disc(0.778) within group (order by col1) from p_disc), col3='updated';
select * from p_disc order by 1, 2, 3, 4, 5;
rollback;
alter table p_disc add constraint pk primary key(col1, col3);
insert into p_disc(col1, col2, col3, col4, col5) values(15, 999, 'mysql', '2013-12-12 12:12:12.222', B'1111') on duplicate key update col2=(select percentile_disc(0.3) within group (order by col1) from p_disc), col3='updated';
select * from p_disc order by 1, 2, 3, 4, 5;
rollback;
