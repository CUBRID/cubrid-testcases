...
--modify charset
alter table t1 modify col_binary char(9) charset utf8;
select * from t1 order by 1,2,3,4;
alter table t1 change col_euckr col_euckr  varchar(10) charset binary;
select * from t1 order by 1,2,3,4;
alter table t1 modify col_euckr  varchar(10) charset euckr;
select * from t1 order by 1,2,3,4;
alter table t1 change col_utf8 col_utf8  varchar(10) charset binary;
select * from t1 order by 1,2,3,4;
alter table t1 change col_iso col_iso  varchar(10) charset binary;
select * from t1 order by 1,2,3,4;
alter table t1 modify col_iso varchar(10) charset iso88591;
select * from t1 order by 1,2,3,4;
