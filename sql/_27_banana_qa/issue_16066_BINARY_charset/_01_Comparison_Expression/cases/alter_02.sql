...
--modify collation
alter table t1 modify col_binary varchar(10) collate utf8_bin;
select * from t1 order by 1,2,3,4;
alter table t1 modify col_euckr varchar(10) collate binary;
alter table t1 change col_euckr col_euckr varchar(10) collate euckr_bin;
select * from t1 order by 1,2,3,4;
alter table t1 modify col_utf8  varchar(10) collate binary;
alter table t1 change col_utf8 col_utf8  varchar(10) collate utf8_en_ci;
select * from t1 order by 1,2,3,4;
show full columns in t1;
alter table t1 modify col_utf8  varchar(10) collate binary;
alter table t1 change col_utf8 col_utf8  varchar(10) collate utf8_en_cs;
select * from t1 order by 1,2,3,4;

alter table t1 modify col_iso  varchar(10) collate binary;
select * from t1 order by 1,2,3,4;
alter table t1 modify col_iso  varchar(10) collate iso88591_en_cs;
select * from t1 order by 1,2,3,4;
show full columns in t1;
