...
SELECT strcmp(col_binary , col_euckr) from t1;
SELECT strcmp(col_binary , col_utf8 ) from t1;
SELECT strcmp(col_binary , col_iso ) from t1;
SELECT strcmp(col_euckr , col_utf8 ) from t1;
SELECT strcmp(col_euckr , col_iso ) from t1;
SELECT strcmp(col_utf8 , col_iso ) from t1;
