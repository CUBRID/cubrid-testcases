...
select if(subdate('2009-3-14 23:11:12.999 America/Argentina/Cordoba ART', interval '1' hour)='2009-3-14 23:11:12.999 America/Argentina/Cordoba'), 'ok', 'nok');
select if(subdate('2009-3-14 23:11:12.999 America/Argentina/Cordoba ART', interval '1' hour)='2009-3-14 23:11:12.999 America/Argentina/Cordoba ARST'), 'ok', 'nok');
select if(subdate('2009-3-15 12:11:12.999 AM', interval '1' hour)='2009-3-14 23:11:12.999 America/Argentina/Cordoba ART', 'ok', 'nok');
select if(subdate('2009-3-15 12:11:12.999 AM', interval '2' hour)='2009-3-14 23:11:12.999 America/Argentina/Cordoba ARST', 'ok', 'nok');
--[er]
