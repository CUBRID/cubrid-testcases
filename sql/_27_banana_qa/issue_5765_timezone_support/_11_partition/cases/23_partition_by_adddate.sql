...
create table t(i int auto_increment,j datetime with time zone,k varchar(20)) partition  by range(adddate(j,interval '3:00:00' hour_second))
(
...
set timezone '+3:00';
drop table if exists t;
create table t(i int auto_increment,j datetime with local time zone,k varchar(20)) partition  by range(adddate(j,interval '3:00:00' hour_second))
(
...
set timezone '+00:00';
drop table if exists t;
create table t(i int auto_increment,j timestamp with time zone,k varchar(20)) partition  by range(adddate(j,interval '3:00:00' hour_second))
(
partition p0 values less than (datetimetz'2015-1-1 00:00:00'),
partition p1 values less than (datetimetz'2015-1-1 3:00:00'),
partition p2 values less than (datetimetz'2015-1-2 12:00:00 am'),
...
set timezone '+3:00';
drop table if exists t;
create table t(i int auto_increment,j timestamp with local time zone,k varchar(20)) partition  by range(adddate(j,interval '3:00:00' hour_second))
(
partition p0 values less than (datetimetz'2015-1-1 00:00:00 +03:00'),
partition p1 values less than (datetimetz'2015-1-1 3:00:00 +03:00'),
partition p2 values less than (datetimetz'2015-1-2 12:00:00 am -03:00'),
