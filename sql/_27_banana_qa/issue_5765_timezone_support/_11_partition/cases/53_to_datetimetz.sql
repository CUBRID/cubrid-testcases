...
create table t(i int auto_increment,j datetime ,k varchar(20)) partition  by range(to_datetime_tz(j))
(
...
set timezone '+3:00';
drop table if exists t;
create table t(i int auto_increment,j datetime with local time zone,k varchar(20)) partition  by range(to_datetime_tz(j))
(
