...
alter table t partition by range(to_timestamp_tz(j))
(
...
alter table t partition by range(to_timestamp(dttz))
(
partition p0 values less than (timestamptz'2015-3-8 01:59:59'),
partition p1 values less than (timestamptz'2015-11-1 01:59:59 America/New_York'),
partition p2 values less than maxvalue
...
alter table t partition by range(to_timestamp(dtltz))
(
partition p0 values less than (timestamptz'2015-3-8 01:59:59'),
partition p1 values less than (timestamptz'2015-11-1 01:59:59 America/New_York'),
partition p2 values less than maxvalue
...
insert into t values
(null,'2015-3-8 01:59:59','2015-3-8 01:59:59','2015-3-8 01:59:59','2015-3-8 01:59:59','2015-3-8 01:59:59');
alter table t partition by range(to_timestamp(tstz))
(
partition p0 values less than (timestamptz'2015-3-8 01:59:59'),
partition p1 values less than (timestamptz'2015-11-1 01:59:59 America/New_York'),
partition p2 values less than maxvalue
...
alter table t partition by range(to_timestamp(tsltz))
(
partition p0 values less than (timestamptz'2015-3-8 01:59:59'),
partition p1 values less than (timestamptz'2015-11-1 01:59:59 America/New_York'),
partition p2 values less than maxvalue
