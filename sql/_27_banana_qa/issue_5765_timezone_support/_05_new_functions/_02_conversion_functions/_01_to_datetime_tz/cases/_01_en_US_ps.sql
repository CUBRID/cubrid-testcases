--test to_datetime_tz function, with en_US language
--+ holdcas on;


set system parameters 'intl_date_lang=en_US';

prepare st from 'select to_char(to_datetime_tz(?, ?), ''TZR'');';
...
execute st using '11 30 59 pm Feb/26/2000 America/Fortaleza BRST', 'HH24 MI SS AM MON/DD/YYYY TZR TZD';
