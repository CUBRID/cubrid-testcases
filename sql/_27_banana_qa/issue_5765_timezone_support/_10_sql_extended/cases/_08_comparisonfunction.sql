...
select c_tsltz1,c_tsltz2,IFNULL(c_tsltz2,c_tsltz1) from tztest where id =1; 
select c_tsltz1,c_tsltz2,NVL(c_tsltz2,c_tsltz1) from tztest where  id =1;
select c_tsltz1,c_tsltz2,NVL2(c_tsltz2,c_tsltz2,c_tsltz1) from tztest where id =1;
...
select c_dtltz1,c_dtltz2,IFNULL(c_dtltz2,c_dtltz1) from tztest where id =1;
select c_dtltz1,c_dtltz2,NVL(c_dtltz2,c_dtltz1) from tztest where  id =1;
select c_dtltz1,c_dtltz2,NVL2(c_dtltz2,c_dtltz2,c_dtltz1) from tztest where id =1;
