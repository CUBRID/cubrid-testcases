--compare TIMESTAMPLTZ column with constant values

drop table if exists tz_test;

create table tz_test(id int, ts timestamp with local time zone);

set timezone '-8:00';
insert into tz_test values(1, timestampltz'2014-10-10 13:50:59');
insert into tz_test values(2, timestampltz'2014-10-10 13:50:59 +10:00');
insert into tz_test values(3, timestampltz'2014-10-10 13:50:59 Asia/Seoul');

--test: test with constant values
select if(ts=timestampltz'2014-10-10 13:50:59 -8:00', 'ok', 'nok') from tz_test where id=1;
select if(ts=timestampltz'2014-10-10 13:50:59 America/Metlakatla', 'ok', 'nok') from tz_test where id=1;
select if(ts=timestampltz'2014-10-10 12:50:59 -9:00', 'ok', 'nok') from tz_test where id=1;
select if(ts=timestampltz'2014-10-10 14:50:59 +11:00', 'ok', 'nok') from tz_test where id=2;
select if(ts=timestampltz'2014-10-10 13:50:59 Asia/Tokyo', 'ok', 'nok') from tz_test where id=3;
select if(ts=timestampltz'2014-10-10 13:50:59 +9:00', 'ok', 'nok') from tz_test where id=3;
