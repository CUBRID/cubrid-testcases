...
select id,to_char(ts,'YYYY-MM-DD HH24:MI:SS.FF TZR TZD') from (select id, dttz as ts from (select id, dttz,to_char(dttz) from t2 order by 1,3 desc ) union select id, ts from t1 order by 1, 2) order by 1,2;
...
select id,to_char(ts,'YYYY-MM-DD HH24:MI:SS.FF TZR TZD') from (select id, dttz as ts from (select id, dttz,to_char(dttz) from t2 order by 1,3
 desc ) union select id, dtltz as ts from t1 order by 1, 2) order by 1,2;
...
select id,to_char(ts,'YYYY-MM-DD HH24:MI:SS.FF TZR TZD') from (select id, dttz as ts from (select id, dttz,to_char(dttz) from t2 order by 1,3 desc ) intersect select id, dtltz as ts from t1 order by 1, 2);
