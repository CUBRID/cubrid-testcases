...
select if(tsltz-timestampltz'2025-09-21 23:00:00 Asia/Tehran IRDT'=3600, 'ok', 'nok') from tz_test where id=7;
select if(timestampltz'2025-09-21 23:59:59 Asia/Tehran IRDT'+1=tsltz, 'ok', 'nok') from tz_test where id=7;
