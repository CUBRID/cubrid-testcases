...
select if(dttz-datetimeltz'2025-09-21 23:00:00.999 Asia/Tehran +0430'=3600*1000, 'ok', 'nok') from tz_test where id=7;
select if(datetimeltz'2025-09-21 23:59:59.999 Asia/Tehran +0430'+1000=dttz, 'ok', 'nok') from tz_test where id=7;
