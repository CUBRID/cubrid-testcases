--[er]test cast function by casting list{nchar varying }data type to list of string data type
set timezone '+9:00';
...
select cast(list{ncharvartest} as list of string) from func_03 order by 1;
