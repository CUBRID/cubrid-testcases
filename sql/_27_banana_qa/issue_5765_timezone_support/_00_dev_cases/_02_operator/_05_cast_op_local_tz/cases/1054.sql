--test cast function by casting varchar to string or varchar(n) or int or numeric or float data type in select clause
set timezone '+9:00';
...
select cast(varchartest as string) from func_03 order by 1;	
select cast(varchartest as varchar(10)) from func_03 order by 1;	
select cast(varchartest as varchar(20)) from func_03 order by 1;	
select cast(varchartest as int) from func_03	 order by 1 order by 1;
select cast(varchartest as numeric(38,10)) from func_03	 order by 1 order by 1;
select cast(varchartest as float) from func_03 order by 1 order by 1;
