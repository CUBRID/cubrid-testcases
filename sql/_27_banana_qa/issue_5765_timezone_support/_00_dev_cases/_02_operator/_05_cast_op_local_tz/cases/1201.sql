--[er]test cast function by casting varchar to multiset of string data type in select clause
set timezone '+9:00';
...
select cast(varchartest as multiset of string) from func_03 order by 1;
