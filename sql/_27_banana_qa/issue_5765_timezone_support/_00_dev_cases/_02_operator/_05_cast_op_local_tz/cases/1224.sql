-- insert data  whith create range partition table on a datetimeltz field witch using function of cast as char and then query all partitions and drop table
set timezone '+9:00';
...
create table range_test(id int not null,	
	...
	PARTITION BY RANGE (cast(test_time as char(30))) (
