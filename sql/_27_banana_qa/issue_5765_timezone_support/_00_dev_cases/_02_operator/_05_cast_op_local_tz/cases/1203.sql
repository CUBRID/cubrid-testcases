--[er]test cast function by casting set{nchar varying }data type to set of string data type
set timezone '+9:00';
...
select cast(set{ncharvartest} as set of string) from func_03 order by 1;
