...
select cast(doublepretest as int) from func_03 order by 1 desc;	
select cast(doublepretest as numeric(38,10)) from func_03 order by 1 desc;	
select cast(doublepretest as float) from func_03 order by 1 desc;	
select cast(doublepretest as double) from func_03 order by 1 desc;	
select cast(doublepretest as monetary) from func_03 order by 1 desc;	
select cast(doublepretest as nchar(20)) from func_03 order by 1 desc;	
select cast(doublepretest as nchar varying(20)) from func_03 order by 1 desc;	
select cast(set{doublepretest} as set of numeric(38,10)) from func_03	 order by 1;
select cast(list{doublepretest} as list of numeric(38)) from func_03 order by 1 desc;	
