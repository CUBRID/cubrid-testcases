...
--select cast(timetest as varchar(10)) from func_03 order by 1;	
select cast(timetest as varchar(20)) from func_03 order by 1;	
select cast(timetest as time) from func_03 order by 1;	
select cast(timetest as nchar(20)) from func_03 order by 1;	
select cast(timetest as nchar varying(20)) from func_03 order by 1;	
