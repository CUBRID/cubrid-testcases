...
select addtime(to_char(datetimeltz'1111-10-55 12:23:22.111'), time'23:59:59');
...
--TEST: argument of timestampltz type
...
--TEST: argument of datetimeltz type
select addtime(timestampltz('2010-10-28', 'abcabcabc'), time'23:59:59');
