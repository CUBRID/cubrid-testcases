...
select last_day(datetimeltz'2003-08-23 01:02:03.1234'), if (last_day(datetimeltz'2010-08-23 01:02:03.1234') = '2010-08-31', 'ok', 'nok');
select last_day(timestampltz'2010-08-23 01:02:03'), if (last_day(timestampltz'2010-08-23 01:02:03') = '2010-08-31', 'ok', 'nok');
