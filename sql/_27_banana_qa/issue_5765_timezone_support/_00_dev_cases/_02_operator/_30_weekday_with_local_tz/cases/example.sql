...
select weekday(datetimeltz'2003-08-23 01:02:03.1234'), if (weekday(datetimeltz'2010-08-23 01:02:03.1234') = 0, 'ok', 'nok');
select weekday(timestampltz'2010-08-23 01:02:03'), if (weekday(timestampltz'2010-08-23 01:02:03') = 0, 'ok', 'nok');
