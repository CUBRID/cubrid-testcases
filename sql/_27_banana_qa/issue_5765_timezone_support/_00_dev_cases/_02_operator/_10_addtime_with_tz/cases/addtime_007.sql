...
--TEST: 2. marginal values: string type of timestamptz format
...
--TEST: 3. marginal values: string type of datetimetz format
...
--TEST: 4. marginal values: string type of timetz format
