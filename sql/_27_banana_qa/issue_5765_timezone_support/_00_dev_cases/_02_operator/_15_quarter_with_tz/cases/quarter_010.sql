...
select quarter(to_char(to_timestamp_tz('19:39:45 PM 12/12/2012 Europe/London')));

--argument of timestamp type
select quarter(to_timestamp_tz('19:39:45 PM 12/12/2012 Europe/London'));

--argument of datetime type
select quarter(to_datetime_tz('01:23:33 am 10/23/1988 Europe/London'));
