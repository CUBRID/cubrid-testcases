...
select second(to_char(datetimetz'1111-10-55 12:23:22.111'));
...
select second(to_timestamp_tz('19:39:45 BM 12/12/2012 Europe/London'));


--argument of datetime type
select second(to_datetime_tz(123456));
