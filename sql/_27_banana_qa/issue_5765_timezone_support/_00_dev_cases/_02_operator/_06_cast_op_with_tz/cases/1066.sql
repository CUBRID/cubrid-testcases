--test cast function by casting varchar data type to bit varying(n) or set of string or multiset of string or list of string data type 
...
select cast(varchartest as bit varying(80)) from func_03	 order by 1;
select cast(set{varchartest} as set of string) from func_03 order by 1;
select cast(multiset{varchartest} as multiset of string) from func_03	 order by 1;
select cast(list{varchartest} as list of string) from func_03 order by 1;
