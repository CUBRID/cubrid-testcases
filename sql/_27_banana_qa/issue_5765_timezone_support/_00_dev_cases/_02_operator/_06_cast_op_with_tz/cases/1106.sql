--[er]test cast function by casting numeric data type to multiset of string data type
...
select cast(numerictest as multiset of string) from func_03 order by 1;
