-- insert data  whith create range partition table on a date field witch using function of cast as char and then query all partitions and drop table
...
create table range_test(id int not null,	
	...
	PARTITION BY RANGE (cast(test_date as char(10))) (
	PARTITION p0 VALUES LESS THAN ('19950211'),
	PARTITION p1 VALUES LESS THAN ('20000501'),
	PARTITION p2 VALUES LESS THAN ('20020701'),
	PARTITION p3 VALUES LESS THAN MAXVALUE

);
create index date_idx on range_test (test_date);
