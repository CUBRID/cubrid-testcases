--test casting date to other type(like string, varchar, date, timestamptz, nchar, nchar varying, set, multiset, sequence)
...
select cast(datetest as timestamptz) from func_03 order by 1;
