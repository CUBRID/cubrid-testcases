--test cast function by casting nchar varying data type to nchar(n) or nchar varying(n) data type
...
select ncharvartest from func_03	 order by 1;
select cast(ncharvartest as nchar(20)) from func_03 order by 1;
select cast(ncharvartest as nchar varying(20)) from func_03 order by 1;
