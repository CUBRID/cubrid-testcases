-- insert data  whith create range partition table on a timestamptz field witch using function of cast as char and then query all partitions and drop table
