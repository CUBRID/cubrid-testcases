--[er]test cast function by casting nchar varying data type to list of string data type
...
select cast(ncharvartest as list of string) from func_03 order by 1;
