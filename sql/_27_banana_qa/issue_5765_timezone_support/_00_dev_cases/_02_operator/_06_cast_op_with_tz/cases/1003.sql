--[er]test casting timestamptz to other type(like string, varchar, char, date, datetimetz, timestamptz, nchar, nchar varying)
...
select cast(timestamptest as datetimetz) from func_03 order by 1;
select cast(timestamptest as timestamptz) from func_03 order by 1;
...
select cast(set{timestamptest} as set of timestamptz) from func_03 order by 1;
select cast(multiset{timestamptest} as multiset of timestamptz) from func_03 order by 1;
select cast(list{timestamptest} as list of timestamptz) from func_03 order by 1;
