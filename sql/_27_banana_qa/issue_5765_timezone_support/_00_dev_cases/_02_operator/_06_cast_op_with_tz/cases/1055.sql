--test cast function by casting varchar data type to double or monetary or char(n) or bit(n) data type 
...
select cast(varchartest as char(20)) from func_03 order by 1 desc;	
