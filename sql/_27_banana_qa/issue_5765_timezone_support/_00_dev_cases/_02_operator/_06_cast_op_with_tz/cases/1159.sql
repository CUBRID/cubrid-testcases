--[er]test cast function by casting bit date type to multiset of string data type in select clause
...
select cast(bittest as multiset of string) from func_03 order by 1;
