-- insert data  whith create range partition table on a datetimetz field witch using function of cast as char and then query all partitions and drop table

create table range_test(id int not null,	
				   test_time datetimetz,
				   test_date date,
				   test_timestamp timestamptz,
				   primary key(id, test_time))
	PARTITION BY RANGE (cast(test_time as char(11))) (
	PARTITION p0 VALUES LESS THAN ('2015-9-17 12:00:00'),
	PARTITION p1 VALUES LESS THAN ('2015-9-17 15:00:00'),
	PARTITION p2 VALUES LESS THAN ('2015-9-17 18:00:00'),
	PARTITION p3 VALUES LESS THAN ('2015-9-17 21:00:00'),
