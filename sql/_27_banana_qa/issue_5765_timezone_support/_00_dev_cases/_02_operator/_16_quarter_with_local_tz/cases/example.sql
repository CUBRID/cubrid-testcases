...
select quarter(datetimeltz'2003-12-31 01:02:03.1234'), if (quarter(datetimeltz'2003-12-31 01:02:03.1234') = 4, 'ok', 'nok');
select quarter(timestampltz'2003-12-31 01:02:03'), if (quarter(timestampltz'2003-12-31 01:02:03') = 4, 'ok', 'nok');
