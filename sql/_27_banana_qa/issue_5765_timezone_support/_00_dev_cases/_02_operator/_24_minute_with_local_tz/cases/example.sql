...
select minute(datetimeltz'2003-12-31 01:02:03.1234'), if (minute(datetimeltz'2003-12-31 01:02:03.1234') = 2, 'ok', 'nok');
select minute(timestampltz'2003-12-31 01:02:03'), if (minute(timestampltz'2003-12-31 01:02:03') = 2, 'ok', 'nok');
