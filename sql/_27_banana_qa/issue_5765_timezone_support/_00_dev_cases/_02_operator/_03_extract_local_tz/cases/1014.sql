-- create table of hash partition having size 4 on timestampltz field that using extract function get day  and query all partitions
set timezone '+9:00';
...
create table hash_test(id int not null,	
	...
	PARTITION BY HASH (extract(day from test_timestamp))
	PARTITIONS 4;
