-- create table of hash partition having size 4 on timestampltz field that using extract function get minute and query all partitions
set timezone '+9:00';
...
create table hash_test(id int not null,	
	...
	PARTITIONS 4;
create index timestamp_idx on hash_test (test_timestamp);
