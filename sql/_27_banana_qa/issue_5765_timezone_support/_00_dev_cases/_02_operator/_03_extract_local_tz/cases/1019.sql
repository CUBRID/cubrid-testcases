-- insert data  whith create range partition table on a timestampltz field witch using function of extract hour  and then query all partitions and drop table
set timezone '+9:00';
...
update range_test set test_timestamp = '2000-01-01 23:59:59' where test_timestamp < '2008-01-01 11:59:59';
select * from range_test__p__p0 order by id;
select * from range_test__p__p1 order by id;
select * from range_test__p__p2 order by id;
select * from range_test__p__p3 order by id;
