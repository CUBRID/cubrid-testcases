-- insert data  whith create range partition table on a timeltz field witch using function of extract minute and then query all partitions and drop table
...
create index time_idx on range_test (test_timestamp);
