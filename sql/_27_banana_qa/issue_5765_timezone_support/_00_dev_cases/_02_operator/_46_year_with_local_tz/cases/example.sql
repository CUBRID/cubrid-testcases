...
select year(datetimeltz'2003-12-31 01:02:03.1234'), if (year(datetimeltz'2003-12-31 01:02:03.1234') = 2003, 'ok', 'nok');
select year(timestampltz'2003-12-31 01:02:03'), if (year(timestampltz'2003-12-31 01:02:03') = 2003, 'ok', 'nok');
