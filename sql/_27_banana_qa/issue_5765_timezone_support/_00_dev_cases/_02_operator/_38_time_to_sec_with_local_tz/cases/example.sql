...
select time_to_sec(datetimeltz'2000-12-31 17:34:23.1234'), if (time_to_sec(datetimeltz'2000-12-31 17:34:23.1234') = 17*3600 + 34*60 + 23, 'ok', 'nok');
select time_to_sec(timestampltz'2000-12-31 17:34:23'), if (time_to_sec(timestampltz'2000-12-31 17:34:23') = 17*3600 + 34*60 + 23, 'ok', 'nok');
