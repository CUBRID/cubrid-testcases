...
select second(datetimeltz'2003-12-31 01:02:03.1234'), if (second(datetimeltz'2003-12-31 01:02:03.1234') = 3, 'ok', 'nok');
select second(timestampltz'2003-12-31 01:02:03'), if (second(timestampltz'2003-12-31 01:02:03') = 3, 'ok', 'nok');
