...
select to_days(datetimeltz'2003-12-31 01:02:03.1234'), if (to_days(datetimeltz'2003-12-31 01:02:03.1234') = 731945, 'ok', 'nok');
select to_days(timestampltz'2003-12-31 01:02:03'), if (to_days(timestampltz'2003-12-31 01:02:03') = 731945, 'ok', 'nok');
