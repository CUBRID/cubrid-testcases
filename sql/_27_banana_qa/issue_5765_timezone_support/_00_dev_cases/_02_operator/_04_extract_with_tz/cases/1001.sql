-- insert data  whith create range partition table on a timetz field witch using function of extract hour  and then query all partitions and drop table
...
create table range_test(id int not null,	
	...
	PARTITION BY RANGE (extract(hour from test_time)) (
