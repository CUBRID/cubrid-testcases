-- insert data  whith create range partition table on a timestamptz field witch using function of extract day and then query all partitions and drop table
