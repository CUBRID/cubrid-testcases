-- insert data  whith create range partition table on a timestamptz field witch using function of extract year and then query all partitions and drop table
