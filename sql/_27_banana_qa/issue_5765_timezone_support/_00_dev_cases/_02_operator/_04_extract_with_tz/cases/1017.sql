-- insert data  whith create range partition table on a date field witch using function of extract day and then query all partitions and drop table
...
create table range_test(id int not null,	
	...
	PARTITION BY RANGE (extract(day from test_date)) (
...
update range_test set test_date = '2008-01-21' where test_date < '2000-01-01';
select * from range_test__p__p0 order by id;
select * from range_test__p__p1 order by id;
select * from range_test__p__p2 order by id;
select * from range_test__p__p3 order by id;
