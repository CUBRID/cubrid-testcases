-- create table of hash partition having size 4 on timetz field that using extract function get hour and query all partitions
...
create table hash_test(id int not null,	
	...
	PARTITION BY HASH (extract(hour from test_time)) 
PARTITIONS 4;
