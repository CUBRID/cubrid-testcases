...
select datetime_col + 10000 from test_class order by 1;
select datetime_col - 10000 from test_class order by 1;;
select datetime_col - datetime_col1 from test_class order by 1;;
select datetime_col + 3600000 from test_class order by 1;;
select datetime_col - 3600000 from test_class order by 1;;
update test_class set datetime_col = datetime_col + 3600000 - 36000000;
