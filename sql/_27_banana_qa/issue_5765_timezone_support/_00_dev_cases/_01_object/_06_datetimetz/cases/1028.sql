...
SELECT extract(YEAR from datetimetz '2009-01-12 15:04:02.999') FROM test_class order by 1;
SELECT extract(MONTH from datetimetz '2009-01-12 15:04:02.999') FROM test_class order by 1;
SELECT extract(DAY from datetimetz '2009-01-12 15:04:02.999') FROM test_class order by 1;
SELECT extract(HOUR from datetimetz '2009-01-12 15:04:02.999') FROM test_class order by 1;
SELECT extract(MINUTE from datetimetz '2009-01-12 15:04:02.999') FROM test_class order by 1;
SELECT extract(SECOND from datetimetz '2009-01-12 15:04:02.999') FROM test_class order by 1;
SELECT extract(MILLISECOND from datetimetz '2009-01-12 15:04:02.999') FROM test_class order by 1;
