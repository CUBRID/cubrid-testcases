...
select * from test_class where datetime_col > '1000-01-01 00:00:00.000' using index none order by 4;
select * from test_class where datetime_col > '1000-01-01 00:00:00.000' using index idx_datetime_col order by 4;
select * from test_class where datetime_col > '1000-01-01 00:00:00.000' using index idx_datetime_col(+) order by 4;
