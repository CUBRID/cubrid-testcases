...
select decode(datetime_col, datetimetz '1970-01-01 00:00:00.000', 'EQUAL') from test_class order by 1;
select decode(datetime_col, datetimetz '1970-01-01 00:00:00.000', 'EQUAL', 'NOT EQUAL') from test_class order by 1;
