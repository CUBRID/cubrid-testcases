...
select * from test_class where datetime_col in (datetimeltz '01/02/2990 23:59:59', datetimeltz '01/01/1970 00:00:00') order by 4;
select * from test_class where datetime_col not in (datetimeltz '01/02/2990 23:59:59', datetimeltz '01/01/1970 00:00:00') order by 4;
