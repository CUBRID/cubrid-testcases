--SEQUENCE, Containment operators
create class test_class (col_set SEQUENCE datetimeltz);
...
select * from test_class where col_set seteq {'9999-12-31 23:59:59.999', '0001-01-01 00:00:00.000'};
select * from test_class where col_set seteq {NULL, NULL};
...
select * from test_class where col_set superset {'9999-12-31 23:59:59.999'};
select * from test_class where col_set superset {NULL};

select * from test_class where col_set superseteq {'9999-12-31 23:59:59.999', '0001-01-01 00:00:00.000'};
select * from test_class where col_set superseteq {NULL};

select * from test_class where col_set subset {'9999-12-31 23:59:59.999', '0001-01-01 00:00:00.000', '1900-12-31 12:30:00.888'};
select * from test_class where col_set subset {NULL, '2000-01-01 01:01:01.111'};

select * from test_class where col_set subseteq {'9999-12-31 23:59:59.999', '0001-01-01 00:00:00.000', '1900-12-31 12:30:00.888'};
select * from test_class where col_set subseteq {NULL, '2000-01-01 01:01:01.111'};
