...
select * from test_class where datetime_col in (datetimeltz '1970-01-01 00:00:00.000', datetimeltz '1970-01-01 00:00:00.001')  order by 1;
select * from test_class where datetime_col not in (datetimeltz '1970-01-01 00:00:00.000', datetimeltz '1970-01-01 00:00:00.001') order by 1;
select * from test_class where datetime_col between datetimeltz '1970-01-01 00:00:00.000' AND datetimeltz '1970-01-01 00:00:00.001' order by 1;
