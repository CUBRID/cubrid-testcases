...
--@queryplan
select /*+ recompile */ t.col1 a, to_char(t.col2) b from (select /*+ recompile */ col1, col2 from tz_test where col1=datetimeltz'1992-07-10 3:00:00.999 Europe/Bucharest' order by 1, 2) t order by b;
