--test DATETIMELTZ column, with group by clause
...
select col1, max(col2) from tz_test group by col1 having col1<datetimeltz'2013-12-10 15:30:00.999 +9:00' order by 1, 2;
set timezone 'Asia/Shanghai';
select col2, max(col1) from tz_test group by col1 having max(col1)<datetimeltz'2013-12-10 14:30:00.999' order by 1, 2 limit 3;
