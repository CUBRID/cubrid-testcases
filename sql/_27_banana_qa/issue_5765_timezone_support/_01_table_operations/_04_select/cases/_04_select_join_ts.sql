...
select * from tz_test1 t1, tz_test2 t2 where t1.ts=t2.ts order by t1.id,2,3;
...
select t1.id, t2.tstz, t1.tstz, t1.ts aa, t2.tsltz bb from tz_test1 t1, tz_test2 t2 where t1.tstz=t2.tstz and t2.tstz < timestamptz'2000-12-1 00:00:00' order by 1,2,3,4,5;
...
select t1.id, t1.ts, t2.tstz, t1.tsltz, t2.tsltz from tz_test2 t2 left outer join tz_test1 t1 on t1.tsltz=t2.tstz where t2.tsltz > timestamptz'1990-05-01 13:14:15 -10:00' order by t2.tstz, t1.id, t2.tsltz, t1.tsltz;
...
--test: mix
select t1.id, t1.tsltz, t2.tstz, t3.tstz, t1.ts, t2.tsltz, t3.tsltz from tz_test1 t1 right outer join tz_test2 t2 on t1.tsltz=t2.tstz inner join tz_test1 t3 on t2.tstz=t3.tstz order by t1.id, t1.tsltz, t2.tstz, t3.tstz, t1.ts, t2.tsltz, t3.tsltz;
