--test DATETIMETZ column, with where clause
...
select * from tz_test where col1=datetimetz'2013-12-10 15:30:00.999 +9:00' order by 1;
set timezone 'Asia/Seoul';
select * from tz_test where col2=datetimetz'2013-12-10 15:30:00.999' order by col1, id;
select col2, id from tz_test where col1=datetimetz'2013-12-10 8:30:00.999 Europe/Riga' order by 1, id desc;
set timezone 'America/Argentina/Buenos_Aires';
select col1, col2, id from tz_test where col1=datetimetz'2011-05-12 9:12:56.999 AM' order by 1, 2, id asc;
set timezone '+4:00';
select * from tz_test where col2=datetimetz'2011-05-12 17:12:56.999 +05:00' order by 1;
select * from tz_test where col2=datetimetz'2011-05-12 16:12:56.999' order by 1;
select col2, col1, id from tz_test where col2=datetimetz'2011-05-12 9:12:56.999 AM America/Argentina/Buenos_Aires' order by 1, 2, id desc;

--test: where clause, normal value, col<constant value, 3 rows should be selected
set timezone '-04:30';
select * from tz_test where col1>datetimetz'2013-12-10 3:00:00.999' order by 1;
set timezone 'Australia/Perth';
select * from tz_test where col1<datetimetz'2013-12-10 15:30:00.999 +9:00' and col2>datetimetz'2011-05-12 8:12:55.999 PM' order by 1;
...
set timezone 'Europe/Bucharest';
select * from tz_test where col1=datetimetz'1992-07-10 2:00:00.999' order by 1;
--test: where clause, DST values, 2 rows should be select
select * from tz_test where col2=datetimetz'1992-07-10 3:00:00.999' order by 1;
select col1, col2 from tz_test where col2=datetimetz'1992-07-10 10:00:00.999 +10:00' order by 1;

--test: where clause, leap second
select * from tz_test where col1=datetimetz'1994-6-30 23:59:59.999 UTC' and col2=datetimetz'1994-6-30 23:59:59.999 GMT' order by 1;
set timezone 'UTC';
select id, col1, col2 from tz_test where col1=(datetimetz'1994-6-30 23:59:59.999'+1) order by 1, col2;
select id, col1, col2 from tz_test where col2<datetimetz'1994-6-30 23:59:59.999'+1 order by 1, col2 desc, col1;
select id, col1, col2 from tz_test where col2=datetimetz'1994-7-01 00:00:00' order by 1, col2 desc, col1;
select id, col1, col2 from tz_test where col1<datetimetz'1994-7-01 00:00:00' order by 1, col1 desc, col2;
set timezone 'Europe/Bucharest';
select * from tz_test where col2=datetimetz'1994-7-1 2:59:59.999 AM' order by 1;
select * from tz_test where col2=(datetimetz'1994-7-1 2:59:59.999 AM'+1) order by 1;
select * from tz_test where col1=datetimetz'1994-7-1 1:59:59.999 AM Europe/Bucharest' order by 1;
select * from tz_test where col2=(datetimetz'1994-7-1 1:59:59.999 AM'+1) order by 1;
select col1, col2 from tz_test where col1=datetimetz'1994-7-1 7:59:59.999 Asia/Harbin' and col2=datetimetz'6/30/1994 21:59:59.999 -2:00';
select col1, col2 from tz_test where col1<datetimetz'1994-7-1 7:59:59.999 Asia/Harbin'+1 or col2<datetimetz'6/30/1994 21:59:59.999 -2:00'+1;

--test: update to null
update tz_test set col2=default where hour(col1)=hour(datetimetz'2013-12-10 3:00:00.999 AM -03:30');
