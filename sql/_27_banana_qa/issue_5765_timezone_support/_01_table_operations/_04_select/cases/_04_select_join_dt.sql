...
select * from tz_test1 t1, tz_test2 t2 where t1.dt=t2.dt order by t1.id;
...
select t1.id, t2.dttz, t1.dttz, t1.dt aa, t2.dtltz bb from tz_test1 t1, tz_test2 t2 where t1.dttz=t2.dttz and t2.dttz < datetimetz'2000-12-1 00:00:00.999';
...
select t1.id, t1.dt, t2.dttz, t1.dtltz, t2.dtltz from tz_test2 t2 left outer join tz_test1 t1 on t1.dtltz=t2.dttz where t2.dtltz > datetimetz'1990-05-01 13:14:15.999 -10:00' order by t2.dttz, t1.id;
...
select t2.id, t1.dttz, t2.dt, t1.dt, t2.dtltz from tz_test1 t1 right outer join tz_test2 t2 on t1.dtltz=t2.dtltz where year(t1.dttz) < 2010;

--test: mix
select t1.id, t1.dtltz, t2.dttz, t3.dttz, t1.dt, t2.dtltz, t3.dtltz from tz_test1 t1 right outer join tz_test2 t2 on t1.dtltz=t2.dttz inner join tz_test1 t3 on t2.dttz=t3.dttz order by 1, 2, 3, 4, 5, 6;
