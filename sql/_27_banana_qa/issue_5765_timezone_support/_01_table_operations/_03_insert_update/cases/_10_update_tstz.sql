...
create table tz_test(id int auto_increment, col1 timestamp with time zone primary key default timestamptz'2014-09-01 2:00:20 Asia/Shanghai', col2 timestamp with time zone unique);
...
set timezone '+04:00';
insert into tz_test(col1, col2) values(timestamp'2011-05-12 4:12:20', timestamptz'2011-05-12 9:12:47 America/Noronha FNT');
set timezone '+02:00';
...
set timezone '-5:00';
insert into tz_test(col1, col2) values(timestamp'2011-05-11 19:12:30', timestamptz'2011-05-12 8:12:37 PM Asia/Dili TLT');
set timezone '-7:00';
insert into tz_test(col1, col2) values(timestamp'2011-05-11 17:12:32', timestamptz'2011-05-12 10:12:35 PM Asia/Vladivostok');
set timezone '-9:00';
insert into tz_test(col1, col2) values(timestamp'2011-05-11 15:12:34', timestamptz'2011-05-12 12:12:33 AM Pacific/Fakaofo TKT');
set timezone '-11:00';
