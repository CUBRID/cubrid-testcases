--change TIMESTAMPTZ from without DEFAULT/constraints to with DEFAULT/constraints, strict no
...
--test: not null + defualt
alter table tz change c_tstz6 c_tstz66 timestamp with time zone default '2000-10-10 10:10:10 +00:00' not null;
show full columns in tz;
select * from tz order by 1, 2, 3, 4, 5;
