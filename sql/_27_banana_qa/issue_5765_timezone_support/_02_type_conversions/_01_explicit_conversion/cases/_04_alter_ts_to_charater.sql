...
select * from tz_test order by 1;
rollback;
alter table tz_test change tsltz tsltz char(64);
desc tz_test;
select * from tz_test order by 1;
rollback;
...
select * from tz_test order by 1;
rollback;
alter table tz_test change tsltz tsltz varchar(64);
desc tz_test;
select * from tz_test order by 1;
rollback;
...
select * from tz_test order by 1;
rollback;
alter table tz_test change tstz tstz char(64);
desc tz_test;
select * from tz_test order by 1;
rollback;
...
select * from tz_test order by 1;
rollback;
alter table tz_test change tstz tstz varchar(64);
desc tz_test;
select * from tz_test order by 1;
rollback;
