...
select vclass_name, owner_name, vclass_def, comment from db_vclass where vclass_name='b_view' order by 1,2;
...
show create view b_view;
select vclass_name, owner_name, vclass_def, comment from db_vclass where vclass_name='b_view' order by vclass_name,vclass_def;
