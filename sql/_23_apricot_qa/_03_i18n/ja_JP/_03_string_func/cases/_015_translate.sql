...
select id, name, translate (name,'午前','沼尻') from test_jp order by 1;

select id, name, translate (name,'基盤','辷岡崎') from test_jp order by 1;
select id, name, translate (name,'中国語','韩国') from test_jp order by 1;
select id, name, translate (name,'中国','韩国人') from test_jp order by 1;
