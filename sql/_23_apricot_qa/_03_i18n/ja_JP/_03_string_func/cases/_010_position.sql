...
select id, name, POSITION ('桜' in name) from test_jp order by 1;

select id, name, POSITION ('沢' in name) from test_jp order by 1;

select id, name, POSITION ('嶋' in name) from test_jp order by 1;
