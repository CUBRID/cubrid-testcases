...
select id, name, replace (name,'基盤','午前') from test_jp order by 1;

select id, name, replace (name,'韓国語','_暦_') from test_jp order by 1;

select id, name, replace (name,'西暦','') from test_jp order by 1;

select id, name, replace (name,'語','暦') from test_jp order by 1;
