...
select id, name, LPAD (name,5,'訊') from test_jp order by 1;

select id, name, LPAD (name,7,'図') from test_jp order by 1;

select id, name, LPAD (name,7,'辷図') from test_jp order by 1;


select id, name, RPAD (name,5,'訊') from test_jp order by 1;

select id, name, RPAD (name,7,'図') from test_jp order by 1;
