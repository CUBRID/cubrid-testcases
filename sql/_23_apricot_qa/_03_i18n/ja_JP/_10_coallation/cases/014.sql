...
INSERT INTO t1 VALUES ('ゞ ゝヽ ヾ ぁァ あア','ゞ ゝヽ ヾ ぁァ あア','ゞ ゝヽ ヾ ぁァ あア','2008-05-26', '14:23:00', '2008-06-28 14:24:00',{'ゞ ゝヽ ヾ ぁァ あア'},{'ゞ ゝヽ ヾ ぁァ あア'},{'ゞ ゝヽ ヾ ぁァ あア'});
INSERT INTO t1 VALUES (null,'せぜそぞただちぢ','せぜそぞただちぢ','2009-05-26', '14:16:19', ' 2008-05-26 14:24:00',null,{'せぜそぞただちぢ'},null);
INSERT INTO t1 VALUES ('せぜそぞただちぢ',null,null,'2008-05-28', '14:24:01', '2008-06-26 08:16:19',{'せぜそぞただちぢ'},null,{'せぜそぞただちぢ'});

create index t1_index on t1(col7);
--test
SELECT * FROM t1 order by 1,2;
--test
SELECT col7 FROM t1 order by col7;

UPDATE t1 SET col7={'ヨあ12p■「亜_aa'} WHERE col1='ヨあ12p■「亜';
