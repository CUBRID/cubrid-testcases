...
select id,name from test_jp where name between 'ぁはァヰ■' and 'Qd発は   ' order by 1;

select id,name from test_jp where name between 'Qdぁ=. ' and '_  ' order by 1;

select id,name from test_jp where name between ' .' and 'Qdぁ=   ' order by 1;
