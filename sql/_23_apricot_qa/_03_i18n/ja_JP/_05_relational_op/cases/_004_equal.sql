...
select id,name from test_jp where name = 'Qdぁ1' order by 1;

select id,name from test_jp where name = '麼は樹■沢ン ' order by 1;

select id,name from test_jp where name != '*Qdぁ實 ' order by 1;

select id,name from test_jp where name <> 'Qddヰ亜愛Qン ' order by 1;
