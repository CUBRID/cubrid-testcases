...
--test
SELECT /*+ recompile */col6 FROM t1 order by col6;

UPDATE t1 SET col6=' 2011-01-02 17:10:32' WHERE col6='2011-01-02 17:10:32 ';

DELETE  FROM t1 WHERE col6=' 2011-01-02 17:10:32';
--test
