...
INSERT INTO t1 VALUES ('ឯៀៀតឰឰហថ',null,'ឯៀៀតឰឰហថ','2011-12-20', '7:07:32', '2011-12-20  7:07:00',{'ឯៀៀតឰឰហថ'},{'ឯៀៀតឰឰហថ'},{'ឯៀៀតឰឰហថ'});
...
INSERT INTO t1 VALUES ('ឯកកតឰឰហថ',null,null,'2011-12-20', '14:24:01', '2011-12-20  7:07:00',{'ឯកកតឰឰហថ'},null,{'ឯកកតឰឰហថ'});

create index t1_index on t1(col9);
--test
SELECT /*+ recompile */* FROM t1 order by 1,2;
--test
SELECT /*+ recompile */col9 FROM t1 order by col9;

UPDATE t1 SET col9={'ហឡឡតឰឿហថ_aa'} WHERE col1='ហឡឡតឰឿហថ';
