...
INSERT INTO t1 VALUES ('ឯកកតឰឰហថ',null,null,'2011-12-20', '14:24:01', '2011-12-20  7:07:00');

create index t1_index on t1(col3) where col1>='ហឡឡតឰឿហថ';
--test
SELECT /*+ recompile */* FROM t1 where col1>='ហឡឡតឰឿហថ'order by 1,2;
--test
SELECT /*+ recompile */col3 FROM t1 where  col1>='ហឡឡតឰឿហថ' order by col3;
...
--test
SELECT /*+ recompile */col3 FROM t1 where t1 col1>='ហឡឡតឰឿហថ'order by col3;
