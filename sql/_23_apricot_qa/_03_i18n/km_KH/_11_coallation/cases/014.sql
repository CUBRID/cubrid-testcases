...
INSERT INTO t1 VALUES ('ឯកកតឰឰហថ',null,null,'2011-12-20', '14:24:01', '2011-01-02 14:24:01',{'ឯកកតឰឰហថ'},null,{'ឯកកតឰឰហថ'});

create index t1_index on t1(col7);
--test
SELECT /*+ recompile */* FROM t1 order by 1,2;
--test
SELECT /*+ recompile */col7 FROM t1 order by col7;

UPDATE t1 SET col7={'ហឡឡតឰឿហថ_aa'} WHERE col1='ហឡឡតឰឿហថ';
