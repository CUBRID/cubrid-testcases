...
select id, name, left (name,1) from test_kh order by 1;

select id, name, left (name,2) from test_kh order by 1;

select id, name, left (name,4) from test_kh order by 1;
