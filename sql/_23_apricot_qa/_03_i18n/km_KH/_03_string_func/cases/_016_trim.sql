...
select id, name, trim ('មិ' from name) from test_kh order by 1;

select id, name, trim ('.' from name) from test_kh order by 1;

select id, name, trim (TRAILING 'ម' from name) from test_kh order by 1;

select id, name, rtrim (name,'កុ') from test_kh order by 1;

select id, name, trim (LEADING '៧' from name) from test_kh order by 1;

select id, name, ltrim (name,'?') from test_kh order by 1;
