...
select id, name, LPAD (name,5,'១') from test_kh order by 1;

select id, name, LPAD (name,7,'២') from test_kh order by 1;

select id, name, LPAD (name,7,'ពីរ២') from test_kh order by 1;


select id, name, RPAD (name,5,'១') from test_kh order by 1;

select id, name, RPAD (name,7,'២') from test_kh order by 1;

select id, name, RPAD (name,7,'ពីរ២') from test_kh order by 1;
