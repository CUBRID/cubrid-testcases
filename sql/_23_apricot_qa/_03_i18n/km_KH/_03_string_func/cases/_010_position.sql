...
select id, name, POSITION ('បី' in name) from test_kh order by 1;

select id, name, POSITION ('ប្រាំ' in name) from test_kh order by 1;

select id, name, POSITION ('ា' in name) from test_kh order by 1;
