...
INSERT INTO t1 VALUES (null,'Öö_Şş_Üü啊阿','Öö_Şş_Üü啊你','2008-05-26', '14:24:00', '14:24:00 2008-05-26');
INSERT INTO t1 VALUES ('Öö_Şş_Üü啊阿',null,null,'2008-05-26', '14:24:00', '14:24:00 2008-05-26');

create Reverse unique index t1_index on t1(col2) where col1>='Çç_Ğğ_İı';
--test
SELECT * FROM t1 where col1>='Çç_Ğğ_İı' order by 1,2;
--test
SELECT col2 FROM t1 where col1>='Çç_Ğğ_İı' order by col2;

UPDATE t1 SET col2='Öö_Şş_Üü啊你' WHERE col2='Öö_Şş_Üü阿啊';

DELETE  FROM t1 WHERE col2='Öö_Şş_Üü啊阿';
--test
SELECT index_name, is_unique, is_reverse, class_name, owner_name, key_count, is_primary_key, is_foreign_key, filter_expression, have_function, comment, status FROM db_index WHERE class_name='t1' where col1>='Çç_Ğğ_İı' order by 1,2;
--test
SELECT col2 FROM t1 where col1>='Çç_Ğğ_İı' order by col2;
