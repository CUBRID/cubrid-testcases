...
SELECT TO_TIMESTAMP('2011-05-02 PAZARTESİ 10:11:12', 'yyyy-MM-DD DAY HH:MI:SS');
SELECT TO_TIMESTAMP('2011-05-03 SALI 10:11:12', 'yyyy-MM-DD DAY HH:MI:SS');
SELECT TO_TIMESTAMP('2011-05-04 ÇARŞAMBA 10:11:12', 'yyyy-MM-DD DAY HH:MI:SS');
SELECT TO_TIMESTAMP('2011-05-05 PERŞEMBE 10:11:12', 'yyyy-MM-DD DAY HH:MI:SS');
SELECT TO_TIMESTAMP('2011-05-06 CUMA 10:11:12', 'yyyy-MM-DD DAY HH:MI:SS');
SELECT TO_TIMESTAMP('2011-05-07 CUMARTESİ 10:11:12', 'yyyy-MM-DD DAY HH:MI:SS');

select 'TO_TIMESTAMP( ,  day )';
SELECT TO_TIMESTAMP('2011-05-01 pazar', 'yyyy-MM-DD day');
SELECT TO_TIMESTAMP('2011-05-02 pazartesi', 'yyyy-MM-DD day');
SELECT TO_TIMESTAMP('2011-05-03 Salı', 'yyyy-MM-DD day');
SELECT TO_TIMESTAMP('2011-05-04 çarşamba', 'yyyy-MM-DD day');
SELECT TO_TIMESTAMP('2011-05-05 perşembe', 'yyyy-MM-DD day');
...
SELECT TO_TIMESTAMP('2011-05-04 ÇA', 'yyyy-MM-DD DY');
...
SELECT TO_TIMESTAMP('2010-01 ŞUBAT', 'yyyy-dd MONTH');
SELECT TO_TIMESTAMP('2010-01 MART', 'yyyy-dd MONTH');
SELECT TO_TIMESTAMP('2010-01 NİSAN', 'yyyy-dd MONTH');
SELECT TO_TIMESTAMP('2010-01 MAYIS', 'yyyy-dd MONTH');
SELECT TO_TIMESTAMP('2010-01 HAZİRAN', 'yyyy-dd MONTH');
SELECT TO_TIMESTAMP('2010-01 TEMMUZ', 'yyyy-dd MONTH');
SELECT TO_TIMESTAMP('2010-01 AĞUSTOS', 'yyyy-dd MONTH');
SELECT TO_TIMESTAMP('2010-01 EYLÜL', 'yyyy-dd MONTH');
SELECT TO_TIMESTAMP('2010-01 EKİM', 'yyyy-dd MONTH');
...
SELECT TO_TIMESTAMP('2010-01 mayıs', 'yyyy-dd month');
SELECT TO_TIMESTAMP('2010-01 haziran', 'yyyy-dd month');
SELECT TO_TIMESTAMP('2010-01 temmuz', 'yyyy-dd month');
SELECT TO_TIMESTAMP('2010-01 ağustos', 'yyyy-dd month');
SELECT TO_TIMESTAMP('2010-01 eylül', 'yyyy-dd month');
SELECT TO_TIMESTAMP('2010-01 ekim', 'yyyy-dd month');
SELECT TO_TIMESTAMP('2010-01 kasım', 'yyyy-dd month');
SELECT TO_TIMESTAMP('2010-01 aralık', 'yyyy-dd month');


select 'TO_TIMESTAMP( ,  MON)';
SELECT TO_TIMESTAMP('2010-01 OCK', 'yyyy-dd MON');
SELECT TO_TIMESTAMP('2010-01 ŞBT', 'yyyy-dd MON');
...
SELECT TO_TIMESTAMP('2010-01 AĞS', 'yyyy-dd MON');
...
-- text
SELECT TO_TIMESTAMP('2010-01 teIt Ksm', 'yyyy-dd "teıt" Mon');
