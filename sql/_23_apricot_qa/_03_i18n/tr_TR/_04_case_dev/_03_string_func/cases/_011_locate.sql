...
select id, name, locate ('i',name,1) from test_tr order by 1;

select id, name, locate ('i',name, 5) from test_tr order by 1;

select id, name, locate ('ı.i',name, 1) from test_tr order by 1;

select id, name, locate ('ı.i',name, 4) from test_tr order by 1;
