...
select id, name, LPAD (name,7,'ı') from test_tr order by 1;

select id, name, LPAD (name,7,'2ı ') from test_tr order by 1;


select id, name, RPAD (name,5,'x') from test_tr order by 1;

select id, name, RPAD (name,7,'ı') from test_tr order by 1;

select id, name, RPAD (name,7,'2ı ') from test_tr order by 1;
