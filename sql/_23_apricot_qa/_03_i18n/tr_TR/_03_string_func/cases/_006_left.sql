...
--test
select id, name, right (name,null) from test_tr order by 1;
--test
select id, name, right (name,100) from test_tr order by 1;
--test
select id, name, right (left(name,100),1) from test_tr order by 1;
drop table test_tr;
set names iso88591;
commit;
--+ holdcas off;
