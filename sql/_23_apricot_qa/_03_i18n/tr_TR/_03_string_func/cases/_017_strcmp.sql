...
--test
select id, name, strcmp (name, upper(name)) from test_tr order by 1;
--test
select id, name, strcmp (name, lower(name)) from test_tr order by 1;
--test
select id, name, strcmp (name, null) from test_tr order by 1;
--test
