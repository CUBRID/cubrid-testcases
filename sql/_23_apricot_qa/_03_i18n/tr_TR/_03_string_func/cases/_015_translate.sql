...
--test
select id, name, translate (name,'Ğül','Gu1') from test_tr order by 1;
--test
select id, name, translate (name,null,'Gu1') from test_tr order by 1;
--test
select id, name, translate (name,'Ğül',null) from test_tr order by 1;
--test
