...
select name, id, password, direct_groups, groups, authorization, triggers, is_loginable, is_system_created, comment from db_user where name =upper('AB_Çç_Ğğ_İı_Öö_Şş_Üü');
--test
