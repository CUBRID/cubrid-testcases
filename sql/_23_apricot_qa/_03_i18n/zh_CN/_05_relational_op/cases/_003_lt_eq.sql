...
select id,name from test_cn where name < '火咱工哎' order by 1;

select id,name from test_cn where name <= '尚洼开人啊嗯 ' order by 1;

select id,name from test_cn where name <= ' ' order by 1;

select id,name from test_cn where name < '蛤咱 ' order by 1;

select id,name from test_cn where name < '_ ' order by 1;
