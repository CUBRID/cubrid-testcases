...
insert into test_cn values (105,'你我好');
...
select id, name, POSITION ('吧' in name) from test_cn order by 1;

select id, name, POSITION ('们' in name) from test_cn order by 1;

select id, name, POSITION ('车' in name) from test_cn order by 1;
