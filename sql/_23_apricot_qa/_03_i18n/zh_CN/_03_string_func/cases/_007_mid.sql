...
select id, name, mid (name,1,2) from test_cn order by 1;

select id, name, mid (name,2,2) from test_cn order by 1;

select id, name, mid (name,2,1) from test_cn order by 1;

select id, name, mid (name,4,3) from test_cn order by 1;
