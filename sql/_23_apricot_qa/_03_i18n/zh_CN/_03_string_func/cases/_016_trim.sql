...
select id, name, trim ('我' from name) from test_cn order by 1;

select id, name, trim ('.' from name) from test_cn order by 1;

select id, name, trim (TRAILING '观' from name) from test_cn order by 1;

select id, name, rtrim (name,'学') from test_cn order by 1;

select id, name, trim (LEADING '汽' from name) from test_cn order by 1;

select id, name, ltrim (name,'？') from test_cn order by 1;
