...
select id, name, right (name,1) from test_cn order by 1;

select id, name, right (name,2) from test_cn order by 1;

select id, name, right (name,5) from test_cn order by 1;
