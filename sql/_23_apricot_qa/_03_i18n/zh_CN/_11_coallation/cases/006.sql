...
--test
SELECT * from t  where col2 between UPPER('一') and '阿' order by col2, col1 limit 3;
--test
SELECT * from t  where col2 between UPPER('ē') and 'ü' order by col2, col1 desc limit 2;
...
--test
SELECT * from t  where col2 between UPPER('再') and '一' order by col2, col1;
--test
SELECT * from t  where col2 between UPPER('再') and 'ü' order by col2, col1 desc;
--test
SELECT * from t  where col2 between UPPER('9') and 'a' order by col2, col1 limit 3;
--test
SELECT * from t  where col2 between UPPER('b') and '帀' order by col2, col1 desc limit 2;
...
SELECT * from t  where col2 between UPPER('再') and '一'order by col2, col1;
--test                              
SELECT * from t  where col2 between UPPER('再') and 'ü' order by col2 desc, col1;
--test                              
SELECT * from t  where col2 between UPPER('9') and 'a'  order by col2, col1 limit 3;
--test                              
SELECT * from t  where col2 between UPPER('b') and '帀' order by col2 desc, col1 limit 2;
