...
INSERT INTO t1 VALUES (null,'uū喝呵水果91啊你','ū喝水sh果91','2008-05-26', '14:24:00', ' 2008-05-26 14:24:00');
INSERT INTO t1 VALUES ('ū喝水sh果91',null,null,'2008-05-26', '14:24:00', ' 2008-05-26 14:24:00');

create Reverse index t1_index on t1(col2) where col1>='喝水shū果91';
--test
...
DELETE  FROM t1 WHERE col2='uū喝呵水果91啊你';
--test
