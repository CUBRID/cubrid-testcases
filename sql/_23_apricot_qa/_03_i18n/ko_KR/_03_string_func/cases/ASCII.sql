...
select (ASCII(col1)),col1 from t order by 1;
select (ASCII(col2)),col2 from t order by 1;
select (ASCII(col3)),col3 from t order by 1;
select (ASCII(col4)),col4 from t order by 1;
select (ASCII(col5)),col5 from t order by 1;
select (ASCII(ASCII(col1))),col1 from t order by 1;
select (ASCII(ASCII(col2))),col2 from t order by 1;
select (ASCII(ASCII(col3))),col3 from t order by 1;
