...
select * from t where SUBSTR(col1,0,2)>'abc' order by 1;
select * from t where SUBSTR(col2,0,2)>'각刻' order by 2;
select * from t where SUBSTR(col3,0,2)>N'가伽' order by 3;
