...
select/*+ recompile*/* from t where col1>'abc' order by 1;
select/*+ recompile*/* from t where col2>'abc' order by 2;
select/*+ recompile*/* from t where col3>N'abc' order by 3;
select/*+ recompile*/* from t where col4>N'abc' order by 4;
select/*+ recompile*/* from t where col5>'abc' order by 5;
drop table t;
set names iso88591;
commit;
--+ holdcas off;