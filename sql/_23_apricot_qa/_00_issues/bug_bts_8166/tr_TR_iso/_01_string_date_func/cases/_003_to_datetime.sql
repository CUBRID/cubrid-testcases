...
SELECT TO_DATETIME('2011-05-02 PAZARTESI 10:11:12.678', 'yyyy-MM-DD DAY HH:MI:SS.FF');
SELECT TO_DATETIME('2011-05-03 SALI 10:11:12.678', 'yyyy-MM-DD DAY HH:MI:SS.FF');
SELECT TO_DATETIME('2011-05-04 CARSAMBA 10:11:12.678', 'yyyy-MM-DD DAY HH:MI:SS.FF');
SELECT TO_DATETIME('2011-05-05 PERSEMBE 10:11:12.678', 'yyyy-MM-DD DAY HH:MI:SS.FF');
SELECT TO_DATETIME('2011-05-06 CUMA 10:11:12.678', 'yyyy-MM-DD DAY HH:MI:SS.FF');
SELECT TO_DATETIME('2011-05-07 CUMARTESI 10:11:12.678', 'yyyy-MM-DD DAY HH:MI:SS.FF');

select 'TO_DATETIME( ,  day )';
SELECT TO_DATETIME('2011-05-01 pazar', 'yyyy-MM-DD day');
SELECT TO_DATETIME('2011-05-02 pazartesi', 'yyyy-MM-DD day');
SELECT TO_DATETIME('2011-05-03 Sali', 'yyyy-MM-DD day');
SELECT TO_DATETIME('2011-05-04 carsamba', 'yyyy-MM-DD day');
SELECT TO_DATETIME('2011-05-05 persembe', 'yyyy-MM-DD day');
...
SELECT TO_DATETIME('2011-05-04 CA', 'yyyy-MM-DD DY');
...
SELECT TO_DATETIME('2010-01 SUBAT', 'yyyy-dd MONTH');
...
SELECT TO_DATETIME('2010-01 AGUSTOS', 'yyyy-dd MONTH');
SELECT TO_DATETIME('2010-01 EYLUL', 'yyyy-dd MONTH');
...
SELECT TO_DATETIME('2010-01 SBT', 'yyyy-dd MON');
...
SELECT TO_DATETIME('2010-01 AGS', 'yyyy-dd MON');
...
-- text
SELECT TO_DATETIME('2010-01 teIt Ksm', 'yyyy-dd "teit" Mon');
