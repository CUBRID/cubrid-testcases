--set or reset default value of a column to SYSTIMESTAMP
...
--add default value
alter table d01 alter column col1 set default SYSTIMESTAMP;
alter table d01 alter column col1 set default 'SYSTIMESTAMP';
show columns in d01;
...
--add default value
alter table d01 alter column col2 set default SYSTIMESTAMP;
alter table d01 alter column col2 set default 'SYSTIMESTAMP';
desc d01;
...
--add default value
alter table d01 alter column col3 set default SYSTIMESTAMP;
alter table d01 alter column col3 set default 'SYSTIMESTAMP';
show columns in d01;
insert into d01(id) values(default);
select if ((CURRENT_TIMESTAMP - col3) <=100 and col1 = col2 and col2 = col3, 'ok', 'nok') from d01 where id = 4;


--reset default value
alter table d01 alter column col4 set default SYSTIMESTAMP;
alter table d01 alter column col4 set default 'SYSTIMESTAMP';
describe d01;
insert into d01(col3, col4) values('1975-10-01 12:12:12', default);
select if ((CURRENT_TIMESTAMP - col4) <=100 and col1 = col2 and col2 = col4 and col3 = '1975-10-01 12:12:12', 'ok', 'nok') from d01 where id = 5;
--set again
alter table d01 alter column col4 set default '1999-09-09 9:9:9';
show columns in d01;
insert into d01(col3) values('2010-10-10 10:10:10');
select if (col4 = '1999-09-09 9:9:9' and (CURRENT_TIMESTAMP - col2) <=100 and col1 = col2, 'ok', 'nok') from d01 where id = 6;
--set again
alter table d01 alter column col4 set default SYSTIMESTAMP;
alter table d01 alter column col4 set default 'SYSTIMESTAMP';
describe d01;
insert into d01(id, col3, col4) values(default, '1988-08-08 12:12:12', default);
select if ((CURRENT_TIMESTAMP - col4) <=100 and col1 = col2 and col2 = col4 and col3 = '1988-08-08 12:12:12', 'ok', 'nok') from d01 where id = 7;
