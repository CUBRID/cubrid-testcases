...
alter table a08 add column col1 timestamp default UNIX_TIMESTAMP();
show columns in a08;
select if(col1 is not null, 'ok', 'nok') from a08;
insert into a08(id) values (null);
select if ((SYSTIMESTAMP - col1) <=100, 'ok', 'nok') from a08 where id > 3;

--add column with default value and not null constraint
alter table a08 add column col2 timestamp default UNIX_TIMESTAMP() not null;
desc a08;
insert into a08(col2) values (default);
select if ((SYSTIMESTAMP - col2) <=100, 'ok','nok' ) from a08 where id > 4;
select if ((col1 - col2) <= 100, 'ok','nok') from a08 where id > 4;

--default + unique constraint
alter table a08 add column col3 timestamp default UNIX_TIMESTAMP() ;
show columns in a08;
...
select if ((SYSTIMESTAMP - col2) <=100 , 'ok', 'nok') from a08 where id > 5;
select if ((col1 - col2) <= 100 , 'ok', 'nok') from a08 where id > 5;
...
select if ((SYSTIMESTAMP - col2) <= 100, 'ok', 'nok') from a08 where id > 6;
select if ((col1 - col2) <= 100, 'ok', 'nok') from a08 where id > 6;
select if (col6 = timestamp'2000-12-12 12:12:12', 'ok', 'nok') from a08 where id >6;
