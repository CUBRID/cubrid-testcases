...
insert into c27 values default;
create table a27 as select * from c27;
select if((SYSDATE-col1) = 0 and SYSDATETIME >= col2 and col3 = USER, 'ok', 'nok') from a27 order by 1;
insert into a27 values default;
select if((SYSDATE-col1) = 0 and SYSDATETIME >= col2 and col3 = USER, 'ok', 'nok') from a27 order by col2 desc limit 1;
show columns in a27;
drop table if exists c27;
drop table if exists a27;
...
select if((SYSDATE-col1) = 0 and SYSDATETIME>=col2 and col4 = USER, 'ok', 'nok') from a27 order by 1;
insert into a27 values default;
select if((SYSDATE-col1) = 0 and SYSDATETIME>=col2 and col4 = CURRENT_USER, 'ok', 'nok') from a27 order by col2 desc limit 1;
show columns in a27;
drop table if exists c27;
drop table if exists a27;
