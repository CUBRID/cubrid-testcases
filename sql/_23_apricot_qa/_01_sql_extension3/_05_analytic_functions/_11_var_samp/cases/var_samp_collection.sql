...
--TEST: OVER() clause
--TEST: set 
select col1, col2, var_samp(col5) over() from var_samp_collection order by 1, 2, 3;
...
select col3, col4, var_samp(unique col5) over() var_samp from var_samp_collection where col1 > {1, 2, 3} order by col3, col4;
--TEST: sequence, distinct
select col4, col1, var_samp(distinct col5) over() var_samp from var_samp_collection order by 1, 2;
--TEST: syntax error
select *, var_samp(col5) over() var_samp from var_samp_collection order by 1,2, 3, 4, 5;
select col1, col3, col4, var_samp(distinctrow col5) over var_samp from var_samp_collection;
select col1, col3, col2, var_samp(col5) over(1) var_samp from var_samp_collection;
--TEST: wrong type of arguments
select var_samp(col1) over() from var_samp_collection;
select var_samp(col2) over() from var_samp_collection;
select var_samp(col3) over() from var_samp_collection;
select var_samp(col4) over() from var_samp_collection;
...
select col1, col2, col3, col4, var_samp(col5) over(partition by col2) var_samp from var_samp_collection order by 2, 1, 3, 4;
--TEST: partition by list
select col1, col2, col3, col4, var_samp(all col5) over(partition by col3) var_samp from var_samp_collection order by 3, 1, 2, 4;
--TEST: partition by sequence
select col1, col2, col3, col4, var_samp(col5) over(partition by col4) var_samp from var_samp_collection order by 4, 1, 2, 3, 5;



--TEST: OVER(ORDER BY) clause
--TEST: order by 1 column name
select col1, var_samp(distinct col5) over(order by col1) var_samp from var_samp_collection;
--TEST: order by 2 column names
select col2, col3, var_samp(col5) over(order by col2, col3 asc) var_samp from var_samp_collection;
--TEST: order by more than 2 column names
select col1, col2, col3, col4, var_samp(distinctrow col5) over(order by col1, col2 desc, col3, col4 asc) var_samp from var_samp_collection;
--TEST: order by columns not selected
select col3, var_samp(col5) over(order by col4 desc, col2, col1 asc) var_samp from var_samp_collection;
--TEST: order by 1 position
select col4, var_samp(all col5) over(order by 1) var_samp from var_samp_collection;
--TEST: order by 3 positions
select col3, col2, var_samp(col5) over(order by 1, 2 desc, 3 asc) var_samp from var_samp_collection;
--TEST: order by more than 3 positions
select col1, col2, col3, col4, var_samp(unique col5) over(order by 3, 2 asc, 1 desc, 4) var_samp from var_samp_collection;
--TEST: order by positions not existed
select col2, var_samp(col5) over(order by 2) var_samp from var_samp_collection;
select col1, var_samp(col5) over(order by 3, 4, 1 desc) var_samp, col2, col4 from var_samp_collection;
...
select col1, col2, col3, col4, var_samp(col5) over(order by 1, col2 desc, 3, col4 asc) var_samp from var_samp_collection;
...
--TEST: partition by set
select col1, col2, col3, var_samp(unique col5) over(partition by col1 order by col1, col2, col3) from var_samp_collection;
--TEST: partition by multiset
select col2, col4, col1, var_samp(col5) over(partition by col2 order by col2, col4, col1 desc) from var_samp_collection;
--TEST: partition by list
select col3, var_samp(all col5) over(partition by col3 order by col1, col2, col3) var_samp, col2 from var_samp_collection;
--TEST: partition by sequence
select col4, col1, var_samp(distinct col5) over(partition by col4 order by col1, col2 desc) var_samp from var_samp_collection;
--TEST: syntax error
select col1, col2, var_samp(col5) over(order by col1, col2 partition by col2) from var_samp_collection;
