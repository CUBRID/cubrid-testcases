...
--TEST: OVER() clause
--TEST: set 
select trunc(stddev, 2) from (select  col1, col2, stddev(col5) over() stddev from stddev_collection) order by 1;
--TEST: multiset, with alias+all
select trunc(stddev, 2) from (select  col2, col3, stddev(all col5) over() stddev from stddev_collection) order by 1;
--TEST: list, with where clause
select trunc(stddev, 2) from (select  col3, col4, stddev(unique col5) over() stddev from stddev_collection where col1 > {1, 2, 3}) order by 1;
--TEST: sequence, distinct
select trunc(stddev, 2) from (select  col4, col1, stddev(distinct col5) over() stddev from stddev_collection) order by 1;
select trunc(stddev, 2) from (select  *, stddev(col5) over() stddev from stddev_collection) order by 1;
--TEST: syntax error
select col1, col3, col4, stddev(distinctrow col5) over stddev from stddev_collection;
select col1, col3, col2, stddev(col5) over(1) stddev from stddev_collection;
--TEST: wrong type of arguments
select stddev(col1) over() from stddev_collection;
select stddev(col2) over() from stddev_collection;
select stddev(col3) over() from stddev_collection;
select stddev(col4) over() from stddev_collection;
...
select col1, col2, col3, col4, trunc(stddev(col5) over(partition by col2), 2) stddev from stddev_collection order by 2, 1, 3, 4;
--TEST: partition by list
select col1, col2, col3, col4, trunc(stddev(all col5) over(partition by col3), 2) stddev from stddev_collection order by 3, 1, 2, 4;
--TEST: partition by sequence
select col1, col2, col3, col4, trunc(stddev(col5) over(partition by col4), 2) stddev from stddev_collection order by 4, 1, 2, 3, 5;



--TEST: OVER(ORDER BY) clause
--TEST: order by 1 column name
select col1, trunc(stddev(col5) over(order by col5), 2) stddev1, trunc(stddev(distinct col5) over(), 2) stddev2 from stddev_collection order by 1, 2, 3;
select col1, trunc(stddev(distinct col5) over(order by col1), 2) stddev1, trunc(stddev(distinct col5) over(), 2) stddev2 from stddev_collection order by 1, 2, 3;
--TEST: order by 2 column names
select col2, col3, trunc(stddev(col5) over(order by col2, col3 asc), 2) stddev1, trunc(stddev(col5) over(), 2) stddev2 from stddev_collection;
--TEST: order by more than 2 column names
select col1, col2, col3, col4, trunc(stddev(distinctrow col5) over(order by col1, col2 desc, col3, col4 asc), 2) stddev1, trunc(stddev(distinctrow col5) over(), 2) stddev2 from stddev_collection;
--TEST: order by columns not selected
select col3, trunc(stddev(col5) over(order by col4 desc, col2, col1 asc), 2) stddev1, trunc(stddev(col5) over(), 2) stddev2 from stddev_collection;
--TEST: order by 1 position
select col4, trunc(stddev(all col5) over(order by 1), 2) stddev from stddev_collection;
--TEST: order by 3 positions
select col3, col2, trunc(stddev(col5) over(order by 1, 2 desc, 3 asc), 2) stddev from stddev_collection;
--TEST: order by more than 3 positions
select col1, col2, col3, col4, trunc(stddev(unique col5) over(order by 3, 2 asc, 1 desc, 4), 2) stddev from stddev_collection;
--TEST: order by positions not existed
select col2, trunc(stddev(col5) over(order by 2), 2) stddev from stddev_collection;
select col1, trunc(stddev(col5) over(order by 3, 4, 1 desc), 2) stddev, col2, col4 from stddev_collection;
...
--TEST: partition by set
select col1, col2, col3, trunc(stddev(unique col5) over(partition by col1 order by col1, col2, col3), 2) stddev1, trunc(stddev(unique col5) over(partition by col1), 2) stddev2 from stddev_collection;
--TEST: partition by multiset
...
--TEST: partition by list
select col3, trunc(stddev(all col5) over(partition by col3 order by col1, col2, col3), 2) stddev1, col2, trunc(stddev(all col5) over(partition by col3), 2) stddev2 from stddev_collection;
--TEST: partition by sequence
select col4, col1, trunc(stddev(distinct col5) over(partition by col4 order by col1, col2 desc), 2) stddev1, trunc(stddev(distinct col5) over(partition by col4), 2) stddev2 from stddev_collection;
--TEST: syntax error
select col1, col2, trunc(stddev(col5) over(order by col1, col2 partition by col2) from stddev_collection;
