...
select trunc(stddev_samp, 5) from (select  col3, col4, stddev_samp(unique col5) over() stddev_samp from stddev_samp_collection where col1 > {1, 2, 3}) order by 1;
...
--TEST: syntax error
select trunc(stddev_samp, 5) from (select  *, stddev_samp(col5) over() stddev_samp from stddev_samp_collection) order by 1;
select trunc(stddev_samp, 5) from (select  col1, col3, col4, stddev_samp(distinctrow col5) over stddev_samp from stddev_samp_collection;
...
select trunc(stddev_samp, 5) from (select  stddev_samp(col1) over() from stddev_samp_collection;
select trunc(stddev_samp, 5) from (select  stddev_samp(col2) over() from stddev_samp_collection;
select trunc(stddev_samp, 5) from (select  stddev_samp(col3) over() from stddev_samp_collection;
select trunc(stddev_samp, 5) from (select  stddev_samp(col4) over() from stddev_samp_collection;
...
select trunc(stddev_samp, 5) from (select  col1, col2, col3, col4, stddev_samp(col5) over(partition by col2) stddev_samp from stddev_samp_collection) order by 1;
--TEST: partition by list
select trunc(stddev_samp, 5) from (select  col1, col2, col3, col4, stddev_samp(all col5) over(partition by col3) stddev_samp from stddev_samp_collection) order by 1;
--TEST: partition by sequence
select trunc(stddev_samp, 5) from (select  col1, col2, col3, col4, stddev_samp(col5) over(partition by col4) stddev_samp from stddev_samp_collection) order by 1;



--TEST: OVER(ORDER BY) clause
--TEST: order by 1 column name
select trunc(stddev_samp, 5) from (select  col1, stddev_samp(distinct col5) over(order by col1) stddev_samp from stddev_samp_collection) order by 1;
--TEST: order by 2 column names
select trunc(stddev_samp, 5) from (select  col2, col3, stddev_samp(col5) over(order by col2, col3 asc) stddev_samp from stddev_samp_collection) order by 1;
--TEST: order by more than 2 column names
select trunc(stddev_samp, 5) from (select  col1, col2, col3, col4, stddev_samp(distinctrow col5) over(order by col1, col2 desc, col3, col4 asc) stddev_samp from stddev_samp_collection) order by 1;
--TEST: order by columns not select trunc(stddev_samp, 5) from (select ed
select trunc(stddev_samp, 5) from (select  col3, stddev_samp(col5) over(order by col4 desc, col2, col1 asc) stddev_samp from stddev_samp_collection) order by 1;
--TEST: order by 1 position
select trunc(stddev_samp, 5) from (select  col4, stddev_samp(all col5) over(order by 1) stddev_samp from stddev_samp_collection) order by 1;
...
select trunc(stddev_samp, 5) from (select  col1, col2, col3, col4, stddev_samp(unique col5) over(order by 3, 2 asc, 1 desc, 4) stddev_samp from stddev_samp_collection) order by 1;
--TEST: order by positions not existed
select trunc(stddev_samp, 5) from (select  col2, stddev_samp(col5) over(order by 2) stddev_samp from stddev_samp_collection) order by 1;
select trunc(stddev_samp, 5) from (select  col1, stddev_samp(col5) over(order by 3, 4, 1 desc) stddev_samp, col2, col4 from stddev_samp_collection) order by 1;
...
--TEST: partition by set
select trunc(stddev_samp, 5) from (select  col1, col2, col3, stddev_samp(unique col5) over(partition by col1 order by col1, col2, col3) stddev_samp from stddev_samp_collection) order by 1;
--TEST: partition by multiset
...
--TEST: partition by list
select trunc(stddev_samp, 5) from (select  col3, stddev_samp(all col5) over(partition by col3 order by col1, col2, col3) stddev_samp, col2 from stddev_samp_collection) order by 1; --TEST: partition by sequence
select trunc(stddev_samp, 5) from (select  col4, col1, stddev_samp(distinct col5) over(partition by col4 order by col1, col2 desc) stddev_samp from stddev_samp_collection) order by 1;
--TEST: syntax error
select trunc(stddev_samp, 5) from (select  col1, col2, stddev_samp(col5) over(order by col1, col2 partition by col2) from stddev_samp_collection) order by 1;
