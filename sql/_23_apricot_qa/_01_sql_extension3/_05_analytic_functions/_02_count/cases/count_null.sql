...
insert into count_numeric values(10000, 200, null, 12345.06789, 111.12, 11111.129, 1000);
insert into count_numeric values(10000, null, 30000000, 12345.16789, 111.13, 11111.128, 1000);
insert into count_numeric values(10000, 200, 40000000, 12345.06789, 111.14, 11111.127, 1000);
insert into count_numeric values(null, 100, 50000000, null, 111.15, 11111.126, 1000);
...
insert into count_numeric values(null, 300, 20000000, null, 111.19, 11111.122, 1000);
insert into count_numeric values(30000, null, 30000000, 12345.06789, 111.20, 11111.121, 1000);
insert into count_numeric values(30000, 100, 40000000, null, 111.21, 11111.120, 1000);
insert into count_numeric values(null, 300, 50000000, 12345.06789, 111.23, 11111.119, 1000);
insert into count_numeric values(40000, 100, 10000000, 12345.06789, 111.24, null, 1000);
insert into count_numeric values(50000, null, 20000000, 12345.06789, 111.25, 11111.117, 1000);
...
insert into count_numeric values(null, 100, 50000000, 12345.06789, 111.28, 11111.114, 1000);
...
select col1, col2, col3, col4, col5, col6, col7, count(all col4) over(partition by col4) cnt from count_numeric order by 4, 1, 2, 3, 5, 6;
...
select col1, col2, count(col2) over(order by col1) cnt from count_numeric order by 1, 2, 3;
--TEST: order by 2 column names
select col2, col3, col4, count(all col4) over(order by col2, col3 asc) cnt from count_numeric order by 1, 2, 3, 4;
...
--TEST: partition by double
select col6, col1, col2, col3, count(all col7) over(partition by col6 order by 5,4,3 desc,2,1) cnt from count_numeric order by 1, 2, 3, 4, 5;
--TEST: partition by monetary
