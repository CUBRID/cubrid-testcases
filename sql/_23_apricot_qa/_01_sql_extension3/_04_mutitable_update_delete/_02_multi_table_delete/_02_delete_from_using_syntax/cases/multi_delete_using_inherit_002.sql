...
delete from m1, md_varbit2 using md_varbit1 m1 left outer join md_varbit2 on m1.col2=md_varbit2.col2 where m1.id1 < (select count(concat(m1.col1, m2.col1)) from md_varbit1 m1 inner join md_varbit2 m2 on m1.id1=m2.id2);
