...
delete from m2 using md_float1 m1, md_float2 m2 where m1.id1=m2.id2 and time(m1.col1) <= '12:12:15';
...
delete from m1, m2 using md_float2 m2 left outer join md_float1 m1 on m1.id1=m2.id2 where m1.id1 > (select abs(avg(id2)) from md_float2);
