...
delete from md_v1, md_v2 using md_v1, md_v2 where md_v1.id1=md_v2.id2 and md_v2.col1 = 10;
...
delete from v1, v2 using md_v1 as v1 inner join md_v2 as v2 on v1.id1=v2.id2 where v2.col1 < 20;
