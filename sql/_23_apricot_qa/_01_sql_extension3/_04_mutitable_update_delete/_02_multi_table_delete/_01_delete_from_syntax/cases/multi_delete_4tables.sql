...
delete m1, m2, m3, m4 from md1 m1, md2 m2, md3 m3, md4 m4 where m2.col1=m1.col1 and m1.id1=m3.col1 and m4.col1=m2.col1;


--TEST: without table aliases, 4 rows deleted
delete md1, md2, md3, md4 from md1, md2, md3, md4 where md1.id1=md2.id2 and md1.id1=md3.id3 and md2.id2=md4.id4 and truncate(md1.id1, 2)=truncate(md2.id2, 2) and day(md4.col1)=4;
...
--TEST: [er] with table aliases, delete from a derivedtable
delete m2, m3 from md1 as m1, md2 m2, (select id3, col1 from (select * from md3 where month(col1)=9) md3) m3, (select id4, date(col1) as col1 from md4) as m4 where m1.id1=m2.id2 and m3.id3=m1.id1 and m4.id4=m2.id2 and m1.id1=33;
select if (count(*) = 7, 'ok', 'nok') from md1;
select if (count(*) = 6, 'ok', 'nok') from md2;
select if (count(*) = 5, 'ok', 'nok') from md3;
select if (count(*) = 4, 'ok', 'nok') from md4;
