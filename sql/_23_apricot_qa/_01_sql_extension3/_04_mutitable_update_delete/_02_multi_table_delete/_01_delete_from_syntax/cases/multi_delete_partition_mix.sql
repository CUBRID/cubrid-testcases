--TEST: delete from 3 table with different partition types
...
delete m1, m2, m3 from md_datetime1 m1, md_datetime2 m2, md_datetime3 m3 where m2.col1=m1.col1 and m1.col1=m3.col3;
