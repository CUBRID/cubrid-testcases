...
delete m1, m2 from dep m1 inner join emp m2 on m1.depid=m2.depid where m2.empid=3;
...
delete m1, m2 from dep m1 inner join emp m2 on m1.depid=m2.depid where m1.depid like '_03'; 
...
delete m2 from dep m1 inner join emp m2 on m1.depid=m2.depid where m1.depid like '_04' and m2.name='ff';
select if (count(*) =  2, 'ok', 'nok') from dep;
