...
insert into t2 select rownum, rownum from t1;
select * from t1 left join t2 on t2.a=t1.a where t1.a>0 and t2.a >0 and t2.a%2=0 using index i_t1_a keylimit 0,1000, i_t2_a keylimit 0,1000;
update /*+ recompile */ t1 left join t2 on t2.a=t1.a set t1.a=t2.a+1000, t1.b=t2.b+2000, t2.a=t1.a+3000, t2.b=t1.b+4000 where t1.a>0 and t2.a >0 and t2.a%2=0 using index i_t1_a keylimit 0,1000, i_t2_a keylimit 0,1000;
