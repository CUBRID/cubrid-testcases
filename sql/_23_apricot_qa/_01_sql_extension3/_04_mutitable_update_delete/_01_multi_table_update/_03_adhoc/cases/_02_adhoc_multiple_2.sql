...
insert into t1 values (1,1),(2,2),(3,3),(4,4);
create index i_t1_a on t1(a);
update /*+ recompile */ t1 left join t2 on t1.a=t2.a and t2.a>2 set t1.b=100, t2.b=100 where t1.a>2 using index t1.i_t1_a keylimit 0,0;
select * from t1 order by 1,2;
drop table t1;
drop view t2;
...
insert into t1 values (1,1),(2,2),(3,3),(4,4);
create index i_t1_a on t1(a);
update /*+ recompile */ t1 left join t2 on t1.a=t2.a and t2.a>2 set t1.b=100, t2.b=100 where t1.a>1 using index t1.i_t1_a keylimit 1,2;
select * from t1 order by 1,2;
drop table t1;
drop view t2;
...
insert into t1 values (1,1),(2,2),(3,3),(4,4);
create index i_t1_a on t1(a);
update /*+ recompile */ t1 left join t2 on t1.a=t2.a and t2.a>9999 set t1.b=100 where t1.a>1 using index t1.i_t1_a keylimit 1,2;
select * from t1 order by 1,2;
drop table t1;
drop view t2;
...
insert into t1 values (1,1),(2,2),(3,3),(4,4);
create index i_t1_a on t1(a);
update /*+ recompile */ t1 left join t2 on t1.a=t2.a and t2.a>9999 set t2.b=100 where t1.a>1 using index t1.i_t1_a keylimit 1,2;
select * from t1 order by 1,2;
drop table t1;
drop view t2;
