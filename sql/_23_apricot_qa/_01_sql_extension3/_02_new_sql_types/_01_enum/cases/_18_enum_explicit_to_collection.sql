...
select cast(b as set) from conv order by 1;
select cast(b as multiset) from conv order by 1;
select cast(b as sequence) from conv order by 1;

--TEST: convert enum to numeric type
select cast(d as set) from conv order by 1;
select cast(d as multiset) from conv order by 1;
select cast(d as sequence) from conv order by 1;
