...
--Test
select /*+ recompile */ * from t1 where abs(d1) > 3;

--Test
select /*+ recompile */ * from t1 where abs(d1) = 3;

--Test
select /*+ recompile */ * from t1 where abs(d1) < 4 and abs(d1) > 2;
...
create index idx on t1 (i2, abs(d1));
...
--Test
select /*+ recompile */ * from t1 where i2 = 3 and abs(d1) > 5;

--Test
select /*+ recompile */ * from t1 where i2 = 3 and abs(d1) > 5 and abs(d1) < 8;
