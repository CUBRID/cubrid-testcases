...
--Test ISS
select /*+ recompile INDEX_SS */ i, j from t2 where j = '2' order by 1;
--Test
select /*+ recompile INDEX_SS */ i, j from t2 where j = '2' order by i desc;
--Test
select /*+ recompile INDEX_SS */ i, j from t2 where j <= '1' order by 1;
--Test
select /*+ recompile INDEX_SS */ i, j from t2 where j <= '1' or j = 3 order by 1;
--Test
