...
create trigger tr1 before delete on t1 execute insert into t3 values (obj.str);
create trigger tr2 before delete on t2 execute insert into t3 values (obj.str);
