...
-- values should all be outside the index --
...
-- values should all be inside the index --
...
-- bring a value from outside the index into the index --
...
-- take values from the index out of it --
...
-- bring values from outside the index into the index --
