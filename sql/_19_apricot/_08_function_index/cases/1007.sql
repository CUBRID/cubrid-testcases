...
select /*+ recompile */ * from t1 where floor(d1) > 3 order by 1;
...
select /*+ recompile */ * from t1 where d1 > 3 order by 1;
...
select /*+ recompile */ * from t1 where i2 = 3 and floor(d1) > 5 order by 1;


select /*+ recompile */ * from t1 where i2 = 3 and floor(d1) > 5 and floor(d1) < 8 order by 1;


select /*+ recompile */ * from t1 where i2 > 2 and d1 > 3 order by 1;
