...
-- should use ISS but not return NULL values for j
...
--create too many ranges for ISS
...
-- should use ISS because it generates an SKIP ORDER BY plan
select /*+ recompile */ j, k from t where j <=2 and s = '2' order by i;
