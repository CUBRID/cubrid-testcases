CREATE TABLE tst (i int, s timestamp default unix_timestamp());
...
select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 , 'ok', 'nok') from tst where i > 1;

insert into tst values (6, DEFAULT);

insert into tst values (7, DEFAULT);

select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 , 'ok', 'nok') from tst where i > 5;
...
select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 , 'ok', 'nok') from tst where i > 10;

drop table test_helper;

drop table tst;

CREATE TABLE tst (i int, s timestamp default unix_timestamp(), d double default 10);
...
select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 and d = 10, 'ok', 'nok') from tst where i > 1;

insert into tst values (6, DEFAULT, DEFAULT);

insert into tst values (7, DEFAULT, DEFAULT);

select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 and d = 10, 'ok', 'nok') from tst where i > 5;
...
select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 and d = 10, 'ok', 'nok') from tst where i > 10;
...
CREATE TABLE tst (i int, s timestamp default unix_timestamp(), d double default 10, s1 timestamp default unix_timestamp());

insert into tst values (1, timestamp'2011-01-01 01:01:01', 10, timestamp'2011-02-02 12:34:56');
...
select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 and abs(s-s1)<=1 and d = 10 , 'ok', 'nok') from tst where i > 1;

insert into tst values (6, DEFAULT, DEFAULT, DEFAULT);

insert into tst values (7, DEFAULT, DEFAULT, DEFAULT);

select if (abs(s - from_unixtime(unix_timestamp())) <= 864000 and abs(s-s1)<=1 and d = 10 , 'ok', 'nok') from tst where i > 5;
...
select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 and abs(s-s1)<=1 and d = 10 , 'ok', 'nok') from tst where i > 12;
...
select if (abs(s - from_unixtime(UNIX_TIMESTAMP())) <= 864000 and abs(s-s1)<=1 and d = 10 , 'ok', 'nok') from tst where i > 24;
