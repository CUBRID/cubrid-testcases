CREATE TABLE tst (i int, s string default user());
...
select if (lower(substring_index(s,'@',1)) = lower(substring_index(user(),'@',1)), 'ok', 'nok') from tst where s is not null and i > 1;

insert into tst values (6, DEFAULT);

insert into tst values (7, DEFAULT);

select if (lower(substring_index(s,'@',1)) = lower(substring_index(user(),'@',1)), 'ok', 'nok') from tst where s is not null and i > 5;
...
CREATE TABLE tst (i int, s string default user(), d double default 10);
...
CREATE TABLE tst (i int, s string default user(), d double default 10, s1 string default user());
...
select if (lower(substring_index(s,'@',1)) = lower(substring_index(user(),'@',1)) and lower(substring_index(s1,'@',1)) = lower(substring_index(user(),'@',1)), 'ok', 'nok') from tst where s is not null and s1 is not null and i > 1;

insert into tst values (6, DEFAULT, DEFAULT, DEFAULT);

insert into tst values (7, DEFAULT, DEFAULT, DEFAULT);

select if (lower(substring_index(s,'@',1)) = lower(substring_index(user(),'@',1)) and lower(substring_index(s1,'@',1)) = lower(substring_index(user(),'@',1)), 'ok', 'nok') from tst where s is not null and s1 is not null and i > 5;
...
select if (lower(substring_index(s,'@',1)) = lower(substring_index(user(),'@',1)) and lower(substring_index(s1,'@',1)) = lower(substring_index(user(),'@',1)), 'ok', 'nok') from tst where s is not null and s1 is not null and i = 8;
...
select if (lower(substring_index(s,'@',1)) = lower(substring_index(user(),'@',1)) and lower(substring_index(s1,'@',1)) = lower(substring_index(user(),'@',1)), 'ok', 'nok') from tst where s is not null and s1 is not null and i > 12;
