...
create index i_t1_v on t1(v) with online parallel 2;
create index i_t1_c on t1(c) with online parallel 2;
create index i_t1_s on t1(s) with online parallel 2;
