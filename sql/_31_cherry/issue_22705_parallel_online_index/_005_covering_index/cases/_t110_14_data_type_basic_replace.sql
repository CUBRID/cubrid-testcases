...
create index i_t1_a on t1(a) with online parallel 3;
create index i_t1_b on t1(b) with online parallel 3;
create index i_t1_c on t1(c) with online parallel 3;
create index i_t1_d on t1(d) with online parallel 3;
create index i_t1_e on t1(e) with online parallel 3;
create index i_t1_f on t1(f) with online parallel 3;
create index i_t1_gh on t1(g,h) with online parallel 3;
create index i_t1_h on t1(h) with online parallel 3;
create index i_t1_i on t1(i) with online parallel 3;
create index i_t1_j on t1(j) with online parallel 3;
create index i_t1_k on t1(k) with online parallel 3;
create index i_t1_l on t1(l) with online parallel 3;
create index i_t1_m on t1(m) with online parallel 3;
create index i_t1_n on t1(n) with online parallel 3;
create index i_t1_o on t1(o) with online parallel 3;
create index i_t1_p on t1(p) with online parallel 3;
create index i_t1_q on t1(q) with online parallel 3;
