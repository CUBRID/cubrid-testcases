-- create class on all type and create reverse index on int type and insert/update/delete/select data
...
create reverse index t1_index on t1(col1) with online parallel 5;
