...
select GREATEST(cast(json_extract(a, '/addtime') as datetime)) from t order by 1;
select LEAST(cast(json_extract(a, '/addtime') as datetime)) from t order by 1;
...
select LEAST(cast(json_extract(a, '/addtime') as string)) from t order by 1;  
select GREATEST(cast(json_extract(a, '/addtime') as string)) from t order by 1;  
drop table if exists t;
...
select GREATEST(cast(json_extract(a, '/addtime') as string)) from t9 order by 1;
select GREATEST(cast(json_extract(a, '/addtime') as string), b) from t9;
select GREATEST(cast(json_extract(a, '/addtime') as string), cast(b as string)) from t9 order by 1;
select LEAST(cast(json_extract(a, '/addtime') as string), cast(b as string)) from t9 order by 1;
select GREATEST('10:44:34.874 AM 12/12/2017', cast(json_extract(a, '/add') as string)) from t9 order by 1;
select LEAST('10:44:34.874 AM 12/12/2017', cast(json_extract(a, '/add') as string)) from t9 order by 1;
select GREATEST('10:44:34.874 AM 12/12/2017', cast(json_extract('{"addby":"cubrid"}', '/addby')as string)) from t9 order by 1;
select LEAST('10:44:34.874 AM 12/12/2017', cast(json_extract('{"addby":"cubrid"}', '/addby')as string)) from t9 order by 1;
