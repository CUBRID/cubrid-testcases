...
create class test_class (col1 integer, col2 date default '2001-05-05',col3 timestamp on update current_timestamp);
...
col3 timestamp  default '2001-05-05' on update current_timestamp
);
