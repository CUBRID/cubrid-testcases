...
update Categories a,ProductsOverTenDollars p,CategoryAndNumberOfProducts c set a.CategoryName='aa'
where p.CategoryID = c.CategoryID and a.CategoryID=c.CategoryID;
