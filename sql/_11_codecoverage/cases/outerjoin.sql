...
insert into table1 select rownum,rownum-1,rownum+10,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 10;
insert into table2 select rownum,rownum-12,rownum+20,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 20;
insert into table3 select rownum,rownum-13,rownum+30,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 30;
insert into table4 select rownum,rownum-14,rownum+40,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 40;
insert into table5 select rownum,rownum-15,rownum+50,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 50;
insert into table6 select rownum,rownum-16,rownum+60,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 60;
insert into table7 select rownum,rownum-17,rownum+70,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 70;
insert into table8 select rownum,rownum-18,rownum+80,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 80;
insert into table9 select rownum,rownum-19,rownum+90,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 90;
insert into table10 select rownum,rownum-1,rownum+10,'col0','1','2',3,4,5,6,7 from db_class a,db_class b,db_class c limit 10;
