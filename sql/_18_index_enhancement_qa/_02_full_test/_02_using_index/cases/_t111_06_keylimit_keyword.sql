...
--TEST
delete from t1 from t1 where a>0 and c='011' and rownum=1 using index keylimit keylimit 2,2;

--TEST:
delete from t1 from t1 where a>0 and c='086' and rownum=3 using index keylimit kEyLiMiT 2,4;
