...
select /*+ recompile */ * from t1 where 'a'||v like 'a%';
select /*+ recompile */ * from t1 where 'a'||v like 'aaaa%';
select /*+ recompile */ * from t1 where ' '||v like ' %';

select /*+ recompile */ * from t1 where c||v like 'a%';
select /*+ recompile */ * from t1 where s||c||v like 'a%';

select /*+ recompile */ * from t1 where 1||v like '1%';
