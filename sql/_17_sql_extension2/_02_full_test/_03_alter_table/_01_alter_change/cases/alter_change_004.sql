--change the type of  a nchar varying(n) column to other types
...
create class coo(
        ...
        col7 nchar varying(20),
        col8 nchar varying(20),
        col9 nchar varying(20),
        col10 nchar varying(20),
        col11 nchar varying(20),
        col12 nchar varying(20),
        col13 nchar varying(20),
        col14 nchar varying(20),
        col15 nchar varying(20),
        col16 nchar varying(20),
        col17 nchar varying(20),
        col18 nchar varying(20),
        col19 nchar varying(20),
        col20 nchar varying(20),
        col21 nchar varying(20)
);
