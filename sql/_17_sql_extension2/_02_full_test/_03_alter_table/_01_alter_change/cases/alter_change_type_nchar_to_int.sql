...
--change the type of a nchar() column to int
...
--nchar() -> int, number format -> number, no loss of data
alter table coo change col1 col1 int;
select col1 from coo order by 1;

--nchar() -> int, number format -> number, nchar() > max(int)
...
--nchar() -> int, number format -> number, nchar() < min(int)
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar() -> int, number format -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar() -> int, string -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar() -> int, long string -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
