...
--change the type of a char() column to float
...
--char() -> float, number format -> number, no loss of data
alter table coo change col1 col1 float;
select col1 from coo order by 1;

--char() -> float, number format -> number, char() = max(float)
...
--char() -> float, number format -> number, char() = min(float)
set system parameters 'alter_table_change_type_strict=yes';
...
--char() -> float, number format -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
...
--char() -> float, string -> number, no loss of data
set system parameters 'alter_table_change_type_strict=yes';
...
--char() -> float, long string -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
