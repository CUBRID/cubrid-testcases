...
--change the type of a nchar() column to double
...
--nchar() -> double, number format -> number, no loss of data
alter table coo change col1 col1 double;
select col1 from coo order by 1;

--nchar() -> double, number format -> number, nchar() = max(double)
...
--nchar() -> double, number format -> number, nchar() = min(double)
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar() -> double, number format -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar() -> double, string -> number, no loss of data
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar() -> double, long string -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
