...
--change the type of a nchar varying() column to float
...
--nchar varying() -> float, number format -> number, no loss of data
alter table coo change col1 col1 float;
select col1 from coo order by 1;

--nchar varying() -> float, number format -> number, nchar varying() = max(float)
...
--nchar varying() -> float, number format -> number, nchar varying() = min(float)
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar varying() -> float, number format -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar varying() -> float, string -> number, no loss of data
set system parameters 'alter_table_change_type_strict=yes';
...
--nchar varying() -> float, long string -> number, loss of data
set system parameters 'alter_table_change_type_strict=yes';
