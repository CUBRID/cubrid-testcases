...
select var_samp(col1) from voo;
select var_samp(col2) from voo;
select var_samp(blob_to_bit(col2)) from voo;
select var_samp(col3) from voo;
select var_samp(clob_to_char(col3)) from voo;
