--insert into a table with a composite primary key.
--trigger: 1) before insert  2) after insert  3) before update  4) after update


CREATE TABLE with_trigger(a int not null, b char(10), c int, primary key(a, b));
...
INSERT INTO with_trigger VALUES (3, 'DDD', 4) ON DUPLICATE KEY UPDATE b='DUPLICATED';
SELECT * FROM trigger_actions order by 1;
SELECT * FROM with_trigger order by 1;

INSERT INTO with_trigger VALUES (3, 'CCC', 5) ON DUPLICATE KEY UPDATE b='DUPLICATED';
SELECT * FROM trigger_actions order by 1;
SELECT * FROM with_trigger order by 1;

INSERT INTO with_trigger VALUES (1, 'BBB', 5) ON DUPLICATE KEY UPDATE b='DUPLICATED';
SELECT * FROM trigger_actions order by 1;
SELECT * FROM with_trigger order by 1;
