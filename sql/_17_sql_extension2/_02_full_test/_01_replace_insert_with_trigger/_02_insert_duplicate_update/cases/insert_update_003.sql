...
drop table if exists with_trigger,trigger_actions1,trigger_actions2;
...
CREATE TABLE trigger_actions1(a int, b char(20));
CREATE TABLE trigger_actions2(a int, b char(20));
...
INSERT INTO with_trigger VALUES (5, 'FFF', 4) ON DUPLICATE KEY UPDATE b='DUPLICATED';
SELECT * FROM trigger_actions1 order by 1;
SELECT * FROM trigger_actions2 order by 1;
SELECT * FROM with_trigger order by 1;
