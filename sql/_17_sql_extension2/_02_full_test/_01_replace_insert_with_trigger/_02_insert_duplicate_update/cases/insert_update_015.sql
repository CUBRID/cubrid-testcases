--1.insert into a table with partition
--trigger: 1) before delete  2) after delete 
--trigger action: insert/update/delete into 1 table.

drop table if exists with_trigger2,with_trigger,trigger_actions;
...
INSERT INTO with_trigger VALUES (2, 'BBB', 4) ON DUPLICATE KEY UPDATE b='DUPLICATED';
