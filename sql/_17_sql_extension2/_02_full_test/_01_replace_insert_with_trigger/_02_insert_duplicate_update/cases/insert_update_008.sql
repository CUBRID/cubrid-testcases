...
CREATE TRIGGER trig_aft_upd AFTER UPDATE ON with_trigger EXECUTE
	INSERT INTO trigger_actions2 (a, b, c) VALUES (66, 'AFTER UPDATE', 66);

INSERT INTO with_trigger VALUES (4.4, '2010-09-26', 'DDD', char_to_clob('ddd')) ON DUPLICATE KEY UPDATE c='DUPLICATED', a=a*100;
SELECT a, b, c, clob_to_char(d) FROM with_trigger order by 1;
SELECT * FROM trigger_actions1 order by 1;
SELECT * FROM trigger_actions2 order by 1;

INSERT INTO with_trigger VALUES (4.4, '2000-11-08', 'FFF', char_to_clob('fff')) ON DUPLICATE KEY UPDATE c='DUPLICATED', a=a*100;
SELECT a, b, c, clob_to_char(d) FROM with_trigger order by 1;
SELECT * FROM trigger_actions1 order by 1;
SELECT * FROM trigger_actions2 order by 1;

INSERT INTO with_trigger VALUES (4.4, '11/08/2000', 'GGG', char_to_clob('ggg')) ON DUPLICATE KEY UPDATE c='DUPLICATED', a=a*100;
SELECT a, b, c, clob_to_char(d) FROM with_trigger order by 1;
SELECT * FROM trigger_actions1 order by 1;
SELECT * FROM trigger_actions2 order by 1;
