--TEST: [Merge Statement] 'System error (generate attr) in ../../src/parser/xasl_generation.c (line: 9557)' error occurs when there is pk violation in the insert_clause.
