...
select round(34567.34567, 'default'), round(34567.34567, 0), round(34567.34567);
select round(34567.94567, 'default'), round(34567.94567, 0), round(34567.94567);
select trunc(34567.34567, 'default'), trunc(34567.34567, 0), trunc(34567.34567);
select trunc(34567.94567, 'default'), trunc(34567.94567, 0), trunc(34567.94567);
