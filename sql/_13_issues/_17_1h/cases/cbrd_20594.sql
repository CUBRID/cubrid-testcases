...
select x.a,y.a from tb x,tb y where x.a>1 and y.a>1;

select x.a,y.a from tb x,tb y where x.a=y.a and (x.a>1);
...
select s3,count(*) from t1 where s1>'0' group by s1 desc having count(*) >0; 
...
select * from t a,t b where a.a=b.b using index a.i_t_a_b;

select * from (select * from t where a>0 using index i_t_a_b keylimit 0,3) x, (select * from t where b>'0' using index i_t_b_a keylimit 0,2) y where x.a=y.a;
