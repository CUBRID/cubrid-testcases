...
select /*+ recompile index_ls */ a from t group by a;
select /*+ recompile index_ls */ a from t group by a desc;
select /*+ recompile index_ls */ a from t where c>0 group by a;
select /*+ recompile index_ls */ a from t where c>0 group by a desc;
