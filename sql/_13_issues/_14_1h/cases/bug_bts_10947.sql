...
call change_owner('db_user', 'test_user') on class db_root;
call change_owner('db_root', 'test_user') on class db_root;
call change_owner('db_index', 'test_user') on class db_root;
...
alter class db_root owner to test_user1;
