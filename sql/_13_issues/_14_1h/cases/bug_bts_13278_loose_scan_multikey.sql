...
select /*+ recompile index_ls */ a from t where a=4 or a=8 group by a;
select /*+ recompile index_ls */ a from t where a=4 or a=8 group by a desc;
select /*+ recompile index_ls */ a, b from t where a=4 or a=8 group by a, b;
select /*+ recompile index_ls */ a, b from t where a=4 or a=8 group by a desc, b desc;
select /*+ recompile index_ls */ a, b from t where a=4 or a=8 group by a desc, b;
select /*+ recompile index_ls */ a, b from t where a=4 or a=8 group by a, b desc;
