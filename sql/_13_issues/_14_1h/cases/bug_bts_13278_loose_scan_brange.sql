...
select /*+ recompile index_ls */ a from t where a>=4 group by a;
select /*+ recompile index_ls */ a from t where a>=4 group by a desc;
select /*+ recompile index_ls */ a from t where a<6 group by a;
select /*+ recompile index_ls */ a from t where a<6 group by a desc;
select /*+ recompile index_ls */ a from t where a<=6 group by a;
select /*+ recompile index_ls */ a from t where a<=6 group by a desc;
select /*+ recompile index_ls */ a from t where a>4 and a<6 group by a;
select /*+ recompile index_ls */ a from t where a>4 and a<6 group by a desc;
select /*+ recompile index_ls */ a,b from t where a>4 and a<7 and b>3 and b<6 group by a, b;
select /*+ recompile index_ls */ a,b from t where a>4 and a<7 and b>3 and b<6 group by a desc, b desc;
select /*+ recompile index_ls */ a,b from t where a>4 and a<7 and b>3 and b<6 group by a desc, b;
select /*+ recompile index_ls */ a,b from t where a>4 and a<7 and b>3 and b<6 group by a, b desc;
