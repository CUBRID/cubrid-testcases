...
from aaa, bbb left outer join ccc on bbb.id = ccc.id left outer join ddd on bbb.key2 = ddd.key1 ,eee
where aaa.id = bbb.id and bbb.key1 = eee.key1 and (ddd.nm = 'aaa' or eee.nm = 'bbb') and aaa.id = 1;
drop aaa,bbb,ccc,ddd,eee;
