...
select charset(if(id%2,  _utf8'a', _iso88591'b')), collation(if(id%2,  _utf8'a', _iso88591'b' collate iso88591_en_ci)) from t1;
select charset(if(id%2,  _utf8'a', a)), collation(if(id%2,  _utf8'a', a)) from t1;
select charset(if(id%2,  _utf8'a', b)), collation(if(id%2,  _utf8'a', b)) from t1;
select charset(if(id%2,  a, b)), collation(if(id%2,  a, b)) from t1;
