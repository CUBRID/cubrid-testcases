...
drop class if exists c2;
drop class if exists d1;
drop class if exists d2;
...
create unique index i_c2_i on c2(i) with online;

create unique index i_d1_id1_sd1 on d1(id1,sd1) with online;
