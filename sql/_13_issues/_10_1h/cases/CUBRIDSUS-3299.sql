...
select if(prec is null, 'OK', 'NOK') from db_attribute where class_name='vx' and attr_name = 'a';
select if(scale is null, 'OK', 'NOK') from db_attribute where class_name='vx' and attr_name = 'a';
