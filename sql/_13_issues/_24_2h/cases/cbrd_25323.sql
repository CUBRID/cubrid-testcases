...
select 'AS-IS Eliminate INNER JOIN optimization is not performed.
TO-BE
- The join type of the second table is LEFT OUTER JOIN
- With ANSI JOIN syntax' as "test case 7";
...
select 'AS-IS Eliminate INNER JOIN optimization is performed.
TO-BE
- The join type of the second table is LEFT OUTER JOIN
...
select 'Eliminate INNER JOIN optimization is performed.
TO-BE
- The join type of the second table is RIGHT OUTER JOIN
- With ORACLE JOIN syntax
' as "test case 13";
