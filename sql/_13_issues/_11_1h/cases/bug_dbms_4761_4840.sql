create table tb(a int, b date, c int);
insert into tb values (1, date'02/21/2011', 1);
insert into tb values (2, date'02/20/2011', 5);
insert into tb values (3, date'02/19/2011', 2);
insert into tb values (4, date'02/18/2011', 4);
...
select * from tb where a in (null, 1, 2) order by a;
select * from tb where a in (1, null, 2) order by a;

select * from tb where a in (null, c) order by a;
select * from tb where a in (c, null) order by a;

select * from tb where a in (null, null);

prepare x from 'select * from tb where a in (null, 1, ?) order by a'
execute x using 3
drop prepare x;

prepare x from 'select * from tb where a in (1, null, ?) order by a'
execute x using 3
drop prepare x;
