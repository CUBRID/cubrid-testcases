...
select column_integer, column_datetime from test_table group by column_integer;
select column_integer, column_datetime from test_table group by column_integer desc;
select column_integer, column_timestamp from test_table where column_timestamp > column_datetime group by column_timestamp;
select column_integer, column_timestamp from test_table where column_integer >= 2 group by column_integer, column_timestamp;
select t.column_varchar_92, t.column_bit, t.column_datetime, t.column_smallint from (select * from test_table where column_integer * 100 >= column_smallint and column_varchar_92 > '' group by column_varchar_92, column_bit, column_datetime, column_smallint) as t;
