...
select col_timestamp from test_table where col_timestamp > '06:59:12 PM 05/03/2008' group by col_timestamp;
select col_datetime from test_table where col_timestamp = '06:59:12 PM 05/03/2008' group by col_datetime;
select col_timestamp from test_table where cast(date_format(col_timestamp, '%Y') as int) > 2005 group by col_timestamp;
select col_smallint, col_float, col_string from test_table where col_string like('%ab%') group by col_smallint, col_float, col_string;
select col_smallint, col_float from test_table where col_varchar_92 like('%ab%') group by col_smallint, col_float;
