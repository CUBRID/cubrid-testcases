...
create index i_t4_id3_id1 on t4(id3, id1);
...
create index i_t7_id_parentid on t7(id, parentid);
...
select * from tab1 a,tab1 b where a.id>0 and b.id>0 
using index a.i_tab1_id_num(+), b.i_tab1_id(+) order by 1, 2, 3, 4;
select * from tab1, tab2, tab3 where tab1.id>0 and tab2.id>0 and tab3.text>'abc' 
using index i_tab1_id_num(+), i_tab2_id(+), i_tab3_text(+) order by 1, 2, 3, 4;

select * from tab1 a,tab1 b where a.id>0 and b.id>0 
using index a.none, b.i_tab1_id_num(+) order by 1, 2, 3, 4;
select * from tab1 a,tab1 b where a.id>0 and b.id>0 
using index a.none, b.none order by 1, 2, 3, 4;
select * from tab1, tab2, tab3 where tab1.id>0 and tab2.id>0 and tab3.text>'abc' 
using index i_tab1_id_num(+), tab2.none, i_tab3_text(+) order by 1, 2, 3, 4;
select * from tab1, tab2, tab3 where tab1.id>0 and tab2.id>0 and tab3.text>'abc' 
using index tab1.none, i_tab2_id(+), i_tab3_text(+) order by 1, 2, 3, 4;
...
select
					...
					from
						t1,t2,t3,t4,t6,t7,firms,clients
					where
						t1.id1>0 and t2.id2>'abc' and t3.id3<111 and t4.id1=10 and t6.id2='abc'
						and t7.text between 'DDDDE' and 'EAAAE' and firms.company='ghi_inc'
						and clients.job='auditor'
					using index i_clients_job_fname_lname(+), firms.none, i_t1_id1_id2(+),
						t2.none, i_t3_id1_id3(+), t4.none, t6.none;
						
select
						t1.id1, t2.id2, t3.id3, t4.id1, t6.id3, t7.text, firms.clno, clients.lname
					from
						t1,t2,t3,t4,t6,t7,firms,clients
					where
						t1.id1>0 and t2.id2>'abc' and t3.id3<111 and t4.id1=10 and t6.id2='abc'
						...
						and clients.job='auditor'
					using index
						t1.none, i_t2_id2(+), t3.none, i_t4_id1_id3(+), i_t6_id2_id3(+), t7.none,
						i_firms_company_city(+), clients.none;
