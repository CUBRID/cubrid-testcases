...
create index i_t1_treeid on t1(treeid);
create index i_t1_text on t1(text);
create index i_t1_id_text on t1(id, text);


create table t2(id int not null, parentid int,text varchar(64));

insert into t2 values(1,6,'AAAAA'), 
(2,6,'AAAAB'), 
(3,6,'AAAAC'), 
(4,6,'AAAAD'), 
(5,6,'AAAAE'), 
...
(998,999,'BBBE'), 
(999,1093,'BBB');
insert into t2 values (1000,1005,'BBCAA'), 
(1001,1005,'BBCAB'), 
(1002,1005,'BBCAC'), 
(1003,1005,'BBCAD'), 
(1004,1005,'BBCAE'), 
...
(1998,2030,'CCD'), 
(1999,2004,'CCEAA');
insert into t2 values (2000,2004,'CCEAB'), 
(2001,2004,'CCEAC'), 
(2002,2004,'CCEAD'), 
(2003,2004,'CCEAE'), 
(2004,2029,'CCEA'), 
...
(2998,3123,'DEA'), 
(2999,3004,'DEBAA');
insert into t2 values (3000,3004,'DEBAB'), 
(3001,3004,'DEBAC'), 
(3002,3004,'DEBAD'), 
(3003,3004,'DEBAE'), 
(3004,3029,'DEBA'), 
...
(3904,3905,'EE'), 
(3905,null,'E');
insert into t2 values (81,86,'AACDA'), 
(82,86,'AACDB'), 
(83,86,'AACDC'), 
(84,86,'AACDD'), 
(85,86,'AACDE'), 
...
create index i_t2_parentid on t2(parentid);
create reverse index ri_t2_parentid on t2(parentid);
create index i_t2_text on t2(text);
create index i_t2_id_text on t2(id, text);
create index i_t2_id_parentid on t2(id, parentid);
create index i_t2_parentid_id on t2(parentid, id);
create index i_t2_parentid_text on t2(parentid, text);
create reverse index ri_t2_parentid_id on t2(parentid, id);
create index i_t2_id_parentid_text on t2(id, parentid, text);
create reverse index ri_t2_id_parentid_text on t2(id, parentid, text);
...
CREATE TABLE test_table2(column_integer INTEGER,
...
INSERT INTO test_table2 VALUES(1, 11, 1.1, '1', '07:00:34 PM', '12/31/2000', NULL, '07:00:34 PM', '05:55:31 PM 03/02/2002', '05:55:31 PM 02/03/2000');
INSERT INTO test_table2 VALUES(22, 222, 2.2, '22', '-07:-15:-34.-13 PM', '12/31/2000', NULL, '00:00:35 AM', '05:55:31 PM 05/04/2004', '05:55:31 PM 05/04/2002');
INSERT INTO test_table2 VALUES(333, 3333, 3.3, null, '05:55:31 PM 02/03/2000', '12/31/2004', NULL, '00:00:36 AM', '05:55:31 PM 05/04/2000', '05:55:31 PM 05/04/2004');

create reverse index ri_test_table2_column_integer on test_table2(column_integer);
create index i_test_table2_column_integer_column_varchar_92 on test_table2(column_integer, column_varchar_92);
create reverse index ri_test_table2_column_integer_column_varchar_92 on test_table2(column_integer, column_varchar_92);
create index i_test_table2_column_integer_column_timestamp on test_table2(column_integer, column_timestamp);
create index i_test_table2_column_timestamp on test_table2(column_timestamp);
create index i_test_table2_column_varchar_92_column_bit_column_datetime_column_smallint on test_table2(column_varchar_92, column_bit, column_datetime, column_smallint);

update statistics on all classes with fullscan;

select /*+ recompile */ id, treeid from t1 where treeid is null order by treeid, id;
select /*+ recompile */ treeid from t1 where id > treeid order by treeid;
select /*+ recompile */ treeid from t1 where treeid - 1 > 0 order by treeid;
select /*+ recompile */ * from tree2 where id > 0 or treeid < 100 and id < 10 or text > 'A' order by treeid;
select /*+ recompile */ * from t1 where id > treeid or text < 'C' order by treeid, id;

select /*+ recompile */ parentid from t2 where parentid % 7 = 0 order by parentid;
select /*+ recompile */ * from t2 where id > 3900 and parentid > 1800 order by id, parentid;
update statistics on all classes with fullscan;
select /*+ recompile */ parentid from t2 where parentid % 131 = 0 order by parentid desc;
select /*+ recompile */ * from t2 where parentid % 2 = 0 and id > 1800 and text like '%E' order by id, parentid, text;
select /*+ recompile */ * from t2 where parentid = 3747 order by id;
