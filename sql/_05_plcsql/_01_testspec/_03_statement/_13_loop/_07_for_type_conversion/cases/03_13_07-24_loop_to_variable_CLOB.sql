...
create or replace procedure t_DATETIME_CLOB(param_type string, variables_type string ) as 
...
call t_DATETIME_CLOB('DATETIME', 'CLOB'  ) ;
drop procedure t_DATETIME_CLOB ;



call print_message('t_DATETIMELTZ_CLOB. This scenario is a failure.');
create or replace procedure t_DATETIMELTZ_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATETIMELTZ_CLOB('DATETIMELTZ', 'CLOB'  ) ;
drop procedure t_DATETIMELTZ_CLOB ;



call print_message('t_DATETIMETZ_CLOB. This scenario is a failure.');
create or replace procedure t_DATETIMETZ_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATETIMETZ_CLOB('DATETIMETZ', 'CLOB'  ) ;
drop procedure t_DATETIMETZ_CLOB ;



call print_message('t_DATE_CLOB. This scenario is a failure.');
create or replace procedure t_DATE_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATE_CLOB('DATE', 'CLOB'  ) ;
drop procedure t_DATE_CLOB ;



call print_message('t_TIME_CLOB. This scenario is a failure.');
create or replace procedure t_TIME_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIME_CLOB('TIME', 'CLOB'  ) ;
drop procedure t_TIME_CLOB ;



call print_message('t_TIMESTAMP_CLOB. This scenario is a failure.');
create or replace procedure t_TIMESTAMP_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMP_CLOB('TIMESTAMP', 'CLOB'  ) ;
drop procedure t_TIMESTAMP_CLOB ;



call print_message('t_TIMESTAMPLTZ_CLOB. This scenario is a failure.');
create or replace procedure t_TIMESTAMPLTZ_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMPLTZ_CLOB('TIMESTAMPLTZ', 'CLOB'  ) ;
drop procedure t_TIMESTAMPLTZ_CLOB ;



call print_message('t_TIMESTAMPTZ_CLOB. This scenario is a failure.');
create or replace procedure t_TIMESTAMPTZ_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMPTZ_CLOB('TIMESTAMPTZ', 'CLOB'  ) ;
drop procedure t_TIMESTAMPTZ_CLOB ;



call print_message('t_DOUBLE_CLOB. This scenario is a failure.');
create or replace procedure t_DOUBLE_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DOUBLE_CLOB('DOUBLE', 'CLOB'  ) ;
drop procedure t_DOUBLE_CLOB ;



call print_message('t_FLOAT_CLOB. This scenario is a failure.');
create or replace procedure t_FLOAT_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_FLOAT_CLOB('FLOAT', 'CLOB'  ) ;
drop procedure t_FLOAT_CLOB ;



call print_message('t_NUMERIC(8,4)_CLOB. This scenario is a failure.');
create or replace procedure t_NUMERIC_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_NUMERIC_CLOB('NUMERIC(8,4)', 'CLOB'  ) ;
drop procedure t_NUMERIC_CLOB ;



call print_message('t_BIGINT_CLOB. This scenario is a failure.');
create or replace procedure t_BIGINT_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BIGINT_CLOB('BIGINT', 'CLOB'  ) ;
drop procedure t_BIGINT_CLOB ;



call print_message('t_INT_CLOB. This scenario is a failure.');
create or replace procedure t_INT_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_INT_CLOB('INT', 'CLOB'  ) ;
drop procedure t_INT_CLOB ;



call print_message('t_SHORT_CLOB. This scenario is a failure.');
create or replace procedure t_SHORT_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_SHORT_CLOB('SHORT', 'CLOB'  ) ;
drop procedure t_SHORT_CLOB ;



call print_message('t_BIT(8)_CLOB. This scenario is a failure.');
create or replace procedure t_BIT_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BIT_CLOB('BIT(8)', 'CLOB'  ) ;
drop procedure t_BIT_CLOB ;



call print_message('t_BIT VARYING_CLOB. This scenario is a failure.');
create or replace procedure t_BITVARYING_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BITVARYING_CLOB('BIT VARYING', 'CLOB'  ) ;
drop procedure t_BITVARYING_CLOB ;



call print_message('t_CHAR_CLOB. This scenario is a failure.');
create or replace procedure t_CHAR_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_CHAR_CLOB('CHAR', 'CLOB'  ) ;
drop procedure t_CHAR_CLOB ;



call print_message('t_VARCHAR_CLOB. This scenario is a failure.');
create or replace procedure t_VARCHAR_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_VARCHAR_CLOB('VARCHAR', 'CLOB'  ) ;
drop procedure t_VARCHAR_CLOB ;



call print_message('t_SET_CLOB. This scenario is a failure.');
create or replace procedure t_SET_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_SET_CLOB('SET', 'CLOB'  ) ;
drop procedure t_SET_CLOB ;



call print_message('t_MULTISET_CLOB. This scenario is a failure.');
create or replace procedure t_MULTISET_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_MULTISET_CLOB('MULTISET', 'CLOB'  ) ;
drop procedure t_MULTISET_CLOB ;



call print_message('t_LIST_CLOB. This scenario is a failure.');
create or replace procedure t_LIST_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_LIST_CLOB('LIST', 'CLOB'  ) ;
drop procedure t_LIST_CLOB ;



call print_message('t_ENUM_CLOB. This scenario is a failure.');
create or replace procedure t_ENUM_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_ENUM_CLOB('ENUM', 'CLOB'  ) ;
drop procedure t_ENUM_CLOB ;



call print_message('t_BLOB_CLOB. This scenario is a failure.');
create or replace procedure t_BLOB_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BLOB_CLOB('BLOB', 'CLOB'  ) ;
drop procedure t_BLOB_CLOB ;



call print_message('t_CLOB_CLOB. This scenario is a failure.');
create or replace procedure t_CLOB_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_CLOB_CLOB('CLOB', 'CLOB'  ) ;
drop procedure t_CLOB_CLOB ;



call print_message('t_JSON_CLOB. This scenario is a failure.');
create or replace procedure t_JSON_CLOB(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
