...
create or replace procedure t_DATETIME_FLOAT(param_type string, variables_type string ) as 
...
call t_DATETIME_FLOAT('DATETIME', 'FLOAT'  ) ;
drop procedure t_DATETIME_FLOAT ;



call print_message('t_DATETIMELTZ_FLOAT. This scenario is a failure.');
create or replace procedure t_DATETIMELTZ_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATETIMELTZ_FLOAT('DATETIMELTZ', 'FLOAT'  ) ;
drop procedure t_DATETIMELTZ_FLOAT ;



call print_message('t_DATETIMETZ_FLOAT. This scenario is a failure.');
create or replace procedure t_DATETIMETZ_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATETIMETZ_FLOAT('DATETIMETZ', 'FLOAT'  ) ;
drop procedure t_DATETIMETZ_FLOAT ;



call print_message('t_DATE_FLOAT. This scenario is a failure.');
create or replace procedure t_DATE_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATE_FLOAT('DATE', 'FLOAT'  ) ;
drop procedure t_DATE_FLOAT ;



call print_message('t_TIME_FLOAT. This scenario is a failure.');
create or replace procedure t_TIME_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIME_FLOAT('TIME', 'FLOAT'  ) ;
drop procedure t_TIME_FLOAT ;



call print_message('t_TIMESTAMP_FLOAT. This scenario is a failure.');
create or replace procedure t_TIMESTAMP_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMP_FLOAT('TIMESTAMP', 'FLOAT'  ) ;
drop procedure t_TIMESTAMP_FLOAT ;



call print_message('t_TIMESTAMPLTZ_FLOAT. This scenario is a failure.');
create or replace procedure t_TIMESTAMPLTZ_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMPLTZ_FLOAT('TIMESTAMPLTZ', 'FLOAT'  ) ;
drop procedure t_TIMESTAMPLTZ_FLOAT ;



call print_message('t_TIMESTAMPTZ_FLOAT. This scenario is a failure.');
create or replace procedure t_TIMESTAMPTZ_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMPTZ_FLOAT('TIMESTAMPTZ', 'FLOAT'  ) ;
drop procedure t_TIMESTAMPTZ_FLOAT ;



call print_message('t_DOUBLE_FLOAT. This scenario is a success.');
create or replace procedure t_DOUBLE_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DOUBLE_FLOAT('DOUBLE', 'FLOAT'  ) ;
drop procedure t_DOUBLE_FLOAT ;



call print_message('t_FLOAT_FLOAT. This scenario is a success.');
create or replace procedure t_FLOAT_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_FLOAT_FLOAT('FLOAT', 'FLOAT'  ) ;
drop procedure t_FLOAT_FLOAT ;

--BUG

call print_message('t_NUMERIC_FLOAT. This scenario is a success.');
create or replace procedure t_NUMERIC_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_NUMERIC_FLOAT('NUMERIC(8,4)', 'FLOAT'  ) ;
drop procedure t_NUMERIC_FLOAT ;



call print_message('t_BIGINT_FLOAT. This scenario is a success.');
create or replace procedure t_BIGINT_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BIGINT_FLOAT('BIGINT', 'FLOAT'  ) ;
drop procedure t_BIGINT_FLOAT ;



call print_message('t_INT_FLOAT. This scenario is a success.');
create or replace procedure t_INT_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_INT_FLOAT('INT', 'FLOAT'  ) ;
drop procedure t_INT_FLOAT ;



call print_message('t_SHORT_FLOAT. This scenario is a success.');
create or replace procedure t_SHORT_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_SHORT_FLOAT('SHORT', 'FLOAT'  ) ;
drop procedure t_SHORT_FLOAT ;



call print_message('t_BIT(8)_FLOAT. This scenario is a failure.');
create or replace procedure t_BIT_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BIT_FLOAT('BIT(8)', 'FLOAT'  ) ;
drop procedure t_BIT_FLOAT ;



call print_message('t_BIT VARYING_FLOAT. This scenario is a failure.');
create or replace procedure t_BITVARYING_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BITVARYING_FLOAT('BIT VARYING', 'FLOAT'  ) ;
drop procedure t_BITVARYING_FLOAT ;



call print_message('t_CHAR_FLOAT. This scenario is a success.');
create or replace procedure t_CHAR_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_CHAR_FLOAT('CHAR', 'FLOAT'  ) ;
drop procedure t_CHAR_FLOAT ;



call print_message('t_VARCHAR_FLOAT. This scenario is a success.');
create or replace procedure t_VARCHAR_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
          SELECT T_VARCHAR_NUMBER as col_val FROM plcsql_type_tbl WHERE ID = 1 ;
...
call t_VARCHAR_FLOAT('VARCHAR', 'FLOAT'  ) ;
drop procedure t_VARCHAR_FLOAT ;



call print_message('t_SET_FLOAT. This scenario is a failure.');
create or replace procedure t_SET_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_SET_FLOAT('SET', 'FLOAT'  ) ;
drop procedure t_SET_FLOAT ;



call print_message('t_MULTISET_FLOAT. This scenario is a failure.');
create or replace procedure t_MULTISET_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_MULTISET_FLOAT('MULTISET', 'FLOAT'  ) ;
drop procedure t_MULTISET_FLOAT ;



call print_message('t_LIST_FLOAT. This scenario is a failure.');
create or replace procedure t_LIST_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_LIST_FLOAT('LIST', 'FLOAT'  ) ;
drop procedure t_LIST_FLOAT ;



call print_message('t_ENUM_FLOAT. This scenario is a failure.');
create or replace procedure t_ENUM_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_ENUM_FLOAT('ENUM', 'FLOAT'  ) ;
drop procedure t_ENUM_FLOAT ;



call print_message('t_BLOB_FLOAT. This scenario is a failure.');
create or replace procedure t_BLOB_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BLOB_FLOAT('BLOB', 'FLOAT'  ) ;
drop procedure t_BLOB_FLOAT ;



call print_message('t_CLOB_FLOAT. This scenario is a failure.');
create or replace procedure t_CLOB_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_CLOB_FLOAT('CLOB', 'FLOAT'  ) ;
drop procedure t_CLOB_FLOAT ;



call print_message('t_JSON_FLOAT. This scenario is a failure.');
create or replace procedure t_JSON_FLOAT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
