...
create or replace procedure t_DATETIME_BIT(param_type string, variables_type string ) as 
...
call t_DATETIME_BIT('DATETIME', 'BIT'  ) ;
drop procedure t_DATETIME_BIT ;



call print_message('t_DATETIMELTZ_BIT. This scenario is a failure.');
create or replace procedure t_DATETIMELTZ_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATETIMELTZ_BIT('DATETIMELTZ', 'BIT'  ) ;
drop procedure t_DATETIMELTZ_BIT ;



call print_message('t_DATETIMETZ_BIT. This scenario is a failure.');
create or replace procedure t_DATETIMETZ_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATETIMETZ_BIT('DATETIMETZ', 'BIT'  ) ;
drop procedure t_DATETIMETZ_BIT ;



call print_message('t_DATE_BIT. This scenario is a failure.');
create or replace procedure t_DATE_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATE_BIT('DATE', 'BIT'  ) ;
drop procedure t_DATE_BIT ;



call print_message('t_TIME_BIT. This scenario is a failure.');
create or replace procedure t_TIME_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIME_BIT('TIME', 'BIT'  ) ;
drop procedure t_TIME_BIT ;



call print_message('t_TIMESTAMP_BIT. This scenario is a failure.');
create or replace procedure t_TIMESTAMP_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMP_BIT('TIMESTAMP', 'BIT'  ) ;
drop procedure t_TIMESTAMP_BIT ;



call print_message('t_TIMESTAMPLTZ_BIT. This scenario is a failure.');
create or replace procedure t_TIMESTAMPLTZ_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMPLTZ_BIT('TIMESTAMPLTZ', 'BIT'  ) ;
drop procedure t_TIMESTAMPLTZ_BIT ;



call print_message('t_TIMESTAMPTZ_BIT. This scenario is a failure.');
create or replace procedure t_TIMESTAMPTZ_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMPTZ_BIT('TIMESTAMPTZ', 'BIT'  ) ;
drop procedure t_TIMESTAMPTZ_BIT ;



call print_message('t_DOUBLE_BIT. This scenario is a failure.');
create or replace procedure t_DOUBLE_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DOUBLE_BIT('DOUBLE', 'BIT'  ) ;
drop procedure t_DOUBLE_BIT ;



call print_message('t_FLOAT_BIT. This scenario is a failure.');
create or replace procedure t_FLOAT_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_FLOAT_BIT('FLOAT', 'BIT'  ) ;
drop procedure t_FLOAT_BIT ;



call print_message('t_NUMERIC(8,4)_BIT. This scenario is a failure.');
create or replace procedure t_NUMERIC_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_NUMERIC_BIT('NUMERIC(8,4)', 'BIT'  ) ;
drop procedure t_NUMERIC_BIT ;



call print_message('t_BIGINT_BIT. This scenario is a failure.');
create or replace procedure t_BIGINT_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BIGINT_BIT('BIGINT', 'BIT'  ) ;
drop procedure t_BIGINT_BIT ;



call print_message('t_INT_BIT. This scenario is a failure.');
create or replace procedure t_INT_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_INT_BIT('INT', 'BIT'  ) ;
drop procedure t_INT_BIT ;



call print_message('t_SHORT_BIT. This scenario is a failure.');
create or replace procedure t_SHORT_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_SHORT_BIT('SHORT', 'BIT'  ) ;
drop procedure t_SHORT_BIT ;



call print_message('t_BIT(8)_BIT. This scenario is a failure.');
create or replace procedure t_BIT_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BIT_BIT('BIT(8)', 'BIT'  ) ;
drop procedure t_BIT_BIT ;



call print_message('t_BIT VARYING_BIT. This scenario is a failure.');
create or replace procedure t_BITVARYING_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BITVARYING_BIT('BIT VARYING', 'BIT'  ) ;
drop procedure t_BITVARYING_BIT ;



call print_message('t_CHAR_BIT. This scenario is a failure.');
create or replace procedure t_CHAR_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
          SELECT T_BIT_BARYING as col_val FROM plcsql_type_tbl WHERE ID = 1 ;
...
call t_CHAR_BIT('CHAR', 'BIT'  ) ;
drop procedure t_CHAR_BIT ;



call print_message('t_VARCHAR_BIT. This scenario is a failure.');
create or replace procedure t_VARCHAR_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
          SELECT T_BIT_BARYING as col_val FROM plcsql_type_tbl WHERE ID = 1 ;
...
call t_VARCHAR_BIT('VARCHAR', 'BIT'  ) ;
drop procedure t_VARCHAR_BIT ;



call print_message('t_SET_BIT. This scenario is a failure.');
create or replace procedure t_SET_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_SET_BIT('SET', 'BIT'  ) ;
drop procedure t_SET_BIT ;



call print_message('t_MULTISET_BIT. This scenario is a failure.');
create or replace procedure t_MULTISET_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_MULTISET_BIT('MULTISET', 'BIT'  ) ;
drop procedure t_MULTISET_BIT ;



call print_message('t_LIST_BIT. This scenario is a failure.');
create or replace procedure t_LIST_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_LIST_BIT('LIST', 'BIT'  ) ;
drop procedure t_LIST_BIT ;



call print_message('t_ENUM_BIT. This scenario is a failure.');
create or replace procedure t_ENUM_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_ENUM_BIT('ENUM', 'BIT'  ) ;
drop procedure t_ENUM_BIT ;



call print_message('t_BLOB_BIT. This scenario is a failure.');
create or replace procedure t_BLOB_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BLOB_BIT('BLOB', 'BIT'  ) ;
drop procedure t_BLOB_BIT ;



call print_message('t_CLOB_BIT. This scenario is a failure.');
create or replace procedure t_CLOB_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_CLOB_BIT('CLOB', 'BIT'  ) ;
drop procedure t_CLOB_BIT ;



call print_message('t_JSON_BIT. This scenario is a failure.');
create or replace procedure t_JSON_BIT(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
