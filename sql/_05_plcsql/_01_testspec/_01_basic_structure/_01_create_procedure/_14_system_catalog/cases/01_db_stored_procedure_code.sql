--+ server-message on
-- Verified for CBRD-25227 with CBRD-24902, CBRD-25370
...
select
    name, if (created_time is not null,'no_problem','problem') as "created_time",
    owner, is_static, is_system_generated, stype, scode, otype,
    if (ocode is not null,'no_problem','problem') as "ocode"
