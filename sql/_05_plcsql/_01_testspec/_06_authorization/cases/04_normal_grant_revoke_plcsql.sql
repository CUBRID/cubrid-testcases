...
SELECT grantor_name, grantee_name, object_type, object_name, owner_name, auth_type, is_grantable FROM db_auth WHERE grantee_name = 'T1' ORDER BY object_name, auth_type;
SHOW GRANTS FOR T1;
