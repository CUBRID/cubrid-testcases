...
select 'This test throws an execution error. ( t_null, int )' ;
create or replace procedure t_exe_error_null_int( tc_comment string ) as 
begin 
...
call t_exe_error_null_int(' Integer Arithmetic operations : null, int ' ) ; 
drop procedure t_exe_error_null_int ; 
...
select 'This test throws an execution error. ( t_string, int )' ;
create or replace procedure t_exe_error_string_int( tc_comment string ) as 
begin 
...
call t_exe_error_string_int(' Integer Arithmetic operations : string, int ' ) ; 
drop procedure t_exe_error_string_int ; 
...
select 'This test throws an execution error. ( t_short, int )' ;
create or replace procedure t_exe_error_short_int( tc_comment string ) as 
begin 
...
call t_exe_error_short_int(' Integer Arithmetic operations : short, int ' ) ; 
drop procedure t_exe_error_short_int ; 
...
select 'This test throws an execution error. ( t_int, int )' ;
create or replace procedure t_exe_error_int_int( tc_comment string ) as 
begin 
...
call t_exe_error_int_int(' Integer Arithmetic operations : int, int ' ) ; 
drop procedure t_exe_error_int_int ; 
...
select 'This test throws an execution error. ( t_bigint, int )' ;
create or replace procedure t_exe_error_bigint_int( tc_comment string ) as 
begin 
...
call t_exe_error_bigint_int(' Integer Arithmetic operations : bigint, int ' ) ; 
drop procedure t_exe_error_bigint_int ; 
...
select 'This test throws an execution error. ( t_numeric, int )' ;
create or replace procedure t_exe_error_numeric_int( tc_comment string ) as 
begin 
...
call t_exe_error_numeric_int(' Integer Arithmetic operations : numeric, int ' ) ; 
drop procedure t_exe_error_numeric_int ; 
...
select 'This test throws an execution error. ( t_float, int )' ;
create or replace procedure t_exe_error_float_int( tc_comment string ) as 
begin 
...
call t_exe_error_float_int(' Integer Arithmetic operations : float, int ' ) ; 
drop procedure t_exe_error_float_int ; 
...
select 'This test throws an execution error. ( t_double, int )' ;
create or replace procedure t_exe_error_double_int( tc_comment string ) as 
begin 
...
call t_exe_error_double_int(' Integer Arithmetic operations : double, int ' ) ; 
drop procedure t_exe_error_double_int ; 
