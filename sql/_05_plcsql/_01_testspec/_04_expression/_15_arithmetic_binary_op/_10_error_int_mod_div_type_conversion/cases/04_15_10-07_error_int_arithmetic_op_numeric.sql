...
select 'This test throws an execution error. ( t_null, numeric )' ;
create or replace procedure t_exe_error_null_numeric( tc_comment string ) as 
begin 
...
call t_exe_error_null_numeric(' Integer Arithmetic operations : null, numeric ' ) ; 
drop procedure t_exe_error_null_numeric ; 
...
select 'This test throws an execution error. ( t_string, numeric )' ;
create or replace procedure t_exe_error_string_numeric( tc_comment string ) as 
begin 
...
call t_exe_error_string_numeric(' Integer Arithmetic operations : string, numeric ' ) ; 
drop procedure t_exe_error_string_numeric ; 
...
select 'This test throws an execution error. ( t_short, numeric )' ;
create or replace procedure t_exe_error_short_numeric( tc_comment string ) as 
begin 
...
call t_exe_error_short_numeric(' Integer Arithmetic operations : short, numeric ' ) ; 
drop procedure t_exe_error_short_numeric ; 
...
select 'This test throws an execution error. ( t_int, numeric )' ;
create or replace procedure t_exe_error_int_numeric( tc_comment string ) as 
begin 
...
call t_exe_error_int_numeric(' Integer Arithmetic operations : int, numeric ' ) ; 
drop procedure t_exe_error_int_numeric ; 
...
select 'This test throws an execution error. ( t_bigint, numeric )' ;
create or replace procedure t_exe_error_bigint_numeric( tc_comment string ) as 
begin 
...
call t_exe_error_bigint_numeric(' Integer Arithmetic operations : bigint, numeric ' ) ; 
drop procedure t_exe_error_bigint_numeric ; 
...
select 'This test throws an execution error. ( t_numeric, numeric )' ;
create or replace procedure t_exe_error_numeric_numeric( tc_comment string ) as 
begin 
...
call t_exe_error_numeric_numeric(' Integer Arithmetic operations : numeric, numeric ' ) ; 
drop procedure t_exe_error_numeric_numeric ; 
...
select 'This test throws an execution error. ( t_float, numeric )' ;
create or replace procedure t_exe_error_float_numeric( tc_comment string ) as 
begin 
...
call t_exe_error_float_numeric(' Integer Arithmetic operations : float, numeric ' ) ; 
drop procedure t_exe_error_float_numeric ; 
...
select 'This test throws an execution error. ( t_double, numeric )' ;
create or replace procedure t_exe_error_double_numeric( tc_comment string ) as 
begin 
...
call t_exe_error_double_numeric(' Integer Arithmetic operations : double, numeric ' ) ; 
drop procedure t_exe_error_double_numeric ; 
