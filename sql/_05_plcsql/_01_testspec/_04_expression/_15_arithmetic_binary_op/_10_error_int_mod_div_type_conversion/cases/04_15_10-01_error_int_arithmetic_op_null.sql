...
select 'This test throws an execution error. ( t_null, null )' ;
create or replace procedure t_exe_error_null_null( tc_comment string ) as 
begin 
...
call t_exe_error_null_null(' Integer Arithmetic operations : null, null ' ) ; 
drop procedure t_exe_error_null_null ; 
...
select 'This test throws an execution error. ( t_short, null )' ;
create or replace procedure t_exe_error_short_null( tc_comment string ) as 
begin 
...
call t_exe_error_short_null(' Integer Arithmetic operations : short, null ' ) ; 
drop procedure t_exe_error_short_null ; 
...
select 'This test throws an execution error. ( t_int, null )' ;
create or replace procedure t_exe_error_int_null( tc_comment string ) as 
begin 
...
call t_exe_error_int_null(' Integer Arithmetic operations : int, null ' ) ; 
drop procedure t_exe_error_int_null ; 
...
select 'This test throws an execution error. ( t_bigint, null )' ;
create or replace procedure t_exe_error_bigint_null( tc_comment string ) as 
begin 
...
call t_exe_error_bigint_null(' Integer Arithmetic operations : bigint, null ' ) ; 
drop procedure t_exe_error_bigint_null ; 
...
select 'This test throws an execution error. ( t_numeric, null )' ;
create or replace procedure t_exe_error_numeric_null( tc_comment string ) as 
begin 
...
call t_exe_error_numeric_null(' Integer Arithmetic operations : numeric, null ' ) ; 
drop procedure t_exe_error_numeric_null ; 
...
select 'This test throws an execution error. ( t_float, null )' ;
create or replace procedure t_exe_error_float_null( tc_comment string ) as 
begin 
...
call t_exe_error_float_null(' Integer Arithmetic operations : float, null ' ) ; 
drop procedure t_exe_error_float_null ; 
...
select 'This test throws an execution error. ( t_double, null )' ;
create or replace procedure t_exe_error_double_null( tc_comment string ) as 
begin 
...
call t_exe_error_double_null(' Integer Arithmetic operations : double, null ' ) ; 
drop procedure t_exe_error_double_null ; 
