...
select 'This test throws an execution error. ( t_null, bigint )' ;
create or replace procedure t_exe_error_null_bigint( tc_comment string ) as 
begin 
...
call t_exe_error_null_bigint(' Integer Arithmetic operations : null, bigint ' ) ; 
drop procedure t_exe_error_null_bigint ; 
...
select 'This test throws an execution error. ( t_string, bigint )' ;
create or replace procedure t_exe_error_string_bigint( tc_comment string ) as 
begin 
...
call t_exe_error_string_bigint(' Integer Arithmetic operations : string, bigint ' ) ; 
drop procedure t_exe_error_string_bigint ; 
...
select 'This test throws an execution error. ( t_short, bigint )' ;
create or replace procedure t_exe_error_short_bigint( tc_comment string ) as 
begin 
...
call t_exe_error_short_bigint(' Integer Arithmetic operations : short, bigint ' ) ; 
drop procedure t_exe_error_short_bigint ; 
...
select 'This test throws an execution error. ( t_int, bigint )' ;
create or replace procedure t_exe_error_int_bigint( tc_comment string ) as 
begin 
...
call t_exe_error_int_bigint(' Integer Arithmetic operations : int, bigint ' ) ; 
drop procedure t_exe_error_int_bigint ; 
...
select 'This test throws an execution error. ( t_bigint, bigint )' ;
create or replace procedure t_exe_error_bigint_bigint( tc_comment string ) as 
begin 
...
call t_exe_error_bigint_bigint(' Integer Arithmetic operations : bigint, bigint ' ) ; 
drop procedure t_exe_error_bigint_bigint ; 
...
select 'This test throws an execution error. ( t_numeric, bigint )' ;
create or replace procedure t_exe_error_numeric_bigint( tc_comment string ) as 
begin 
...
call t_exe_error_numeric_bigint(' Integer Arithmetic operations : numeric, bigint ' ) ; 
drop procedure t_exe_error_numeric_bigint ; 
...
select 'This test throws an execution error. ( t_float, bigint )' ;
create or replace procedure t_exe_error_float_bigint( tc_comment string ) as 
begin 
...
call t_exe_error_float_bigint(' Integer Arithmetic operations : float, bigint ' ) ; 
drop procedure t_exe_error_float_bigint ; 
...
select 'This test throws an execution error. ( t_double, bigint )' ;
create or replace procedure t_exe_error_double_bigint( tc_comment string ) as 
begin 
...
call t_exe_error_double_bigint(' Integer Arithmetic operations : double, bigint ' ) ; 
drop procedure t_exe_error_double_bigint ; 
