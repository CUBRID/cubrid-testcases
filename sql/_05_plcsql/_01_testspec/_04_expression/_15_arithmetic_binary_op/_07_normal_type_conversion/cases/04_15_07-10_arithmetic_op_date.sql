...
select 'This test is a normal run case. ( t_null, date )' ;
...
call t_null_date(' Arithmetic operations : null, date ' ) ; 
...
begin 
    ...
    dbms_output.put_line('right_date = ' ||NVL(right_date,'NULL')  ); 
    dbms_output.put_line('***************************************');
    dbms_output.put_line('left_boolean + right_date = '||left_boolean + right_date ) ; 
    dbms_output.put_line('');
end;
...
select 'This test is a normal run case. ( t_string, date )' ;
...
call t_string_date(' Arithmetic operations : string, date ' ) ; 
drop procedure t_string_date ; 



select 'This test is a normal run case. ( t_short, date )' ;
...
call t_short_date(' Arithmetic operations : short, date ' ) ; 
drop procedure t_short_date ; 



select 'This test is a normal run case. ( t_int, date )' ;
...
call t_int_date(' Arithmetic operations : int, date ' ) ; 
drop procedure t_int_date ; 



select 'This test is a normal run case. ( t_bigint, date )' ;
...
call t_bigint_date(' Arithmetic operations : bigint, date ' ) ; 
drop procedure t_bigint_date ; 



select 'This test is a normal run case. ( t_numeric, date )' ;
...
call t_numeric_date(' Arithmetic operations : numeric, date ' ) ; 
drop procedure t_numeric_date ; 



select 'This test is a normal run case. ( t_float, date )' ;
...
call t_float_date(' Arithmetic operations : float, date ' ) ; 
drop procedure t_float_date ; 



select 'This test is a normal run case. ( t_double, date )' ;
...
call t_double_date(' Arithmetic operations : double, date ' ) ; 
drop procedure t_double_date ; 



select 'This test is a normal run case. ( t_date, date )' ;
...
call t_date_date(' Arithmetic operations : date, date ' ) ; 
...
begin 
    ...
    dbms_output.put_line('right_date = ' ||NVL(right_date,'NULL')  ); 
    dbms_output.put_line('***************************************');
    dbms_output.put_line('left_time + right_date = '||left_time + right_date ) ; 
    dbms_output.put_line('');
end;
...
select 'This test is a normal run case. ( t_datetime, date )' ;
...
call t_datetime_date(' Arithmetic operations : datetime, date ' ) ; 
drop procedure t_datetime_date ; 



select 'This test is a normal run case. ( t_timestamp, date )' ;
...
call t_timestamp_date(' Arithmetic operations : timestamp, date ' ) ; 
...
begin 
    ...
    dbms_output.put_line('right_date = ' ||NVL(right_date,'NULL')  ); 
    dbms_output.put_line('***************************************');
    dbms_output.put_line('left_sys_refcursor + right_date = '||left_sys_refcursor + right_date ) ; 
    dbms_output.put_line('');
end;
...
begin 
    ...
    dbms_output.put_line('right_date = ' ||NVL(right_date,'NULL')  ); 
    dbms_output.put_line('***************************************');
    dbms_output.put_line('left_cursor + right_date = '||left_cursor + right_date ) ; 
    dbms_output.put_line('');
end;
