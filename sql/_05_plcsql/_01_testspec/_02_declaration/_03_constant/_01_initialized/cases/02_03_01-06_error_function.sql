...
create or replace procedure t  as
    a constant date := to_date('2012-13-28', 'YYYY-MM-DD') + 7 ;
begin
...
--create OK. run error.
create or replace procedure t  as
    a constant string := to_char(to_datetime('2012-11-28 23:59:61', 'YYYY-MM-DD HH24:MI:SS')+1000, 'YYYY-MM-DD HH24:MI:SS' );
begin
    dbms_output.put_line('a =' || a );
end;
call t();
...
-- run error.
create or replace procedure t  as
    a constant varchar := lpad('4', 5, '0','abc');
begin
    dbms_output.put_line('a = ' || a );
end;
