...
create or replace procedure t_DATETIME_TIMESTAMPLTZ(param_type string, variables_type string, param DATETIME ) as 
...
create or replace procedure t_DATETIMELTZ_TIMESTAMPLTZ(param_type string, variables_type string, param DATETIMELTZ ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_DATETIMETZ_TIMESTAMPLTZ(param_type string, variables_type string, param DATETIMETZ ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_DATE_TIMESTAMPLTZ(param_type string, variables_type string, param DATE ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_TIME_TIMESTAMPLTZ(param_type string, variables_type string, param TIME ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_TIMESTAMP_TIMESTAMPLTZ(param_type string, variables_type string, param TIMESTAMP ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_TIMESTAMPLTZ_TIMESTAMPLTZ(param_type string, variables_type string, param TIMESTAMPLTZ ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_TIMESTAMPTZ_TIMESTAMPLTZ(param_type string, variables_type string, param TIMESTAMPTZ ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_DOUBLE_TIMESTAMPLTZ(param_type string, variables_type string, param DOUBLE ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_FLOAT_TIMESTAMPLTZ(param_type string, variables_type string, param FLOAT ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
call t_FLOAT_TIMESTAMPLTZ('FLOAT', 'TIMESTAMPLTZ', cast( 1677.217 as float ) ) ;
...
create or replace procedure t_BIGINT_TIMESTAMPLTZ(param_type string, variables_type string, param BIGINT ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_INT_TIMESTAMPLTZ(param_type string, variables_type string, param INT ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_SHORT_TIMESTAMPLTZ(param_type string, variables_type string, param SHORT ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_BITVARYING_TIMESTAMPLTZ(param_type string, variables_type string, param BIT VARYING ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_CHAR_TIMESTAMPLTZ(param_type string, variables_type string, param CHAR ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_VARCHAR_TIMESTAMPLTZ(param_type string, variables_type string, param VARCHAR ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_SET_TIMESTAMPLTZ(param_type string, variables_type string, param SET ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_MULTISET_TIMESTAMPLTZ(param_type string, variables_type string, param MULTISET ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_LIST_TIMESTAMPLTZ(param_type string, variables_type string, param LIST ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_ENUM_TIMESTAMPLTZ(param_type string, variables_type string, param ENUM ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_BLOB_TIMESTAMPLTZ(param_type string, variables_type string, param BLOB ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_CLOB_TIMESTAMPLTZ(param_type string, variables_type string, param CLOB ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
...
create or replace procedure t_JSON_TIMESTAMPLTZ(param_type string, variables_type string, param JSON ) as 
VAR TIMESTAMPLTZ := param ;
VAR1 TIMESTAMPLTZ  ;
begin
VAR1 := VAR ;
