...
create or replace procedure t_DATETIME_BITVARYING(param_type string, variables_type string ) as 
...
call t_DATETIME_BITVARYING('DATETIME', 'BIT VARYING'  ) ;
drop procedure t_DATETIME_BITVARYING ;



call print_message('t_DATETIMELTZ_BIT VARYING. This scenario is a failure.');
create or replace procedure t_DATETIMELTZ_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATETIMELTZ_BITVARYING('DATETIMELTZ', 'BIT VARYING'  ) ;
drop procedure t_DATETIMELTZ_BITVARYING ;



call print_message('t_DATETIMETZ_BIT VARYING. This scenario is a failure.');
create or replace procedure t_DATETIMETZ_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATETIMETZ_BITVARYING('DATETIMETZ', 'BIT VARYING'  ) ;
drop procedure t_DATETIMETZ_BITVARYING ;



call print_message('t_DATE_BIT VARYING. This scenario is a failure.');
create or replace procedure t_DATE_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DATE_BITVARYING('DATE', 'BIT VARYING'  ) ;
drop procedure t_DATE_BITVARYING ;



call print_message('t_TIME_BIT VARYING. This scenario is a failure.');
create or replace procedure t_TIME_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIME_BITVARYING('TIME', 'BIT VARYING'  ) ;
drop procedure t_TIME_BITVARYING ;



call print_message('t_TIMESTAMP_BIT VARYING. This scenario is a failure.');
create or replace procedure t_TIMESTAMP_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMP_BITVARYING('TIMESTAMP', 'BIT VARYING'  ) ;
drop procedure t_TIMESTAMP_BITVARYING ;



call print_message('t_TIMESTAMPLTZ_BIT VARYING. This scenario is a failure.');
create or replace procedure t_TIMESTAMPLTZ_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMPLTZ_BITVARYING('TIMESTAMPLTZ', 'BIT VARYING'  ) ;
drop procedure t_TIMESTAMPLTZ_BITVARYING ;



call print_message('t_TIMESTAMPTZ_BIT VARYING. This scenario is a failure.');
create or replace procedure t_TIMESTAMPTZ_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_TIMESTAMPTZ_BITVARYING('TIMESTAMPTZ', 'BIT VARYING'  ) ;
drop procedure t_TIMESTAMPTZ_BITVARYING ;



call print_message('t_DOUBLE_BIT VARYING. This scenario is a failure.');
create or replace procedure t_DOUBLE_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_DOUBLE_BITVARYING('DOUBLE', 'BIT VARYING'  ) ;
drop procedure t_DOUBLE_BITVARYING ;



call print_message('t_FLOAT_BIT VARYING. This scenario is a failure.');
create or replace procedure t_FLOAT_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_FLOAT_BITVARYING('FLOAT', 'BIT VARYING'  ) ;
drop procedure t_FLOAT_BITVARYING ;



call print_message('t_NUMERIC(8,4)_BIT VARYING. This scenario is a failure.');
create or replace procedure t_NUMERIC_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_NUMERIC_BITVARYING('NUMERIC(8,4)', 'BIT VARYING'  ) ;
drop procedure t_NUMERIC_BITVARYING ;



call print_message('t_BIGINT_BIT VARYING. This scenario is a failure.');
create or replace procedure t_BIGINT_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BIGINT_BITVARYING('BIGINT', 'BIT VARYING'  ) ;
drop procedure t_BIGINT_BITVARYING ;



call print_message('t_INT_BIT VARYING. This scenario is a failure.');
create or replace procedure t_INT_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_INT_BITVARYING('INT', 'BIT VARYING'  ) ;
drop procedure t_INT_BITVARYING ;



call print_message('t_SHORT_BIT VARYING. This scenario is a failure.');
create or replace procedure t_SHORT_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_SHORT_BITVARYING('SHORT', 'BIT VARYING'  ) ;
drop procedure t_SHORT_BITVARYING ;



call print_message('t_BIT(8)_BIT VARYING. This scenario is a failure.');
create or replace procedure t_BIT_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BIT_BITVARYING('BIT(8)', 'BIT VARYING'  ) ;
drop procedure t_BIT_BITVARYING ;



call print_message('t_BIT VARYING_BIT VARYING. This scenario is a failure.');
create or replace procedure t_BITVARYING_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BITVARYING_BITVARYING('BIT VARYING', 'BIT VARYING'  ) ;
drop procedure t_BITVARYING_BITVARYING ;



call print_message('t_CHAR_BIT VARYING. This scenario is a failure.');
create or replace procedure t_CHAR_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_CHAR_BITVARYING('CHAR', 'BIT VARYING'  ) ;
drop procedure t_CHAR_BITVARYING ;



call print_message('t_VARCHAR_BIT VARYING. This scenario is a failure.');
create or replace procedure t_VARCHAR_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_VARCHAR_BITVARYING('VARCHAR', 'BIT VARYING'  ) ;
drop procedure t_VARCHAR_BITVARYING ;



call print_message('t_SET_BIT VARYING. This scenario is a failure.');
create or replace procedure t_SET_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_SET_BITVARYING('SET', 'BIT VARYING'  ) ;
drop procedure t_SET_BITVARYING ;



call print_message('t_MULTISET_BIT VARYING. This scenario is a failure.');
create or replace procedure t_MULTISET_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_MULTISET_BITVARYING('MULTISET', 'BIT VARYING'  ) ;
drop procedure t_MULTISET_BITVARYING ;



call print_message('t_LIST_BIT VARYING. This scenario is a failure.');
create or replace procedure t_LIST_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_LIST_BITVARYING('LIST', 'BIT VARYING'  ) ;
drop procedure t_LIST_BITVARYING ;



call print_message('t_ENUM_BIT VARYING. This scenario is a failure.');
create or replace procedure t_ENUM_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_ENUM_BITVARYING('ENUM', 'BIT VARYING'  ) ;
drop procedure t_ENUM_BITVARYING ;



call print_message('t_BLOB_BIT VARYING. This scenario is a failure.');
create or replace procedure t_BLOB_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_BLOB_BITVARYING('BLOB', 'BIT VARYING'  ) ;
drop procedure t_BLOB_BITVARYING ;



call print_message('t_CLOB_BIT VARYING. This scenario is a failure.');
create or replace procedure t_CLOB_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_CLOB_BITVARYING('CLOB', 'BIT VARYING'  ) ;
drop procedure t_CLOB_BITVARYING ;



call print_message('t_JSON_BIT VARYING. This scenario is a failure.');
create or replace procedure t_JSON_BITVARYING(param_type string, variables_type string ) as 
     CURSOR my_cursor1 IS 
...
call t_JSON_BITVARYING('JSON', 'BIT VARYING'  ) ;
