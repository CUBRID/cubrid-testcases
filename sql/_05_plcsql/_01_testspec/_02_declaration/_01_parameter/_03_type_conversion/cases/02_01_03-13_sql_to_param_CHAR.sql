...
call t_SET_CHAR('SET', 'CHAR', cast( {'c','c','c','b','b','a'} as SET) ) ;
...
call t_MULTISET_CHAR('MULTISET', 'CHAR', cast( {'c','c','c','b','b','a'} as MULTISET) ) ;
...
select t_ENUM_CHAR( 'ENUM', 'CHAR', color ) from enum_tbl;
