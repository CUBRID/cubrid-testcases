...
create or replace procedure t_DATETIME_TIME(sql_type string, procedure_type string, param TIME ) as begin
...
create or replace procedure t_DATETIMELTZ_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_DATETIMETZ_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_TIME_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_TIMESTAMP_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_TIMESTAMPLTZ_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_TIMESTAMPTZ_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
call t_SHORT_TIME('SHORT', 'TIME', cast( 8934 as short ) ) ;
drop procedure t_SHORT_TIME ;


call print_message('t_BIT(8)_TIME. This scenario is a failure.');
create or replace procedure t_BIT_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_BITVARYING_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_CHAR_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_VARCHAR_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_SET_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_MULTISET_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_LIST_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_ENUM_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_BLOB_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_CLOB_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
...
create or replace procedure t_JSON_TIME(sql_type string, procedure_type string, param TIME ) as begin
    dbms_output.put_line('sql_type = ' ||sql_type ||', procedure_type = '||procedure_type||', current_value = '|| param ); 
end;
