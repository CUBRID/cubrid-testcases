...
ALTER TABLE [t_parent] ADD CONSTRAINT PRIMARY KEY([id]); -- Fail
SHOW CREATE TABLE [t_parent];
...
[id] INTEGER NOT NULL PRIMARY KEY,
[val] CHARACTER VARYING(11));
ALTER TABLE [t_parent] ADD INDEX [ix_id_de12]([id]) WITH DEDUPLICATE=12; -- Fail
SHOW CREATE TABLE [t_parent];

ALTER TABLE [t_parent] DROP PRIMARY KEY;
ALTER TABLE [t_parent] ADD UNIQUE INDEX [ux_id]([id]);
ALTER TABLE [t_parent] ADD UNIQUE INDEX [ux_id]([id]) WITH DEDUPLICATE=14; -- Fail
