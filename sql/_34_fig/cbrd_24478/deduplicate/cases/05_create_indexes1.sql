...
SELECT index_of.index_name, key_attr_name, key_order, asc_desc FROM _db_index_key WHERE index_of.index_name like 'ix_val_pid_de%'
...
SELECT index_of.index_name, key_attr_name, key_order, asc_desc FROM _db_index_key WHERE index_of.index_name = 'ix_val_pid_de11'
ORDER BY index_of.class_of.class_name, key_order;
SHOW CREATE TABLE t_child;
...
SELECT index_of.index_name, key_attr_name, key_order, asc_desc FROM _db_index_key WHERE index_of.index_name = 'ix_val_pid_de12'
ORDER BY index_of.class_of.class_name, key_order;
SHOW CREATE TABLE t_child;
...
SELECT index_of.index_name, key_attr_name, key_order, asc_desc, func FROM _db_index_key WHERE index_of.index_name = 'ix_val_pid_de13' ORDER BY index_of.class_of.class_name, key_order;;
SHOW CREATE TABLE t_child;
...
SELECT index_of.index_name, key_attr_name, key_order, asc_desc, func, index_of.filter_expression FROM _db_index_key WHERE index_of.index_name = 'ix_val_pid_de14' ORDER BY index_of.class_of.class_name, key_order;x;
SHOW CREATE TABLE t_child;
