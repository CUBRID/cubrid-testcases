...
alter table t_child add column parenta_col_a int references t_parenta (col_a); /* null */
alter table t_child add column parentb_col_a int references t_parentb (col_a); /* null */
