--test operators seteq, subset, superset, superseteq with set(multiset,list) of nchar VARYING.
create class tb ( a set(nchar VARYING(3)), b multiset(nchar VARYING(3)), c list(nchar VARYING(3)));
