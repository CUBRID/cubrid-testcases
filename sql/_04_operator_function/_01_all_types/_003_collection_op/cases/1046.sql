--test operators seteq, subset, superset, superseteq,subseteq, superseteq, setneq with multiset(bit) and multiset(bit varying)
create class tb1 ( a multiset(bit(8)));
create class tb2 ( b multiset(bit VARYING(8)));
