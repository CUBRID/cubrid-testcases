--test operators seteq, subset, superset, superseteq with set(multiset,list) of bit VARYING
create class tb ( a set(bit VARYING(8)), b multiset(bit VARYING(8)) , c list(bit VARYING(8)));
