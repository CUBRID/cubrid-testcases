--test operators seteq, subset, superset, superseteq with set(multiset,list) of monetary
create class tb ( a set of monetary, b multiset of monetary , c list of monetary );
