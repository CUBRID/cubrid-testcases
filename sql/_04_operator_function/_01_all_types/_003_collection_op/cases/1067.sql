--test operators seteq, subset, superset, superseteq,subseteq, superseteq, setneq with multiset(monetary) and multiset(double)
create class tb1 ( a multiset(monetary));
