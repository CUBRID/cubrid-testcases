--test operators seteq, subset, superset, superseteq with set(multiset,list) of numeric
create class tb ( a set of numeric, b multiset of numeric , c list of numeric );
