--test operators seteq, subset, superset, superseteq,subseteq, superseteq, setneq with set(integer) and set(smallint)
create class tb1 ( a set(integer));
create class tb2 ( b set(smallint));
