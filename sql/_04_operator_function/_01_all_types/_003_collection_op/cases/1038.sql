--test operators seteq, subset, superset, superseteq,subseteq, superseteq, setneq with set(nchar) and set(nchar varying)
create class tb1 ( a set(nchar(2)));
create class tb2 ( b set(nchar VARYING(2)));
