--+ holdcas on;
--[er]test the union all keyword with 2 tables whose number of columns are unmatched.
...
select * from DML_0001 union all select * from DML_0001 union all select * from DML_0003 order by 1;
