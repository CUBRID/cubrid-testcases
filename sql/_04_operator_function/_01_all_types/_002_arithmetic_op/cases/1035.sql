--test operators intersection, difference, union with 3 select queries and  cast function used for int type casting.
...
select  cast(b as int) from func_13 intersection select cast(c as int) from func_13 order by 1;
	
select  cast(b as int) from func_13 difference select cast(c as int) from func_13 order by 1;

select  cast(b as int) from func_13 union select cast(c as int) from func_13 order by 1;
