--test difference, intersection operators with 2 select queries and cast function used for int type casting
...
select  na from func_13 difference select cast(a as int) from func_13 order by 1;

select  na from func_13 intersection select cast(a as int) from func_13 order by 1;
