--test union all operator with 2 select queries and a table.
...
(select * from func_13 union all select * from func_13)  order by 1,2,3,4,5;

(select a from func_13 union all select a from func_13)  order by 1;
