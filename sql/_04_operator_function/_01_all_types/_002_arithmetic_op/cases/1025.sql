--test operators difference, intersection, union with 4 select queries and a table.
...
(select * from func_13 difference select * from func_13 ) order by 1,2,3,4,5;
(select * from func_13 intersection select * from func_13 ) order by 1,2,3,4,5;
(select * from func_13 union select * from func_13)  order by 1,2,3,4,5;
(select * from func_13 difference distinct select * from func_13)  order by 1,2,3,4,5;
