--[er]test intersection operator using two subqueries whose column is compatible
...
select  a from func_13 intersection select cast(a as int) from func_13 order by 1;
