...
--[er]test union keywords with two select statements with different number of selected coloums
--+ holdcas on;
...
select int_col from DML_0001 union select int_col, var_col from DML_0002 order by 1;
