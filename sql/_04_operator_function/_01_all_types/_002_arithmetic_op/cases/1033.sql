--test operators difference, intersection, union with 3 select queries and cast function used for smallint type casting
...
select  b from func_13 difference select cast(c as smallint) from func_13 order by 1;

select  b from func_13 intersection select cast(c as smallint) from func_13 order by 1;	

select  b from func_13 union select cast(c as smallint) from func_13 order by 1;
