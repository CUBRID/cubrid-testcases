--test nchar data type by casting nchar data type to nchar(n),nchar varying(n) data type
...
select nchartest from func_03 order by 1;	
select cast(nchartest as nchar(20)) from func_03 order by 1;	
select cast(nchartest as nchar varying(20)) from func_03 order by 1;
