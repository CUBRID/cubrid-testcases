--[er]test nchar data type by casting list{nchartype} data type to list of string data type
...
select cast(list{nchartest} as list of string) from func_03 order by 1;
