-- insert data  whith create range partition table on a time field witch using function of cast as char and then query all partitions and drop table
...
create table range_test(id int,	
	...
	PARTITION p1 VALUES LESS THAN ('15:00:00'),
	PARTITION p2 VALUES LESS THAN ('18:00:00'),
	PARTITION p3 VALUES LESS THAN ('21:00:00'),
