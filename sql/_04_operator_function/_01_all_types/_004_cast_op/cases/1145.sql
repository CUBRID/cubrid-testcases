--[er]test cast function by casting set{chartypefield} to set of string ,multiset{chartypefield} to multiset of string,list{chartypefield} to list of string data type
...
select cast(set{chartest} as set of string) from func_03	 order by 1;
select cast(multiset{chartest} as multiset of string) from func_03	 order by 1;
select cast(list{chartest} as list of string) from func_03 order by 1;
