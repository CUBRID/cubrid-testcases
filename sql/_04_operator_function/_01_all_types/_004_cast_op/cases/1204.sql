--[er]test cast function by casting multiset{nchar varying }data type to multiset of string data type
...
select cast(multiset{ncharvartest} as multiset of string) from func_03 order by 1;
