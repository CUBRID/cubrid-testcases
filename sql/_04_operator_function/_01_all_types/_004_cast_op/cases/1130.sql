--[er]test cast function by casting double data type to multiset of string data type 
...
select cast(doublepretest as multiset of string) from func_03 order by 1;
