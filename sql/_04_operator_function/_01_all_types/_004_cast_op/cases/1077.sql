--test cast function by casting char data type to string,varchar(n),char(n) data type 
...
select chartest from func_03 order by 1;	
select cast(chartest as string) from func_03	 order by 1;
select cast(chartest as varchar(10)) from func_03 order by 1;	
select cast(chartest as varchar(20)) from func_03 order by 1;	
select cast(chartest as char(8)) from func_03 order by 1;
