--[er]test nchar data type by casting multiset{nchartype} data type to multiset of string data type
...
select cast(multiset{nchartest} as multiset of string) from func_03 order by 1;
