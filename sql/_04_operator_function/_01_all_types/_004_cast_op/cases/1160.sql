--[er]test cast function by casting bit date type to list of string data type in select clause
...
select cast(bittest as list of string) from func_03 order by 1;
