--[er]test cast function by casting varchar to list of string data type in select clause
...
select cast(varchartest as list of string) from func_03 order by 1;
