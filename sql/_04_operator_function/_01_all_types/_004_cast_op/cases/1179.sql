--[er]test cast function by casting varchar to nchar varying(n) data type in select clause
...
select cast(varchartest as nchar varying(20)) from func_03 order by 1;
