--[er]test cast function by casting bit date type to set of string data type in select clause
...
select cast(bittest as set of string) from func_03 order by 1;
