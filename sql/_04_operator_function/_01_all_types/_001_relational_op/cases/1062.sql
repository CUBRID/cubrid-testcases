--[er]compare timestamp  and date data type value by comparison operator '<>'
...
select datetest, timetest, timestamptest from func_01 where timestamptest <> datetest order by 1,2,3;
