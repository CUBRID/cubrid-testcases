--[er]compare timestamp  and time data type value by comparison operator '>'
...
select datetest, timetest, timestamptest from func_01 where timestamptest > timetest order by 1,2,3;
