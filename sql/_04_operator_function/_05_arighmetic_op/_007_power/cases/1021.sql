--+ holdcas on;
--[er]test power( numeric, x) with x={numeric}
...
select power(test_numeric, test_numeric) from test_number order by 1;

set system parameters 'compat_mode=mysql';
select to_char(power(test_numeric, test_numeric),'9.9999999EEEE') from test_number order by 1;
