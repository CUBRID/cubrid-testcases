--+ holdcas on;
--test power( smallint, x) with x={smallint, int}
...
select power(test_smallint, test_smallint) from test_number order by 1;
select power(test_smallint, test_int) from test_number order by 1;
