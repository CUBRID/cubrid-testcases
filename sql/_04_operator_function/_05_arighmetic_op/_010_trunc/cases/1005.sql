--test trunc(double, x) with x={smallint, int}
...
select trunc(test_double, test_smallint) from test_number order by 1;
select trunc(test_double, test_int) from test_number order by 1;
