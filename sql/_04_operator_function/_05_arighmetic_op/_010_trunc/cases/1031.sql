--test trunc(smallint, x) with x={smallint, int}
...
select trunc(test_smallint, test_smallint) from test_number order by 1;
select trunc(test_smallint, test_int) from test_number order by 1;
