--test round( real, x) with x={smallint, int}
...
select round(test_real, test_smallint) from test_number order by 1;
select round(test_real, test_int) from test_number order by 1;
