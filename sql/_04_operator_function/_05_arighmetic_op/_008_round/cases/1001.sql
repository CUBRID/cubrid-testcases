--test round(integer, x) with int type
...
select round(test_int, test_smallint) from test_number order by 1;
select round(test_int, test_int) from test_number order by 1;
