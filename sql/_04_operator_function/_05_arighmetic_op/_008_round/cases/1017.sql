--test round( numeric, x) with x={smallint, int}
...
--select round(test_numeric, test_smallint) from test_number order by 1;
select round(test_numeric, test_int) from test_number order by 1;
