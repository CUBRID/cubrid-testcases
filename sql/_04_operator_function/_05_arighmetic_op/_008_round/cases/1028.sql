--test round( smallint, x) with x={smallint, int}
...
select round(test_smallint, test_smallint) from test_number order by 1;
select round(test_smallint, test_int) from test_number order by 1;
