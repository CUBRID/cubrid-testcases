--test mod(float,x) with x¡Êfloat, double, real, numeric, monetary, smallint, int}
...
select mod(test_float, test_float) from test_number order by 1;
select mod(test_float, test_double) from test_number order by 1;
select mod(test_float, test_real) from test_number order by 1;
select mod(test_float, test_numeric) from test_number order by 1;
select mod(test_float, test_monetary) from test_number order by 1;
select mod(test_float, test_smallint) from test_number order by 1;
select mod(test_float, test_int) from test_number order by 1;
