--test mod(int,x) with x¡Êfloat, double, real, numeric, monetary, smallint, int}
...
select mod(test_int, test_float) from test_number order by 1;
select mod(test_int, test_double) from test_number order by 1;
select mod(test_int, test_real) from test_number order by 1;
select mod(test_int, test_numeric) from test_number order by 1;
select mod(test_int, test_monetary) from test_number order by 1;
select mod(test_int, test_smallint) from test_number order by 1;
select mod(test_int, test_int) from test_number order by 1;
