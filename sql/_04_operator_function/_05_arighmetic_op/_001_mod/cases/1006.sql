--test mod(double,x) with x¡Êfloat, double, real, numeric, monetary, smallint, int}
...
select mod(test_double, test_float) from test_number order by 1;
select mod(test_double, test_double) from test_number order by 1;
select mod(test_double, test_real) from test_number order by 1;
--select mod(test_double, test_numeric) from test_number order by 1;
select mod(test_double, test_monetary) from test_number order by 1;
select mod(test_double, test_smallint) from test_number order by 1;
select mod(test_double, test_int) from test_number order by 1;
