--test mod(real,x) with x¡Êfloat, double, real, numeric, monetary, smallint, int}
...
select mod(test_real, test_float) from test_number order by 1;
select mod(test_real, test_double) from test_number order by 1;
select mod(test_real, test_real) from test_number order by 1;
select mod(test_real, test_numeric) from test_number order by 1;
select mod(test_real, test_monetary) from test_number order by 1;
select mod(test_real, test_smallint) from test_number order by 1;
select mod(test_real, test_int) from test_number order by 1;
