--test mod(monetary,x) with x¡Êfloat, double, real, numeric, monetary, smallint, int}
...
select mod(test_monetary, test_float) from test_number order by 1;
select mod(test_monetary, test_double) from test_number order by 1;
select mod(test_monetary, test_real) from test_number order by 1;
select mod(test_monetary, test_numeric) from test_number order by 1;
select mod(test_monetary, test_monetary) from test_number order by 1;
select mod(test_monetary, test_smallint) from test_number order by 1;
select mod(test_monetary, test_int) from test_number order by 1;
