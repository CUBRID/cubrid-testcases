-- insert data  whith create range partition table on a smallint field witch using function of to_char and then query all partitions and drop table

create table range_test(id int,
			test_int int,
			test_smallint smallint, 
            primary key(id, test_smallint))
		PARTITION BY RANGE (to_char(test_smallint)) (
