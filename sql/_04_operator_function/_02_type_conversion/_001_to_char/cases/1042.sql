-- create table of hash partition having size 4 on samllint field that using to_char function and query all partitions

create table hash_test(id int,
			test_int int,
			test_smallint smallint,
            primary key(id, test_smallint))
		PARTITION BY HASH (to_char(test_smallint))
		PARTITIONS 4;
