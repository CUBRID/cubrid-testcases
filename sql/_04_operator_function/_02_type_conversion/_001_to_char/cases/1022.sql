...
-- retrieve by function of to_char using parameter of smallint field and using parameter of 'null' format_argument
...
select a,to_char(a), to_char(a,null) from func_04 order by 1;
