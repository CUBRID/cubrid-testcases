...
-- retrieve by function of to_char using parameter of timestamp and using keyword 'between '
...
select a from func_04 where to_char(a) between to_char(a) and to_char(a) order by 1;
