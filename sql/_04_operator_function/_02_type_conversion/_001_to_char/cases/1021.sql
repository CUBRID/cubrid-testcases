-- retrieve by function of to_char using parameter of smallint field and using parameter of 's999' ,'s999.9' or 's9.EEEE' format_argument
...
select a,to_char(a, 's999') from  func_04 order by 1	;
select a,to_char(a, 's999.9') from  func_04 order by 1	;
