-- insert data  whith create range partition table on a date field witch using function of to_char and then query all partitions and drop table
...
create table range_test(id int,
	...
	PARTITION BY RANGE (to_char(test_date,'yyyymmdd')) (
	PARTITION p0 VALUES LESS THAN ('1995-02-11'),
	PARTITION p1 VALUES LESS THAN ('2000-05-01'),
	PARTITION p2 VALUES LESS THAN ('2002-07-01'),
