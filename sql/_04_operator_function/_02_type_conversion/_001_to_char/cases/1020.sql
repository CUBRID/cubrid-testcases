-- retrieve by function of to_char using parameter of smallint field and using parameter of '99,999' ,'99' or 's'+'909.0' format_argument
...
select a, to_char(a,'99,999')  from func_04 order by 1	;
select a, to_char(a,'99') from func_04 order by 1	;
select a,to_char(a, 's'+'909.0') from  func_04 order by 1;
