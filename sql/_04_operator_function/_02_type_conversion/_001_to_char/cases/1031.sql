-- [er]retrieve by function of to_char using parameter of int field and using parameter of 's9eeeeeeee' format_argument
...
select b, to_char(b,'s9eeeeeeee') from func_04 order by 1;
