-- insert data  whith create range partition table on a time field witch using function of to_char and then query all partitions and drop table
...
create table range_test(id int,	
	...
	PARTITION BY RANGE (to_char(test_time,'hh24:mi:ss')) (
