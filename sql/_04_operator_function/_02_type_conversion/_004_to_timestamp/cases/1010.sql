-- create serial and table which insert data into using data type of string and int and test "month" in function of to_timestamp using parameter of selected format and 'Ko_KR' and then dorp table and serial 
...
select u_month, to_timestamp(u_month, u_format, 'Ko_KR'), lang from month_test where lang = 'Ko_KR' order by ord;
