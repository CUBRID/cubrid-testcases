-- [er]retrieve by function of to_number using parameter of string and using format_argument of '999.999999'
...
select c, to_number(c,'999.999999') from func_04 order by 1;
