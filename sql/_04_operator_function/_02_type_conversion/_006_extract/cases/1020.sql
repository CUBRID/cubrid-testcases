-- insert data  whith create range partition table on a timestamp field witch using function of extract minute and then query all partitions and drop table
