-- create class,insert data,select clause with incr(object.attr) and  left outer join  keyword for testing
...
insert into xoo10 values(1, 1);
insert into xoo10 values(2, 2);
select incr(xoo10.a), incr(yoo10.b)
from xoo10, yoo10
...
select * from xoo10 order by 1,2;
select * from yoo10 order by 1,2;
