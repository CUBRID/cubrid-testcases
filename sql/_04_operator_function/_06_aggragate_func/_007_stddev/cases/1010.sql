...
select STDDEV(inttest) from tb;
select STDDEV(floattest) from tb;
select STDDEV(realtest) from tb;
select STDDEV(doublepretest) from tb;
select STDDEV(moneytest) from tb;
