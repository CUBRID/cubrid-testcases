...
select STDDEV(UNIQUE  chartest) from tb;
select STDDEV(UNIQUE  datetest) from tb;
select STDDEV(UNIQUE  timetest) from tb;
select STDDEV(UNIQUE  timestamptest) from tb;
select STDDEV(UNIQUE  bittest) from tb;
select STDDEV(UNIQUE  nchartest) from tb;
select STDDEV(UNIQUE  ncharvartest) from tb;
select STDDEV(UNIQUE  bitvartest) from tb;
select STDDEV(UNIQUE  stringtest) from tb;
