--test stddev function with cast function and the date type(like int, smallint, float,double, monetary)
...
select stddev(cast(sinttest as numeric(38,10))), stddev(cast(inttest as numeric)), stddev(cast(floattest as numeric))  from func_09 order by 1;

select stddev(cast(doublepretest as numeric(38,10))) from func_09 order by 1;
	
select stddev(cast(moneytest as numeric(38,10))) from func_09 order by 1;
