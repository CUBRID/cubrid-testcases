--test STDDEV function with types int,float,double, monetary 
create class tb (
...
select STDDEV(  chartest) from tb;
select STDDEV(  datetest) from tb;
select STDDEV(  timetest) from tb;
select STDDEV(  timestamptest) from tb;
select STDDEV(  bittest) from tb;
select STDDEV(  nchartest) from tb;
select STDDEV(  ncharvartest) from tb;
select STDDEV(  bitvartest) from tb;
select STDDEV(  stringtest) from tb;
