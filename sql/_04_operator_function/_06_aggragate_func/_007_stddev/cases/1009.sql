...
select STDDEV(DISTINCT  chartest) from tb;
select STDDEV(DISTINCT  datetest) from tb;
select STDDEV(DISTINCT  timetest) from tb;
select STDDEV(DISTINCT  timestamptest) from tb;
select STDDEV(DISTINCT  bittest) from tb;
select STDDEV(DISTINCT  nchartest) from tb;
select STDDEV(DISTINCT  ncharvartest) from tb;
select STDDEV(DISTINCT  bitvartest) from tb;
select STDDEV(DISTINCT  stringtest) from tb;
