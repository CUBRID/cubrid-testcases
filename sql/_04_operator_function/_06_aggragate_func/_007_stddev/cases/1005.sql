...
select STDDEV(UNIQUE  inttest) from tb;
select STDDEV(UNIQUE  floattest) from tb;
select STDDEV(UNIQUE  realtest) from tb;
select STDDEV(UNIQUE  doublepretest) from tb;
select STDDEV(UNIQUE  moneytest) from tb;
