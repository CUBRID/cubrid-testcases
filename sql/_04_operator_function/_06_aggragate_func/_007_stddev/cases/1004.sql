...
select STDDEV(distinct  inttest) from tb;
select STDDEV(distinct  floattest) from tb;
select STDDEV(distinct  realtest) from tb;
select STDDEV(distinct  doublepretest) from tb;
select STDDEV(distinct  moneytest) from tb;
