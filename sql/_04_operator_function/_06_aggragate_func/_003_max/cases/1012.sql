--test max function with 'distinct' keyword and the data type(like bit, bit varying)
...
select max(distinct bittest), max(distinct bitvartest) from func_09 order by 1;
