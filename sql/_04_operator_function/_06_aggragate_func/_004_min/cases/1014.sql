--+ holdcas on;
--test min function with operators +,-,*,/,||
...
select min(col1)+'aa' from tb;
select min(col1)||'aa' from tb;

select min(col2)+'aa' from tb;
select min(col2)||'aa' from tb;

select min(col3)+'aa' from tb;
select min(col3)||'aa' from tb;

select min(col4)||'aa' from tb;
select min(col5)||'aa' from tb;
select min(col6)||'aa' from tb;
select min(col7)||'aa' from tb;

select min(col4)-3 from tb;
select min(col5)-3 from tb;
select min(col6)-3 from tb;
select min(col7)-3 from tb;
