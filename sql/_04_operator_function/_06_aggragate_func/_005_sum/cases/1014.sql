--[er]test sum function with 'unique' operator and the data type(like bit, bit varying)
...
select sum(unique bittest), sum(unique bitvartest) from func_09 order by 1;
