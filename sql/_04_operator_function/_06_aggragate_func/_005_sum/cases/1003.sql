--[er]test sum function with 'distinct' operator and the data type(like bit, bit varying)
...
select sum(distinct bittest), sum(distinct bitvartest) from func_09 order by 1;
