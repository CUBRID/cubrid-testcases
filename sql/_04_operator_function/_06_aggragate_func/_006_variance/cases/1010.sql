...
select variance(inttest) from tb;
select variance(floattest) from tb;
select variance(realtest) from tb;
select variance(doublepretest) from tb;
select variance(moneytest) from tb;
