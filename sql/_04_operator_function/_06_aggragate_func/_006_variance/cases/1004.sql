...
select variance(distinct  inttest) from tb;
select variance(distinct  floattest) from tb;
select variance(distinct  realtest) from tb;
select variance(distinct  doublepretest) from tb;
select variance(distinct  moneytest) from tb;
