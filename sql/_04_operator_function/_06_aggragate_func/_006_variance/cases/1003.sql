...
select variance(all inttest) from tb;
select variance(all floattest) from tb;
select variance(all realtest) from tb;
select variance(all doublepretest) from tb;
select variance(all moneytest) from tb;
