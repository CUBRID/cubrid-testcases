--test variance function with types int,float,double, monetary 
create class tb (
...
select variance(  chartest) from tb;
select variance(  datetest) from tb;
select variance(  timetest) from tb;
select variance(  timestamptest) from tb;
select variance(  bittest) from tb;
select variance(  nchartest) from tb;
select variance(  ncharvartest) from tb;
select variance(  bitvartest) from tb;
select variance(  stringtest) from tb;
