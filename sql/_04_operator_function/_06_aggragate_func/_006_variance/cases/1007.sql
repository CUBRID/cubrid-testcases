...
select variance(UNIQUE  chartest) from tb;
select variance(UNIQUE  datetest) from tb;
select variance(UNIQUE  timetest) from tb;
select variance(UNIQUE  timestamptest) from tb;
select variance(UNIQUE  bittest) from tb;
select variance(UNIQUE  nchartest) from tb;
select variance(UNIQUE  ncharvartest) from tb;
select variance(UNIQUE  bitvartest) from tb;
select variance(UNIQUE  stringtest) from tb;
