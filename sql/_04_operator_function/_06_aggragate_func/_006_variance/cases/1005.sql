...
select variance(UNIQUE  inttest) from tb;
select variance(UNIQUE  floattest) from tb;
select variance(UNIQUE  realtest) from tb;
select variance(UNIQUE  doublepretest) from tb;
select variance(UNIQUE  moneytest) from tb;
