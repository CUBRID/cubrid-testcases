--[er]test avg function with 'distinct' keyword and incompatible type like varchar 
...
select avg(distinct varchartest),avg(distinct chartest),avg(distinct nchartest), avg(distinct ncharvartest) , avg(distinct stringtest) from func_09 order by 1;
