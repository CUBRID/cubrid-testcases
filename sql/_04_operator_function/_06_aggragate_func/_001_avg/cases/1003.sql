--[er]test avg function with 'all' keyword and incompatible type like varchar
...
select avg(all varchartest),avg(all chartest),avg(all nchartest), avg(all ncharvartest) , avg(all stringtest) from func_09 order by 1;
