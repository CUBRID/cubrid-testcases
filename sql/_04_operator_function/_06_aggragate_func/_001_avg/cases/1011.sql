--[er]test avg function with Incompatible types such as date, time, timestamp
...
select avg(unique datetest), avg(unique timetest), avg(unique timestamptest)   from func_09 order by 1;
