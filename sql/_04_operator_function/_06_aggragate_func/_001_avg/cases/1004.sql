--[er]test avg function with 'all' keyword and incompatible type like timestamp
...
select avg(all datetest), avg(all timetest), avg(all timestamptest)   from func_09 order by 1;
