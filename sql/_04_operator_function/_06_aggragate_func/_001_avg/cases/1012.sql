--[er]test avg function with Incompatible types such as bit, bit varying and it also used 'unique' keyword. 
...
select avg(unique bittest), avg(unique bitvartest) from func_09 order by 1;
