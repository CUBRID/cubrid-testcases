--[er]test avg function with incompatible type like timestamp
...
select avg(distinct datetest), avg(distinct timetest), avg(distinct timestamptest)   from func_09 order by 1;
