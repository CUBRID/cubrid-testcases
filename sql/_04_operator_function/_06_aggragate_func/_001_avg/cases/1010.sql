--[er]test avg function with the types varchar, char, nchar, nchar varying, string and  it also used 'unique' keyword
...
select avg(unique varchartest),avg(unique chartest),avg(unique nchartest), avg(unique ncharvartest) , avg(unique stringtest) from func_09 order by 1;
