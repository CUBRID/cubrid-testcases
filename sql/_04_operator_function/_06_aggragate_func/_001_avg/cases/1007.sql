--[er]test avg function with the types varchar, char, nchar types.
...
select avg(varchartest),avg(chartest),avg(nchartest), avg(ncharvartest) , avg(stringtest) from func_09 order by 1;
