...
--boundary test
--select groupid, col1, first_value(col1) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(col1,col1) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value((1)) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(1) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(0xbb) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(0xbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(2+1) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(2+1) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(null) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(null+1) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(1+null) over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(1) over(partition by 1) as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(1) over(partition by 1 order by 1) as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(1) over(partition by 1 order by col1) as ret_val from  lprocess2_tb order by 2,1,3;
--select groupid, col1, first_value(col1) over(partition by 1 order by 1) as ret_val from  lprocess2_tb order by 2,1,3;
--select groupid, col1, first_value(col1) over(partition by 1 order by 1) as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(col1) over(order by 1) as ret_val from  (select * from lprocess2_tb order by 1,2,3) order by 2,1,3;
select groupid, col1, first_value(col1) over(order by col1) as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(null+1) respect nulls over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(1>1) respect nulls over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(1=1) respect nulls over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(1<1) respect nulls over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(max(col1)) respect nulls over() as ret_val from  lprocess2_tb order by 2,1,3;
--select groupid, col1, first_value(abs(groupid)) respect nulls over() as ret_val from  lprocess2_tb order by 2,1,3;
select groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc,col2 asc, col3 desc, col4 asc, col5 desc) as ret_val from  lprocess2_tb order by 1,2,3;
...
select id,groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, col1, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, col1, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, col1, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, col1, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, col1, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, col1, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, col1, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, col1, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1)  over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, col1, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, col1, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, col1, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, col1, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, col1, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, col1, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, col1, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, col1, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1) respect nulls over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, col1, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val, first_value(col1) ignore nulls over(partition by groupid order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, groupid1, col1, first_value(col1) ignore nulls over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, groupid1, col1, first_value(col1) ignore nulls over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, groupid1, col1, first_value(col1) ignore nulls over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, groupid1, col1, first_value(col1) ignore nulls over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, groupid1, col1, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, groupid1, col1, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, groupid1, col1, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, groupid1, col1, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, groupid1, col1, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, groupid1, col1, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, groupid1, col1, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, groupid1, col1, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val, first_value(col1)  over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val2 from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
...
select id,groupid, groupid1, col1, first_value(col1) respect nulls over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls first,2,3;
select id,groupid, groupid1, col1, first_value(col1) respect nulls over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  nulls last,2,3;
select id,groupid, groupid1, col1, first_value(col1) respect nulls over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
select id,groupid, groupid1, col1, first_value(col1) respect nulls over(partition by groupid, groupid1 order by col1 desc nulls last) as ret_val from  lprocess2_tb group by id order by groupid  desc nulls last,2,3;
