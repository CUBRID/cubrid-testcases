--+ holdcas on;
--[er]Revoke two users privilege of select on superclass and subclass with keyword of except
...
REVOKE SELECT ON ALL DCL1 (EXCEPT DCL2) FROM DCL_USER1, DCL_USER2;
