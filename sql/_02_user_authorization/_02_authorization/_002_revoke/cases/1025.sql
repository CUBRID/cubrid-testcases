--+ holdcas on;
--[er]Revoke user all privilege on superclass and subclass with keyword of except(Manipulate DCL1,DCL3 )
...
REVOKE ALL PRIVILEGES ON ALL DCL1 (EXCEPT DCL2) FROM DCL_USER1;	
