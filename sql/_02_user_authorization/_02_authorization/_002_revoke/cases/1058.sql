...
create class a(aid int, b db1.b);
create class aa(aid int, s set(db1.b));
...
call login('db2','') on class db_user;
insert into a values(1, ( select b from db1.b where bid=1));
insert into aa values(1, set(select b from db1.b where bid=1));
