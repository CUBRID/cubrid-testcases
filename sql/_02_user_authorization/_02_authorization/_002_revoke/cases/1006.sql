--+ holdcas on;
--[er]Revoke two users privilege of select and insert on superclass and subclass with keyword of except
...
REVOKE INSERT, SELECT ON ALL DCL1 (EXCEPT DCL2) FROM DCL_USER1, DCL_USER2;
