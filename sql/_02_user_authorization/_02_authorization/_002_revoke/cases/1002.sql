--+ holdcas on;
--[er]Revoke user privilege of select and insert on superclass and subclass with keyword of except(insert into DCL1,DCL3)
...
REVOKE INSERT, SELECT ON ALL DCL1 (EXCEPT DCL2) FROM DCL_USER1;
