...
update test_class set datetime_col = DATETIME '0002-01-02 00:00:00.000' where datetime_col = DATETIME '0001-01-01 00:00:00.000';
update test_class set datetime_col = DATETIME '1970-01-02 00:00:00.000' where datetime_col = DATETIME '1970-01-01 00:00:00.000';
update test_class set datetime_col = DATETIME '1990-01-03 23:59:59.999' where datetime_col = DATETIME '1990-01-02 23:59:59.999';
update test_class set datetime_col = DATETIME '2990-01-03 23:59:59.999' where datetime_col = DATETIME '2990-01-02 23:59:59.999';
update test_class set datetime_col = DATETIME '01/03/1970 00:00:00.000' where datetime_col = DATETIME '01/02/1970 00:00:00.000';
update test_class set datetime_col = DATETIME '01/04/1990 23:59:59.999' where datetime_col = DATETIME '01/03/1990 23:59:59.999';
update test_class set datetime_col = DATETIME '01/04/2990 23:59:59.999' where datetime_col = DATETIME '01/03/2990 23:59:59.999';
