...
select * from test_class where datetime_col in (DATETIME '01/02/2990 23:59:59', DATETIME '01/01/1970 00:00:00') order by 4;
select * from test_class where datetime_col not in (DATETIME '01/02/2990 23:59:59', DATETIME '01/01/1970 00:00:00') order by 4;
