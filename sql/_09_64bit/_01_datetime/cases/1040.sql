...
select * from test_class where datetime_col in (DATETIME '1970-01-01 00:00:00.000', DATETIME '1970-01-01 00:00:00.001')  order by 1;
select * from test_class where datetime_col not in (DATETIME '1970-01-01 00:00:00.000', DATETIME '1970-01-01 00:00:00.001') order by 1;
select * from test_class where datetime_col between DATETIME '1970-01-01 00:00:00.000' AND DATETIME '1970-01-01 00:00:00.001' order by 1;
