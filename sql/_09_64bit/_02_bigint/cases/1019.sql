...
select datetime_col1 - datetime_col - bigint_col  from test_class;
select (datetime_col1 - datetime_col) + bigint_col  from test_class;
select datetime_col1 - datetime_col + bigint_col  from test_class;
select datetime_col1 - bigint_col from test_class order by 1;
select datetime_col1 + bigint_col from test_class order by 1 desc;
