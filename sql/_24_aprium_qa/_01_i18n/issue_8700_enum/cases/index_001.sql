...
create table t(
	i int,
	e1 enum('a', 'b') collate utf8_en_ci,
	e2 enum('Yes', 'No', 'Cancel') collate utf8_en_cs,
	e3 enum ('Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday') collate utf8_en_ci,
	e4 enum('x', 'y', 'z', 't') collate utf8_tr_cs);
