...
create table t(i bigint, j SMALLINT, k NUMERIC(5,0),l FLOAT,m date,n char(200) ) partition by hash(i) partitions 5 ;
...
alter table tt add constraint primary key(i,j);
...
create table t2(i bigint, j SMALLINT, k int,l FLOAT,m date,n char(200) )  partition by hash(i) partitions 5 ;
