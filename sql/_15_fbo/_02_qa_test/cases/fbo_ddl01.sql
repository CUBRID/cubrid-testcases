...
select a,blob_to_bit(b),c from pk3;
select a,clob_to_char(b),c from pk4;
delete from  pk3;
delete from  pk4;
drop pk3;
drop pk4;
...
select name, blob_to_bit(photo),gender from sh3;
select name, clob_to_char(photo),gender from sh4;
delete from sh3;
delete from sh4;
drop sh3;
drop sh4;
...
select name,blob_to_bit(photo),gender from df3;
select name,clob_to_char(photo),gender from df4;
delete from df3;
delete from df4;
drop df3;
drop df4;
...
select name, blob_to_bit(photo),gender from nn3;
select name, clob_to_char(photo),gender from nn4;
delete from nn3;
delete from nn4;
drop nn3;
drop nn4;
...
insert into un4 values ('un4',char_to_clob('bbbddd'),'M');
select name, blob_to_bit(photo),gender from un3;
select name, clob_to_char(photo),gender from un4;
delete from un3;
delete from un4;
drop un3;
drop un4;
...
insert into ai4 values (null,'name',char_to_clob('bbbccc'),'M');
insert into ai4 values (null,'name',char_to_clob('bbbccc'),'M');
select id,name,blob_to_bit(photo),gender from ai3;
select id,name,clob_to_char(photo),gender from ai4;
delete from ai3;
delete from ai4;
drop ai3;
drop ai4;
