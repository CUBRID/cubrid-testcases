...
insert into t5(col2,col3,col4) select to_char(CURDATE(), 'YYYY-MM-DD'), to_char(SYS_TIMESTAMP, 'HH24:MI:SS YYYY-MM-DD TZR'), to_char(LOCALTIMESTAMP (), 'HH:MI:SS AM MM/DD/YYYY TZR') from db_class a, db_class b limit 2025;
insert into t5(col2,col3,col4) select default(col2), default(col3), default(col4) from db_class a, db_class b limit 2025;
