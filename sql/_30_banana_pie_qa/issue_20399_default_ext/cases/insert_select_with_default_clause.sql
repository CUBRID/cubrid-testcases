...
create table t5(col1 int not null primary key auto_increment, col2 varchar(10) not null default to_char(CURDATE(), 'YYYY-MM-DD'), col3 varchar(100) not null default to_char(SYS_TIMESTAMP, 'HH24:MI:SS YYYY-MM-DD TZR'), col4 varchar(1000) not null default to_char(LOCALTIMESTAMP (), 'HH:MI:SS AM MM/DD/YYYY TZR'));
