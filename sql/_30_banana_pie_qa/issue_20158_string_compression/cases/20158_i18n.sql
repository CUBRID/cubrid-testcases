...
insert into t values(2,repeat('문자열문',200), repeat('갱신되',200), repeat('测试',200), repeat('ÀÏÀÏÀÏÀÏ',50));

insert into t values(3,repeat(cast( _utf8'문자열문' as string charset euckr),200), repeat('갱신되',200), repeat('测试',200), repeat('ÀÏÀÏÀÏÀÏ',50));

insert into t values(4,repeat(cast( _utf8'ÀÏÀÏÀÏÀÏ' as string charset iso88591),200), repeat('문자열문',200), repeat('测试',200),repeat('동작은',100));
