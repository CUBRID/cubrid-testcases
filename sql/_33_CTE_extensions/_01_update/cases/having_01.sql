...
from student 
group by s_class having s_class>=3 order by score desc,id limit 0,1
)
update student,mycte set student.score=student.score-mycte.min_score
where student.s_class=mycte.s_class;
