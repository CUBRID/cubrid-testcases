...
select var_pop(UNIQUE  inttest) from tb;
select var_pop(UNIQUE  floattest) from tb;
select var_pop(UNIQUE  realtest) from tb;
select var_pop(UNIQUE  doublepretest) from tb;
select var_pop(UNIQUE  moneytest) from tb;
