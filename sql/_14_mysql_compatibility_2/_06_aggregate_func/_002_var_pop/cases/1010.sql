...
select var_pop(inttest) from tb;
select var_pop(floattest) from tb;
select var_pop(realtest) from tb;
select var_pop(doublepretest) from tb;
select var_pop(moneytest) from tb;
