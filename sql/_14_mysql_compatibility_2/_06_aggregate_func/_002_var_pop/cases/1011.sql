--test var_pop function with types int,float,double, monetary 
create class tb (
...
select var_pop(  chartest) from tb;
select var_pop(  datetest) from tb;
select var_pop(  timetest) from tb;
select var_pop(  timestamptest) from tb;
select var_pop(  bittest) from tb;
select var_pop(  nchartest) from tb;
select var_pop(  ncharvartest) from tb;
select var_pop(  bitvartest) from tb;
select var_pop(  stringtest) from tb;
