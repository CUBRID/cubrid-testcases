...
select var_pop(distinct  inttest) from tb;
select var_pop(distinct  floattest) from tb;
select var_pop(distinct  realtest) from tb;
select var_pop(distinct  doublepretest) from tb;
select var_pop(distinct  moneytest) from tb;
