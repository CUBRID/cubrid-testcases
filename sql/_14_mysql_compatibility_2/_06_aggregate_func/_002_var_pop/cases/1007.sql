--test var_pop function with UNIQUE keyword and types int,float,double, monetary 
create class tb (
...
select var_pop(UNIQUE  chartest) from tb;
select var_pop(UNIQUE  datetest) from tb;
select var_pop(UNIQUE  timetest) from tb;
select var_pop(UNIQUE  timestamptest) from tb;
select var_pop(UNIQUE  bittest) from tb;
select var_pop(UNIQUE  nchartest) from tb;
select var_pop(UNIQUE  ncharvartest) from tb;
select var_pop(UNIQUE  bitvartest) from tb;
select var_pop(UNIQUE  stringtest) from tb;
