--test var_pop function with all keyword and types int,float,double, monetary 
create class tb (
...
select var_pop(all  chartest) from tb;
select var_pop(all  datetest) from tb;
select var_pop(all  timetest) from tb;
select var_pop(all  timestamptest) from tb;
select var_pop(all  bittest) from tb;
select var_pop(all  nchartest) from tb;
select var_pop(all  ncharvartest) from tb;
select var_pop(all  bitvartest) from tb;
select var_pop(all  stringtest) from tb;
