--test var_pop function with DISTINCT keyword and types int,float,double, monetary 
create class tb (
...
select var_pop(DISTINCT  chartest) from tb;
select var_pop(DISTINCT  datetest) from tb;
select var_pop(DISTINCT  timetest) from tb;
select var_pop(DISTINCT  timestamptest) from tb;
select var_pop(DISTINCT  bittest) from tb;
select var_pop(DISTINCT  nchartest) from tb;
select var_pop(DISTINCT  ncharvartest) from tb;
select var_pop(DISTINCT  bitvartest) from tb;
select var_pop(DISTINCT  stringtest) from tb;
