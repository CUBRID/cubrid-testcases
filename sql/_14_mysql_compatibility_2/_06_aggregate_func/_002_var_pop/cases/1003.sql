...
select var_pop(all inttest) from tb;
select var_pop(all floattest) from tb;
select var_pop(all realtest) from tb;
select var_pop(all doublepretest) from tb;
select var_pop(all moneytest) from tb;
