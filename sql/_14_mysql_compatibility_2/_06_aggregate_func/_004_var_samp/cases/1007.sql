--test var_samp function with UNIQUE keyword and types int,float,double, monetary 
create class tb (
...
select var_samp(UNIQUE  chartest) from tb;
select var_samp(UNIQUE  datetest) from tb;
select var_samp(UNIQUE  timetest) from tb;
select var_samp(UNIQUE  timestamptest) from tb;
select var_samp(UNIQUE  bittest) from tb;
select var_samp(UNIQUE  nchartest) from tb;
select var_samp(UNIQUE  ncharvartest) from tb;
select var_samp(UNIQUE  bitvartest) from tb;
select var_samp(UNIQUE  stringtest) from tb;
