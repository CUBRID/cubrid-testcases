--Test var_samp function with expression
...
insert into test_class values('bca','xxadxx',N'abc',B'00111',B'11',57755,10601,
                              ...
                              TIMESTAMP'01/31/1998 8:15:00 pm',{1000,500,20},
                              {1000,1000,1000},{50,1000,1000,1000});
insert into test_class values('aaab','xxxxxx',N'abc',B'00001',B'01',55555,10001,
                              32767,68888,-9999,1000001,DATE '09/05/2008',TIME'10:41 am',
                              TIMESTAMP'01/31/1998 8:15:00 pm',{1000,500,20},
                              {1000,1000,1000},{50,1000,1000,1000});
select * from test_class order by 1;                             
select var_samp(cast(col7 as numeric(38,0))+10222) from test_class;
