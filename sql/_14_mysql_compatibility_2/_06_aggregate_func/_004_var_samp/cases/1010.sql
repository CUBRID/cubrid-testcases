...
select var_samp(inttest) from tb;
select var_samp(floattest) from tb;
select var_samp(realtest) from tb;
select var_samp(doublepretest) from tb;
select var_samp(moneytest) from tb;
