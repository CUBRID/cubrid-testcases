--test var_samp function with DISTINCT keyword and types int,float,double, monetary 
create class tb (
...
select var_samp(DISTINCT  chartest) from tb;
select var_samp(DISTINCT  datetest) from tb;
select var_samp(DISTINCT  timetest) from tb;
select var_samp(DISTINCT  timestamptest) from tb;
select var_samp(DISTINCT  bittest) from tb;
select var_samp(DISTINCT  nchartest) from tb;
select var_samp(DISTINCT  ncharvartest) from tb;
select var_samp(DISTINCT  bitvartest) from tb;
select var_samp(DISTINCT  stringtest) from tb;
