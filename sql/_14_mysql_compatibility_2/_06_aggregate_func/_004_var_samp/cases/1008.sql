--test var_samp function with all keyword and types int,float,double, monetary 
create class tb (
...
select var_samp(all  chartest) from tb;
select var_samp(all  datetest) from tb;
select var_samp(all  timetest) from tb;
select var_samp(all  timestamptest) from tb;
select var_samp(all  bittest) from tb;
select var_samp(all  nchartest) from tb;
select var_samp(all  ncharvartest) from tb;
select var_samp(all  bitvartest) from tb;
select var_samp(all  stringtest) from tb;
