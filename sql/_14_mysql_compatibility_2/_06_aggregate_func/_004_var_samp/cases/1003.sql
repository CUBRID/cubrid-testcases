...
select var_samp(all inttest) from tb;
select var_samp(all floattest) from tb;
select var_samp(all realtest) from tb;
select var_samp(all doublepretest) from tb;
select var_samp(all moneytest) from tb;
