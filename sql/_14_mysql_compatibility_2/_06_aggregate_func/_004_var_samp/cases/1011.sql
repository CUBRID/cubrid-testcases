--test var_samp function with types int,float,double, monetary 
create class tb (
...
select var_samp(  chartest) from tb;
select var_samp(  datetest) from tb;
select var_samp(  timetest) from tb;
select var_samp(  timestamptest) from tb;
select var_samp(  bittest) from tb;
select var_samp(  nchartest) from tb;
select var_samp(  ncharvartest) from tb;
select var_samp(  bitvartest) from tb;
select var_samp(  stringtest) from tb;
