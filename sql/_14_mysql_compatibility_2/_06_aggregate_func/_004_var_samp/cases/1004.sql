...
select var_samp(distinct  inttest) from tb;
select var_samp(distinct  floattest) from tb;
select var_samp(distinct  realtest) from tb;
select var_samp(distinct  doublepretest) from tb;
select var_samp(distinct  moneytest) from tb;
