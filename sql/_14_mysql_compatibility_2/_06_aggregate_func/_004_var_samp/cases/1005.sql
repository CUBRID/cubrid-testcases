...
select var_samp(UNIQUE  inttest) from tb;
select var_samp(UNIQUE  floattest) from tb;
select var_samp(UNIQUE  realtest) from tb;
select var_samp(UNIQUE  doublepretest) from tb;
select var_samp(UNIQUE  moneytest) from tb;
