...
select STDDEV_SAMP(UNIQUE  inttest) from tb;
select STDDEV_SAMP(UNIQUE  floattest) from tb;
select STDDEV_SAMP(UNIQUE  realtest) from tb;
select STDDEV_SAMP(UNIQUE  doublepretest) from tb;
select STDDEV_SAMP(UNIQUE  moneytest) from tb;
