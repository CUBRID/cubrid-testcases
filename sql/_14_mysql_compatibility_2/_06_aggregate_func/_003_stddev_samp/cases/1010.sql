...
select STDDEV_SAMP(inttest) from tb;
select STDDEV_SAMP(floattest) from tb;
select STDDEV_SAMP(realtest) from tb;
select STDDEV_SAMP(doublepretest) from tb;
select STDDEV_SAMP(moneytest) from tb;
