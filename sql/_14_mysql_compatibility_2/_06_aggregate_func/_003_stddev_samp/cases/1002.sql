--[er]test stddev_samp function with cast function and data overflow on numeric data type.
...
select stddev_samp(cast(numerictest as numeric(38,0))) from func_09 order by 1;
