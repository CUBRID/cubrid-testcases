...
select STDDEV_SAMP(distinct  inttest) from tb;
select STDDEV_SAMP(distinct  floattest) from tb;
select STDDEV_SAMP(distinct  realtest) from tb;
select STDDEV_SAMP(distinct  doublepretest) from tb;
select STDDEV_SAMP(distinct  moneytest) from tb;
