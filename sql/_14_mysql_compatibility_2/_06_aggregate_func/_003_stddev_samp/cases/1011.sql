--test STDDEV_SAMP function with types int,float,double, monetary 
create class tb (
...
select STDDEV_SAMP(  chartest) from tb;
select STDDEV_SAMP(  datetest) from tb;
select STDDEV_SAMP(  timetest) from tb;
select STDDEV_SAMP(  timestamptest) from tb;
select STDDEV_SAMP(  bittest) from tb;
select STDDEV_SAMP(  nchartest) from tb;
select STDDEV_SAMP(  ncharvartest) from tb;
select STDDEV_SAMP(  bitvartest) from tb;
select STDDEV_SAMP(  stringtest) from tb;
