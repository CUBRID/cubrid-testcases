...
select STDDEV_SAMP(all  chartest) from tb;
select STDDEV_SAMP(all  datetest) from tb;
select STDDEV_SAMP(all  timetest) from tb;
select STDDEV_SAMP(all  timestamptest) from tb;
select STDDEV_SAMP(all  bittest) from tb;
select STDDEV_SAMP(all  nchartest) from tb;
select STDDEV_SAMP(all  ncharvartest) from tb;
select STDDEV_SAMP(all  bitvartest) from tb;
select STDDEV_SAMP(all  stringtest) from tb;
