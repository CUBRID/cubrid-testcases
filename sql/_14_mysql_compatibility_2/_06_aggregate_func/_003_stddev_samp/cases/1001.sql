--test stddev_samp function with cast function and the date type(like int, smallint, float,double, monetary)
...
select stddev_samp(cast(sinttest as numeric(38,10))) from func_09 order by 1;

select stddev_samp(cast(inttest as numeric)) from func_09 order by 1;

select stddev_samp(cast(floattest as numeric))  from func_09 order by 1;

select stddev_samp(cast(doublepretest as numeric(38,10))) from func_09 order by 1;
	
select stddev_samp(cast(moneytest as numeric(38,10))) from func_09 order by 1;
