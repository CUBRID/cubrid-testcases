--test STDDEV_SAMP function with DISTINCT keyword and types int,float,double, monetary 
create class tb (
...
select STDDEV_SAMP(DISTINCT  chartest) from tb;
select STDDEV_SAMP(DISTINCT  datetest) from tb;
select STDDEV_SAMP(DISTINCT  timetest) from tb;
select STDDEV_SAMP(DISTINCT  timestamptest) from tb;
select STDDEV_SAMP(DISTINCT  bittest) from tb;
select STDDEV_SAMP(DISTINCT  nchartest) from tb;
select STDDEV_SAMP(DISTINCT  ncharvartest) from tb;
select STDDEV_SAMP(DISTINCT  bitvartest) from tb;
select STDDEV_SAMP(DISTINCT  stringtest) from tb;
