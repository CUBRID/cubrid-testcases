--test STDDEV_SAMP function with UNIQUE keyword and types int,float,double, monetary 
create class tb (
...
select STDDEV_SAMP(UNIQUE  chartest) from tb;
select STDDEV_SAMP(UNIQUE  datetest) from tb;
select STDDEV_SAMP(UNIQUE  timetest) from tb;
select STDDEV_SAMP(UNIQUE  timestamptest) from tb;
select STDDEV_SAMP(UNIQUE  bittest) from tb;
select STDDEV_SAMP(UNIQUE  nchartest) from tb;
select STDDEV_SAMP(UNIQUE  ncharvartest) from tb;
select STDDEV_SAMP(UNIQUE  bitvartest) from tb;
select STDDEV_SAMP(UNIQUE  stringtest) from tb;
