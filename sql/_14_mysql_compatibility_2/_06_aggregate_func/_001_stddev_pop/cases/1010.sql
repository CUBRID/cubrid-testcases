...
select STDDEV_POP(inttest) from tb;
select STDDEV_POP(floattest) from tb;
select STDDEV_POP(realtest) from tb;
select STDDEV_POP(doublepretest) from tb;
select STDDEV_POP(moneytest) from tb;
