--test STDDEV_POP function with types int,float,double, monetary 
create class tb (
...
select STDDEV_POP(  chartest) from tb;
select STDDEV_POP(  datetest) from tb;
select STDDEV_POP(  timetest) from tb;
select STDDEV_POP(  timestamptest) from tb;
select STDDEV_POP(  bittest) from tb;
select STDDEV_POP(  nchartest) from tb;
select STDDEV_POP(  ncharvartest) from tb;
select STDDEV_POP(  bitvartest) from tb;
select STDDEV_POP(  stringtest) from tb;
