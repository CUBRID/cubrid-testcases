...
select STDDEV_POP(distinct  inttest) from tb;
select STDDEV_POP(distinct  floattest) from tb;
select STDDEV_POP(distinct  realtest) from tb;
select STDDEV_POP(distinct  doublepretest) from tb;
select STDDEV_POP(distinct  moneytest) from tb;
