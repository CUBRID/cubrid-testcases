...
select STDDEV_POP(all inttest) from tb;
select STDDEV_POP(all floattest) from tb;
select STDDEV_POP(all realtest) from tb;
select STDDEV_POP(all doublepretest) from tb;
select STDDEV_POP(all moneytest) from tb;
