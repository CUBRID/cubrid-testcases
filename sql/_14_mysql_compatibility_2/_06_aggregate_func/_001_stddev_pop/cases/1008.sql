--test STDDEV_POP function with all keyword and types int,float,double, monetary 
create class tb (
...
select STDDEV_POP(all  chartest) from tb;
select STDDEV_POP(all  datetest) from tb;
select STDDEV_POP(all  timetest) from tb;
select STDDEV_POP(all  timestamptest) from tb;
select STDDEV_POP(all  bittest) from tb;
select STDDEV_POP(all  nchartest) from tb;
select STDDEV_POP(all  ncharvartest) from tb;
select STDDEV_POP(all  bitvartest) from tb;
select STDDEV_POP(all  stringtest) from tb;
