...
select STDDEV_POP(UNIQUE  chartest) from tb;
select STDDEV_POP(UNIQUE  datetest) from tb;
select STDDEV_POP(UNIQUE  timetest) from tb;
select STDDEV_POP(UNIQUE  timestamptest) from tb;
select STDDEV_POP(UNIQUE  bittest) from tb;
select STDDEV_POP(UNIQUE  nchartest) from tb;
select STDDEV_POP(UNIQUE  ncharvartest) from tb;
select STDDEV_POP(UNIQUE  bitvartest) from tb;
select STDDEV_POP(UNIQUE  stringtest) from tb;
