--test STDDEV_POP function with DISTINCT keyword and types int,float,double, monetary 
create class tb (
...
select STDDEV_POP(DISTINCT  chartest) from tb;
select STDDEV_POP(DISTINCT  datetest) from tb;
select STDDEV_POP(DISTINCT  timetest) from tb;
select STDDEV_POP(DISTINCT  timestamptest) from tb;
select STDDEV_POP(DISTINCT  bittest) from tb;
select STDDEV_POP(DISTINCT  nchartest) from tb;
select STDDEV_POP(DISTINCT  ncharvartest) from tb;
select STDDEV_POP(DISTINCT  bitvartest) from tb;
select STDDEV_POP(DISTINCT  stringtest) from tb;
