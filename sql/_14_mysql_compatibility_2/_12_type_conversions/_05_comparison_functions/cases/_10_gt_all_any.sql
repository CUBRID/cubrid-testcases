select 'ok' from db_root where '2' > any {1,2,3};

select 'ok' from db_root where 2 > any {'1','2','3'};

select 'ok' from db_root where '2010-01-02' > any {date'2010-01-01', date'2010-01-02'};
...
select 'ok' from db_root where '2' > all {1,'1',1.0};

select 'ok' from db_root where '2010-01-03' > all {date'2010-01-01', '2010-01-02'};
