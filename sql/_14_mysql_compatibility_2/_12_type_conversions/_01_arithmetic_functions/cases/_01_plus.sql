...
select date_col+'1' from alltypes;

select '-2'+date_col from alltypes;
...
select datetime_col+'1' from alltypes;

select '-2'+datetime_col from alltypes;
...
select time_col+'20' from alltypes;

select '-10'+time_col from alltypes;
...
select timestamp_col+'10' from alltypes;

select '-20'+timestamp_col from alltypes;
...
select date'2001-10-11' + '1';

select '-2' + date'2001-10-11';


select datetime'2001-10-11 10:11:12.123' + '1';

select '-2' + datetime'2001-10-11 10:11:12.123';


select time'10:11:12' + '1';

select '-2' + time'10:11:12';


select timestamp'2001-10-11 10:11:12' + '1';

select '-2' + timestamp'2001-10-11 10:11:12';
