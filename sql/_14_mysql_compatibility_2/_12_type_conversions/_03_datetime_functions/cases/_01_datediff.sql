...
select if(datediff('2002-03-03 12:00:00 am','1990-01-01 11:59:59 pm') = datediff(timestamp'2002-03-03 12:00:00 am',timestamp'1990-01-01 11:59:59 pm'),'ok','nok');

select if(datediff('2002-03-03 12:00:00.001 am','1990-01-01 11:59:59.002 pm') = datediff(datetime'2002-03-03 12:00:00 am',datetime'1990-01-01 11:59:59 pm'),'ok','nok');
