...
select day(varchar_col) from alltypes;

select day(varnchar_col) from alltypes;

select day(char_col) from alltypes;

select if(day('2002-03-03') = day(date'2002-03-03'),'ok','nok');

select if(day('2002-03-03 12:00:00 am') = day(timestamp'2002-03-03 12:00:00 am'),'ok','nok');

select if(day('2002-03-03 12:00:00.001 am') = day(datetime'2002-03-03 12:00:00 am'),'ok','nok');

$varchar, $2002-03-03
select day(?) from db_root;

$varchar, $2002-03-03
select if (day(?) = day('2002-03-03'), 'ok','nok') from db_root;
