...
select week(varchar_col) from alltypes;

select week(varnchar_col) from alltypes;

select week(char_col) from alltypes;

select if(week('2002-03-03') = week(date'2002-03-03'),'ok','nok');

select if(week('2002-03-03 12:00:00 am') = week(timestamp'2002-03-03 12:00:00 am'),'ok','nok');

select if(week('2002-03-03 12:00:00.001 am') = week(datetime'2002-03-03 12:00:00 am'),'ok','nok');

$varchar, $2002-03-03
select week(?) from db_root;

$varchar, $2002-03-03
select if (week(?) = week('2002-03-03'), 'ok','nok') from db_root;
