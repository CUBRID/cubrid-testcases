...
select minute(varchar_col) from alltypes;

select minute(varnchar_col) from alltypes;

select minute(nchar_col) from alltypes;

select if(minute('2002-03-03') = minute(time'00:20:02'),'ok','nok');

select if(minute('2002-03-03 12:00:00 am') = minute(timestamp'2002-03-03 12:00:00 am'),'ok','nok');

select if(minute('2002-03-03 12:00:00.001 am') = minute(datetime'2002-03-03 12:00:00 am'),'ok','nok');

$varchar, $2002-03-03
select minute(?) from db_root;

$varchar, $2002-03-03
select if (minute(?) = minute('2002-03-03'), 'ok','nok') from db_root;
