...
select month(varchar_col) from alltypes;

select month(varnchar_col) from alltypes;

select month(char_col) from alltypes;

select if(month('2002-03-03') = month(date'2002-03-03'),'ok','nok');

select if(month('2002-03-03 12:00:00 am') = month(timestamp'2002-03-03 12:00:00 am'),'ok','nok');

select if(month('2002-03-03 12:00:00.001 am') = month(datetime'2002-03-03 12:00:00 am'),'ok','nok');

$varchar, $2002-03-03
select month(?) from db_root;

$varchar, $2002-03-03
select if (month(?) = month('2002-03-03'), 'ok','nok') from db_root;
