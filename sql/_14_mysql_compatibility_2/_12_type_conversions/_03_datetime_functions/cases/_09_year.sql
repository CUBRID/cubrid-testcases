...
select year(varchar_col) from alltypes;

select year(varnchar_col) from alltypes;

select year(char_col) from alltypes;

select if(year('2002-03-03') = year(date'2002-03-03'),'ok','nok');

select if(year('2002-03-03 12:00:00 am') = year(timestamp'2002-03-03 12:00:00 am'),'ok','nok');

select if(year('2002-03-03 12:00:00.001 am') = year(datetime'2002-03-03 12:00:00 am'),'ok','nok');

$varchar, $2002-03-03
select year(?) from db_root;

$varchar, $2002-03-03
select if (year(?) = year('2002-03-03'), 'ok','nok') from db_root;
