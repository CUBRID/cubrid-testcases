--+ holdcas on;
---- ALTER TABLE ...  CHANGE COLUMN  , type change : NUMERIC to FLOAT
...
-- should fail
alter table t1 change n1 f1 float;
-- should fail (prec)
...
-- should fail
alter table t1 change n1 f1 float unique;
-- should fail : prec
