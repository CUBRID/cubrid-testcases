...
alter table t1 change i1 f1 float not null default 4, modify class attribute c_i varchar(10);
...
alter table t1 change i1 f1 float not null default 4, modify class attribute c_i date;
...
alter table t1 change i1 f1 float unique default 4, modify class attribute c_i varchar(10);
