...
-- altering a column in a class hierarchy with multiple inheritance , change type
...
alter table b1 change i i bigint;
...
-- altering a column in a class hierarchy with multiple inheritance , change default

create class b1 (i varchar(10));

create class b2 (i varchar(10));
...
alter table b1 change i i varchar(20);
