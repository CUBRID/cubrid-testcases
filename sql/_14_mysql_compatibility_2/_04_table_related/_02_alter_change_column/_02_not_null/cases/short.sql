...
create table t1 ( i short );
insert into t1 values (11),(0),(NULL),(32767),(-32767);
select * from t1 order by 1;
show columns in t1;

alter table t1 change i i1 short not NULL;
...
create table t1 ( i short );
insert into t1 values (11),(0),(32767),(-32767);
select * from t1 order by 1;
show columns in t1;
