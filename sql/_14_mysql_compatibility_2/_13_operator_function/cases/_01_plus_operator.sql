...
select  cast (1 as smallint) + time'12:00:00' from db_root;
select  cast (1 as integer) + time'12:00:00' from db_root;
select  cast (1 as bigint) + time'12:00:00' from db_root;

select  cast (-1 as smallint) + time'13:00:00' from db_root;
select  cast (-1 as integer) + time'13:00:00' from db_root;
select  cast (-1 as bigint) + time'13:00:00' from db_root;

select  cast (2 as smallint) + time'23:59:59' from db_root;
select  cast (2 as integer) + time'23:59:59' from db_root;
select  cast (2 as bigint) + time'23:59:59' from db_root;

select  cast(-1 as smallint) + time'00:00:00' from db_root;
select  cast(-1 as integer) + time'00:00:00' from db_root;
select  cast(-1 as bigint) + time'00:00:00' from db_root;
...
select  cast(-1 as smallint) + date'2010-01-01' from db_root;
select  cast(-1 as integer) + date'2010-01-01' from db_root;
select  cast(-1 as integer) + date'2010-01-01' from db_root;

select  cast(-1 as smallint) + date'0001-01-01' from db_root;
select  cast(-1 as integer) + date'0001-01-01' from db_root;
select  cast(-1 as integer) + date'0001-01-01' from db_root;

select  cast(1 as smallint) + date'9999-12-31' from db_root;
select  cast(1 as integer) + date'9999-12-31' from db_root;
select  cast(1 as integer) + date'9999-12-31' from db_root;
...
select  cast(-1 as smallint) + datetime'2010-01-01 12:00:00' from db_root;
select  cast(-1 as integer) + datetime'2010-01-01 12:00:00' from db_root;
select  cast(-1 as integer) + datetime'2010-01-01 12:00:00' from db_root;

select  cast(-1 as smallint) + datetime'0001-01-01 12:00:00' from db_root;
select  cast(-1 as integer) + datetime'0001-01-01 12:00:00' from db_root;
select  cast(-1 as integer) + datetime'0001-01-01 12:00:00' from db_root;

select  cast(1 as smallint) + datetime'9999-12-31 12:00:00' from db_root;
select  cast(1 as integer) + datetime'9999-12-31 12:00:00' from db_root;
select  cast(1 as integer) + datetime'9999-12-31 12:00:00' from db_root;
--timestamp
