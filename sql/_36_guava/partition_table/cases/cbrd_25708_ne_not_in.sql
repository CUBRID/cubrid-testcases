...
evaluate concat('4. TO_DAYS, NOT IN');
...
evaluate concat('6. UNIX_TIMESTAMP, NOT IN');
...
evaluate concat('7. ADD, !=');
SELECT /*+ recompile */ count(*) FROM add_tbl WHERE col != 7;
show trace;

evaluate concat('8. ADD, NOT IN');
...
evaluate concat('9. SUB, !=');
SELECT /*+ recompile */ count(*) FROM sub_tbl WHERE col != 13;
show trace;

evaluate concat('10. SUB, NOT IN');
...
evaluate concat('11. MUL, !=');
SELECT /*+ recompile */ count(*) FROM mul_tbl WHERE col != 5;
show trace;

evaluate concat('12. MUL, NOT IN');
...
evaluate concat('13. DIV, !=');
SELECT /*+ recompile */ count(*) FROM div_tbl WHERE col != 20;
show trace;

evaluate concat('14. DIV, NOT IN');
...
evaluate concat('15. ABS, !=');
SELECT /*+ recompile */ count(*) FROM abs_tbl WHERE col != -10;
show trace;

evaluate concat('16. ABS, NOT IN');
...
evaluate concat('17. CEIL, !=');
SELECT /*+ recompile */ count(*) FROM ceil_tbl WHERE col != 11;
show trace;

evaluate concat('18. CEIL, NOT IN');
...
evaluate concat('29. FLOOR, !=');
SELECT /*+ recompile */ count(*) FROM floor_tbl WHERE col != 10;
show trace;

evaluate concat('30. FLOOR, NOT IN');
...
evaluate concat('37. MOD, !=');
SELECT /*+ recompile */ count(*) FROM mod_tbl WHERE col != 10;
show trace;

evaluate concat('38. MOD, NOT IN');
