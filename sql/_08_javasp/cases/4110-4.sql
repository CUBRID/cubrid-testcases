...
call testResultSet('select * from kor id,name');
select testResultSet('select * from kor order by id,name') from db_root;
select testResultSet('select * from kor order by id,name') + 1 from db_root;
