...
-- In all of the following test cases, specifying a user-defined stored function as a column default is not allowed, and it returns an error in each case.

DROP TABLE IF EXISTS test_tbl;
DROP TABLE IF EXISTS test_tbl2;
DROP TABLE IF EXISTS test_tbl3;

--(with parameters) fail.
...
--javasp function using db connection. fail.
