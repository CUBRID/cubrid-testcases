--test update statistics on partition of hash partition class
...
update statistics on test_hash__p__p0;
update statistics on test_hash__p__p1;
update statistics on test_hash__p__p2;
update statistics on test_hash__p__p3;
