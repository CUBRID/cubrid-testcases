...
select 0 & (9223372036854775808-1) from db_root;
select 1 & (9223372036854775808-1) from db_root;
select -1 & (9223372036854775808-1) from db_root;
...
select 11 & -11 from db_root where !1 = (select 111 & -11 from db_root where 1 = 111 & -111);