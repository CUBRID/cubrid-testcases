...
SELECT u.name, g.name as groups FROM db_user AS u, TABLE(u.direct_groups) AS g(name) order by u.name;
...
evaluate 'ERROR: PUBLIC user can not execute set_password';
