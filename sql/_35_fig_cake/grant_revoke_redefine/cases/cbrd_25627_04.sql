...
select grantor_name, grantee_name, owner_name from db_auth where grantee_name != 'PUBLIC' order by grantor_name;
...
select class_name, owner_name from db_class where class_name in ('tbl', 'tbl2');
