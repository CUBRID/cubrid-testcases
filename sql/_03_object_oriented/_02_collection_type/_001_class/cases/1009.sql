--Create a class with collection type: list of
create class t1(c1 list of integer, c2 list of varchar(10), 
                c3 list of date, c4 list of char(2),
                c5 list of timestamp, c6 list of bit(8));
