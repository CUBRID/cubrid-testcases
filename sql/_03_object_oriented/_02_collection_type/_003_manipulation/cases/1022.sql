--Test superset on set and multiset
...
select * from t1 where c1 superset {101,102,101,102};

select * from t1 where c1 superset multiset{101,102};
select * from t1 where c1 superset multiset{101,102,101,102};
