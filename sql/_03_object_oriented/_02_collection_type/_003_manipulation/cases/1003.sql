...
insert into DML_0002 values (1,'test1',{1,'test1'},a,{c,d}) into e; 
insert into DML_0002 values (2,'test2',{2,'test2'},b,{c,d}) into f;

insert into DML_0002 values(e);
insert into DML_0002 values(f);
select * from all DML_SUPER order by 1,2;
