...
delete from all DML_0001 where int_col = 1;

insert into DML_0001 values (1,'test1', {1,'test1'});
delete from all DML_0002 where ref_col.int_col = 1 and ref_col.set_col superseteq {1};

insert into DML_0002 values (1, 'test1', {1,'test1'}, a, {a, b, c});
delete from only dml_0001 where int_col =1;

insert into DML_0001 values (1,'test1', {1,'test1'});
delete from all DML_0001 (except DML_0004) where int_col = 1;
