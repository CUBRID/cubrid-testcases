--[er]Create reverse index with keyword asc/desc and datatype:set, multiset, list , sequence
...
create reverse index ddl_0001_idx2 on ddl_0001(col3 desc);
create reverse index ddl_0001_idx3 on ddl_0001(col4 asc);
