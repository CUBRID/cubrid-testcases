--Create unique index with keyword asc/desc and datatype: decimal,integer,smallint
...
create unique index ddl_0001_idx5 on ddl_0001(col1 asc,col2 desc);
create unique index ddl_0001_idx6 on ddl_0001(col1 desc, col2 asc, col3 desc, col4 asc, col5 asc);
create unique index ddl_0001_idx7 on ddl_0001(col3 desc, col4 asc, col5 desc);
create unique index ddl_0001_idx8 on ddl_0001(col1 desc, col2 asc, col4 desc);
create unique index ddl_0001_idx9 on ddl_0001(col5 desc, col3 asc, col1 desc);
create unique index ddl_0001_idx10 on ddl_0001(col5 desc, col2 asc, col4 desc);
