...
RIGHT OUTER JOIN DML_0001 t7 on t7.a not in (1,2,3,4,5,null) and t5.b=t6.b
LEFT OUTER JOIN DML_0002 t8 on t6.b  not in ( 'ooo' ) or t6.b not in ('bbb') and t1.a=t2.a and t3.a=t4.a
