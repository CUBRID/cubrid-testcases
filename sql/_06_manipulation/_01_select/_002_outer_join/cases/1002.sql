--test LEFT OUTER JOIN, RIGHT JOIN using in, not in clauses
...
LEFT OUTER JOIN (select a,b  from DML_0002 ) as  t4(a,b) on t2.a <= 3
...
select t1.a, t2.a from DML_0001 t1 RIGHT JOIN DML_0002 t2 on t1.a = t2.a or t1.a is null RIGHT JOIN DML_0001 t3 on t1.a >=3 LEFT OUTER JOIN (select a,b from DML_0002 ) as  t4(a,b) on t2.a <= 3 order by 1,2;

select t1.a, t2.a from DML_0001 t1 RIGHT JOIN DML_0002 t2 on t1.a = t2.a or t1.a is null        RIGHT JOIN DML_0001 t3 on t1.a >=3 LEFT OUTER JOIN (select * from DML_0002 ) as  t4(a,b) on t2.a <= 3 LEFT OUTER JOIN DML_0001    t5 on t1.b is not null order by 1,2;
...
LEFT OUTER JOIN DML_0001 t7 on t7.a in (1,2,3,4,5,null)
RIGHT OUTER JOIN DML_0002 t8 on t6.b not in ( 'ooo' )
LEFT OUTER JOIN (select a,b  from DML_0001 ) as  t9(a,b) on t2.a > 3
...
RIGHT OUTER JOIN DML_0002 t6 on t6.b is not null and  t2.b is not null
LEFT OUTER JOIN DML_0001 t7 on t7.a in (1,2,3,4,5,null)
RIGHT OUTER JOIN DML_0002 t8 on t6.b  in ( 'ooo' )
