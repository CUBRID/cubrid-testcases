--test LEFT OUTER JOIN, RIGHT OUT JOIN using a complicated query
...
select t1.a + t2.a -  t3.a * t4.a, t5.a * t6.a * t7.a - t8.a + t9.a,  t1.b,t2.b,t3.b,t4.b,t5.b,t6.b,t7.b
from (select a,b from DML_0001 ) as  t1(a,b) LEFT JOIN (select * from DML_0002 ) as t2(a,b) on t1.a = t2.a or t1.a is null
LEFT JOIn DML_0001 t3 on   t2.a in (1,2)
...
LEFT OUTER JOIN DML_0002 t6 on t6.b is null  
RIGHT OUTER JOIN DML_0001 t7 on t7.a   in (1,2,3,4,5,null) 
LEFT OUTER JOIN DML_0002 t8 on t6.b  not in ( 'ooo' )  
where t1.a is not null and t2.a is not null  and t3.a is not null 
and t4.a is not null 
and t7.b = 'oooo' and t4.b = 'oooo' and t3.b='oooo'
