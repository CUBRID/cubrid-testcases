--test LEFT JOIN using a select statement by clause and avg, sum functions
...
select avg(DML_0001.a+1*2) * sum(DML_0001.a) , DML_0002.b from DML_0001 LEFT JOIN ( select a,b from DML_0002 ) as DML_0002(a,b)
