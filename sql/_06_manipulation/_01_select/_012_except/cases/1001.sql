...
select * from all dml_0001 order by 1,2,3;
select * from all dml_0003 order by 1,2,3;
select * from all dml_0001 where int_col = (select Max(int_col) from all dml_0001) order by 1,2,3;
select * from all dml_0003 where int_col = (select Max(int_col) from all dml_0003) order by 1,2,3;
select * from only dml_0001 order by 1,2,3;
select * from only dml_0003 order by 1,2,3;
select * from all DML_0001 (EXCEPT DML_0003) order by 1,2,3;
select * from all DML_0001 (EXCEPT all DML_0004) order by 1,2,3;
select count(*) from all DML_0001, all DML_0002 order by 1;
select * from all DML_0003 (EXCEPT DML_0004) order by 1,2,3;
select * from all DML_0001 (EXCEPT (DML_0003,DML_0005)) order by 1,2,3;
select * from all DML_0001 (EXCEPT all DML_0003 (EXCEPT all DML_0004 (EXCEPT all DML_0005))) order by 1,2,3;
