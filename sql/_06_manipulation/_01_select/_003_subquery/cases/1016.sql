...
update DML_0002 set ref_col.int_col = 1,
ref_col = (select dml_0001 from dml_0001 where int_col=1), set_col = {1,2,3,4,5} where int_col = 1;
update DML_0002 set ref_col = (select dml_0001 from dml_0001 where int_col=1), set_col = {1,2,3,4,5} where int_col = 1;
