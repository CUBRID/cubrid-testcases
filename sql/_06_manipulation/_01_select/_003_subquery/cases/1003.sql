--[er]the number of subquery's selected columns and alias columns are not equal(2)
...
select a.int_col, b.int_col from (select * from dml_0001) as t1(a), (select * from dml_0002) as t2(b) order by 1;
