--[er]the number of subquery's selected columns and alias columns are not equal
...
select int_col, var_col, aa from dml_0001, (select * from dml_0002) as t1(aa) order by 1;
