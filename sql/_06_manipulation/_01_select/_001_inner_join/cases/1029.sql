--[er]test derived table using set type field which has two different type elements
...
select int_col, var_col, aa from dml_0001, table(set_col) as t(aa) order by 1;
