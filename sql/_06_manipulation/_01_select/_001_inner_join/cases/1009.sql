--[er]test derived table using a subquery and table operator with set type column
...
select int_col, var_col, aa from dml_0001, (select set_col,bb from dml_0002,table(set_col)as t1(bb)) as t2(aa) order by 1;
