--Test join with range partition
create class t1 (
...
insert into dept values(10, 'planning', 'NEW YORK');
insert into dept values(20, 'R&D', 'DALLAS');
insert into dept values(30, 'public_information', 'CHICAGO');
insert into dept values(40, 'account', 'BOSTON');
insert into dept values(50, 'sales', 'NEW YORK');


select e.empname, e.testdate, d.loc
from   t1 e inner join dept d
on     e.deptname = d.dname order by 1;
