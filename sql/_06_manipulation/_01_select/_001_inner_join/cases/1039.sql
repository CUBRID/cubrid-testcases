--[er]test derived table using table, cast functions and castting varchar to multiset type
...
select * from dml_0002, table(cast (int_col,var_col as multiset)) as t(aa) order by 1;
