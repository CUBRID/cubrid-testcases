--[er]test derived table using table function which used table keyword with int type
...
select int_col, var_col, aa from dml_0002, table(int_col) as t(aa) order by 1;
