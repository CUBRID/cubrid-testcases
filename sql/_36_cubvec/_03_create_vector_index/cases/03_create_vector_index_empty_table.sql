...
CREATE VECTOR INDEX idx_primary_key ON test_primary_key_table(vector_data COSINE);
DROP INDEX idx_primary_key ON test_primary_key_table(vector_data);
...
CREATE VECTOR INDEX idx_not_null ON test_not_null_table(vector_data COSINE);
DROP INDEX idx_not_null ON test_not_null_table(vector_data);
