...
alter table t add column c4 bit(10) unique not null default B'1100';
alter table t add column c4 bit(10) unique not null default null;
alter table t drop primary key;
alter table t add column c5 int primary key auto_increment default 0;
