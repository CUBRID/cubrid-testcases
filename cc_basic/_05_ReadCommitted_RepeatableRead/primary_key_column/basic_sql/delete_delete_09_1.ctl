...
Priority: 2
Reference case: cc_basic/_02_RepeatableRead/primary_key_column/basic_sql/delete_delete_09.ctl
...
3) All the data affected from C2 should be deleted since C1 rollback (Visibility Test)
...
C2: DELETE FROM t1 WHERE id IN (4,5);
