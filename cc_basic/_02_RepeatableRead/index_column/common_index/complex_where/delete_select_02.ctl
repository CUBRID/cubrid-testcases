...
C2: SELECT * FROM tb1 WHERE salary BETWEEN 300 AND 400 order by 1,2,3,4;
C2: SELECT * FROM tb1 WHERE salary NOT BETWEEN 300 AND 400 order by 1,2,3,4;
MC: wait until C2 ready;
C1: commit;
C1: DELETE FROM tb1 WHERE id=7;
MC: wait until C1 ready;
C2: SELECT * FROM tb1 WHERE name BETWEEN 'A' AND 'E' order by 1,2,3,4;
MC: wait until C2 ready;
C1: commit work;
MC: wait until C1 ready;
