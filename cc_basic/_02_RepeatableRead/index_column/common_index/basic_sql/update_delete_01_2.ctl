...
/* test case */
C1: UPDATE t1 SET col = 'abcd' WHERE id BETWEEN 4 AND 5 AND col != 'jkl';
MC: wait until C1 ready;
...
C2: commit;
/* expect: C2 select - id = 3 is deleted, but id = 5 is not updated */
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: the instances of id = 5 is updated & id = 3 is deleted */
