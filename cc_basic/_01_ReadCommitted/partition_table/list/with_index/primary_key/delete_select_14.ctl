...
C1: create table t1(t_date date primary key, client varchar(10)) partition by list (YEAR(t_date)) (partition p1 values in (2000,2004,2008), partition p2 values in (2001,2002,2003,2005,2006,2007,2009));
