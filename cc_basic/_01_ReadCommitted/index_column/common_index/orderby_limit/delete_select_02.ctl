...
Test Point:
there are simple order by keyword and limit keyword in select statement.
...
C2: select * from (SELECT id AS a1, avg(amount) AS a2 FROM tb1 GROUP BY a1 ORDER BY a2 DESC LIMIT 0, 3) t order by 1,2;
