...
/* test case */
C1: SELECT * FROM tb1 a INNER JOIN tb2 b ON a.id = b.id and a.id < 3 and sleep(1)=0;
C2: DELETE a,b FROM tb1 a INNER JOIN tb2 b ON a.id = b.id WHERE a.id between 1 and 4;
