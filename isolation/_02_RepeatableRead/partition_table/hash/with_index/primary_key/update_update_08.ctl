...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(4,'abc');insert into t1 values(5,'gh');
C1: commit work;
MC: wait until C1 ready;

/* C1 update, C2 update*/
C1: update t1 set id=id-1 where id>2;
MC: wait until C1 ready;
...
C2: commit;
MC: wait until C2 ready;
/* we can only see update result of C1 */
