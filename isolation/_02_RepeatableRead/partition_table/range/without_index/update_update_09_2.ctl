...
NUM_CLIENTS = 4 
C1: update on table t1: 1, 4, 10, 13. C1 block C2 and C3 on different objects 
C2: update on table t1: 1, 4, 10
C3: update on table t1: 4, 10, 13, 16
...
MC: wait until C1 ready;
C2: update t1 set id=id+1 where id<13;
