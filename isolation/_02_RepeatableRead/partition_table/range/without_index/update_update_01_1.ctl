...
C1: insert into t1 values(1,'abc');insert into t1 values(9,'def');insert into t1 values(10,'abc');insert into t1 values(12,'gh');insert into t1 values(15,'abc');
C1: commit work;
MC: wait until C1 ready;

/* C1 update, C2 update*/
C1: update t1 set col='aa' where id<10 and col='abc';
MC: wait until C1 ready;
C2: update t1 set col='bb' where id>10 and col='abc';
