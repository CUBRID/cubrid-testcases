...
NUM_CLIENTS = 2
C1: insert into t select rownum,rownum*2 from db_class a,db_class b,db_class c limit 1000000;
C2: insert into t select rownum,rownum*2-1 from db_class a,db_class b,db_class c limit 1000000; --expected no block
*/
