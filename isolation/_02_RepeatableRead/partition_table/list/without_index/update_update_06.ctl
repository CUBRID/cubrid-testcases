...
C1: create table t1(id int, col varchar(10)) partition by list (id) (partition p0 values in (1,3,5,7,9), partition p1 values in (2,4,6,8,10));
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(4,'ijk');insert into t1 values(5,'abc');insert into t1 values(6,'gh');
C1: commit work;
MC: wait until C1 ready;

/* test case */
C1: update t1 set id=id+1 where sleep(5)=0 and id>0;
MC: sleep 2;
C2: update t1 set id=id+2 where id=6;
