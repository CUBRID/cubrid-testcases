...
C1: insert into t1 values('2000-01-01','abc');insert into t1 values('2004-02-29','abc');insert into t1 values('2004-12-31','def');insert into t1 values('2005-12-31','gh');insert into t1 values('2006-07-01','def');insert into t1 values('2008-08-08','beijing');
C1: commit work;
