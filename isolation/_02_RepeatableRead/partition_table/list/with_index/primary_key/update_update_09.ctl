...
C1: insert into t1 values('2000-01-01','abc');insert into t1 values('2004-02-29','abc');insert into t1 values('2005-12-31','gh');insert into t1 values('2006-07-01','def');insert into t1 values('2008-08-08','beijing');
C1: commit work;
MC: wait until C1 ready;

/* C1 update, C2 update*/
C1: update t1 set client='aa' where YEAR(t_date)=2004;
C1: select * from t1 order by 1,2;
MC: wait until C1 ready;
C2: update t1 set client='bb' where YEAR(t_date)<2008;
