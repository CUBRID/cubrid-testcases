...
/* test case */
C1: UPDATE t1 SET id = 0 WHERE id = 5;
MC: wait until C1 ready;
...
C1: commit;
/* expect: 1 row (id=1) deleted message, C2 select - id = 1 is deleted, but id = 5 is existed and unchanged */
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: the instances of id = 1 is deleted, id = 5 is updated */
