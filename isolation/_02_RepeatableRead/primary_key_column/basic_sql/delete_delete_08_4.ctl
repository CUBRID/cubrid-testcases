...
Priority: 2
Reference case: cc_basic/_02_RepeatableRead/primary_key_column/basic_sql/delete_delete_08.ctl
...
3) All the data affected from C2 should be deleted (Visibility Test)
...
/* test case */
C1: DELETE FROM t1 WHERE id BETWEEN 2 AND 3;
MC: wait until C1 ready;
...
C1: rollback;
/* expect: 2 rows (id=2,3) deleted message should generated once C2 ready, C2 select - id = 2,3 are deleted */
