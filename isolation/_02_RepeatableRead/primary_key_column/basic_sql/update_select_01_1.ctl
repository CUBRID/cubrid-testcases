...
C1: CREATE TABLE tb1( col1 INT auto_increment primary key, col2 VARCHAR(10),col3 datetime, col4 int);
C1: insert into tb1(col2,col3,col4) values('tea','2012-9-8',NULL);
C1: commit;
