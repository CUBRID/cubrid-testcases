...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(4,'aaa');insert into t1 values(5,'abc');
C1: commit work;
...
/* we can only see C1's update result  */
