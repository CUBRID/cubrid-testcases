...
C2: SELECT * FROM hi order by id,col ASC;
C2: SELECT * FROM tt1 order by id,col ASC;
C2: commit work;
MC: wait until C2 ready;

C1: SELECT * FROM hi order by id,col ASC;
C1: SELECT * FROM tt1 order by id,col ASC;
C1: commit work;
MC: wait until C1 ready;
