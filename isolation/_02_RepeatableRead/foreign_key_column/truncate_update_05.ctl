...
C1: CREATE TABLE t_foreign(id INT,col VARCHAR(10),FOREIGN KEY(id) REFERENCES t_primary(id) ON DELETE CASCADE ON UPDATE SET NULL);
...
C2: INSERT INTO t_foreign VALUES(1,'test'),(2,'make');
C2: commit;
MC: wait until C2 ready;
