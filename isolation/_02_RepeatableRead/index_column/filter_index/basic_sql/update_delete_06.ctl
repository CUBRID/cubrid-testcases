...
/* test case */
C1: UPDATE t1 SET id = 3 WHERE id >= 4 AND id <= 5 USING INDEX idx_id;
MC: wait until C1 ready;
...
C1: commit;
/* expect: 0 row deleted message should generated once C2 ready, C2 select - id = 4,5 is unchanged ? */
MC: wait until C2 ready;
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: the instances of id = 4,5 is updated */
