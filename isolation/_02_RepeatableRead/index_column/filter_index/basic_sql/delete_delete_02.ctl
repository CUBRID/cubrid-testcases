...
C1 where clause is on index (i.e. index scan), C2 where clause id not on index (sequence scan) 
C1 commit, C2 commit
...
C1: commit;
/* expect: 0 row deleted message, C2 select - id = 3,4 are still visible */
