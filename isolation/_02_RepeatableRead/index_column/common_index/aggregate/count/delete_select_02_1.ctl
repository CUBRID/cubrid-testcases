...
C6: SELECT col,COUNT(id) FROM tb1 WHERE id BETWEEN 1 AND 9000 GROUP BY col ORDER BY col;
MC: wait until C6 ready;
C3: DELETE FROM tb1 WHERE id BETWEEN 100 AND 150; 
C2: rollback;
C3: commit;
C4: DELETE FROM tb1 WHERE id BETWEEN 200 AND 210 and (select sleep(1))=0;
MC: sleep 10;
MC: wait until C6 ready;
C4: commit;
C5: commit;
