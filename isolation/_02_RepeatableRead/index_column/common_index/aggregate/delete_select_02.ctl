...
C6: SELECT col,SUM(id),sleep(3) FROM tb1 WHERE id BETWEEN 10001 AND 19000 GROUP BY col ORDER BY col;
...
MC: wait until C4 ready;
MC: wait until C5 ready;
C6: SELECT col,SUM(id) FROM tb1 WHERE id BETWEEN 10001 AND 19000 GROUP BY col ORDER BY col;
C6: commit;
C6: quit;
C5: quit;
C4: quit;
