...
C2: SELECT t1.* FROM (SELECT * FROM tb1 AS t2 WHERE amount > 100 order by 1,2,3,4 limit 5) AS t1 LIMIT 1,3 ;
C2: SELECT t1.* FROM (SELECT * FROM tb1 AS t2 WHERE amount > 100 order by 1,2,3,4 limit 5) AS t1 LIMIT 3 OFFSET 1;
