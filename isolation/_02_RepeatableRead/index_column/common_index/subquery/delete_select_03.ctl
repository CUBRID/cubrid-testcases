...
MC: wait until C1 ready; 
C2: SELECT * FROM tb1 WHERE deptno in (SELECT deptno FROM tb1 WHERE name='Tom') ORDER BY id LIMIT 2;
MC: wait until C2 ready;
C1: SELECT * FROM tb1 WHERE deptno in (SELECT deptno FROM tb1 WHERE name='Tom') ORDER BY id LIMIT 2;
MC: wait until C1 ready; 
C2: commit;
C2: SELECT *, sleep(1) FROM tb1 WHERE deptno = (SELECT deptno FROM tb1 WHERE name='Tom') ORDER BY id LIMIT 2;
MC: wait until C2 ready; 
C1: rollback;
C1: SELECT * FROM tb1 WHERE deptno in (SELECT deptno FROM tb1 WHERE name='Tom') ORDER BY id LIMIT 2;
MC: wait until C1 ready; 
