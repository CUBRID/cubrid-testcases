...
C1 C2 where clauses are on index, C1 range-type search (i.e. mysql all-range search) 
C1 commit, C2 commit
...
C1: commit;
/* expect: 1 row (id=5)updated message, C2 select - id = 5 is updated, id = 1,2 are existed */
