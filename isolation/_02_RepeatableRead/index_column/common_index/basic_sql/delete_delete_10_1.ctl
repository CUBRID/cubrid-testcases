...
Priority: 2
Reference case: cc_basic/_02_RepeatableRead/index_column/common_index/basic_sql/delete_delete_10.ctl
...
C1: commit;
/* expect: 1 row (id=6)deleted message should generated once C2 ready, C2 select - id = 6 is deleted, id = 3-5 are still existed */
MC: wait until C1 ready;
...
/* expect: the instances of id = 3-6 is deleted */
