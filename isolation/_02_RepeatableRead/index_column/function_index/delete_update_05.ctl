...
C1: commit;
/* expect: 0 row updated message should generated once C2 ready, C2 select - id = 2 is not updated, but id = 4,7 are still visible */
MC: wait until C2 ready;
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: the instances of id = 4,7 is deleted, id = 2 is not updated */
