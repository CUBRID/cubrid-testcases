...
C1's updating the instances equal to the C2's delete instances (based on where clause)
C1 commit, C2 commit
...
C1: commit;
/* expect: 0 row deleted message should generated once C2 ready,C2 select - no data is deleted, but id = 2,3 are still unchanged */
