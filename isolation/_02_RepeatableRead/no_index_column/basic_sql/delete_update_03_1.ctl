...
C1's deleting the instances are included to the C2's updating instances
C1 commit, C2 commit
...
C1: commit;
/* expect: 0 row updated message should generated once C2 ready, C2 select - id = 3 is not updated, id = 2,4 are still existed */
MC: wait until C2 ready;
C2: SELECT * FROM t1 order by 1,2;
C2: commit;
/* expect: the instances of id = 2,4 are deleted, id = 3 is not updated */
