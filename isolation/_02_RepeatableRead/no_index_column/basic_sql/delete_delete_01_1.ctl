...
Priority: 2
Reference case: cc_basic/_02_RepeatableRead/no_index_column/basic_sql/delete_delete_01.ctl
...
C1: rollback;
/* expect: 1 row (id=6) deleted message, C2 select - id = 6 is deleted */
C2: SELECT * FROM t1 order by 1,2;
C2: commit;
/* expect: id = 6 is deleted */
