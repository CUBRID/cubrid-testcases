...
MC: wait until C1 ready;
C2: create index idx_t2_3 on t2(SUBDATE(birth_date,INTERVAL 24 HOUR)) with online parallel 2;
...
C2: commit;
MC: wait until C2 ready;
C1: select /*+ recompile */ * from t2 where SUBDATE(birth_date,INTERVAL 24 HOUR)='1999-12-31 00:00:00' using index idx_t2_3(+)  ;
C1: commit work;
MC: wait until C1 ready;
