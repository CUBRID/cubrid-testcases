...
MC: wait until C1 ready;
C2: create index idx_t2_3 on t2(md5(class_name)) with online parallel 2;
...
C2: commit;
MC: wait until C2 ready;
C1: select /*+ recompile */ * from t2 where md5(class_name) ='ba0a6ddd94c73698a3658f92ac222f8a' order by 1 desc ;
C1: commit work;
MC: wait until C1 ready;
