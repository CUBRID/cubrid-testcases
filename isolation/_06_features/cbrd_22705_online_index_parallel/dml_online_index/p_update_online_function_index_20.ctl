...
C1: create table t2(class_id bigint, class_name varchar(10),stu_id int, col1 date default '1999-01-01', col2 datetime default '1999-01-01 13:00:00',col3 timestamp default '1999-01-01 13:00:00', col4 time default '08:00:00', col5 char(1000) ) partition by list(stu_id)(partition p1 values in (1,4,8),partition p2 values in (-8,-16));
...
MC: wait until C1 ready;
C2: create index idx_t2_3 on t2(to_datetime(col2)) with online parallel 2;
