...
C1: create table t2(class_id bigint, class_name varchar(10),stu_id int, col1 date default '1999-01-01', col2 datetime default '1999-01-01 13:00:00',col3 timestamp default '1999-01-01 13:00:00', col4 time default '08:00:00', col5 char(1000) ) PARTITION BY LIST (class_id) (PARTITION p0 VALUES IN (1,2),PARTITION p1 VALUES IN (3,4));
