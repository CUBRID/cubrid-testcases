...
MC: wait until C1 ready;
C2: create index idx_t2_3 on t2(col1,col2,col3,col4,col5) where to_datetime(col2)='1999-01-01 13:00:00'  with online parallel 2;
...
C2: commit;
MC: wait until C2 ready;
C1: select /*+ recompile */ * from t2 where to_datetime(col2)='1999-01-01 13:00:00' using index idx_t2_3(+) order by 1 desc ;
C1: select /*+ recompile */ * from t2 where to_datetime(col2)='1999-01-01 13:00:00' using index none order by 1 desc ;
C1: commit work;
MC: wait until C1 ready;
