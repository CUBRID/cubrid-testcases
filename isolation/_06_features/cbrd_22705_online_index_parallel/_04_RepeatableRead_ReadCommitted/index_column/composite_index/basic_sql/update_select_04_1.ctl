...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(4,'ijk');insert into t1 values(5,'lmn');
C1: create index idx on t1(id,col) with online parallel 3;
C1: commit;
MC: wait until C1 ready;

/* test case */
C1: update t1 set id=4, col='ijk' where id=3 and col='abc';
