...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(4,'abc');insert into t1 values(5,'abc');insert into t1 values(6,'def');
C1: create index idx on t1(id, col) with online parallel 3;
C1: commit work;
MC: wait until C1 ready;

/* C1 update, C2 update*/
C1: update t1 set col='bb' where id<4 and col='abc';
MC: wait until C1 ready;
