...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'gh');insert into t1 values(4,'gh');insert into t1 values(1,'def');insert into t1 values(2,'abc');
