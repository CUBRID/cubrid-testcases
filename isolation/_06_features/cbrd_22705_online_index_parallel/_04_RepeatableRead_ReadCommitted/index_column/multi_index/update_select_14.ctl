...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'ghijk');insert into t1 values(4,'lmn');insert into t1 values(5,'opq');insert into t1 values(5,'rs');
...
/* test case */
C1: update t1 set id=4, col='t' where id=5 and col='opq';
MC: wait until C1 ready;
