/* 
Test Case: create & rollback
create index with online and rollback;
...
C1: create table t1 (b int, c char(250) default 'a');
...
C2: create unique index i on t1(b) with online parallel 2;
MC: wait until C2 blocked;

C3: insert into t1(b) values(7),(8),(9);
MC: wait until C3 blocked;

C4: insert into t1(b) values(1);
