/* 
Test Case: insert
insert duplicate data and commit while loading index with online;
insert into t1 set a=b+1,b=1,c=b;
...
C2: create unique index i on t1(b,c) with online parallel 5;
