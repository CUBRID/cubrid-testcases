/* 
Test Case: insert
insert and commit while loading index with online;
insert into t1 select * from t1 where b=2 on duplicate key update c='bbb';
...
C1: create table t1 (a int auto_increment, b int unique, c char(250));
...
C2: create unique index i on t1(b,c) with online parallel 4;
MC: wait until C2 blocked;

C3: insert into t1 select * from t1 where b=2 on duplicate key update c='bbb';
