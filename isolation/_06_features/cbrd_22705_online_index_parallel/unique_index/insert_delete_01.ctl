...
insert duplicate data and commit; 
delete duplicate data and rollback;
...
C2: create unique index i on t1(a) with online parallel 7;
MC: wait until C2 blocked;

C3: insert into t1 values (1);
MC: wait until C3 blocked;

C4: delete from t1 where a = 1;
