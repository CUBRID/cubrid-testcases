...
/* test case */
C1: set @newincr=0;
C1: insert into t select (@newincr:=@newincr+1),(@newincr)*2 from db_class a,db_class b,db_class c,db_class d limit 10000;
MC: wait until C1 ready;

C2: set @newincr=0;
C2: insert into t select (@newincr:=@newincr+1),(@newincr)*2-1 from db_class a,db_class b,db_class c,db_class d limit 10000;
