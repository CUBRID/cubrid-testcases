...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/foreign_key_column/insert_update_03.ctl
Author: Rong Xu
...
NUM_CLIENTS = 2
C1: update child set id=20 where id=1; -- violate fk constraint
C2: insert into father values(20,'mm'); -- expected ok
*/
...
MC: wait until C1 ready;
C2: insert into father values(20,'mm');
MC: wait until C2 ready;
C2: commit;
C1: commit;

/* expected father (20,mm)(1,'a'); child (1,'b') */
