...
C1: insert into t1 values('1984-01-08','def'),('1999-12-31','abc'),('2000-01-01','abc'),('2001-12-31','def'),('2012-07-02','def');
C1: commit work;
...
MC: wait until C1 ready;
C2: update t1 set t_date=t_date+3 where t_date>'2012-07-01';
