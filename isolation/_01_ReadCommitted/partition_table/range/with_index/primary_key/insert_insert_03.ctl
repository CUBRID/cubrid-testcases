...
C1: create table t(id int,col int primary key) partition by range(col)(partition p1 values less than (10000),partition p2 values less than (20001));
C1: commit work;
...
MC: wait until C1 ready;
C2: set @newincr=0;
C2: insert into t select (@newincr:=@newincr+1),(@newincr)*2-1 from db_class a,db_class b,db_class c limit 10000;
