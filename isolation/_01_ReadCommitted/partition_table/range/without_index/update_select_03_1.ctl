...
C1: insert into t1 values(1,'abc'),(9,'abc'),(9,'def'),(10,'abc'),(11,'gh'),(15,'def');
C1: commit work;
...
C1: select * from t1 where id<16 and col='aa' order by 1,2;
MC: wait until C1 ready;
C2: select * from t1 where id<16 and col='aa' order by 1,2;
