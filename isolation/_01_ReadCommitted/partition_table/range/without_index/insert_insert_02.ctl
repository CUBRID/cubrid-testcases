...
/* test case */
C1: set @newincr=0;
C1: insert into t select (@newincr:=@newincr+1),(@newincr)*2 from t1 a,t1 b,t1 c,t1 d,t1 e,t1 f limit 10000;
MC: wait until C1 ready;

C2: set @newincr=0;
C2: insert into t select (@newincr:=@newincr+1),(@newincr)*2-1 from t1 a,t1 b,t1 c,t1 d,t1 e,t1 f limit 10000;
