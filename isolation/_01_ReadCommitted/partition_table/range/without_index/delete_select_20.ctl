...
C1: insert into t1 values('1996-09-01','abc'),('1999-12-31','abc'),('2000-01-01','gh'),('2004-01-01','abc'),('2006-07-12','abc'),('2008-03-15','def'),(null,'abc');
C1: commit work;
MC: wait until C1 ready;

/* test case */
C1: delete from t1 where YEAR(t_date) in (1996,2000,2006);
