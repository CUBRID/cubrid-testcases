...
/* test case */
C1: update t1 set t_date=t_date+1 where YEAR(t_date) between 1990 and 1999;
C1: select * from t1 where YEAR(t_date)>1990 order by 1,2;
MC: wait until C1 ready;
C2: select * from t1 where YEAR(t_date)>1990 order by 1,2;
