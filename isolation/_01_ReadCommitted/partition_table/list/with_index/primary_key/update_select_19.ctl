...
C1: create table t1(t_date date primary key, client varchar(10)) partition by list (YEAR(t_date)) (partition p0 values in(2000,2004,2008), partition p1 values in(2001,2003,2005,2007), partition p2 values in(2002,2006));
