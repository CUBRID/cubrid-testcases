...
C1: create table t1(t_date date, client varchar(10)) partition by hash (YEAR(t_date)) partitions 3;
C1: insert into t1 values('2000-01-01','abc'),('2002-02-28','def'),('2004-02-29','abc'),('2005-12-31','gh'),('2006-07-01','def');
C1: commit work;
MC: wait until C1 ready;

/* test case */
C1: update t1 set t_date='2006-07-02' where YEAR(t_date) in (2000,2002,2006);
