...
C1: CREATE TABLE t1(id INT primary key, name VARCHAR(10), phone VARCHAR(10)) DONT_REUSE_OID;
C1: INSERT INTO t1 VALUES(1,'aaa','111-1111'), (2,'bbb','222-2222'), (3, 'ccc','333-3333'), (4, 'ddd', NULL), (5, NULL, NULL);
C1: CREATE TABLE t2(id int primary key, name VARCHAR(10)) DONT_REUSE_OID;
C1: INSERT INTO t2 VALUES(1,'stu'),(2,'vwx'),(3,'yzab'),(4,'abc');
C1: CREATE SERIAL s1;
C1: CREATE TRIGGER t1_insert AFTER INSERT ON t1 EXECUTE INSERT INTO t2 VALUES(s1.NEXT_VALUE, obj.name);
C1: CREATE TRIGGER t1_update AFTER UPDATE ON t1 EXECUTE INSERT INTO t2 VALUES(s1.NEXT_VALUE, 'update');
C1: commit;
...
C2: INSERT INTO t1 VALUES(6, 'ccc','666-6666');
MC: wait until C2 ready;
C1: SELECT * FROM t2 order by 1,2;
C1: ALTER TRIGGER t1_update STATUS INACTIVE;
MC: wait until C1 blocked;
C2: SELECT * FROM t2 order by 1,2;
C2: COMMIT;
MC: wait until C1 ready;
C1: update t1_view set id=7 where id=3;
