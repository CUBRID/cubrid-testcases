...
C2: ALTER TABLE t1 PROMOTE PARTITION p1;
...
C2: COMMIT;
MC: wait until C2 ready;
C2: ALTER TABLE t2 REORGANIZE PARTITION p1 INTO ( PARTITION P1_0 VALUES LESS THAN (6), PARTITION p1_1 VALUES LESS THAN (100));
MC: wait until C2 ready;
C1: SELECT * FROM t1_view order by 1,2;
