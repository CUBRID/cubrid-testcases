...
C1: CREATE TABLE t1(id int primary key, phone varchar(10)) DONT_REUSE_OID partition by range (id) (partition p0 values less than (6), partition p1 values less than (100));
C1: INSERT INTO t1 VALUES(1,'111-1111'), (2,'222-2222'), (3, '333-3333'), (4, NULL), (5, NULL), (6, '666-6666');
...
C1: ALTER TABLE t1 PROMOTE PARTITION p1;
C1: alter table t1 add partition(partition p3 values less than (3000));
MC: wait until C1 ready;
C2: INSERT INTO t1 VALUES(8,'888-8888');
...
C1: alter table t1 drop partition p3;
MC: wait until C1 ready;
C2: update t1_view set id=8 where id=1;
MC: wait until C2 blocked;
C1: SELECT * FROM t1_view order by 1,2;
C1: COMMIT;
MC: wait until C2 ready;
