...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/primary_key_column/basic_sql/insert_select_09.ctl
Author: Rong Xu
...
C1:insert begin;C2 begin;C1 commit;C2:select;
...
C2: select * from t where LENGTH(col)>1 order by 1,2;
C2: commit;
MC: wait until C2 ready;
