...
C1: INSERT INTO t1 VALUES(1,'abc','A','hello'),(2,'def','B','morning'),(3,'ghi','C','good'),(4,'jkl','D','test'),(5,'mno','E',NULL),(6,'pqr','F',NULL),(7,'stu','G','');
C1: COMMIT WORK;
MC: wait until C1 ready;

/* test case */
C1: UPDATE t1 SET col = 'abcd', description = NULL WHERE id BETWEEN 2 AND 3 or tag > 'F';
MC: wait until C1 ready;
...
/* expect: the instances of id = 2,3,7 are updated, id = 5,6 are deleted */
