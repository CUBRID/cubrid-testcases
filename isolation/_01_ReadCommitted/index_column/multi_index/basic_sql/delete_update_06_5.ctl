...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/index_column/multi_index/basic_sql/delete_update_06_4.ctl
Author: Ray
...
/* test case */
C1: DELETE FROM t1 WHERE id BETWEEN 4 AND 6;
MC: wait until C1 ready;
C2: UPDATE t1 SET id = 4, col = 'def' WHERE tag = 'E' or tag = 'A';
...
C2: commit;
MC: wait until C2 ready;
/* expect: id = 4,5,6 are deleted, no instance is updated */
