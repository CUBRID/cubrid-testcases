...
C1: insert into t1 values (1,5,'abc'), (2,3,'def'),(3,10,'gh'),(4,12,'abc'),(5,15,'ab'),(6,7,'aa');
...
/* test case */
C1: select * from t1 where id>2 and name like 'ab%' order by 1,2,3;
MC: wait until C1 ready;

C2: select * from t1 where name like 'a%' and age<15 order by 1,2,3;
