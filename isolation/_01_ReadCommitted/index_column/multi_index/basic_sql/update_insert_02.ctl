...
NUM_CLIENTS = 2
C1: update t set col=concat(col,'a') where id>0 and 0 = (select sleep(1)) using index idx;
C2: set @newincr=0;
C2: insert into t select (@newincr:=@newincr+1),(@newincr) ||'a' from t where id>0 limit 3;
*/
