...
C2: update on table t1;if C3 get the lock first, C2 will re-evaluate and update 
...
/* test case */
C1: update t1 set id=3, col='aa' where id<4 and col='abc';
MC: wait until C1 ready;
C2: update t1 set col='bb' where id>1 and id<6 and col like 'a%';
