...
/* test case */
C1: UPDATE t1 SET col = 'abc', id = 0 WHERE id BETWEEN 4 AND 6;
MC: wait until C1 ready;
C2: DELETE FROM t1 WHERE id < 1 or col = 'abc';
...
C2: commit;
MC: wait until C2 ready;
/* expect: the instances of id = 4,5,6 are updated, id = 1,7 are deleted */
