...
C1: insert into t1 values(1,'abc'),(2,'def'),(3,'ghijk'),(4,'lmn'),(5,'aaa'),(1,'lmn');
C1: create index idx on t1(id);
C1: create index idx_1 on t1(col);
C1: commit work;
MC: wait until C1 ready;

/* test case */
C1: update t1 set id=6, col='aaa' where id=1 and col='abc';
C1: commit;
MC: wait until C1 ready;
C2: update t1 set id=7 where id=6 and col='aaa';
