...
NUM_CLIENTS = 2
prepare(4,3)(5,d)(6,e) --(4,3a)(3,3a) overlap, expected didn't violate unique
C1: set @newincr=0;
C1: insert into t select (@newincr:=@newincr+1),concat((@newincr),'a') from (select sleep(1)) x, t limit 3;
C2: update t set col=concat(col,'a') where col>'1' and 0 = (select sleep(1)) using index idx;
*/
...
/* expected (4,3a)(5,da)(5,ea)(1,1a)(2,2a)(3,3a) */
