...
C1: set @newincr=0;
C1: insert into t select (@newincr:=@newincr+1)%10,(@newincr)%1000 from db_class a,db_class b,db_class c,db_class d limit 100000;
...
C5: insert into t select * from t where id between 2 and 4 ;/*and sleep2(6)=6;*/
MC: wait until C5 ready;
...
/* expected 10 group */
C6: select count(*) from t where col=1 ;/*and sleep2(3)=3;*/
...
C4: insert into t select * from t where id between 4 and 5 ;/*and sleep2(4)=4;*/
MC: wait until C4 ready;
