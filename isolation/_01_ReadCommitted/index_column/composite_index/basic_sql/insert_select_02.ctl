...
C2: select * from t where id=1 and sleep(1)=0; -- expected can not select (1,1)
*/
...
C1: set @newincr=0;
C1: insert into t select (@newincr:=@newincr+1)%100,(@newincr) from db_class a,db_class b limit 500;
