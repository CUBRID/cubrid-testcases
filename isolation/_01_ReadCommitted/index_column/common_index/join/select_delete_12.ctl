...
/* test case */
C1: SELECT * FROM tb1 a CROSS JOIN tb2 b WHERE a.id >4 and b.id >4 order by a.id;
MC: wait until C1 ready;
C2: DELETE a,b FROM tb1 a CROSS JOIN tb2 b WHERE a.id between 3 and 6 and b.id between 3 and 6;
