...
/* test case */
C1: SELECT * FROM tb1 a INNER JOIN tb2 b ON a.id = b.id and a.id between 2 and 6 order by 1;
MC: wait until C1 ready;

C2: DELETE a,b FROM tb1 a INNER JOIN tb2 b ON a.id = b.id WHERE a.id>3;
