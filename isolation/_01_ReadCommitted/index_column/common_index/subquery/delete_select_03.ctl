...
C1: INSERT INTO tb1 VALUES(104,'Carol','analyst',20),(105,'Jack','clerk',30),(106,'Jim','analyst',10);
...
C2: SELECT * FROM tb1 WHERE deptno = (SELECT deptno FROM tb1 WHERE name='Tom') ORDER BY id LIMIT 2;
MC: wait until C2 ready;
C1: SELECT * FROM tb1 WHERE deptno = (SELECT deptno FROM tb1 WHERE name='Tom') ORDER BY id LIMIT 2;
C1: rollback;
MC: wait until C1 ready;
