...
C1: update tb1 set col=concat('PR',col) where id%5=0;
MC: wait until C1 ready;
...
C5: DELETE FROM tb1 WHERE id BETWEEN 100010 AND 100020 AND 0=(select sleep(2));
MC: wait until C5 ready;
...
C6: SELECT DISTINCT col FROM tb1 WHERE id BETWEEN 100001 AND 150000 GROUP BY col ORDER BY col;
...
C4: DELETE FROM tb1 WHERE id BETWEEN 100200 AND 100210 and 0=(select sleep(2));
MC: wait until C4 ready;
/*
MC: sleep 6;
MC: wait until C6 ready;
