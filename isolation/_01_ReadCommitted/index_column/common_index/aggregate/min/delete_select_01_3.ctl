...
C5: DELETE FROM tb1 WHERE id BETWEEN 10 AND 20 AND 0=(select sleep(2));
...
C6: SELECT col,MIN(id) FROM tb1 WHERE id BETWEEN 1 AND 90000 GROUP BY col ORDER BY col;
...
C4: DELETE FROM tb1 WHERE id BETWEEN 200 AND 210 and 0=(select sleep(2));
/*MC: wait until C6 ready;*/
