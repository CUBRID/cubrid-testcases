...
C1: insert into t1 values(1,'abc'),(2,'def'),(3,'abc'),(3,'lmn'),(4,'lmn');
...
C1: select max(id), col from t1 where id>0 group by col;
MC: wait until C1 ready;
C2: select max(id), col from t1 where id>0 group by col;
