...
/* test case */
C1: UPDATE t1 SET col = 'abcd' WHERE col = 'def' or tag = 'E';
MC: wait until C1 ready;

C2: DELETE FROM t1 WHERE col LIKE '%ghi%';
/* expect: no transactions need to wait */
MC: wait until C2 ready;

/* expect: C1 select - id = 2,5 are updated */
...
/* expect: the instances of id = 2,5 are updated & id = 3 is deleted */
