...
C1: commit work;
C2: update t set id='2014-01-01 10:10:00' where id='2014-01-01 10:00:01'; --expected update successfully
*/
...
C2: update t set id='2014-01-01 10:10:00' where id='2014-01-01 10:00:01';
C2: commit;
