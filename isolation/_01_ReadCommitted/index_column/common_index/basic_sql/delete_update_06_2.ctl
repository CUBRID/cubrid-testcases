...
2) All the C1 instances won't be deleted because of C1 rollback, all the C2 instances will be updated 
...
/* test case */
C1: DELETE FROM t1 WHERE id = 1 or id > 5 or col = 'def';
MC: wait until C1 ready;
...
C1: rollback;
/* expect: 2 rows updated message should generated once C2 ready, C2 select - id = 2,7 are updated */
MC: wait until C2 ready;
C2: SELECT * FROM t1 order by 1,2;
C2: commit;
/* expect: id = 2,7 are updated */
