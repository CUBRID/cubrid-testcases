/*
Test Case: update with lob & update with lob
Priority: 1
Reference case:
...
/* test case */
C1: UPDATE t1 SET content = CHAR_TO_CLOB('test lob 2') WHERE CHAR_TO_CLOB(content) LIKE '%test lob 1%';
MC: wait until C1 ready;
...
/* expect: C2 - 0 rows updated, the id=1 is updated */
