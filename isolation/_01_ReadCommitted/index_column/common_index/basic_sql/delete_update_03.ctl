...
/* test case */
C1: DELETE FROM t1 WHERE col = 'def' or (tag BETWEEN 'D' AND 'E');
MC: wait until C1 ready;

C2: UPDATE t1 SET col = 'abc', tag = 'E' WHERE col like '%qr';
...
/* expect: the instances of id = 2,4,5 are deleted, id = 6 is updated */
