...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/no_index_column/basic_sql/delete_delete_10.ctl
...
2) All the C1 instances won't be deleted, all the instances of C2 will be deleted (Visibility Test)    
...
C1: rollback;
/* expect: 5 rows deleted message should generated once C2 ready,  C2 select - id = 1-5 are deleted */
