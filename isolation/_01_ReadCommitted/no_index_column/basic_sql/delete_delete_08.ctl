...
2) All the C1 instances won't deleted, but the C2 instances will - after revaluation (Visibility Test)
...
C1: rollback;
/* expect: 2 rows deleted message should generated once C2 ready,  C2 select - id = 5,6 are deleted */
