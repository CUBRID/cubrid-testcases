...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/no_index_column/join/delete_select_05.ctl
Author: Lily
...
C2: SELECT * FROM tb1 a LEFT JOIN tb2 b ON a.id = b.id WHERE a.id = 2 or b.col = 'yzab' order by a.id;
