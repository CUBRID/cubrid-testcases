...
/* test case */
C1: SELECT * FROM (select sleep(1)) x, tb1 a LEFT JOIN tb2 b ON a.id = b.id WHERE a.id between 2 and 6 order by a.id;
C2: DELETE a,b FROM tb1 a LEFT JOIN tb2 b ON a.id = b.id WHERE a.id < 3;
