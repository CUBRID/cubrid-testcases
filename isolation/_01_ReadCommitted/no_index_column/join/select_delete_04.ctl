...
C1: INSERT INTO tb2 VALUES(1,'stu'),(2,'vwx'),(13,'yzab'),(4,'abc'),(5,'def'),(6,'apple'),(7,'mno'),(8,'axe');
C1: commit work;
MC: wait until C1 ready;

/* test case */
C1: SELECT * FROM tb1 a INNER JOIN tb2 b ON a.id = b.id WHERE a.id in (2,3,4) order by a.id;
MC: wait until C1 ready;
