...
/* test case */
C1: SELECT * FROM (select sleep(2)) x, tb1 a INNER JOIN tb2 b ON a.id = b.id WHERE a.id = 2 or b.col = 'yzab' ;
MC: wait until C1 ready;

C2: DELETE a,b FROM tb1 a INNER JOIN tb2 b ON a.id = b.id WHERE a.id between 2 and 4;
