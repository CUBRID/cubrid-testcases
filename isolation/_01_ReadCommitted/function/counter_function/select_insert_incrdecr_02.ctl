...
2) C1 instances will be updated(increment) by using INCR function 
   C2 instances won't be inserted because of the duplicate key constraint(after reevaluation)
...
C1: commit;
/* expect: a duplicate key constraint error message should be generated once C2 ready, no instance is inserted */
MC: wait until C1 ready;
