...
C1: CREATE INDEX idx_title_read on t1 (title,read_count);
...
C1: commit;
/* expect: 1 row (id=7)updated message should be generated once C2 ready, C2 select - id = 7 is are updated after reevaluation*/
MC: wait until C1 ready;
