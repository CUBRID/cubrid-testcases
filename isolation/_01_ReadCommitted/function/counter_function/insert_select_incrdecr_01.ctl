...
2) C1 instances will be inserted 
   C2 instances won't be updated because of the duplicate key constraint(after reevaluation)
...
C1: commit;
/* expect: a duplicate key constraint error message should be generated once C2 ready, no instance is updated */
MC: wait until C2 ready;
C2: SELECT * FROM t1 order by 1,2;
C2: commit;
/* expect: the instances of id = 8 is inserted, no instance is updated */
