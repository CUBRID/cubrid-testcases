...
2) C1 instances won't be inserted since C1 rollback, the last_insert_id requested by C1 will be retrieved based on its own snapshot(session) 
...
/* test case */
C1: INSERT INTO t1 (col,tag) VALUES('xyz','H'),('abcd','I'),('fdgr','J');
MC: wait until C1 ready;

C2: INSERT INTO t1 (col,tag) VALUES('abcd','K'),('thutw','L');
