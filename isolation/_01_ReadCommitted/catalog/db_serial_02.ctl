...
C4: select name, current_val, increment_val, max_val, min_val, cyclic, started, class_name, attr_name, cached_num, comment from db_serial;
...
C3: drop SERIAL s3;
MC: wait until C3 ready;
C1: select name, current_val, increment_val, max_val, min_val, cyclic, started, class_name, attr_name, cached_num, comment from db_serial;
