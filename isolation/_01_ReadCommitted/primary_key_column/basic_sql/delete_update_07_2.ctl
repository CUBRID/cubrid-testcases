...
2) C1 instances will be deleted, C2 instances will be updated (since the duplicate key has been deleted)
...
/* test case */
C1: DELETE FROM t1 WHERE id IN (1,5,7);
MC: wait until C1 ready;
C2: UPDATE t1 SET id = 1 WHERE col = 'ghi';
...
C2: commit;
/* expect: id = 1,5,7 are deleted, id = 3 is updated */
