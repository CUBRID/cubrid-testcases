...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/no_index_column/basic_sql/insert_update_06.ctl
Author: Rong Xu
...
C2: update t set id=id+1,col='c' where id>0;
*/
...
/* result should be (1,b)(2,b)(3,b)(6,c)(7,c)(8,c) */
