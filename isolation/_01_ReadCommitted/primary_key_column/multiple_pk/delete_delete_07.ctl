...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/primary_key_column/multiple_pk/delete_delete_04.ctl
Author: Ray
...
MC: wait until C1 ready;
C2: DELETE FROM t1 WHERE col = 'def' or col = 'ghi' or col = 'jkl';
...
C2: commit;
/* expect: all the instances except id = 2,3,4 are deleted */
