...
/* expected 10 group */
C6: select distinct col from t, (select sleep(3)) x where id between 1 and 1000;
C3: insert into t values(2,'cc');
C2: commit;
MC: wait until C2 ready;
C3: commit;
MC: wait until C3 ready;
C4: insert into t select id-12,col from t where id between 3 and 4 and sleep(2)=0;
