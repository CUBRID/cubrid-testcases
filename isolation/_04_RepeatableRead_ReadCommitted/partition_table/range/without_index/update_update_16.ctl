...
C1: insert into t1 values(1,'abc');insert into t1 values(8,'def');insert into t1 values(10,'abc');insert into t1 values(11,'gh');insert into t1 values(NULL,'def');insert into t1 values(NULL,'abc');
C1: commit work;
MC: wait until C1 ready;

/* test case */
/* C1 does not cross partitions; C2 cross partitions*/
C1: update t1 set id=12 where id is null;
MC: wait until C1 ready;
C2: update t1 set id=15;
