...
C1: insert into t1 values('1990-12-31','abc');insert into t1 values('1984-01-08','def');insert into t1 values('1999-12-31','abc');insert into t1 values('2000-01-01','abc');insert into t1 values('2001-12-31','def');insert into t1 values('2012-07-02','def');
C1: commit work;
MC: wait until C1 ready;

/* test case */
/* both updates cross partitions */
C1: update t1 set t_date='1999-09-01' where t_date>'2002-02-01';
MC: wait until C1 ready;
C2: update t1 set t_date=t_date+1 where t_date>'1990-09-01';
