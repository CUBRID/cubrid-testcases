...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(2,'abc');insert into t1 values(9,'def');insert into t1 values(10,'abc');insert into t1 values(11,'gh');
C1: commit work;
MC: wait until C1 ready;

/* test case */
/* do not cross partitions */
C1: update t1 set id=id-1 where id between 2 and 9;
