...
C1: insert into t1 values('1996-09-01','abc');insert into t1 values('1999-12-31','def');insert into t1 values('2000-01-01','abc');insert into t1 values('2004-01-02','gh');insert into t1 values('2007-03-15','def');
C1: commit work;
