...
C1: insert into t1 values(1,'abc');insert into t1 values(5,'def');insert into t1 values(5,'def');insert into t1 values(9,'abc');insert into t1 values(10,'abc');insert into t1 values(15,'def');
C1: commit work;
