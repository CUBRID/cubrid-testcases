...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/foreign_key_column/update_insert_01.ctl
Author: Rong Xu
...
MC: wait until C1 ready;
C2: update father set id=200 where id=1;
...
/* expected father (200,'a'); child no value */
