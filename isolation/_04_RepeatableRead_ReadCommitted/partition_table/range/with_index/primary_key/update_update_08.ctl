...
C1: insert into t1 values(1,'abc');insert into t1 values(10,'def');insert into t1 values(11,'abc');insert into t1 values(12,'gh');insert into t1 values(15,'def');
C1: commit work;
...
MC: wait until C1 ready;
C2: update t1 set id=id-4 where id>10;
