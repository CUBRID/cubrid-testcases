...
C1: insert into t1 values(1,'abc');insert into t1 values(8,'def');insert into t1 values(9,'abc');insert into t1 values(12,'gh');insert into t1 values(15,'def');
C1: commit work;
MC: wait until C1 ready;

/* C1 update, C2 update*/
/* the where clause in C2 cross partitions; C1 and C2 update result cross partitions */
C1: update t1 set id=id+3 where id<8;
MC: wait until C1 ready;
C2: update t1 set id=id-2 where id>8;
