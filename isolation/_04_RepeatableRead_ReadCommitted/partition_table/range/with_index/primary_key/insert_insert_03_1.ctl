...
/* test case */
C1: insert into t select rownum*2,rownum from db_class a,db_class b,db_class c where rownum <= 10000;
MC: wait until C1 ready;
C2: insert into t select rownum*2-1,rownum from db_class a,db_class b,db_class c where rownum <= 10000;
