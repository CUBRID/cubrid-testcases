...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(1,'def');insert into t1 values(1,'def');
...
MC: wait until C1 ready;
C2: select * from t1 where id=1 and col='def' order by 1,2;
