...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(1,'def');insert into t1 values(1,'abc');
...
/* test case */
C1: update t1 set col='aa' where id=1 and col='abc';
MC: wait until C1 ready;
C2: select * from t1 where id=1 and col not like 'dd' order by 1,2;
