...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'ghijk');insert into t1 values(4,'lmn');insert into t1 values(5,'opq');insert into t1 values(1,'lmn');
...
MC: wait until C1 ready;
C2: select * from t1 where id>0 and col not like 'cc' and (select sleep(10))=0 order by 1,2;
MC: sleep 2;
C1: commit;
MC: wait until C1 ready;
