...
/* test case */
C1: insert into t values('2014-01-01 10:10:10','abc');
MC: wait until C1 ready;
C2: insert into t values('2014-01-01 10:00:20','abc');
C2: commit work;
MC: wait until C2 ready;

/* expected update failed */
C1: update t set id='2014-01-01 10:10:10' where id='2014-01-01 10:00:20';
C1: commit;
