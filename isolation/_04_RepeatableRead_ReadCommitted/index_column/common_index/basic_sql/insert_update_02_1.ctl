...
C1: commit work;
C2: update t set id='2014-01-01 10:20:00' where id='2014-01-01 10:00:01'; --expected update successfully
*/
...
C1: create table t(id timestamp unique,col varchar(10));
C1: commit work;
...
C1: commit work;
MC: wait until C1 ready;
C2: update t set id='2014-01-01 10:20:00' where id='2014-01-01 10:00:01';
C2: commit;
