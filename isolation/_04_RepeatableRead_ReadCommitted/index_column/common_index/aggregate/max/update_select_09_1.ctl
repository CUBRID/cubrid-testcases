...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(4,'ijk');insert into t1 values(3,'lmn');
...
MC: wait until C1 ready;
/*  get 5*/
C2: select max(id) from t1 where sleep(2)=0 and id>0;
MC: sleep 2;
C1: rollback;
MC: wait until C1 ready;
/* get 5*/
