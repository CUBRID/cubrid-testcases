...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(1,'ijk');insert into t1 values(4,'lmn');insert into t1 values(4,'abc');
