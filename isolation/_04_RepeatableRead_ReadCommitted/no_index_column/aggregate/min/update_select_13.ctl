...
C1: insert into t1 values(2,'abc');insert into t1 values(3,'def');insert into t1 values(4,'abc');insert into t1 values(2,'ijk');insert into t1 values(0,'lmn');
C1: commit;
...
/* C1 get 1; C2 get 2*/
C1: select col,min(id) from t1 group by col order by 1,2;
MC: wait until C1 ready;
