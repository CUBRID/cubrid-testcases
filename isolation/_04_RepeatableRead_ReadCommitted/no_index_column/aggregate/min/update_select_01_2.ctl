...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(2,'abc');insert into t1 values(3,'ijk');insert into t1 values(4,'lmn');
C1: commit;
MC: wait until C1 ready;

/* test case */
C1: update t1 set id=3 where col='abc';
MC: wait until C1 ready;
