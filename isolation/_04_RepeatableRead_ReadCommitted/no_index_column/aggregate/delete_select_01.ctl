...
C1: INSERT INTO tb1 SELECT rownum,rownum%100 FROM db_class a,db_class b,db_class c,db_class d where rownum <= 1000;
C1: commit;
...
/* test case */
C1: DELETE FROM tb1 WHERE mod(id,5)=0 and 0=(select sleep(3));
/* expected 4999950000 */ 
C2: SELECT SUM(id) FROM tb1;
