...
C1's updated results affect a portion of the C2's deleting instances (case 2)
C1 commit, C2 commit
...
/* test case */
C1: UPDATE t1 SET id = 8 WHERE col = 'abc';
MC: wait until C1 ready;
...
/* expect: the instances of id = 1,7 are updated, no instance is deleted */
