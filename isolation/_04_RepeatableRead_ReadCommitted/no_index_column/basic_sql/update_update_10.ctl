...
3. C2 commit, C1 get the lock, re-evaluate and update.

NUM_CLIENTS = 3
C1: update all the rows one by one; blocked; re-evaluate and update
...
/* test case */
C1: update t1 set col='aa' where id>0 and (select sleep(10))=0;
MC: sleep 2;
