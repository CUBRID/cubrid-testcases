...
C1's updating the instances are intersected with the C2's deleting instances
...
C1: commit;
/* expect: 3 rows deleted message should generated once C2 ready, C2 select - id = 4,5,6 are deleted */
MC: wait until C2 ready;
C2: SELECT * FROM t1 order by 1,2;
C2: commit;
/* expect: id = 7 is updated, id = 4,5,6 are deleted */
