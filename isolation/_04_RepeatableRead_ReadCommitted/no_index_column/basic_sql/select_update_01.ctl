...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(4,'def');insert into t1 values(1,'a');
C1: commit;
MC: wait until C1 ready;

/* test case */
C1: select * from t1 where col='def' order by 1,2;
MC: wait until C1 ready;
