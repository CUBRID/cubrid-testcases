...
Test Plan: 
Test DELETE/UPDATE locks (X_LOCK on instance) if the instances of the transactions are overlapped

Test Scenario:
C1 delete, C2 update, the affected rows are totally overlapped(whole table interaction)
