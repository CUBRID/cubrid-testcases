...
C1: INSERT INTO tb1 SELECT rownum,rownum%100 FROM db_class a,db_class b,db_class c,db_class d where rownum <= 10;
C1: commit;
...
/* test case */
C1: UPDATE tb1 SET id=id+10 WHERE mod(id,2)=0 ;
/*MC: wait until C1 ready;*/
MC: sleep 1;
