...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/primary_key_column/basic_sql/update_update_09.ctl
Author: Mandy
...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(3,'gh');insert into t1 values(4,'ijk');insert into t1 values(5,'lmn');
C1: commit work;
