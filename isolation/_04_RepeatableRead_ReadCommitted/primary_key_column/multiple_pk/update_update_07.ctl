...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(3,'def');insert into t1 values(4,'abc');insert into t1 values(5,'abc');insert into t1 values(6,'def');
C1: commit work;
