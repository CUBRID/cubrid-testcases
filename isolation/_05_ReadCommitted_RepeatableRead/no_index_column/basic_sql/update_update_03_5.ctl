...
If the first transaction commits, the second transaction must be aborted. C1's update results decreases the record number to 0 in
 C2's where condition.
...
/* test case */
C1: update t1 set id=3 where id<4;
