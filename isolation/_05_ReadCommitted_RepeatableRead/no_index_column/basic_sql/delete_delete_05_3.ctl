...
Priority: 1
Reference case: cc_basic/_02_RepeatableRead/no_index_column/basic_sql/delete_delete_05.ctl
...
C1 delete instances intersect with in C2 delete instances 
...
MC: wait until C1 ready;
/* expect: C2 select - all data are selected */
...
C1: commit;
/* expect: 2 rows (id=1,2) deleted message should generated once C2 ready, C2 select - id = 1,2 are deleted, id = 3,4 are still existed */
MC: wait until C2 ready;
C2: SELECT * FROM t1 order by 1,2;
C2: commit;
/* expect: id = 1-4 are deleted */
