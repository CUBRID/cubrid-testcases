...
C1's updating the instances equal to the C2's delete instances
C1 commit, C2 commit
...
C1: commit;
/* expect: 0 rows deleted message should generated once C2 ready,C2 select - id = 2,3 are unchanged */
MC: wait until C2 ready;
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: no instances are deleted, id = 2,3 are updated */
