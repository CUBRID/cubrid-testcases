...
C1: CREATE TRIGGER tt1_ins AFTER INSERT ON tt1 EXECUTE INSERT INTO hi(id,col) VALUES(obj.id, obj.col);
C1: commit work;
MC: wait until C1 ready;

/* test case */
C1: INSERT INTO tt1 VALUES(1,'test');INSERT INTO tt1 VALUES(2,'call');INSERT INTO tt1 VALUES(3,'cool');
MC: sleep 1;
