...
Priority: 2
Reference case: cc_basic/_02_RepeatableRead/primary_key_column/basic_sql/delete_delete_11.ctl
...
Test Point:
1) C1, C2 doesn't need to wait (Locking Test)
...
/* test case */
C1: DELETE FROM t1 WHERE col = 'aaa';
MC: wait until C1 ready;
C2: DELETE FROM t1 WHERE col = 'aaa';
