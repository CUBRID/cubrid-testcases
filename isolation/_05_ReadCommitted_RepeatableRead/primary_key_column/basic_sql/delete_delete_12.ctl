...
Reference case: cc_basic/_02_RepeatableRead/primary_key_column/basic_sql/delete_delete_11.ctl
				cc_basic/_02_RepeatableRead/primary_key_column/basic_sql/delete_delete_03.ctl
...
C1: commit;
/* expect: 0 row deleted message, C2 select - no data is deleted, id = 1 is still existed */
