...
C1: create table t_sub1(id int primary key, val int(10), constraint fk_id foreign key (id) REFERENCES t (id) ON update RESTRICT );
...
MC: wait until C1 ready;
C2: insert into t_sub1 values(2,222);
