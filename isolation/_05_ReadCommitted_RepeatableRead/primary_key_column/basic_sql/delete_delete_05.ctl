...
/* test case */
C1: DELETE FROM t1 WHERE id = 2 OR col = 'jkl';
MC: wait until C1 ready;
...
C1: commit;
/* expect: 2 rows (id=3,6) deleted message, C2 select - id = 3,6 are deleted, but id = 2,4 are still existed */
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: the instances of id = 2,3,4,6 are deleted */
