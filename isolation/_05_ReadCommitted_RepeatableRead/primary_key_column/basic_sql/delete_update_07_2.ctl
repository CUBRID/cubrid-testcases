...
Author: Ray
Notes: this case is just for reference (mysql behavior)
...
C1: commit;
/* expect: C2 select - id = 3 is updated, id = 4,5 are still existed */
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: the instances of id = 3 is updated, whereas id = 4,5 are deleted */
