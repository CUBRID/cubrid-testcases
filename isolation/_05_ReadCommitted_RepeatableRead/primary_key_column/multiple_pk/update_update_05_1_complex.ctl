...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(5,'abc');
C1: commit work;
...
MC: wait until C1 ready;
C2: update t1 set col='aa' where id<6 and id>1;
MC: wait until C2 blocked;
C3: update t1 set col='bb' where id>2; 
