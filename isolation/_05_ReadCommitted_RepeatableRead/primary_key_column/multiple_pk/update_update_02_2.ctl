...
C1: insert into t1 values(1,'abc');insert into t1 values(2,'def');insert into t1 values(3,'abc');insert into t1 values(3,'ijk');insert into t1 values(5,'gh');
C1: commit work;
MC: wait until C1 ready;

/* test case */
C1: update t1 set id=0, col='aa' where id=3 and col='abc';
