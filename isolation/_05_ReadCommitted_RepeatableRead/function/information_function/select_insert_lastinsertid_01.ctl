...
Test Scenario:
C1 select LAST_INSERT_ID, C2 insert
...
3) the last_insert_id requested by C1 will be retrieved based on its own snapshot(session) 
...
/* test case */
/* expect: C1 select - last insert id = 7 is selected */
