...
C1: select class_name, owner_name, class_type, is_system_class, tde_algorithm, partitioned, is_reuse_oid_class, collation, comment from db_class where owner_name='PUBLIC';
C1: commit;
...
C2: INSERT INTO tb1 VALUES(2,'abc',10);
