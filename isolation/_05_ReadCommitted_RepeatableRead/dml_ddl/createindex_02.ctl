...
C1: INSERT INTO tb_a SELECT rownum,mod(rownum,200) FROM db_class a,db_class b,db_class c,db_class d limit 50000;
C1: INSERT INTO tb_b SELECT rownum,mod(rownum,200) FROM db_class a,db_class b,db_class c,db_class d limit 50000;
