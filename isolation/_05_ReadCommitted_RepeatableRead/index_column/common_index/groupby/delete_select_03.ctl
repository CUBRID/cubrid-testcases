...
Test Point:
there are a simple GROUP BY and HAVIING keyword in select statement.
...
C2: SELECT id AS a1, avg(amount) AS a2 FROM tb1 WHERE amount > 200 GROUP BY a1 HAVING a2 > 200 ORDER BY a2;
