...
C2: UPDATE t1 set id = 2 WHERE id = 6;
...
/* expect: 1 row (id=6)updated message, C2 select - id = 6 is updated, but id = 2,3 are still existed */
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
MC: wait until C2 ready;

/* expect: the instances of id = 2,3 is deleted, id = 6 is updated */
