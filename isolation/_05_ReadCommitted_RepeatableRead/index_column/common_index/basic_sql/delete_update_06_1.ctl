...
C1 C2 where clauses are on index, C1 range-type search (i.e. mysql range search, C2 at C1 right) 
C1 commit, C2 commit
...
C1: commit;
/* expect: 1 row (id=5)updated message, C2 select - id = 5 is updated, id = 3,4 are existed */
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: the instances of id = 3,4 are deleted, id = 5 is updated */
