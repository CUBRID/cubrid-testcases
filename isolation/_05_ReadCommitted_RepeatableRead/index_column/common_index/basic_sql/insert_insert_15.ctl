...
Priority: 2
Reference case: cc_basic/_01_ReadCommitted/primary_key_column/basic_sql/insert_insert_15.ctl
Author: Rong Xu
...
/* test case */
C1: insert into t(id,col) select rownum,'a' from db_class a,db_class b,db_class c where rownum <= 1000;
MC: wait until C1 ready;
