...
C1: insert into t values(1,'abc');insert into t values(3,'a bc');insert into t values(7,'ta a');insert into t values(2,' A ');insert into t values(4, 'a a a');insert into t values(5,'pass A');
