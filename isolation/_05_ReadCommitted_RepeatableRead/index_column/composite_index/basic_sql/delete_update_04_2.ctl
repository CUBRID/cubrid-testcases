...
Priority: 2
Reference case: cc_basic/_02_RepeatableRead/index_column/composite_index/basic_sql/delete_update_04.ctl
...
C1 where clause is on index (i.e. index scan), C2 where clause is on composite index
...
/* test case */
C1: DELETE FROM t1 WHERE id = 0;
MC: wait until C1 ready;
C2: UPDATE t1 set id = 0 WHERE id = 3 AND col = 'ghi';
