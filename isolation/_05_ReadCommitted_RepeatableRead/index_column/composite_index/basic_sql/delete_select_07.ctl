...
C1: INSERT INTO tb1 SELECT mod(rownum,10),mod(rownum,50),mod(rownum,100) FROM db_class a,db_class b,db_class c, db_class d where rownum<=10000;
C1: CREATE INDEX idx_all ON tb1(id,acol,name);
C1: commit work;
MC: wait until C1 ready;

/* test case */
C1: DELETE FROM tb1 WHERE id< 2 and name > 70 ;
MC: sleep 1;
C2: SELECT * FROM tb1 WHERE id < 2 and name >90 ORDER BY id; 
