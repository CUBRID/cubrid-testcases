...
C2: DELETE FROM t1 WHERE id = 2 AND col = 'def';
...
C1: commit;
MC: wait until C1 ready;
/* expect: 0 row deleted message should generated once C2 ready, C2 select - no data is deleted, id = 2 is still visible */
