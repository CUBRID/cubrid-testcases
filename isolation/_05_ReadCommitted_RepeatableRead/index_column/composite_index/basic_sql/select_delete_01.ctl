...
C1: CREATE TABLE tb1( id INT, acol VARCHAR(10), name VARCHAR(10));
...
MC: wait until C1 ready;
C2: DELETE FROM tb1 WHERE acol='3' and name='3';
C2: SELECT * FROM tb1 WHERE acol ='7' and name ='7' ORDER BY id;
MC: wait until C2 ready;
C1: SELECT * FROM tb1 WHERE acol='3' and name='3' order by id;
C1: commit;
