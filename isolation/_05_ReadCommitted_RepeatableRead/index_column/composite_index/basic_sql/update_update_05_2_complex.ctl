...
MC: wait until C1 ready;
C2: update t1 set col='bb' where id<5 and col like 'a%';
MC: wait until C2 blocked;
C3: update t1 set id=0 where col='abc'; 
MC: wait until C3 blocked;
C1: commit;
/* C2 abort and return error, and we cannot see C1' update result at this time */
