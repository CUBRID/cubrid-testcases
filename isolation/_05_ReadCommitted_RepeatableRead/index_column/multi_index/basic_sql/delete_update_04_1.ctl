...
3) C1 instances shouldn't be deleted since rollback, C2 instances shouldn't be updated since unique key violation
...
C1: rollback;
/* expect: an unique key violation message should generated once C2 ready, C2 select - no data is updated */
MC: wait until C2 ready;
C2: SELECT * FROM t1 ORDER BY 1,2;
C2: commit;
/* expect: no data is deleted/updated */
