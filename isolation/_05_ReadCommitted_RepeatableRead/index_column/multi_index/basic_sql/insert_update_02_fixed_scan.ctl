...
C1: insert into t select rownum,rownum+70 from (select sleep(1)) x, t where id>0 where rownum <= 3; --expected blocked
...
C1: insert into t select rownum, rownum+70 from t where id>0 and rownum <= 3;
