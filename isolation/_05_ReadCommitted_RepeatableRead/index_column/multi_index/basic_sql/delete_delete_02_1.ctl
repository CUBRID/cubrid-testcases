...
C1 where clause is on both indexes (i.e. index all scan), C2 where clause is on one index column 
C1 commit, C2 commit
...
C1: commit;
/* expect: 1 row (id=3) deleted message should generated once C2 ready, C2 select - id = 3 is deleted, but id = 5 is still visible */
